...
Propósito:				Permite insertar y modificar datos en la tabla com_normativa_interna
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			...
			$nombre_normativa=$_GET["nombre_normativa_interna_$j"];
			$descripcion_normativa=$_GET["descripcion_normativa_interna_$j"];
			//PARA SUBIR ARCHIVO
		...
		else
		{
			...
			$nombre_normativa=$_POST["nombre_normativa_interna_$j"];
			$descripcion_normativa=$_POST["descripcion_normativa_interna_$j"];
			//PARA SUBIR ARCHIVO
			$txt_archivo = $_FILES["ni_ruta_archivo"]["tmp_name"];
			$ruta_archivo= ($_FILES["ni_ruta_archivo"]["name"]);
			$extension_archivo = $_FILES["ni_ruta_archivo"]["type"];
		...
		if ($id_normativa == "undefined" || $id_normativa== "")
		{
			...
			////////////////////Inserción/////////////////////
					...
					$res = $Custom -> InsertarNormativas($id_normativa,$nombre_normativa,$descripcion_normativa,$ruta_archivo);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarNormativas($id_normativa,$nombre_normativa,$descripcion_normativa,$ruta_archivo);
	...
	if($sortdir == "") $sortdir = " ";
	if($criterio_filtro == "") $criterio_filtro = "0=0 and NI.ni_estado_registro=''activo''";
