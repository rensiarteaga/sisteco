...
Propósito:				Permite eliminar registros de la tabla com_normativa_interna
Tabla:					com_normativa_interna
Parámetros:				$id_normativa_interna
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarNormativas($id_normativa);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($sortcol == "") $sortcol = "NI.id_normativa_interna";
	if($sortdir == "") $sortdir = "asc";
	if($criterio_filtro == "") $criterio_filtro = "NI.ni_estado_registro=''activo''";
