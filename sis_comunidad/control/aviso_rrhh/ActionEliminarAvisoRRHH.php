...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarAvisoRRHH.php
Propósito:				Permite eliminar registros de la tabla com_avisos_rrhh
Tabla:					com_avisos_rrhh
Parámetros:				$id_aviso_rrhh
...
$nombre_archivo = "ActionEliminarAvisoRRHH.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarAvisoRRHH($id_aviso);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($sortdir == "") $sortdir = "  ";
	if($criterio_filtro == "") $criterio_filtro = "RRHH.rrhh_estado_registro=''activo''";
