...
$nombre_archivo = "ActionEliminarSistemas.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarSistemas($id_sistema);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($criterio_filtro == "") $criterio_filtro = "SIST.sis_estado_registro=''activo''";
