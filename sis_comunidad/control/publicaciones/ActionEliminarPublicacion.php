...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarPublicacion.php
Propósito:				Permite eliminar registros de la tabla com_publicaciones
Tabla:					com_publicaciones
Parámetros:				$id_publicacion
...
$nombre_archivo = "ActionEliminarPublicacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			$id_publicacion= $_GET["id_publicacion_$j"];
		}
		else
		{
			$id_publicacion = $_POST["id_publicacion_$j"];				
		}
		...
		{	//Eliminación
			$res = $Custom-> EliminarPublicacion($id_publicacion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($criterio_filtro == "") $criterio_filtro = "PUB.pub_estado_registro=''activo''";
