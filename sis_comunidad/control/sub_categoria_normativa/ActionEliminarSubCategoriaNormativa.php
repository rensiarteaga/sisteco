...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarSubCategoriaNormativa.php
...
$nombre_archivo = "ActionEliminarSubCategoriaNormativa.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDetalleNormativa($id_detalle_normativa);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($criterio_filtro == "") $criterio_filtro = "DN.estado_registro=''activo''";//$criterio_filtro = "TIPSER.id_tipo_servicio=''$m_id_tipo_servicio''";
