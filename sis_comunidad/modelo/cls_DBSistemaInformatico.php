<?php
/**
 * Nombre de la Clase:	cls_DBSistemaInformatico
 * Propósito:			Permite ejecutar la funcionalidad de la tabla com_sistema_informatico
 * Autor:				Morgan Huascar Checa Lopez
 * Fecha creación:		14-05-2013
 *
 */
class cls_DBSistemaInformatico
{
	...
	//Nombre del archivo
	var $nombre_archivo = "cls_DBSistemaInformatico.php";
	...
	function ListarSistemas($cant,$puntero,$sortcol,$sortdir,$criterio_filtro)
	{
		...
		$this->codigo_procedimiento = "'CO_SISTINF_SEL'";
		...
		$this->var->add_def_cols('id_sistema_informatico','integer');
		$this->var->add_def_cols('nombre_sistema_informatico','varchar');
		$this->var->add_def_cols('enlace_sistema','varchar');
		$this->var->add_def_cols('sis_fecha_registro','date');
