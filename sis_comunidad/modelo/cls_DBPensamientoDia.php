 ...
 * Propósito:			Permite ejecutar la funcionalidad de la tabla com_pensamiento_dia
...
class cls_DBPensamiento
{
	...
	/**
	 * Nombre de la función:	InsertarPensamiento
	 * Propósito:				Permite ejecutar la función de inserción de la tabla comunidad.com_pensamiento_dia
	 * Autor:				    (Morgan Huascar Checa Lopez)
	 * Fecha de creación:		15-05-2013
	 * Descripción:             
