...
class cls_DBIngresos 
{
	...
	var $codigo_procedimiento; // codigo del procedimiento a ejecutar
	                           // Nombre del archivo
	var $nombre_archivo = "cls_DBIngresos.php";
	...
	/**
	 * Nombre de la función:	ListarIngresosFinalizados
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tai_ingresos_sel';
		$this->codigo_procedimiento = "'AL_INGRESOS_SEL'";
		...
		$this->var->add_def_cols('id_ingresos','integer');
		...
		$this->var->add_def_cols('desc_mov_proy','text');
	 	...
	 	$this->var->add_def_cols('desc_costeo','varchar');
	 	//añadido 12-05-2015
	 	$this->var->add_def_cols('seleccionado','varchar');
	...
	/**
	 * Nombre de la función:	ContarIngresosFinalizados
	...
	function ContarIngresosFinalizados($cant, $puntero, $sortcol, $sortdir, $criterio_filtro, $id_financiador, $id_regional, $id_programa, $id_proyecto, $id_actividad) 
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tai_ingresos_sel';
		$this->codigo_procedimiento = "'AL_INGRESOS_COUNT'";
	...
	/**
	 * Nombre de la función:	EliminarIngresosFinalizados
	 * Propósito:				Eliminar registros de la tabla tal_ingresos mediante filtros
	 * Autor:					UNKNOW
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tai_ingresos_iud';
		$this->codigo_procedimiento = "'AL_INGRE_DEL'";
		
		// Instancia la clase midlle para la ejecución de la función de la BD
		$this->var = new cls_middle($this->nombre_funcion, $this->codigo_procedimiento, $this->decodificar);
		
		// Carga parámetros específicos (no incluyen los parámetros fijos)
		$this->var->add_param("$hidden_id_ingresos");//al_id_ingresos
		$this->var->add_param("NULL");//al_id_movimiento_proyecto
		$this->var->add_param("NULL");//al_id_costeo
		//añadido12-05-2015
		$this->var->add_param("NULL");//al_sw_seleccionado
	...
	function InsertarIngresosFinalizadoso($id_ingresos, $id_costeo, $id_mov_proyecto,$seleccionado)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tai_ingresos_iud';
		$this->codigo_procedimiento = "'AL_INGRE_INS'";
		 
		// Instancia la clase midlle para la ejecución de la función de la BD
		$this->var = new cls_middle($this->nombre_funcion, $this->codigo_procedimiento, $this->decodificar);
		$this->var->add_param("NULL");//al_id_ingresos
		$this->var->add_param("$id_mov_proyecto");//al_id_movimiento_proyecto
		$this->var->add_param("$id_costeo");//al_id_costeo
		//añadido12-05-2015
		$this->var->add_param("'$seleccionado'");//al_sw_seleccionado
	...
	function ModificarIngresosFinalizados($id_ingresos, $id_costeo, $id_mov_proyecto, $seleccionado)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tai_ingresos_iud';
		$this->codigo_procedimiento = "'AL_INGRE_UPD'";
		
		// Instancia la clase midlle para la ejecución de la función de la BD
		$this->var = new cls_middle($this->nombre_funcion, $this->codigo_procedimiento, $this->decodificar);
		
		$this->var->add_param("$id_ingresos");//al_id_ingresos
		$this->var->add_param("$id_mov_proyecto");//al_id_movimiento_proyecto
		$this->var->add_param("$id_costeo");//al_id_costeo
		//añadido12-05-2015
		$this->var->add_param("'$seleccionado'");//al_sw_seleccionado
