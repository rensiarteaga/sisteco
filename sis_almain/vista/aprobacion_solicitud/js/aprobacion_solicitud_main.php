...
var elemento={pagina:new PaginaAprobacionSolicitud(idContenedor,direccion,paramConfig),idContenedor:'<?echo $idContenedor;?>'};
_CP.setPagina(elemento);
}
Ext.onReady(main,main);

/**
 * Nombre: aprobacion_solicitud.js Autor: Ruddy Ljan Bravo Fecha creación:
 * 25-09-2013
 */
