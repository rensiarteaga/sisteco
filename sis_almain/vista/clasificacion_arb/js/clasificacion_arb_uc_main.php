...
var maestro={m_id_unidad_constructiva:<?php echo $m_id_unidad_constructiva;?>};

var elemento={pagina:new pagina_clasificacion_arb_uc(idContenedor,direccion,paramConfig,maestro),idContenedor:idContenedor};
