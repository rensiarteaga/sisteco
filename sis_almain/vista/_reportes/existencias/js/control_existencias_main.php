...
var elemento={pagina:new ControlExistenciasAlmacen(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);

function ControlExistenciasAlmacen(idContenedor,direccion,paramConfig)
{
	var vectorAtributos=new Array;
    var Atributos=new Array;
    var componentes= new Array();
	var datax,combo_tipo_mov,combo_almacen,identif;
	...
	vectorAtributos[0] = {
		validacion:{
			...
			store:ds_almacen,
		//	onSelect:function(record){vectorAtributos[5].setValue(record.data.id_almacen); componentes[20].setValue(record.data.descripcion); componentes[5].collapse(); },,
	...
	vectorAtributos[1]={
			validacion:{
				fieldLabel: 'Item',
						...
						onSelect:function(record){componentes[1].setValue(record.data.id_item); componentes[1].collapse(); },
						typeAhead: false,
						forceSelection : true,
						mode: 'remote',
						queryDelay: 50,
	...
	//Inicia Layout
	var config={
		titulo_maestro:'Control Existencias'		
	};
	...
	var paramFunciones = {
		...
		height:'70%',
		url:direccion+'../../../../control/_reportes/existencias/ActionReporteControlExistencias.php',
		...
		minHeight:400,	
		closable:true,
		titulo:'Control de Existencia de Materiales',
		
		grupos:[
				{tituloGrupo:'Detalle',columna:0,id_grupo:0}
			]
		}	
	};
	...
	{		
		...
		{
			componentes[1].store.baseParams = {	filtro_stock:'si',id_almacen:ClaseMadre_getComponente('id_almacen').getValue()};
