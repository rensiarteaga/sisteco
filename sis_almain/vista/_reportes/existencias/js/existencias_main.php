...
function ExistenciasAlmacen(idContenedor,direccion,paramConfig)
{
	...
	var ds_item= new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: direccion+'../../../../control/item/ActionListarItem.php?existencias=si'}),
	...
	{		
		...
		var onComboAlmacenSelected=function (e)
		{
             ...
             {
            	 cmb_item.enable();
    			 cmb_item.store.baseParams={
						id_almacen : combo_almacen.getValue(),
						todos : 'si'
    	    			 };
