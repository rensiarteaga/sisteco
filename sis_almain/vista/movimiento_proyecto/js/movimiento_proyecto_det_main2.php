...
{	 
	...
	this.reload = function(m) 
	{
			...
			if(maestro.estado == 'borrador')
				enableCosteoButtons;
			else if(maestro.estado == 'finalizado')
			{
				alert(maestro.estado);
	...
	function formatDate(value) {	return value ? value.dateFormat('d/m/Y h:i:s a') : '';	};

	function disableCosteoButtons()
	{
		//cm_getBoton('nuevo-'+idContenedor).disable();
		cm_getBoton('editar-'+idContenedor).disable();
		cm_getBoton('eliminar-'+idContenedor).disable();
		//cm_getBoton('carga_archivos-'+idContenedor).disable();
		//cm_getBoton('term_solicitud-'+idContenedor).disable(); 
	}
	
	function enableCosteoButtons()
	{
		...
		//cm_getBoton('term_solicitud-'+idContenedor).enable();
	}
	
	//datos necesarios para el filtro
	var paramFunciones = {
			btnEliminar : {
				url : direccion+ "../../../control/movimiento_proyecto_det/ActionEliminarMovimientoProyectoDet.php"
			},
			Save : {
				url : direccion+ "../../../control/movimiento_proyecto_det/ActionGuardarMovimientoProyectoDet.php"
			},
			ConfirmSave : {
				url : direccion
			...
			Formulario : {
				titulo : 'Registro de Detalle Movimiento Proyecto',
