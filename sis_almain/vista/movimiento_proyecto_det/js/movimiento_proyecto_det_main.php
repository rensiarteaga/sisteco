...
var elemento={idContenedor:idContenedor,pagina:new PaginaDetalleMovimientoProyecto(idContenedor,direccion,paramConfig,idContenedorPadre,estado_pagina)};
...
function PaginaDetalleMovimientoProyecto(idContenedor,direccion,paramConfig,idContenedorPadre,estado_pagina)
{	 
	 ...
	 var ds = new Ext.data.Store(
			{
				proxy : new Ext.data.HttpProxy(
						{
							url :direccion+ '../../../control/movimiento_proyecto_det/ActionListarMovimientoProyectoDet.php'
						}),
				reader : new Ext.data.XmlReader({ 
					...
					totalRecords : 'TotalCount'
						...
						'id_unidad_medida_base', 'nombre_medida', 'usuario_reg','costo_unitario','precio_unitario',
						{
							name : 'fecha_reg',
							type : 'date',
							dateFormat : 'd-m-Y'
	...
	var layout_detalle_movimiento_proyecto_det = new DocsLayoutMaestro(idContenedor);
	...
	////////////////////////
	this.pagina = Pagina;
	this.pagina(paramConfig, vectorAtributos, ds, layout_detalle_movimiento_proyecto_det,idContenedor);
	...
	{	
		CM_btnNew();
		CM_getComponente('id_movimiento_proyecto').setValue(maestro.id_movimiento_proyecto);		
	}
	...
	this.reload = function(m) 
	{
			...
			paramFunciones.btnEliminar.parametros='&m_id_movimiento_proyecto='+maestro.id_movimiento_proyecto;
			paramFunciones.Save.parametros='&m_id_movimiento_proyecto='+maestro.id_movimiento_proyecto;
			paramFunciones.ConfirmSave.parametros='&m_id_movimiento_proyecto='+maestro.id_movimiento_proyecto;
