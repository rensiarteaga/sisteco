...
//var master={id_unidad_const:<?php //echo $id_unidad_const;?>};
     	
var elemento={pagina:new PaginaItemUC(idContenedor,direccion,paramConfig),idContenedor:'<?echo $idContenedor;?>'};
