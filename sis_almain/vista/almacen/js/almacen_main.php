...
var elemento={pagina:new PaginaAlmacen(idContenedor,direccion,paramConfig),idContenedor:'<?echo $idContenedor;?>'};
...
function PaginaAlmacen(idContenedor, direccion, paramConfig) {
	...
	this.AdicionarBoton('../../../lib/imagenes/lock.png','Activar/Inactivar', btnActivarInactivarAlmacen, false,'activarInactivarAlmacen', 'Activa o Inactiva un Almacen');
