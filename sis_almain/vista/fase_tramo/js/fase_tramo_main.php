...
var elemento={pagina:new PaginaDetalleFaseTramo(idContenedor,direccion,paramConfig,aux),idContenedor:'<?echo $idContenedor;?>'};
...
function PaginaDetalleFaseTramo(idContenedor,direccion,paramConfig,aux)
{	 
