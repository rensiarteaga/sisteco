...
{	 
	...
	this.btnNew = function() {
			...
			if (maestro.nombre_tipo != 'ingreso')
			{
				CM_ocultarComponente(costo_tot);
				costo_tot.allowBlank=true;
			...
			else if(maestro.nombre_tipo == 'ingreso' || maestro.nombre_tipo == 'transpaso_ingreso') 
			{
				CM_mostrarComponente(costo_tot);
				costo_tot.allowBlank=false;
		...
		this.reload = function(m) 
		{
			...
			else if (maestro.estado == "borrador") 
			{
				...
				//si tipo_movimiento=='transpaso_ingreso' no permite añadir nuevo items
			...
			else
			{
				...
				if (maestro.nombre_tipo == 'ingreso' || maestro.nombre_tipo == 'transpaso_ingreso')
				{
