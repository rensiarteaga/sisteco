...
CREATE OR REPLACE FUNCTION alma.f_tal_detalle_movimiento_sel (
...
/************************************************************************** SISTEMA ENDESIS - SISTEMA ALMACENES*************************************************************************** 
 SCRIPT:         alma.f_tal_detalle_movimiento_sel
...
DECLARE
  ...
  g_consulta text;
  -- VARIABLE QUE CONTENDRA LA CONSULTA DINAMICA PARA EL FILTRO
  g_nivel_error varchar; -- VARIABLE QUE CONTIENE EL NIVEL DE ERROR
  --      ERROR DE SINTAXIS (cuando llega a exception) = 1
  --      ERROR LOGICO (CRITICO) = 2
...
BEGIN
  ...
  g_nombre_funcion := 'f_tal_detalle_movimiento_sel';
  ...
  IF pm_codigo_procedimiento  = 'AL_DETMOV_SEL' THEN
    BEGIN
      g_consulta := 'SELECT 
							...
							FROM alma.tal_detalle_movimiento dem
                            INNER JOIN alma.tal_movimiento mov ON mov.id_movimiento = dem.id_movimiento
                            INNER JOIN alma.tal_item itm ON itm.id_item = dem.id_item
