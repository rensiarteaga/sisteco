...
***************************************************************************
 ...
 DESCRIPCIÃ?N:     Devuelve las consultas a la tabla tal_ubicacion
    ...
    IF pm_codigo_procedimiento  = 'AL_ALUB_SEL' THEN
        BEGIN
              ...
              g_consulta := 'SELECT 	ub.usuario_reg,
                            ...
                            FROM alma.tal_ubicacion ub
                            INNER JOIN alma.tal_almacen al on ub.id_almacen=al.id_almacen AND al.estado=''activo''
                            WHERE ';
