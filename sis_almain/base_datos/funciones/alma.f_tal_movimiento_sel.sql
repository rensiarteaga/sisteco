...
DECLARE
  ...
  g_consulta text; -- VARIABLE QUE CONTENDRAÂ LA CONSULTA DINAMICA PARA EL FILTRO
...
BEGIN
  ...
  IF NOT (g_privilegio_procedimiento OR
    ...
    'El usuario no tiene permisos de ejecuciÃ??Ã?Â³n del procedimiento';
    g_respuesta := param.f_pm_mensaje_error(g_descripcion_log_error,
      g_nombre_funcion, g_nivel_error, pm_codigo_procedimiento);
