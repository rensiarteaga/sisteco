...
CREATE OR REPLACE FUNCTION alma.f_tal_detalle_unidad_constructiva_sel (
...
***************************************************************************
 SCRIPT:          alma.f_tal_detalle_unidad_constructiva_sel
...
BEGIN
    ...
    g_nombre_funcion := 'f_tal_detalle_unidad_constructiva_sel';
    ...
    IF pm_codigo_procedimiento  = 'AL_DETUNICONST_SEL' THEN
        BEGIN
            g_consulta := 'select detunic.id_detalle_unidad_constructiva
                          ...
                          from alma.tal_detalle_unidad_constructiva detunic
                          inner join alma.tal_unidad_constructiva unic on unic.id_unidad_constructiva = detunic.id_unidad_constructiva
                          inner join alma.tal_item it on it.id_item = detunic.id_item
