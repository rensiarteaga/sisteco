...
CREATE OR REPLACE FUNCTION alma.f_tai_stock_item_iud (
...
***************************************************************************
 ...
 DESCRIPCIÃ??N:    insercion, modificacion y eliminacion de la tabla alma.tai_stock_item
 AUTOR:           UNKNOW
 FECHA:           
 COMENTARIOS:    
***************************************************************************
...
---*** SI NO SE TIENE PERMISOS DE EJECUCIO?N SE RETORNA EL MENSAJE DE ERROR
  ...
  --procedimiento de modificacion      
	...
	BEGIN
            ...
            if EXISTS (	select 1 from alma.tai_stock_item s 
            			where s.id_item = al_id_item and s.id_almacen=al_id_almacen and s.id_stock_item != al_id_stock_item)
  			then
