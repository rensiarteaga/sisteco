...
CREATE OR REPLACE FUNCTION alma.f_tal_fase_tramo_sel (
...
***************************************************************************
 SCRIPT: 		 alma.f_tal_fase_tramo_sel
...
BEGIN
    ...
    g_nombre_funcion := 'f_tal_fase_tramo_sel';
    ...
    IF pm_codigo_procedimiento  = 'AL_FATRAM_SEL' THEN
        BEGIN
            g_consulta := 'SELECT fatram.id_fase_tramo,fatram.id_fase,fas.codigo||'' - ''||fas.descripcion as desc_fase
                          ...
                          FROM alma.tal_fase_tramo fatram
                          INNER JOIN alma.tal_fase fas on fas.id_fase=fatram.id_fase AND fas.estado=''activo''
                          INNER JOIN alma.tal_tramo tra on tra.id_tramo=fatram.id_tramo  AND tra.estado=''activo''
