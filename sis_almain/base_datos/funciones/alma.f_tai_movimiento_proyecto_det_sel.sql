...
CREATE OR REPLACE FUNCTION alma.f_tai_movimiento_proyecto_det_sel (
...
/************************************************************************** SISTEMA ENDESIS - SISTEMA ALMACENES*************************************************************************** 
 SCRIPT:         alma.f_tai_movimiento_proyecto_det_sel
***************************************************************************/
...
BEGIN
  ...
  g_nombre_funcion := 'f_tai_movimiento_proyecto_det_sel';
  ...
  IF pm_codigo_procedimiento  = 'AL_DETPROYMOV_SEL' THEN
    BEGIN
      g_consulta := 'SELECT COALESCE(to_char(movdet.fecha_reg,''dd-mm-yyyy''),''0'') AS fecha_reg,
                           ...
                           --aÒadido 12-05-2015
                           ,movdet.costo_unitario as precio_unitario
                           ,movdet.calculo_costeado as costo_unitario
                           
                    FROM alma.tai_movimiento_proyecto_det movdet
                    INNER JOIN alma.tai_item it ON it.id_item=movdet.id_item
                    INNER JOIN alma.tai_movimiento_proyecto movpro ON movpro.id_movimiento_proyecto=movdet.id_movimiento_proyecto
