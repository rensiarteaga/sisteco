...
CREATE OR REPLACE FUNCTION alma.f_tal_unidad_constructiva_sel (
...
***************************************************************************
 SCRIPT: 		 alma.f_tal_unidad_constructiva_sel
 DESCRIPCION: 	 Devuelve las consultas a la tabla alma.tal_unidad_constructiva
 AUTOR: 		 UNKNOW
 FECHA:			 11-08-2014
***************************************************************************/
...
BEGIN
    ...
    g_nombre_funcion := 'f_tal_unidad_constructiva_sel';
    ...
    IF pm_codigo_procedimiento  = 'AL_UNICONST_SEL' THEN
        BEGIN
            g_consulta := 'SELECT 
                               ...
                               ,uni.orden
                               ,uni.cod_tramo
							FROM alma.tal_unidad_constructiva uni
                            WHERE ';
            ...
            THEN
            	IF EXISTS(SELECT 1 FROM alma.tal_unidad_constructiva uc WHERE uc.id_unidad_constructiva_fk=g_registros.id_unidad_constructiva)
                THEN
