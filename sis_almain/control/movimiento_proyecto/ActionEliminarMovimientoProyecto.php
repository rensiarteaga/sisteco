...
/**
 * **********************************************************
 * Nombre de archivo: ActionEliminarMovimientoProyecto.php
 * Propósito:				Permite eliminar registros de la tabla tal_movimiento_proyecto
 * Tabla:					tal_movimiento_proyecto
 * Parámetros:				$hidden_id_movimiento_proyecto	--> id de movimiento
 *
...
$nombre_archivo = 'ActionEliminarMovimientoProyecto.php';
...
if ($_SESSION['autentificado'] == "SI") {
	...
	for($j = 0; $j < $cont; $j ++) {
		...
		if ($id_movimiento_proyecto == "undefined" || $id_movimiento_proyecto == "") {
			...
			$res = $Custom->EliminarMovimientoProyecto($id_movimiento_proyecto);
			if (! $res) {
				$resp = new cls_manejo_mensajes(true, "406");
