...
/**
 * **********************************************************
 * Nombre de archivo: ActionFinalizarEnviarMovimientoClick.php
 * Propósito:				Permite borrador o finalizado registros de la tabla tal_movimiento
...
$nombre_archivo = 'ActionFinalizarEnviarMovimientoClick.php';
...
if ($_SESSION['autentificado'] == "SI") {
	...
	if ($id_movimiento == "undefined" || $id_movimiento == "") {
		...
		$res = $Custom->FinalizarEnviarMovimiento($id_movimiento);
		if (! $res) {
			$resp = new cls_manejo_mensajes(true, "406");
