...
/**
 * **********************************************************
 * Nombre de archivo: ActionBorradorFinalizadoMovimiento.php
...
$nombre_archivo = 'ActionBorradorFinalizadoMovimiento.php';
...
if ($_SESSION['autentificado'] == "SI") {
	...
	if ($id_movimiento == "undefined" || $id_movimiento == "") {
		...
		$res = $Custom->BorradorFinalizadoMovimiento($id_movimiento);
		if (! $res) {
			$resp = new cls_manejo_mensajes(true, "406");
