...
class funciones {
	...
	/*
	 * ********************************************************* Nombre de la función:	copiar_archivo_servidor($archivo_temporal,$carpeta_destino) Propósito:				Se utiliza esta función para copiar srchivos al servidor Parámetros:				$archivo_temporal	-->	Aquí se almacena el nombre del archivo temporal $carpeta_destino --> Aquí se guarda el nombre de la carpeta destino Valores de Retorno:		$nombre_archivo 	-->	Retorna el nombre del archivo -1	--> Indica que se produjo un error y no se pudo subir el archivo al servidor *********************************************************
	 */
	...
	// /////////////////////////////////////////////////////////////////////////////////////////
	// Funciones Ruddy Luján Bravo (Fin)
	// /////////////////////////////////////////////////////////////////////////////////////////
	
	/*
	 * ********************************************************* Nombre de la función:	renombrar ( $archivo,$carpeta_archivo ) Propósito:				Se utiliza esta función para copiar srchivos al servidor Parámetros:				$archivo	-->	Aquí se almacena el nombre del archivo ha ser cambiado $carpeta_archivo --> Aquí se guarda el nombre de la carpeta destino Valores de Retorno:		$nuevo_nombre	-->	El nuevo nombre del archivo Observación:			----- Fecha de Creación:		25 - 07 - 2013 Versión:				1.0.0 *********************************************************
	 */
