...
if ($_SESSION['autentificado'] == 'SI') {
	...
	*/
	...
	if(isset($existencias) && $existencias == 'si' && $id_almacen > 0)
	{
		$criterio_filtro = $criterio_filtro." AND al.estado =''activo'' AND al.id_item IN  (
					SELECT s.id_item
                    FROM alma.tai_item_valoracion_pp s
                    WHERE s.id_almacen = $id_almacen )";
	}
