...
/**
 * **********************************************************
 * Nombre de archivo: 		ActionEliminarFaseTramo.php
 * Propósito:				Permite eliminar registros de la tabla tal_fase_tramo
 * Tabla:					tal_fase_tramo
 * Parámetros:				$hidden_id_fase_tramp	--> id 
...
$nombre_archivo = 'ActionEliminarFaseTramo.php';
...
if ($_SESSION['autentificado'] == "SI") {
	...
	for($j = 0; $j < $cont; $j ++) {
		...
		if ($id_fase_tramo == "undefined" || $id_fase_tramo == "") {
			...
			$res = $Custom->EliminarFaseTramo($id_fase_tramo);
			if (! $res) {
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if ($sortdir == "")
		$sortdir = 'asc';
	if ($criterio_filtro == "")
		$criterio_filtro = "0=0 AND fatram.estado_registro=''activo''";
