...
/**
 * **********************************************************
 * Nombre de archivo: 		ActionEliminarDetalleUnidadConstructiva.php
 * Propósito:				Permite eliminar registros de la tabla tal_detalle_unidad_constructiva
 * Tabla:					tal_detalle_unidad_constructiva
 * Parámetros:				$hidden_id_detalle_unidad_constructiva--> id de la tabla
 * Valores de Retorno: 		Número de -egistros
 * Fecha de Creación:		27-08-2014
 * Versión:					1.0.0
 * Autor:					UNKNOW
 * *********************************************************
 */
...
$nombre_archivo = 'ActionEliminarDetalleUnidadConstructiva.php';
...
if ($_SESSION['autentificado'] == "SI") {
	...
	for($j = 0; $j < $cont; $j ++) {
		...
		if ($id_detalle_unidad_constructiva == "undefined" || $id_detalle_unidad_constructiva == "") {
			...
			$res = $Custom->EliminarDetalleUnidadConstructiva($id_detalle_unidad_constructiva);
			if (! $res) {
				$resp = new cls_manejo_mensajes(true, "406");
