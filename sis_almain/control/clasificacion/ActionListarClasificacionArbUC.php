...
if ($_SESSION['autentificado'] == 'SI') {
	...
	if($m_id_unidad_constructiva != '' && $m_id_unidad_constructiva != 'undefined' && $m_id_unidad_constructiva != null)
	{
		$_SESSION['id_unidad_const'] = $m_id_unidad_constructiva;
	}
	...
	if ($res) {
		...
		foreach ( $Custom->salida as $f ) {
			$tmp['text'] = utf8_encode("[" . $f["codigo_largo"] . "]-" . $f["nombre"]);
