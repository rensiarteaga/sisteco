...
$nombre_archivo = 'ActionListarCosto.php';
...
if ($_SESSION['autentificado'] == 'SI') {
	...
	$res = $Custom->ListarCosto($cant, $puntero, $sortcol, $sortdir, $criterio_filtro, $id_financiador, $id_regional, $id_programa, $id_proyecto, $id_actividad);
	if ($res) {
		...
		foreach ( $Custom->salida as $f ) {
			...
			$xml->add_nodo('codigo_costo', $f["codigo_costo"]);
