 ...
 * Propósito:				Permite desplegar los tramos de una unidad constructiva
...
if ($_SESSION['autentificado'] == 'SI') {
	...
	if ($sort == '')
		$sortcol = 'id_tramo_unidad_constructiva'; // falta
	else
		$sortcol = $sort;
	...
	if($m_id_tramo != null && $m_id_tramo!='undefined' && $m_id_tramo !='')
	{
		$cond->add_criterio_extra("tuc.id_tramo",$m_id_tramo);
	}
	...
	$res = $Custom->ListarTramoUnidadConstructiva($cant, $puntero, $sortcol, $sortdir, $criterio_filtro, $id_financiador, $id_regional, $id_programa, $id_proyecto, $id_actividad);
