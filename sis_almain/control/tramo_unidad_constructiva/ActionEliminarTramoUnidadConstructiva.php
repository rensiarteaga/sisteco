...
$nombre_archivo = 'ActionEliminarTramoUniaddConstructiva.php';
...
if ($_SESSION['autentificado'] == "SI") {
	...
	for($j = 0; $j < $cont; $j ++) {
		...
		if ($id_tramo_uc == "undefined" || $id_tramo_uc == "") {
			...
			$res = $Custom->EliminarTramoUC($id_tramo_uc);
			if (! $res) {
				$resp = new cls_manejo_mensajes(true, "406");
