...
/**
 * **********************************************************
 * Nombre de archivo: 		ActionEliminarSalidaUnidadConstructiva.php
 * Propósito:				Permite eliminar registros de la tabla tal_salida_uc
 * Tabla:					tal_salida_uc
 * Parámetros:				$hidden_id_salida_uc	--> id salida
...
$nombre_archivo = 'ActionEliminarSalidaUnidadConstructiva.php';
...
if ($_SESSION['autentificado'] == "SI") {
	...
	for($j = 0; $j < $cont; $j ++) {
		...
		if ($id_salida_uc == "undefined" || $id_salida_uc == "") {
			...
			$res = $Custom->EliminarSalidaUC($id_salida_uc);
			if (! $res) {
				$resp = new cls_manejo_mensajes(true, "406");
