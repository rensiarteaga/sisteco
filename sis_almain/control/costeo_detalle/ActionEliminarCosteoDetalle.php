...
/**
 * **********************************************************
 * Nombre de archivo: 		ActionEliminarCosteoDetalle.php
 * Propósito:				Permite eliminar registros de la tabla tal_costeo_detalle
 * Tabla:					tal_costeo_detalle
 * Parámetros:				$h_id_costeo_detalle
...
$nombre_archivo = 'ActionEliminarCosteoDetalle.php';
...
if ($_SESSION['autentificado'] == "SI") {
	...
	for($j = 0; $j < $cont; $j ++) {
		...
		{ // Eliminación
			$res = $Custom->EliminarCosteoDetalle($id_costeo_det);
			if (! $res) 
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if ($sortdir == "")
		$sortdir = 'asc';
	if ($criterio_filtro == "")
		$criterio_filtro = '0=0 AND det.id_costeo LIKE('.$id_costeo.')';
