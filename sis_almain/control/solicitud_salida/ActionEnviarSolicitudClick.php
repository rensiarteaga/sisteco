...
/**
 * **********************************************************
 * Nombre de archivo: ActionEnviarSolicitudClick.php
 * Propósito:				Permite enviar solicitud de registros de la tabla tal_solicitud_salida
...
$nombre_archivo = 'ActionEnviarSolicitudClick.php';
...
if ($_SESSION['autentificado'] == "SI") {
	...
	if ($id_solicitud_salida == "undefined" || $id_solicitud_salida == "") {
		...
		$res = $Custom->EnviarSolicitud($id_solicitud_salida);
		if (! $res) {
			$resp = new cls_manejo_mensajes(true, "406");
