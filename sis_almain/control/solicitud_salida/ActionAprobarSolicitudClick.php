...
/**
 * **********************************************************
 * Nombre de archivo: ActionAprobarSolicitudClick.php
 * Propósito:				Permite aprobar solicitud de registros de la tabla tal_solicitud_salida
...
$nombre_archivo = 'ActionAprobarSolicitudClick.php';
...
if ($_SESSION['autentificado'] == "SI") {
	...
	if ($id_solicitud_salida == "undefined" || $id_solicitud_salida == "") {
		...
		$res = $Custom->AprobarSolicitud($id_solicitud_salida);
		if (! $res) {
			$resp = new cls_manejo_mensajes(true, "406");
	...
	$res = $Custom->ContarAprobarSolicitud($cant, $puntero, $sortcol, $sortdir, $criterio_filtro, $id_financiador, $id_regional, $id_programa, $id_proyecto, $id_actividad);
	if ($res)
