...
CREATE OR REPLACE FUNCTION alma.f_tai_fase_sel (
...
BEGIN
    ...
    g_nombre_funcion := 'f_tai_fase_sel';
    ...
    IF pm_codigo_procedimiento  = 'AL_FASE_SEL' THEN
        BEGIN
            g_consulta := 'SELECT fa.id_fase,fa.descripcion,fa.codigo,fa.observaciones,fa.estado,fa.sw_tramo
                          ...
                          FROM alma.tai_fase fa
                          INNER JOIN alma.tai_almacen al on al.id_almacen=fa.id_almacen and al.estado=''activo''
