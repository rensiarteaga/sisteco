...
CREATE OR REPLACE FUNCTION alma.f_tai_tramo_sel (
...
***************************************************************************
 SCRIPT: 		 alma.f_tai_tramo_sel
 DESCRIPCION: 	 Devuelve las consultas a la tabla alma.tai_tramo
 AUTOR: 		 UNKNOW
 FECHA:			 01-12-2014
***************************************************************************/
...
BEGIN
    ...
    g_nombre_funcion := 'f_tai_tramo_sel';
