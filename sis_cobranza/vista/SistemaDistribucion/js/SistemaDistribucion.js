...
{ 
	...
	var ds = new Ext.data.Store({
		...
		var ds_id_gestion = new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: direccion+'../../../../sis_parametros/control/gestion/ActionListarGestion.php?tipo_vista=cobra_sis'}),reader:new Ext.data.XmlReader({record:'ROWS',id:'id_gestion',totalRecords: 'TotalCount'},['id_gestion','id_empresa','id_moneda_base','gestion','estado_ges_gral'])});
	...
	Atributos[5]= {
		...
		var config={titulo_maestro:'SistemaDistribucion',grid_maestro:'grid-'+idContenedor,urlHijo:'../../../sis_cobranza/vista/SistemaDistribucion/ConceptoFactura.php'};
