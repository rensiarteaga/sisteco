...
$nombre_archivo = "ActionEliminarProcesoFacturacionCobranza.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarProcesoFacturacionCobranza($id_proceso_facturacion_cobranza);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($sortcol == "") $sortcol = "id_proceso_facturacion_cobranza";
