...
/**
**********************************************************
Nombre de archivo:	   ActionEliminarCuenta.php
Propósito:				Permite eliminar registros de la tabla tct_cuenta
Tabla:					tct_cuenta
...
$nombre_archivo = "ActionEliminarSistemaDistribucion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarSistemadistribucion($id_sistema);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	$res = $Custom->ContarSistemaDBL($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
