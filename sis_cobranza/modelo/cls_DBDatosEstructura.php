...
class cls_DBDatosEstructura
{
	...
	/**
	 * Nombre de la función:	ListarTipoFacturacionCobranza
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'cobra.f_tcb_datos_estructura_sel';
		$this->codigo_procedimiento = "'CB_DATEST_SEL'";
		...
		$this->var->add_def_cols('nombre_columna','name');
		$this->var->add_def_cols('tipo','name');
	...
	function ContarDatosEstructura($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'cobra.f_tcb_datos_estructura_sel';
		$this->codigo_procedimiento = "'CB_DATEST_COUNT'";
