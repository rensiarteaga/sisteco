...
function main(){
	...
	var elemento={idContenedor:idContenedor,pagina:new pagina_ndc_det(idContenedor,direccion,paramConfig,idContenedorPadre)};
...
{        
	...
	//DEFINICION DE FUNCIONES
	 var paramFunciones={
		...
		ConfirmSave:{url:direccion+'../../../control/ndc_fac_det/ActionEditarNdcDet.php'},
		Formulario:{html_apply:'dlgInfo-'+idContenedor,height:370,width:510,minWidth:'25%',minHeight:222,columnas:['90%'],	
			closable:true,
			titulo:'Detalle NDC',
			grupos:[{
