...
function main(){
	...
	var elemento={idContenedor:idContenedor,pagina:new pagina_factura_det(idContenedor,direccion,paramConfig,idContenedorPadre)};
...
{        
	...
	//DEFINICION DE FUNCIONES
	 var paramFunciones={
		...
		ConfirmSave:{url:direccion+'../../../control/factura_det/ActionEditarFacturaDet.php'},
	 ...
	 function iniciarEventosFormularios() {
		comp_id_presupuesto = CM_getComponente('id_presupuesto');
		comp_id_ppto_gasto = CM_getComponente('id_ppto_gasto');
		comp_id_concepto_ingas = CM_getComponente('id_concepto_ingas');
