...
function main(){
	...
	var elemento={pagina:new pagina_factura(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
function pagina_factura(idContenedor,direccion,paramConfig){
	...
	var tpl_id_dosifica=new Ext.Template('<div class="search-item">','<b><i>{nro_autoriza}</i></b>','<br><FONT COLOR="#B5A642"><b> - </b>{fecha_vence}</FONT>','</div>');
	...
	var paramFunciones={
		...
		ConfirmSave:{url:direccion+'../../../control/factura/ActionEditarFactura.php'},
	...
	this.EnableSelect=function(sm,row,rec){
		...
		var btn_modfac = CM_getBoton('fac_mod-'+ idContenedor);
	...
	this.AdicionarBoton('../../../lib/imagenes/pencil.png','Editar la Factura',btn_modfac,true,'fac_mod','Editar');
