 ...
 * Propósito:			Permite ejecutar la funcionalidad de la tabla tfv_clie_cta
 * Autor:				MTSL
...
class cls_DBClieCta
{
	...
	/**
	 * Nombre de la función:	ListarClieCta
	 * Propósito:				Desplegar los registros de tfv_clie_cta en función de los parámetros del filtro
	 * Autor:					MTSL
	...
	/**
	 * Nombre de la función:	ContarClieCta
	...
	/**
	 * Nombre de la función:	InsertarClieCta
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tfv_ClieCta
	...
	/**
	 * Nombre de la función:	ModificarClieCta
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tfv_ClieCta
	 * con los parámetros requeridos
	 * Autor:					MTSL
	 * Fecha de creación:		2014.05
	 */
	...
	/**
	 * Nombre de la función:	EliminarClieCta
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tfv_ClieCta
	 * con los parámetros requeridos
	 * Autor:					MTSL
	 * Fecha de creación:		2014.05
	 */
	...
	/**
	 * Nombre de la función:	ValidarClieCta
