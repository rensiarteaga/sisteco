...
Ext.form.LovItemsAlm=function(config){
	...
	this.triggerConfig = {
		...
		width:50
			...
			dataIndex:"descripcion_aux", /// modificar con el de activo_fijo
			filterColValue:"descripcion_aux",
			header: "Desc Aux",
			width:150
		},
...
Ext.extend(Ext.form.LovItemsAlm,Ext.form.ComboBox,{
	...
	resizable:true,
	lazyRender:true,
	filterCol:'codigo#nombre#descripcion#observaciones#descripcion_aux',
	tpl:new Ext.Template('<div class="search-item">','<b>{descripcion}</b>','<br><FONT COLOR="#B5A642"><b>Código:</b> {codigo}</FONT>','<br><FONT COLOR="#B5A642"><b>Nombre:</b> {nombre}</FONT>','<br>Aux: {descripcion_aux}','</div>'),
