...
function EnviarCorreoAdjunto($origen,$destino,$nom_archivo,$dir_archivo,$asunto,$mensaje)
{
	...
	/*
**********************************************************
Nombre de la función:	EnviarCorreoConfirmacion($origen,$destino,$nombre,$id)
Propósito:				Se utiliza para crear enviar un mail con un archivo adjunto
...
function EnviarCorreoConfirmacion($origen,$destino,$nombre,$id)
{
	...
	///
		...
		$asunto = "Confirmación Loto Millonario";
		$cuerpo = "
		<html>
		<head>
...
*/
    ...
    {return 0;
  	...
  	/*
**********************************************************
Nombre de la función:	EnviarCorreoSugerencia("lotito@loto.com.bo","rensi_4rn@hotmail.com",$nombre,$tema,$email,$sugerencia);     
Propósito:				Se utiliza para crear enviar un mail con un archivo adjunto
...
{ // if($_SESSION["ss_id_usuario"]==120){echo strlen($mensaje) ; exit;}  //$origen."---".$destino."----".$tema."----".$mensaje."---".$titulo."----".$mensaje_cab; exit; }
		$destinatario = $destino;
		$asunto = "$tema";
