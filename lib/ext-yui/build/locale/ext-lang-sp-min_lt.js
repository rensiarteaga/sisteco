...
if(Ext.MessageBox)
{
	Ext.MessageBox.buttonText={ok:"Aceptar",cancel:"Cancelar",yes:"Sí",no:"No"};
}
if(Ext.util.Format)
{
	Ext.util.Format.date=function(v,_2)
	{
		if(!v)
		{
			return "";
...
if(Ext.DatePicker)
{
	...
	if(Ext.form.TextField)
	{
		Ext.apply(
			...
			{
				minLengthText:"El tamaño mínimo para este campo es de {0}",maxLengthText:"El tamaño máximo para este campo es de {0}",blankText:"Este campo es obligatorio",regexText:"",emptyText:null});
	}
	...
	if(Ext.form.VTypes){
		...
		{
			emailText:"Este campo debe ser una dirección de correo electrónico con el formato \"usuario@dominio.com\"",urlText:"Este campo debe ser una URL con el formato \"http:/"+"/www.dominio.com\"",
			alphaText:"Este campo solo debe contener letras y _",alphanumText:"Este campo solo debe contener letras, números y _"});
	}
	if(Ext.grid.GridView)
	{
		Ext.apply(
		Ext.grid.GridView.prototype,
		{
	...
	{
		Ext.apply(
			Ext.SplitLayoutRegion.prototype,
			{
