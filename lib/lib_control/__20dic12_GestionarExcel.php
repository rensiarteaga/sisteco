...
//imagepng($imageObject, $imageFile . '.png');
	//imagewbmp($imageObject, "../../../lib/images/logo_reporte".'.bmp');
		...
		//$this->sheet->insertBitmap(0,$columnas-1,"../../../lib/images/logo_reporte.jpg",1,1,0.4,1);
		
		//ENDE-0001: 04/09/2012: Modificacion a logo en reportes 
		$this->sheet->insertBitmap(1,$columnas-1,"../../../lib/images/logo_reporte1.bmp",1,1,0.1,0.1);
		...
		{ 	$this->contador=0;
			...
			{	 
				/*$format_casilla =& $this->xls->addFormat(array(	'Size'=>$this->size,
					...
					$this->sheet->write($this->fila,$this->columna,$filas[$fila_columa]);
