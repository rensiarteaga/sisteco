<?php
/**
 * Nombre de la clase:	cls_DBKardexLogicoVista.php
...
class cls_DBKardexLogicoVista
{
	...
	/**
	 * Nombre de la función:	ListarKardexLogicoVista
	 * Propósito:				Desplegar los registros de val_kardex_logico
	 * Autor:				    José Abraham Mita Huanca
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_val_kardex_logico_sel';
		$this->codigo_procedimiento = "'AL_VISTA_KARDEX_SEL'";
