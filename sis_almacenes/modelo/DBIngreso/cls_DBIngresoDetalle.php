...
class cls_DBIngresoDetalle
{
	...
	/**
	 * Nombre de la función:	Detalle Reporte 
	 * Propósito:				Desplegar el detalle del ingreso para reporte Vale de Ingreso de Materiales
	 * Autor:				    RCM
	...
	function ListarIngresoDetalleReporte($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		...
		/**
	 * Nombre de la función:	Resumen Detalle  de Ingresos Reporte 
	 * Propósito:				Desplegar el resumen detalle del ingreso por origen 
	 * Autor:				    ARV
	...
	/**
	 * Nombre de la función:	ObtenerIngresoItem
	 * Propósito:				Devuelve la cantidad ingresada de un item específico
	 * Autor:				    RCM
