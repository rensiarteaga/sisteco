...
class cls_DBOrdenIngresoAprob
{
	...
	/**
	 * Nombre de la función:	ListarOrdenIngresoAprob
	...
	function ListarOrdenIngresoAprob($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		...
		$this->codigo_procedimiento = "'AL_OINAPR_SEL'";
	...
	/**
	 * Nombre de la función:	ContarOrdenIngresoAprob
	...
	function ContarOrdenIngresoAprob($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_ingreso_sel';
		$this->codigo_procedimiento = "'AL_OINAPR_COUNT'";
	...
	/**
	 * Nombre de la función:	AprobarOrdenIngreso
	...
	function AprobarOrdenIngreso($id_ingreso)
	{
		...
		$this->codigo_procedimiento = "'AL_OINAPR_APR'";
	...
	function RechazarOrdenIngreso($id_ingreso)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_ingreso_iud';
		$this->codigo_procedimiento = "'AL_OINAPR_REC'";
	...
	function CorregirOrdenIngreso($id_ingreso)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_ingreso_iud';
		$this->codigo_procedimiento = "'AL_OINAPR_COR'";
	...
	/**
	 * Nombre de la función:	ValidarOrdenIngresoAprob
