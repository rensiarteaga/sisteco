...
class cls_DBOrdenIngresoSolDet
{
	var $salida;
	var $query;
	var $var;
	...
	/**
	 * Nombre de la función:	ListarOrdenIngresoSolDet
	...
	/**
	 * Nombre de la función:	ContarOrdenIngresoSolDet
	...
	/**
	 * Nombre de la función:	InsertarOrdenIngresoSolDet
	...
	/**
	 * Nombre de la función:	ModificarOrdenIngresoSolDet
	...
	/**
	 * Nombre de la función:	EliminarOrdenIngresoSolDet
	...
	/**
	 * Nombre de la función:	InsertarIngresoProyDet
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tal_ingreso_detalle
	 * Autor:				    RCM
	...
	function InsertarIngresoProyDet($id_ingreso_detalle,$cantidad,$costo,$precio_venta,$costo_unitario,$precio_venta_unitario,$observaciones,$fecha_reg,$id_ingreso,$id_item,$estado_item)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_ingreso_detalle_iud';
		$this->codigo_procedimiento = "'AL_INDEPR_INS'";
	...
	/**
	 * Nombre de la función:	ModificarIngresoProyDet
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tal_ingreso_detalle
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-17 12:32:39
	 */
	function ModificarIngresoProyDet($id_ingreso_detalle,$cantidad,$costo,$precio_venta,$costo_unitario,$precio_venta_unitario,$observaciones,$fecha_reg,$id_ingreso,$id_item,$estado_item)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_ingreso_detalle_iud';
		$this->codigo_procedimiento = "'AL_INDEPR_UPD'";
	...
	/**
	 * Nombre de la función:	ValidarOrdenIngresoSolDet
