...
class cls_DBIngresoPend
{
	...
	/**
	 * Nombre de la función:	AnularIngreso
	 * Propósito:				Permite anular un ingreso (también órdenes de ingresos)
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-29 
	 */
	...
	/**
	 * Nombre de la función:	ValidarIngresoPend
