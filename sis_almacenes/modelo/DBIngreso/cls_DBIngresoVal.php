...
class cls_DBIngresoVal
{
	...
	/**
	 * Nombre de la función:	ListarIngresoVal
	...
	/**
	 * Nombre de la función:	ContarIngresoVal
	...
	/**
	 * Nombre de la función:	TerminarIngresoVal
	...
	/**
	 * Nombre de la función:	ValidarIngresoVal
