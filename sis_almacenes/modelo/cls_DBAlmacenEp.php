 ...
 * Autor:				(autogenerado)
 * Fecha creación:		2007-10-25 18:52:49
 */
...
class cls_DBAlmacenEp
{
	 ...
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-25 18:52:49
	 */
	...
	function ListarEp($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_almacen_ep_sel';
		$this->codigo_procedimiento = "'AL_ALMAEP_SELEP'";
		...
		$this->var->add_def_cols('codigo_proyecto','varchar');
		$this->var->add_def_cols('codigo_actividad','varchar');
		$this->var->add_def_cols('desc_todo','text');
	...
	function ContarEp($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_almacen_ep_sel';
		$this->codigo_procedimiento = "'AL_ALMAEP_COUNTEP'";
		...
		if($operacion_sql=='insert' || $operacion_sql=='update')
		{
			...
			elseif ($operacion_sql=='insert')
			{
				...
				if(!in_array($bloqueado,$check))
				{
					...
					$this->salida[3] = "PROC = ValidarAlmacenEp";
