<?php
/**
 * Nombre de la clase:	cls_DBMotivoSalida.php
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tal_tal_motivo_salida
 * Autor:				(autogenerado)
 * Fecha creación:		2007-10-18 10:10:18
 */

class cls_DBMotivoSalida
{
	var $salida;
	var $query;
	var $var;
	...
	/**
	 * Nombre de la función:	ListarMotivoSalida
	 * Propósito:				Desplegar los registros de tal_motivo_salida
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-18 10:10:18
	 */
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_motivo_salida_sel';
		$this->codigo_procedimiento = "'AL_MOTSAL_SEL'";
	...
	/**
	 * Nombre de la función:	ListarMotivoSalidaEP
	 * Propósito:				Desplegar los registros de tal_motivo_salida
	 * Autor:				    (autogenerado)
	...
	function ListarMotivoSalidaEP($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_motivo_salida_sel';
		$this->codigo_procedimiento = "'AL_MOTSAL_SELEP'";
	...
	/**
	 * Nombre de la función:	ContarMotivoSalida
	 * Propósito:				Contar los registros de tal_motivo_salida
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-18 10:10:18
	 */
	function ContarMotivoSalida($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_motivo_salida_sel';
		$this->codigo_procedimiento = "'AL_MOTSAL_COUNT'";
	...
	/**
	 * Nombre de la función:	ContarMotivoSalidaEP
	 * Propósito:				Contar los registros de tal_motivo_salida
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-17 15:49:42
	 */
	function ContarMotivoSalidaEP($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_motivo_salida_sel';
		$this->codigo_procedimiento = "'AL_MOTSAL_COUNTEP'";
	...
	/**
	 * Nombre de la función:	InsertarMotivoSalida
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tal_motivo_salida
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-18 10:10:18
	 */
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_motivo_salida_iud';
		$this->codigo_procedimiento = "'AL_MOTSAL_INS'";
	...
	/**
	 * Nombre de la función:	ModificarMotivoSalida
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tal_motivo_salida
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-18 10:10:18
	 */
	function ModificarMotivoSalida($id_motivo_salida,$nombre,$descripcion,$estado_registro,$fecha_reg,$codigo)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_motivo_salida_iud';
		$this->codigo_procedimiento = "'AL_MOTSAL_UPD'";
	...
	/**
	 * Nombre de la función:	EliminarMotivoSalida
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tal_motivo_salida
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-18 10:10:18
	 */
	function EliminarMotivoSalida($id_motivo_salida)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_motivo_salida_iud';
		$this->codigo_procedimiento = "'AL_MOTSAL_DEL'";
	...
	/**
	 * Nombre de la función:	ValidarMotivoSalida
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tal_motivo_salida
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-18 10:10:18
	 */
	function ValidarMotivoSalida($operacion_sql,$id_motivo_salida,$nombre,$descripcion,$estado_registro,$fecha_reg,$codigo)
	{
		...
		if($operacion_sql=='insert' || $operacion_sql=='update')
		{
			...
			if(!in_array($estado_registro,$check))
			{
				...
				$this->salida[3] = "PROC = ValidarMotivoSalida";
