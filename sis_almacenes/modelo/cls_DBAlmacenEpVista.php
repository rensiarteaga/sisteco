...
class cls_DBAlmacenEpVista
{
	...
	/**
	 * Nombre de la función:	ListarAlmacenEPVista
	 * Propósito:				Desplegar los registros de val_almacen_ep
	 * Autor:				    José Abraham Mita Huanca
	...
	/**
	 * Nombre de la función:	ContarAlmacenEpVista
