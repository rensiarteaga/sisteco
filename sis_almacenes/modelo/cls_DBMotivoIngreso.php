...
class cls_DBMotivoIngreso
{
	...
	/**
	 * Nombre de la función:	ListarMotivoIngresoEP
	 * Propósito:				Desplegar los registros de tal_motivo_ingreso
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-17 15:49:42
	 */
	function ListarMotivoIngresoEP($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_motivo_ingreso_sel';
		$this->codigo_procedimiento = "'AL_MOTING_SELEP'";
	...
	/**
	 * Nombre de la función:	ContarMotivoIngresoEP
	 * Propósito:				Contar los registros de tal_motivo_ingreso
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-17 15:49:42
	 */
	function ContarMotivoIngresoEP($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_motivo_ingreso_sel';
		$this->codigo_procedimiento = "'AL_MOTING_COUNTEP'";
