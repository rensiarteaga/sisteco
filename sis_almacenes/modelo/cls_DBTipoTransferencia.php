 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tal_tal_tipo_transferencia
 * Autor:				(autogenerado)
...
class cls_DBTipoTransferencia
{
	...
	/**
	 * Nombre de la función:	ListarTipoTransferencia
	 * Propósito:				Desplegar los registros de tal_tipo_transferencia
	 * Autor:				    (autogenerado)
	...
	/**
	 * Nombre de la función:	ContarTipoTransferencia
	 * Propósito:				Contar los registros de tal_tipo_transferencia
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-02 11:05:39
	 */
	...
	/**
	 * Nombre de la función:	InsertarTipoTransferencia
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tal_tipo_transferencia
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-02 11:05:39
	 */
	...
	/**
	 * Nombre de la función:	ModificarTipoTransferencia
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tal_tipo_transferencia
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-02 11:05:39
	 */
	...
	/**
	 * Nombre de la función:	EliminarTipoTransferencia
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tal_tipo_transferencia
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-02 11:05:39
	 */
	...
	/**
	 * Nombre de la función:	ValidarTipoTransferencia
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tal_tipo_transferencia
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-02 11:05:39
	 */
