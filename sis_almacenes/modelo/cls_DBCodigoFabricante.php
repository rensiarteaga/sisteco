 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tal_tal_codigo_fabricante
...
class cls_DBCodigoFabricante
{
	...
	/**
	 * Nombre de la función:	ListarCodigoFabricante
	 * Propósito:				Desplegar los registros de tal_codigo_fabricante
	 * Autor:				    (autogenerado)
	...
	function ListarCodigoFabricante($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		...
		$this->codigo_procedimiento = "'AL_CODFAB_SEL'";
	...
	/**
	 * Nombre de la función:	ContarCodigoFabricante
	 * Propósito:				Contar los registros de tal_codigo_fabricante
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-03 19:30:59
	 */
	function ContarCodigoFabricante($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_codigo_fabricante_sel';
		$this->codigo_procedimiento = "'AL_CODFAB_COUNT'";
	...
	/**
	 * Nombre de la función:	InsertarCodigoFabricante
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tal_codigo_fabricante
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-03 19:30:59
	 */
	function InsertarCodigoFabricante($id_codigo_fabricante,$codigo,$estado_registro,$nombre,$anio,$descripcion,$observaciones,$fecha_reg,$id_item)
	{
		...
		$this->codigo_procedimiento = "'AL_CODFAB_INS'";
	...
	/**
	 * Nombre de la función:	ModificarCodigoFabricante
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tal_codigo_fabricante
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-03 19:30:59
	 */
	function ModificarCodigoFabricante($id_codigo_fabricante,$codigo,$estado_registro,$nombre,$anio,$descripcion,$observaciones,$fecha_reg,$id_item)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_codigo_fabricante_iud';
		$this->codigo_procedimiento = "'AL_CODFAB_UPD'";
	...
	/**
	 * Nombre de la función:	EliminarCodigoFabricante
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tal_codigo_fabricante
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-03 19:30:59
	 */
	function EliminarCodigoFabricante($id_codigo_fabricante)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tal_codigo_fabricante_iud';
		$this->codigo_procedimiento = "'AL_CODFAB_DEL'";
	...
	/**
	 * Nombre de la función:	ValidarCodigoFabricante
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tal_codigo_fabricante
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-03 19:30:59
	 */
	function ValidarCodigoFabricante($operacion_sql,$id_codigo_fabricante,$codigo,$estado_registro,$nombre,$anio,$descripcion,$observaciones,$fecha_reg,$id_item)
	{
		...
		if($operacion_sql=='insert' || $operacion_sql=='update')
		{
			...
			//Validar anio - tipo varchar
			$tipo_dato->_reiniciar_valor();
			$tipo_dato->set_Columna("anio");
			if(!$valid->verifica_dato($tipo_dato->TipoDatoText(), "anio", $anio))
			{
				$this->salida = $valid->salida;
				return false;
			}
