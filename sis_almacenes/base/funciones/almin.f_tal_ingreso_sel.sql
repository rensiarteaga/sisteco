    ...
    --Selección de todos los ingresos para Proyectos
        BEGIN
            g_consulta := 'SELECT  distinct
                                ...
                                COALESCE(INGRES.importacion,0)  as tot_importacion,
                                COALESCE(INGRES.gastos_alm,0) + COALESCE(INGRES.gastos_aduana,0) + COALESCE(INGRES.iva,0) + COALESCE(INGRES.flete,0) + COALESCE(INGRES.seguro,0) + COALESCE(INGRES.rep_form,0) as tot_nacionaliz,
