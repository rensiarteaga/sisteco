...
CREATE OR REPLACE FUNCTION almin.f_tal_parametro_almacen_logico_iud (
...
***************************************************************************
 SCRIPT: 		almin.f_tal_parametro_almacen_logico_iud
...
---*** INICIACIÓN DE VARIABLES
    ...
    g_nombre_funcion := 'almin.f_tal_parametro_almacen_logico_iud';
...
---*** SI NO SE TIENE PERMISOS DE EJECUCIÓN SE RETORNA EL MENSAJE DE ERROR
    ...
    IF pm_codigo_procedimiento = 'AL_CERALMLOG_IUD' THEN
