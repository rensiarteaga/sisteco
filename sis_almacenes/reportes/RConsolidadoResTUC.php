...
class RConsolidadoResTUC extends  ReportePDF {
	var $datos_titulo;
	var $datos_detalle;
	var $desde;
	var $hasta;
	...
	function Header() {
		...
		$this->Cell(85 + 60 ,3.5,'Desc Item','LTB',0,'C');
	...
	function generarReporte1C() {
			...
			$conf_par_tablealigns=array('C','L','R','R');
			$conf_par_tablenumbers=array(0,0,1,1);
