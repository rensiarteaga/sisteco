...
var mtr={
	     	...
	     	estado_reg:'<?php echo $m_estado_reg;?>'
};


var elemento={pagina:new pagina_aprobacion_det_tuc(idContenedor,direccion,paramConfig,mtr,'<?php echo $idContenedorPadre;?>'),idContenedor:idContenedor};
