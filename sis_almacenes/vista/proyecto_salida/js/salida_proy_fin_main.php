...
function main(){
	...
	var elemento={pagina:new pagina_salida_proy_fin(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
* Fecha creación:		2007-10-25 15:08:17
*/
function pagina_salida_proy_fin(idContenedor,direccion,paramConfig)
{
