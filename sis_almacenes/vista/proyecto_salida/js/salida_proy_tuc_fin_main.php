...
function main(){
	...
	var elemento={pagina:new pagina_salida_proy_tuc_fin(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
* Fecha creación:		2007-10-25 15:08:17
*/
function pagina_salida_proy_tuc_fin(idContenedor,direccion,paramConfig)
{
	...
	ds=new Ext.data.Store({
		...
		proxy:new Ext.data.HttpProxy({url:direccion+'../../../control/salida/ActionListarSalidaPedidoFin.php'}),
	...
	ds_supervisor = new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/supervisor/ActionListarSupervisor.php'}),reader: new Ext.data.XmlReader({record: 'ROWS',id: 'id_supervisor',totalRecords: 'TotalCount'}, ['id_persona','nombre_superv','doc_id','fecha_reg'])});
	...
	var resultTplTramoSubactividad = new Ext.Template('<div class="search-item">','<br><FONT COLOR="#B5A642">{desc_tramo}</FONT>','','</div>');
	...
	var resultTplSupervisor = new Ext.Template('<div class="search-item">','<b>{nombre_superv}</b>','','</div>');
	...
	var paramFunciones={
		...
		ConfirmSave:{url:direccion+'../../../control/salida/ActionModificarSalidaFinalizada.php',parametros:'&tipo_pedido=Tipo Unidad Constructiva&tipo='},
