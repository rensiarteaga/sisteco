...
var elemento={idContenedor:idContenedor,pagina:new pagina_salida_finalizada_detalle_det(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
