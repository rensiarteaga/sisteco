...
var maestro={id_salida:<?php echo $m_id_salida;?>,estado_reg:'<?php echo $m_estado_reg;?>'};
var elemento={idContenedor:idContenedor,pagina:new pagina_salida_aprobacion_detalle_det(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
 ...
 */
function pagina_salida_aprobacion_detalle_det(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
...
// txt id_item
	vectorAtributos[2]= {
		...
		filtro_0:true,
		filtro_1:true,
		filterColValue:'ITEM.codigo#ITEM.nombre#ITEM.descripcion',
		defecto: '',
		save_as:'txt_id_item'
	};
// txt id_salida
	...
	var config={
		titulo_maestro:'Aprobación Pedido de Material (Maestro)',
		titulo_detalle:'Detalle de Aprobación de Material',
		grid_maestro:'grid-'+idContenedor
	};
	layout_salida_aprobacion_detalle = new DocsLayoutDetalle(idContenedor,idContenedorPadre);
	layout_salida_aprobacion_detalle.init(config);
	//---------- INICIAMOS HERENCIA
	this.pagina = Pagina;
	this.pagina(paramConfig,vectorAtributos,ds,layout_salida_aprobacion_detalle,idContenedor);
	...
	this.reload=function(params){
		...
		vectorAtributos[3].defecto=maestro.id_salida;
		var paramFunciones={
			btnEliminar:{url:direccion+'../../../control/salida_detalle/ActionEliminarSalidaDetalle.php',parametros:'&m_id_salida='+maestro.id_salida},
			Save:{url:direccion+'../../../control/salida_detalle/ActionGuardarSalidaDetalle.php',parametros:'&m_id_salida='+maestro.id_salida},
	...
	this.getLayout=function(){
		return layout_salida_aprobacion_detalle.getLayout()
	};
	...
	layout_salida_aprobacion_detalle.getLayout().addListener('layout',this.onResize);
