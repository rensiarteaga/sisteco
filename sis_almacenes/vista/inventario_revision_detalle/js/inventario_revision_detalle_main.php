...
var elemento={idContenedor:idContenedor,pagina:new pagina_inventario_revision_detalle(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
