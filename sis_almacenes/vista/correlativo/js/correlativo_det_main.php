 ...
 * Autor:				JoSé A. Mita H.
 * Fecha creación:		2007-10-18 15:38:52
 * FEcha Modificacion   2008-02-27 16:21:02
 */
session_start();
?>
//<script>
...
var maestro={id_parametro_almacen:<?php echo $m_id_parametro_almacen;?>,dias_reserva:'<?php echo $m_dias_reserva;?>',cierre:'<?php echo $m_cierre;?>'};
var elemento={idContenedor:idContenedor,pagina:new pagina_correlativo_det(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
