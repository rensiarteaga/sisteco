...
function main(){
	...
	var elemento={pagina:new pagina_salida_pedido_t(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
* Fecha creación:		2007-10-25 15:08:17
*/
function pagina_salida_pedido_t(idContenedor,direccion,paramConfig)
{
	...
	var paramFunciones={
		btnEliminar:{url:direccion+'../../../control/salida/ActionEliminarSalida.php',parametros:'&tipo=Normal&tipo_pedido=Item'},
		Save:{url:direccion+'../../../control/salida/ActionGuardarSalidaPedido.php',parametros:'&tipo=Normal&tipo_pedido=Item'},
		ConfirmSave:{url:direccion+'../../../control/salida/ActionGuardarSalidaPedido.php',parametros:'&tipo=Normal&tipo_pedido=Item'},
	...
	this.btnNew=function(){
		...
		CM_ocultarComponente(componentes[5]);//empleado
		CM_mostrarComponente(componentes[6]);//contratista
		CM_ocultarComponente(componentes[11]);//observac
