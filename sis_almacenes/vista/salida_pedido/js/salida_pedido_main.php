...
function main(){
	...
	var elemento={pagina:new pagina_salida_pedido(idContenedor,direccion,paramConfig),idContenedor:'<?php echo $idContenedor;?>'};
...
* Fecha creación:		2007-10-25 15:08:17
*/
function pagina_salida_pedido(idContenedor,direccion,paramConfig)
{
	...
	var	combo_motivo_salida,combo_motivo_salida_cuenta,cmb_ep;
