...
function main(){
	...
	var elemento={pagina:new pagina_salida_pedido_unidad_cons(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
function pagina_salida_pedido_unidad_cons(idContenedor,direccion,paramConfig)
{
	...
	function btn_ver(){
		...
		var NumSelect=sm.getCount();
		if(NumSelect!=0){
			if(confirm("¿Está seguro de verficar?\nEste proceso puede tardar varios minutos!")){
				var SelectionsRecord=sm.getSelected();
				Ext.Ajax.request({
