...
var elemento={pagina:new pagina_material_entregado_solicitante(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
* Nombre:		  	    pagina_material_entregado_solicitante_main.js
* Propósito: 			pagina objeto principal
* Autor:				RCM
* Fecha creación:		25/08/2008
*/
function pagina_material_entregado_solicitante(idContenedor,direccion,paramConfig)
{
	var vectorAtributos=new Array;
	var data_ep;
	var componentes=new Array();
	//var nombre_motivo_salida;
	...
	var ds_motivo_salida=new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: direccion+'../../../../control/motivo_salida/ActionListarMotivoSalidaEP.php'}),reader: new Ext.data.XmlReader({record: 'ROWS',id: 'id_motivo_salida',totalRecords: 'TotalCount'}, ['id_motivo_salida','nombre','descripcion','fecha_reg'])});
...
vectorAtributos[18]={
	...
	vectorAtributos[23]= {
		...
		filtro_0:true,
		filtro_1:true,
		filterColValue:'MOTSAL.id_motivo_salida',
		defecto: '',
	...
	var paramFunciones = {
		...
		height:'70%',
		url:direccion+'../../../../control/_reportes/material_entrega_solicitante/ActionPDFMaterialEntregaSolicitud.php',
		abrir_pestana:true, //abrir pestana
		titulo_pestana:obtenerTitulo,
		fileUpload:false,
		width:'70%',
		columnas:['47%'],
		minWidth:150,minHeight:200,	closable:true,titulo:'Material Entregado',
		grupos:[
	...
	function iniciarEventosFormularios(){
		...
		txt_desc_motivo_salida=ClaseMadre_getComponente('desc_motivo_salida');
        ...
        nombre_motivo_salida=ClaseMadre_getComponente('nombre');
		...
		var onMotivoSalidaSelect=function(e){
			...
			//Obtiene la descripción del almacén
			if(combo_motivo_salida.store.getById(id)!=undefined){
				txt_desc_motivo_salida.setValue(combo_motivo_salida.store.getById(id).data.nombre);
			}
	...
	function actualizar_ds_combos(){
		...
		Ext.apply(cmbGestion.store.baseParams,datos)
		Ext.apply(combo_motivo_salida.store.baseParams,datos)
		
		Ext.apply(combo_solicitante.store.baseParams,datos)
		Ext.apply(combo_contratista.store.baseParams,datos)
		Ext.apply(combo_empleado.store.baseParams,datos)
		Ext.apply(combo_institucion.store.baseParams,datos)
		//Ext.apply(combo_motivo_salida.store.baseParams,datos)
