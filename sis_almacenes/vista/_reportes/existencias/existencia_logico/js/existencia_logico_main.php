...
var elemento={pagina:new pagina_existencia_logico(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
 * Nombre:		  	    pagina_existencia_logico_main.js
 * Propósito: 			pagina objeto principal
 * Autor:				Generado Automaticamente
 * Fecha creación:		2007-10-18 21:00:48
 */
function pagina_existencia_logico(idContenedor,direccion,paramConfig)
	...
	var paramMes = {
		validacion: {
			...
			store: new Ext.data.SimpleStore({
				fields: ['mes', 'nombre'],
				data : Ext.proc_existencia_logicoCombo.meses
			}),
			valueField:'mes',
			displayField:'nombre',
			width: 120,
...
/*var param_fecha= {
	...
	//Inicia Layout
	var config={
		titulo_maestro:'existencia_logico de Valor'
		
	};
	layout_existencia_logico=new DocsLayoutProceso(idContenedor);
	layout_existencia_logico.init(config);
	////////////////////////
	// INICIAMOS HERENCIA //
	////////////////////////
	...
	this.pagina(paramConfig,vectorAtributos,layout_existencia_logico,idContenedor);
	...
	function obtenerTitulo()
	{
		...
		var titulo = "existencia_logico de Valor";
	...
	var paramFunciones = {
		...
		height:'70%',
		url:direccion+'../../../../../control/_reportes/existencia_logico/ActionReporteExistenciaLogico.php',
   ...
   function verificar_ep()
	...
	this.getLayout=function(){return layout_existencia_logico.getLayout();};
