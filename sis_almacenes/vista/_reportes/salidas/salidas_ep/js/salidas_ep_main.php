...
var elemento={pagina:new pagina_salidas_ep(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);

/**
 * Nombre:		  	    pagina_salidas_ep_main.js
 * Propósito: 			pagina objeto principal
 * Autor:				Generado Automaticamente
 * Fecha creación:		2007-10-18 21:00:48
 */
function pagina_salidas_ep(idContenedor,direccion,paramConfig)
{	var vectorAtributos=new Array;
	...
	//Inicia Layout
	var config={
		titulo_maestro:'salidas_ep de Valor'
		
	};
	layout_salidas_ep=new DocsLayoutProceso(idContenedor);
	layout_salidas_ep.init(config);
	////////////////////////
	// INICIAMOS HERENCIA //
	////////////////////////
	...
	this.pagina(paramConfig,vectorAtributos,layout_salidas_ep,idContenedor);
	...
	var paramFunciones = {
		...
		height:'70%',
		url:direccion+'../../../../../control/_reportes/salidas_ep/ActionReporteSalidasEp.php',
   ...
   function verificar_ep()
	...
	this.getLayout=function(){return layout_salidas_ep.getLayout();};
