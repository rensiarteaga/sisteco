...
var elemento={pagina:new pagina_almacen_ep(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
{	var vectorAtributos=new Array;
	...
	//Inicia Layout
	var config={
		titulo_maestro:'Almacen EP'	
	};
	layout_almacen_ep=new DocsLayoutProceso(idContenedor);
	...
	this.pagina(paramConfig,vectorAtributos,layout_almacen_ep,idContenedor);
	...
	var paramFunciones = {
		...
		height:'70%',
		url:direccion+'../../../../../control/_reportes/almacen_ep/ActionReporteAlmacenEP.php',
