...
var elemento={pagina:new pagina_total_valoracion_ing_sal(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);

/**
* Nombre:		  	    total_valoracion_ing_sal.js
* Propósito: 			pagina objeto principal
* Autor:				RCM
* Fecha creación:		16/04/2009
*/
function pagina_total_valoracion_ing_sal(idContenedor,direccion,paramConfig)
{
	...
	var paramFunciones = {
		...
		height:'70%',
		url:direccion+'../../../../control/_reportes/total_valoracion_ing_sal/ActionTotalValoracionIngSal.php',
		abrir_pestana:true, //abrir pestana
		titulo_pestana:obtenerTitulo,
		fileUpload:false,
		width:'70%',
		columnas:['47%'],
		minWidth:150,minHeight:200,	closable:true,titulo:'Valoración',
		grupos:[
