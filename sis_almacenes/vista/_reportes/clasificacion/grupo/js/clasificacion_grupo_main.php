...
var elemento={pagina:new pagina_clasificacion_grupo(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
{	var vectorAtributos=new Array;
	...
	//Inicia Layout
	var config={
		titulo_maestro:'Clasificación de Grupos'
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Clasificación de Grupos";
		return titulo;
	}
	...
	//	window.open(direccion+'../../../../../control/_reportes/clasificacion_supergrupo/ActionClasificacionSupergrupo.php?txt_id_supergrupo='+combo_supergrupo.getValue()),
		...
		grupos:[{
			tituloGrupo:'Clasificación de Grupos',
			columna: 0,
			id_grupo:0
		}
		]}};
