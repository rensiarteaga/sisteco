...
var elemento={pagina:new pagina_clasificacion_id2(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
 * Nombre:		  	    pagina_clasificacion_id2.js
 * Propósito: 			pagina objeto principal
 * Autor:				
 * Fecha creación:		2007-11-26 
 */
function pagina_clasificacion_id2(idContenedor,direccion,paramConfig)
{	var vectorAtributos=new Array;
	...
	layout_clasificacion_id2=new DocsLayoutProceso(idContenedor);
	layout_clasificacion_id2.init(config);
	////////////////////////
	// INICIAMOS HERENCIA //
	////////////////////////
	...
	this.pagina(paramConfig,vectorAtributos,layout_clasificacion_id2,idContenedor);
	...
	var paramFunciones = {
		...
		height:'70%',
		url:direccion+'../../../../../control/_reportes/clasificacion_id2/ActionClasificacionId2.php?'+datax,
	...
	//	window.open(direccion+'../../../../../control/_reportes/clasificacion_supergrupo/ActionClasificacionSupergrupo.php?txt_id_supergrupo='+combo_supergrupo.getValue()),
		...
		width:'60%',
		columnas:['50%'],
		minWidth:150,minHeight:200,	closable:true,titulo:'Clasificacion ID2',
		grupos:[{
			tituloGrupo:'Clasificación ID2',
			columna: 0,
			id_grupo:0
		}
		]}};
	...
	//Para manejo de eventos
		...
		function clasificacion(){
		    datax = "txt_id_supergrupo=" + combo_supergrupo.getValue()+'&txt_id_grupo='+combo_grupo.getValue()+'&txt_id_subgrupo='+combo_subgrupo.getValue()+'&txt_id_id1='+combo_id1.getValue();
				
		 }
		
		//combo_id2.on('select',clasificacion);
		//combo_id2.on('change',clasificacion);
   ...
   //para que los hijos puedan ajustarse al tamaño
	this.getLayout=function(){return layout_clasificacion_id2.getLayout();};
