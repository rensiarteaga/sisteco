...
var elemento={pagina:new pagina_valoracion_saldos(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);

/**
* Nombre:		  	    pagina_valoracion_saldos.js
* Propósito: 			pagina objeto principal
* Autor:				RCM
* Fecha creación:		31/03/2009
*/
function pagina_valoracion_saldos(idContenedor,direccion,paramConfig)
{
	...
	var paramFunciones = {
		...
		height:'70%',
		url:direccion+'../../../../control/_reportes/total_valoracion_ing_sal/ActionValoracionSaldos.php',
