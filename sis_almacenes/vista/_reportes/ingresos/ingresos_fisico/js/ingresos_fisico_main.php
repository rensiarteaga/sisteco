...
var elemento={pagina:new pagina_ingresos_fisico(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
 ...
 */
function pagina_ingresos_fisico(idContenedor,direccion,paramConfig)
{	var vectorAtributos=new Array;
	...
	//Inicia Layout
	var config={
		titulo_maestro:'Ingresos de Almacenes'
		
	};
	layout_ingresos_fisico=new DocsLayoutProceso(idContenedor);
	layout_ingresos_fisico.init(config);
	////////////////////////
	// INICIAMOS HERENCIA //
	////////////////////////
	...
	this.pagina(paramConfig,vectorAtributos,layout_ingresos_fisico,idContenedor);
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Ingresoss de Almacen";
	...
	var paramFunciones = {
		...
		height:'70%',
		url:direccion+'../../../../../control/_reportes/ingresos_fisico/ActionReporteIngresosFisico.php',
