...
var elemento={pagina:new pagina_ingresos_ep(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
* Nombre:		  	    pagina_ingresos_ep_main.js
* Propósito: 			pagina objeto principal
* Autor:				Generado Automaticamente
* Fecha creación:		2007-10-18 21:00:48
*/
function pagina_ingresos_ep(idContenedor,direccion,paramConfig)
...
vectorAtributos[6] = param_fecha_apertura;
...
vectorAtributos[7] = param_fecha_cierre;
...
//Inicia Layout
var config={
	titulo_maestro:'ingresos_ep de Valor'

};
layout_ingresos_ep=new DocsLayoutProceso(idContenedor);
layout_ingresos_ep.init(config);
////////////////////////
// INICIAMOS HERENCIA //
////////////////////////
...
this.pagina(paramConfig,vectorAtributos,layout_ingresos_ep,idContenedor);
...
var paramFunciones = {
	...
	height:'70%',
	url:direccion+'../../../../../control/_reportes/ingresos_ep/ActionReporteIngresosEp.php',
	...
	this.getLayout=function(){return layout_ingresos_ep.getLayout();};
