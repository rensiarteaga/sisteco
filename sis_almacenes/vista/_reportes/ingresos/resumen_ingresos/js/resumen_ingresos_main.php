...
var elemento={pagina:new pagina_resumen_ingresos(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
 ...
 */
function pagina_resumen_ingresos(idContenedor,direccion,paramConfig)
{	var vectorAtributos=new Array;
	var ds_almacen,layout_resumen_ingresos;		
	...
	var config={titulo_maestro:'Ingreso de Material'};
	layout_resumen_ingresos=new DocsLayoutProceso(idContenedor);
	layout_resumen_ingresos.init(config);
	// INICIAMOS HERENCIA //
	this.pagina=BaseParametrosReporte;
	this.pagina(paramConfig,vectorAtributos,layout_resumen_ingresos,idContenedor);
	...
	function obtenerTitulo(){
		var titulo="Ingreso de Material";
		return titulo
	}
	var paramFunciones={
		Formulario:{html_apply:'dlgInfo-'+idContenedor,height:'70%',url:direccion+'../../../../../control/_reportes/resumen_ingresos/ActionRptResumenIngresos.php',abrir_pestana:true,titulo_pestana:obtenerTitulo,fileUpload:false,
		            width:'70%',columnas:['50%'],minWidth:150,minHeight:200,closable:true,titulo:'Almacen',grupos:[{tituloGrupo:'Almacén',columna:0,id_grupo:0},{tituloGrupo:'Rango de fechas',columna:0,id_grupo:1}]}};
