...
var elemento={pagina:new pagina_ingresos_logico(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
 * Nombre:		  	    pagina_ingresos_logico_main.js
 * Propósito: 			pagina objeto principal
 * Autor:				Generado Automaticamente
 * Fecha creación:		2007-10-18 21:00:48
 */
function pagina_ingresos_logico(idContenedor,direccion,paramConfig)
...
/*// txt fecha_reg15
	var paramMes = {
		validacion: {
			...
			store: new Ext.data.SimpleStore({
				fields: ['mes', 'nombre'],
				data : Ext.proc_ingresos_logicoCombo.meses
			}),
			valueField:'mes',
			displayField:'nombre',
			width: 120,
	...
	var paramGestion = {
		validacion:{
			...
			store: new Ext.data.SimpleStore({
				fields: ['v1'],
				data : Ext.proc_ingresos_logicoCombo.anos
			}),
			valueField:'v1',
			displayField:'v1',
			lazyRender:true,
...
var param_fecha_apertura= {
	...
	//Inicia Layout
	var config={
		titulo_maestro:'ingresos_logico de Valor'
		
	};
	layout_ingresos_logico=new DocsLayoutProceso(idContenedor);
	layout_ingresos_logico.init(config);
	////////////////////////
	// INICIAMOS HERENCIA //
	////////////////////////
	...
	this.pagina(paramConfig,vectorAtributos,layout_ingresos_logico,idContenedor);
	...
	function obtenerTitulo()
	{
		...
		var titulo = "ingresos_logico de Valor";
	...
	var paramFunciones = {
		...
		height:'70%',
		url:direccion+'../../../../../control/_reportes/ingresos_logico/ActionReporteIngresosLogico.php',
 ...
 function verificar_almacen_logico()
	...
	this.getLayout=function(){return layout_ingresos_logico.getLayout();};
