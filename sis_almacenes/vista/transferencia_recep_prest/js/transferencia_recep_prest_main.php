...
function main(){
	...
	var elemento={pagina:new pagina_transferencia_recep_prest(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
function pagina_transferencia_recep_prest(idContenedor,direccion,paramConfig)
{
	...
	ds = new Ext.data.Store({
		...
		var paramFunciones = {
			...
			width:'80%',
			minWidth:150,minHeight:200,	closable:true,titulo:'Recepción de transferencia',
			}
		};
