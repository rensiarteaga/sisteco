...
function main(){
	...
	var elemento={pagina:new pagina_orden_ingreso_sol_devol(idContenedor,direccion,paramConfig),idContenedor:'<?php echo $idContenedor;?>'};
...
function pagina_orden_ingreso_sol_devol(idContenedor,direccion,paramConfig)
{
	...
	//Inicia Layout
	var config = {
		titulo_maestro:'Orden Ingreso - Devolución',
