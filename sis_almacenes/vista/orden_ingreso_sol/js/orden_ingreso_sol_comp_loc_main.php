...
function main(){
	...
	var elemento={pagina:new pagina_orden_ingreso_sol_comp_loc(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
* Fecha creación:		2007-10-17 12:31:23
*/
function pagina_orden_ingreso_sol_comp_loc(idContenedor,direccion,paramConfig)
{
	...
	//Inicia Layout
	var config = {
		titulo_maestro:'Orden Ingreso - Compra local',
	...
	var paramFunciones = {
		...
		minWidth:150,minHeight:200,	closable:true,titulo:'Orden Ingreso - Compra Local'}
	};
