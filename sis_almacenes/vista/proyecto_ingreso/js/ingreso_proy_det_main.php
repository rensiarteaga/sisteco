<?php
/**
 * Nombre:		  	    pagina_ingreso_proy_det_main.php
...
function main(){
	...
	var elemento={idContenedor:idContenedor,pagina:new pagina_ingreso_proy_det(idContenedor,direccion,paramConfig,maestro,idContenedorPadre,moneda_princ)};
	ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);

/**
* Nombre:		  	    pagina_ingreso_proy_det.js
* Propósito: 			pagina objeto principal
* Autor:				RCM
* Fecha creación:		01/08/2008
*/
function pagina_ingreso_proy_det(idContenedor,direccion,paramConfig,maestro,idContenedorPadre,moneda_princ)
{
	...
	vectorAtributos[1]= {
		validacion: {
			...
			loadMask: true,
			triggerAction: 'all',
			//store: new Ext.data.SimpleStore({fields: ['ID','valor'],data : Ext.ingreso_proy_det_combo.estado_item}),
	...
	var paramFunciones={
		...
		Save:{url:direccion+'../../../control/ingreso_detalle/ActionGuardarIngresoProyDet.php',parametros:'&txt_id_ingreso='+maestro.id_ingreso},
