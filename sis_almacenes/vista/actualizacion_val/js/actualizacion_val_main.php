...
function main(){
	...
	var elemento={pagina:new pagina_actualizacion_val(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
	ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);

/**
* Nombre:		  	    pagina_actualizacion_val_main.js
* Propósito: 			pagina objeto principal
* Autor:				Generado Automaticamente
* Fecha creación:		2007-10-18 21:00:48
*/
function pagina_actualizacion_val(idContenedor,direccion,paramConfig)
{
	var vectorAtributos=new Array;
	var data_ep;
	var combo_financiador,combo_regional,combo_programa,combo_proyecto,combo_actividad,combo_almacen,combo_almacen_logico;
	...
	var param_id_financiador={
		validacion:{
			...
			filterCol:'FINANC.nombre_financiador#FINANC.codigo_financiador',
			typeAhead:true,
			forceSelection:true,
	...
	var param_id_regional={
		validacion:{
			...
			queryParam:'filterValue_0',
			filterCol:'REGION.nombre_regional#REGION.codigo_regional',
	...
	var param_id_programa={
		validacion:{
			...
			queryParam:'filterValue_0',
			filterCol:'PROGRA.nombre_programa#PROGRA.codigo_programa',
	...
	var paramId_proyecto={
		validacion:{
			...
			queryParam:'filterValue_0',
			filterCol:'PROYEC.nombre_proyecto#PROYEC.codigo_proyecto',
	...
	var param_id_actividad={
		validacion:{
			...
			queryParam:'filterValue_0',
			filterCol:'ACTIVI.nombre_actividad#ACTIVI.codigo_actividad',
	...
	fields: ['mes', 'nombre'],
	data : Ext.proc_actualizacionCombo.meses
	}),
	valueField:'mes',
	displayField:'nombre',
	width: 120,
	...
	store: new Ext.data.SimpleStore({
	fields: ['v1'],
	data : Ext.proc_actualizacionCombo.anos
	}),
	valueField:'v1',
	displayField:'v1',
	lazyRender:true,
	...
	*/
	...
	var param_fecha= {
		validacion:{
			...
			fieldLabel:'Fecha de Actualizacion',
			allowBlank:true,
		...
		dateFormat:'m-d-Y',
		defecto:'',
		save_as:'txt_fecha_actualizacion',
		id_grupo:2
	};
	...
	//Inicia Layout
	var config={
		titulo_maestro:'Actualizacion de Valor'

	};
	layout_actualizacion_val=new DocsLayoutProceso(idContenedor);
	layout_actualizacion_val.init(config);
	////////////////////////
	// INICIAMOS HERENCIA //
	////////////////////////
	...
	this.pagina(paramConfig,vectorAtributos,layout_actualizacion_val,idContenedor);
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Actualizacion de Valor";
	...
	var paramFunciones = {
		...
		height:'70%',
		url:direccion+'../../../control/actualizacion_valor/ActionActualizacionValor.php',
		...
		{	tituloGrupo:'Fecha de Actualización',
		columna:0,
		id_grupo:2
		}
		...
		function verificar_ep_logico()
		{
			if(ClaseMadre_getComponente('id_financiador').getValue()>0 &&ClaseMadre_getComponente('id_regional').getValue()>0 &&ClaseMadre_getComponente('id_programa').getValue()>0 &&ClaseMadre_getComponente('id_proyecto').getValue()>0 &&ClaseMadre_getComponente('id_actividad').getValue()>0 && ClaseMadre_getComponente('id_almacen').getValue()>0)
		...
		this.getLayout=function(){return layout_actualizacion_val.getLayout();};
