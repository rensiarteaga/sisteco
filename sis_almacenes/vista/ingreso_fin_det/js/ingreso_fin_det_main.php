...
var elemento={idContenedor:idContenedor,pagina:new pagina_orden_ingreso_val_det(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);

/**
* Nombre:		  	    pagina_orden_ingreso_val_det.js
* Propósito: 			pagina objeto principal
* Autor:				Generado Automaticamente
* Fecha creación:		2007-10-17 12:33:25
*/
function pagina_orden_ingreso_val_det(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
