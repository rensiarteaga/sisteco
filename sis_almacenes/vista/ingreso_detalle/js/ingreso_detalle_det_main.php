 ...
 * Fecha creación:		2007-10-18 18:12:57
 *
 */
session_start();
?>
...
var paramConfig={TamanoPagina:20,
		...
		FiltroAvanzado:fa};
var maestro={id_ingreso:<?php echo $m_id_ingreso;?>,codigo:'<?php echo $m_codigo;?>',descripcion:'<?php echo $m_descripcion;?>'};
var elemento={idContenedor:idContenedor,pagina:new pagina_ingreso_detalle_det(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
 ...
 * Autor:				Generado Automaticamente
 * Fecha creación:		2007-10-18 18:13:10
 */
function pagina_ingreso_detalle_det(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
	...
	ds = new Ext.data.Store({
		...
		proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/ingreso_detalle/ActionListarIngresoDetalle_det.php'}),
	...
	vectorAtributos[5] = {
		validacion:{
			...
			fieldLabel:'precio_venta_unitario',
			allowBlank:false,
			maxLength:50,
			minLength:0,
			selectOnFocus:true,
	...
	Save:{url:direccion+'../../../control/ingreso_detalle/ActionGuardarIngresoDetalle.php',parametros:'&m_id_ingreso='+maestro.id_ingreso},
	ConfirmSave:{url:direccion+'../../../control/ingreso_detalle/ActionGuardarIngresoDetalle.php'},
	Formulario:{html_apply:'dlgInfo-'+idContenedor,height:340,width:480,minWidth:150,minHeight:200,closable:true,titulo: 'Ingreso Detalle'}
	}
