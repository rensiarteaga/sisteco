<?php
/**
 * Nombre:		  	    inventario_det_det_main.php
 * Propósito: 			pagina que arranca la configuracion de la vista del Hijo
 * Autor:				Generado Automaticamente
 * Fecha creación:		2007-10-31 16:33:15
 *
 */
session_start();
?>
...
var maestro={
	     	id_inventario:<?php echo $m_id_inventario;?>,
	     	tipo_inventario:'<?php echo $m_tipo_inventario;?>',
	     	estado:'<?php echo $m_estado;?>',
	     	observaciones:'<?php echo $m_observaciones;?>'};
var elemento={idContenedor:idContenedor,pagina:new pagina_inventario_resultado_detalle(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
 ...
 */
function pagina_inventario_resultado_detalle(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{	var vectorAtributos=new Array;
	var ds,combo_supergrupo,combo_grupo,combo_subgrupo,combo_id1,combo_id2,combo_id3,combo_item,txt_usado,txt_nuevo,txt_total;
	var elementos=new Array();
	var componentes=new Array();
	var cmb_spGrup,cmb_grup,smb_sbGrup,cmb_id1,cmb_id2,cmb_id3;
	var sw=0;
	//  DATA STORE //
   ...
   var cmMaestro = new Ext.grid.ColumnModel([{header:"Atributo",width:150,sortable:false,renderer:negrita,locked:false,dataIndex:'atributo'},{header:"Valor",width: 300,sortable:false,renderer:italic,locked:false,dataIndex:'valor'}]);
	...
	var gridMaestro=new Ext.grid.Grid(div_grid_detalle,{ds:new Ext.data.SimpleStore({fields:['atributos','valor'],data:[['Tipo de Inventario',maestro.tipo_inventario],['Estado',maestro.estado],['Observaciones',maestro.observaciones]]}),cm:cmMaestro});
	gridMaestro.render();
	//DATA STORE COMBOS
...
//--------- DEFINICIÓN DE FUNCIONES
	...
	Formulario:{html_apply:'dlgInfo-'+idContenedor,height:340,width:'60%',minWidth:'85',minHeight:200,closable:true,titulo: 'Inventario Detalle'}
	}
