<?php
/**
 * Nombre:		  	    motivo_ingreso_cuenta_det_main.php
...
var maestro={id_motivo_ingreso:<?php echo $m_id_motivo_ingreso;?>,nombre:'<?php echo $m_nombre;?>',descripcion:'<?php echo $m_descripcion;?>'};
var elemento={idContenedor:idContenedor,pagina:new pagina_motivo_ingreso_cuenta_det(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
