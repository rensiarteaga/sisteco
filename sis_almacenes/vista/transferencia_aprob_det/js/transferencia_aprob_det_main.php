<?php
/**
 * Nombre:		  	    transferencia_det_main.php
...
function main(){
	...
	var elemento={idContenedor:idContenedor,pagina:new pagina_transferencia_aprob_det(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
	ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);

/**
* Nombre:		  	    pagina_transferencia_det_det.js
* Propósito: 			pagina objeto principal
* Autor:				JoSé A. Mita H.
* Fecha creación:		2007-11-21 08:53:40
*/
function pagina_transferencia_aprob_det(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
	...
	ds = new Ext.data.Store({
		...
		var gridMaestro=new Ext.grid.Grid(div_grid_detalle,{ds:new Ext.data.SimpleStore({fields:['atributo','valor'],data:[['Transferencia',maestro.id_transferencia],['Almacen Fisico ID',maestro.id_almacen_logico],['Almacen Logico',maestro.desc_almacen_logico]]}),cm:cmMaestro});
		gridMaestro.render();
		//DATA STORE COMBOS
		...
		vectorAtributos[1]= {
			validacion: {
				...
				loadMask: true,
				triggerAction: 'all',
				//store: new Ext.data.SimpleStore({fields: ['ID','valor'],data : Ext.transferencia_aprob_det_combo.estado_item}),
		...
		this.reload=function(params){
			...
			gridMaestro.getDataSource().loadData([['Transferencia',maestro.id_transferencia],['Almacen Logico Id',maestro.id_almacen_logico],['Almacen Logico',maestro.almacen_logico]]);
