<?php
/**
 * Nombre:		  	    composicion_tuc_det_main.php
...
var elemento={idContenedor:idContenedor,pagina:new PaginaComposicionTuc(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
