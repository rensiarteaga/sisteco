<?php 
/**
 * Nombre:		  	    responsable_almacen_main.php
 * Propósito: 			pagina que arranca la configuracion de la vista
 * Autor:				Generado Automaticamente
 * Fecha creación:		2007-10-12 09:01:22
 *
 */
session_start();
?>
...
function main(){
	...
	var elemento={pagina:new pagina_responsable_almacen(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
