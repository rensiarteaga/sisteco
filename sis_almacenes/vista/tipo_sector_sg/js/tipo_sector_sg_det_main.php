<?php 
/**
 * Nombre:		  	    tipo_sector_sg_det_main.php
...
function main(){
	...
	var maestro={id_tipo_sector:<?php echo $m_id_tipo_sector;?>,codigo:'<?php echo $m_codigo;?>',descripcion:'<?php echo $m_descripcion;?>',observaciones:'<?php echo $m_observaciones;?>'};
	var elemento={idContenedor:idContenedor,pagina:new pagina_tipo_sector_sg_det(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
