...
var maestro={    	id_inventario:<?php echo $m_id_inventario;?>,
                 	tipo_inventario:'<?php echo $m_tipo_inventario;?>', 
	     	    	observaciones:'<?php echo $m_observaciones;?>'};
var elemento={idContenedor:idContenedor,pagina:new pagina_inventario_conclusion_detalle(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
 ...
 */
function pagina_inventario_conclusion_detalle(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{	var vectorAtributos=new Array;
   ...
   var dataMaestro=[['Inventario',maestro.id_inventario],['Tipo de Inventario',maestro.tipo_inventario],['Observaciones',maestro.observaciones]];
	...
	var config={
		titulo_maestro:'Inventario Conclusion (Maestro)',
		titulo_detalle:'Detalle de Inventarios Concluidos (Detalle)',
