...
var maestro={id_salida:<?php echo $m_id_salida;?>,codigo:'<?php echo $m_codigo;?>',descripcion:'<?php echo $m_descripcion;?>'};
var elemento={idContenedor:idContenedor,pagina:new pagina_salida_detalle_det(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
