...
function main(){
	...
	var elemento={pagina:new PaginaId2(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
	ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);

function PaginaId2(idContenedor,direccion,paramConfig){
	var vectorAtributos=new Array;
	var ds,layout_id2,txt_nivel_convertido;
	...
	var sw=0;
	var combo_supergrupo,combo_grupo,combo_subgrupo,combo_id1,txt_codigo,txt_nombre,txt_descripcion,txt_convertido,txt_fecha_reg;
	/////////////////
	//  DATA STORE //
	/////////////////
	...
	vectorAtributos[7]={
		...
		tipo:'TextField',
		filtro_0:true,
		filterColValue:'id2.descripcion',
	...
	vectorAtributos[8]={
		...
		tipo:'TextArea', 
		filtro_0:true,
		filterColValue:'id2.observaciones',
	...
	vectorAtributos[9]={
		validacion:{
			...
			loadMask:true,
			triggerAction:'all',
			//store:new Ext.data.SimpleStore({fields:['id', 'valor'],data:Ext.id2_combo.estado}),
		...
		tipo:'ComboBox',
		filtro_0:true,
		filterColValue:'id2.estado_registro',
	...
	//////////////////////////////////////////////////////////////
	// ---------- Inicia Layout ---------------//
	var config={titulo_maestro:"Identificador Id2",grid_maestro:"grid-"+idContenedor};
	layout_id2=new DocsLayoutMaestro(idContenedor);
	layout_id2.init(config);
	////////////////////////
	// INICIAMOS HERENCIA //
	////////////////////////
	this.pagina=Pagina;
	this.pagina(paramConfig,vectorAtributos,ds,layout_id2,idContenedor);
	...
	//////////////////////////////////////////////////////////////////////////////
	var paramFunciones={
		btnEliminar:{url:direccion+"../../../control/id2/ActionEliminarId2.php"},
		Save:{url:direccion+"../../../control/id2/ActionGuardarId2.php"},
		ConfirmSave:{url:direccion+"../../../control/id2/ActionGuardarId2.php"},
		Formulario:{
			guardar:overloadSave,
			html_apply:"dlgInfo"+idContenedor,width:'40%',height:'52%',minWidth:150,minHeight:200,labelWidth:75,closable:true,titulo: 'identificador 2'}
	};
...
function btnCrearItem(){
	...
	function crearItem(){
		if(txt_convertido.getValue()=='no'){
			...
			var data="cantidad_ids=1&hidden_id_id2_0="+SelectionsRecord.data.id_id2;
			...
			Ext.Ajax.request({url:direccion+"../../../control/id2/ActionCrearItemId2.php",
			params:data,
			method:'POST',
	...
	this.btnEdit=function(){
		if(txt_convertido.getValue()=='si'){
		   ...
		   CM_ocultarComponente(txt_fecha_reg);
			...
			//h_txt_cod=h_txt_codigo.substr(15,3);
			var editar = h_txt_codigo.split('.');
			txt_codigo.setValue(editar[4]);
			combo_grupo.disable();
			combo_subgrupo.disable();
			combo_id1.disable();
			ClaseMadre_btnEdit()
	...
	layout_id2.getLayout().addListener('layout',this.onResize);
