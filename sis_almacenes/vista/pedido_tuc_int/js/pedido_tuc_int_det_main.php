<?php
/**
 * Nombre:		  	    pedido_tuc_int_det_main.php
...
function main(){
	...
	var elemento={idContenedor:idContenedor,pagina:new pagina_pedido_tuc_int_det(idContenedor,direccion,paramConfig,maestro,'<?php echo $idContenedorPadre;?>')};
...
*/
function pagina_pedido_tuc_int_det(idContenedor,direccion,paramConfig,maestro,idContenedorPadre){
	var vectorAtributos=new Array;
	var ds,layout_pedido_tuc_int,combo_bloqueado,combo_cerrado,txt_fecha_reg;
	...
	layout_pedido_tuc_int=new DocsLayoutDetalle(idContenedor,idContenedorPadre);
	layout_pedido_tuc_int.init(config);
	//---------- INICIAMOS HERENCIA
	this.pagina=Pagina;
	this.pagina(paramConfig,vectorAtributos,ds,layout_pedido_tuc_int,idContenedor);
	...
	function btn_autorizar_ped(){
		...
		if(NumSelect!=0){			
				...
				var data=SelectionsRecord.data.id_pedido_tuc_int;
				Ext.MessageBox.show({
				...
				Ext.Ajax.request({
					url:direccion+"../../../control/pedido_tuc_int/ActionAutorizarPedido.php?hidden_id_pedido_tuc_int="+data,
					method:'GET',
					success:terminado,
	...
	this.getLayout=function(){
		return layout_pedido_tuc_int.getLayout()
	};
	...
	this.AdicionarBoton('../../../lib/imagenes/lock_open.png','Abrir restricción de faltante',btn_autorizar_ped,true,'autor_desb','');
	
	this.iniciaFormulario();
	layout_pedido_tuc_int.getLayout().addListener('layout',this.onResize);
