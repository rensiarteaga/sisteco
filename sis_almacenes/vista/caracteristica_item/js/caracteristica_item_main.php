...
idContenedorPadre='<?php echo $idContenedorPadre;?>';
	var elemento={idContenedor:idContenedor,pagina:new PaginaCaracteristicaItem(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
