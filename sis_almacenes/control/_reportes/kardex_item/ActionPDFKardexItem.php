...
$nombre_archivo = 'ActionPDFKardexItem.php';
...
SALIDA.fecha_finalizado_cancelado >=''$txt_fecha_desde'' and SALIDA.fecha_finalizado_cancelado<=''$txt_fecha_hasta'' 
 AND TRAMO.id_tramo = $txt_id_tramo	GROUP BY ITEM.codigo,ITEM.nombre,ITEM.descripcion";*/
		...
		if($tipo_reporte==3){
			header("location: ../../../vista/_reportes/kardex_item/PDFKardexItemCosto.php");
		}elseif ($tipo_reporte==2){
			header("location: ../../../vista/_reportes/kardex_item/PDFKardexItemCantidad.php");
		}else{
			header("location: ../../../vista/_reportes/kardex_item/PDFKardexItem.php");
		}
	}
else
	{
