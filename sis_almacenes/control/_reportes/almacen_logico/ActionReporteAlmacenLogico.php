<?php
/**
 * Nombre:	        ActionReporteAlmacenLogico.php
...
$nombre_archivo = 'ActionReporteAlmacenLogico.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	$reporte -> CreateReport('Pdf','../../../modelo/_reportes/ral_almacen_logico.agt',$parametros);
}
else
{
