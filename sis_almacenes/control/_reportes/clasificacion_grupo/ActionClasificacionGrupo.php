<?php
/**
 * Nombre:	        ActionClasificacionGrupo.php
...
$nombre_archivo = 'ActionClasificacionGrupo.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	$reporte -> CreateReport('Pdf','../../../modelo/_reportes/ral_clasificacion_grupo.agt',$parametros);
}
else
{
