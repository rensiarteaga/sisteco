<?php
/**
 * Nombre:	        ActionReporteInventario.php
...
$nombre_archivo = 'ActionReporteInventario.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	$reporte -> CreateReport('Pdf','../../../modelo/_reportes/ral_inventario_fisico.agt',$parametros);
}
else
{
