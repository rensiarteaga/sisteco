...
if($_SESSION['autentificado']=="SI")
{
			...
			$id_almacen_logico = $maestro_id_almacen_logico;
			...
			$_SESSION['rep_mat_id_almacen_logico']=$id_almacen_logico; 
			
			
			header("location:PDFVerificacionExistUCSalidaReporte.php?id_salida=$id_salida&id_almacen_logico=$id_almacen_logico");
}
