<?php
/**
 * Nombre:	        ActionReporteIngresosFisico.php
...
$nombre_archivo = 'ActionReporteIngresosFisico.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	$reporte -> CreateReport('Pdf','../../../modelo/_reportes/ral_ingresos_fisico.agt',$parametros);
}
else
{
