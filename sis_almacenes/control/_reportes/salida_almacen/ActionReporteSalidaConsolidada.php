<?php
/**
 * Nombre:	        ActionReporteSalidaConsolidada.php
...
$nombre_archivo = 'ActionReporteSalidaConsolidada.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	$reporte -> CreateReport('Pdf','../../../modelo/_reportes/ral_salida_consolidada.agt',$parametros);
}
else
{
