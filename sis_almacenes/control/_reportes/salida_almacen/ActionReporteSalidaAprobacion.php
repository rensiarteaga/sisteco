<?php
/**
 * Nombre:	        ActionReporteSalidaAprobacion.php
...
$nombre_archivo = 'ActionReporteSalidaAprobacion.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	$reporte -> CreateReport('Pdf','../../../modelo/_reportes/ral_salida_aprobacion.agt',$parametros);
}
else
{
