<?php
/**
 * Nombre:	        ActionClasificacionSupergrupo.php
...
if($_SESSION['autentificado']=="SI")
{
	...
	//$parametros = null;
	$parametros = array ('$id'=> $txt_id_supergrupo);
	
	//Valid values are: Pdf, Ps, Html, etc
	
	$reporte -> CreateReport('Pdf','../../../modelo/_reportes/ral_clasificacion_item_x_super.agt',$parametros);
	//$reporte -> CreateReport('Pdf','../../../modelo/_reportes/reporte_triste.agt',$parametros);
}
else
{
