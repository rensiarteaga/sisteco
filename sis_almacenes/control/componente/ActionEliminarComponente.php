...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarComponente.php
Propósito:				Permite eliminar registros de la tabla tal_componente
...
$nombre_archivo = "ActionEliminarComponente.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarComponente($hidden_id_componente);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
