...
Propósito:				Permite insertar y modificar datos en la tabla tal_kardex_logico
...
Fecha de Creación:		2007-10-26 15:20:22
Versión:				1.0.0
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_kardex_logico == "undefined" || $hidden_id_kardex_logico == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tal_kardex_logico
