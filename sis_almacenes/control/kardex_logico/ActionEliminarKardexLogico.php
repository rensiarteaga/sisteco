...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarKardexLogico.php
Propósito:				Permite eliminar registros de la tabla tal_kardex_logico
Tabla:					tal_tal_kardex_logico
Parámetros:				$hidden_id_kardex_logico


Valores de Retorno:    	Número de registros
Fecha de Creación:		2007-10-26 15:20:23
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarKardexLogico.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarKardexLogico($hidden_id_kardex_logico);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
