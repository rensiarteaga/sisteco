...
/**
**********************************************************
Nombre de archivo:	    ActionListarId2.php
Propósito:				Permite desplegar los Identificadores Id2
Tabla:					tal_id2
Parámetros:				$cant
$puntero
$sortcol
...
$nombre_archivo = 'ActionListarId2.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	if($registro=='nuevo'){
		$criterio_filtro .= " AND id2.registro = ''nuevo''";
	} elseif($registro=='antiguo'){
		$criterio_filtro .= " AND (id2.registro is null or id2.registro <> ''nuevo'')";
	}
	
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,'Id2');
	...
	$res = $Custom->ListarId2($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
