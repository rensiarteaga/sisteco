...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarSupervisor.php
Propósito:				Permite eliminar registros de la tabla tal_supervisor
Tabla:					tal_supervisor
Parámetros:				$hidden_id_supervisor
...
$nombre_archivo = "ActionEliminarSupervisor.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarSupervisor($hidden_id_supervisor);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
