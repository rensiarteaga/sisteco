...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarAlmacenLogico.php
Propósito:				Permite eliminar registros de la tabla tal_almacen_logico
...
$nombre_archivo = "ActionEliminarAlmacenLogico.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarAlmacenLogico($hidden_id_almacen_logico);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
