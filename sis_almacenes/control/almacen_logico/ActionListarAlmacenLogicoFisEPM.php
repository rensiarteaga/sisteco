...
$nombre_archivo = 'ActionListarAlmacenLogicoFisEPM.php';
...
//Parámetros del filtro
	...
	if($hidden_id_uo>0){//para filtrar almacenes logicos de la EP del solicitante (Sist. Adquisiciones)
	    $criterio_filtro=$criterio_filtro." AND ALMLOG.id_unidad_organizacional=$hidden_id_uo";
	}
	...
	$res = $Custom -> ContarAlmacenLogicoFisEpM($cant ,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);

	if($res) $total_registros= $Custom->salida;

	//Obtiene el conjunto de datos de la consulta
	$res = $Custom->ListarAlmacenLogicoFisEpM($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
