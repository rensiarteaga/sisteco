...
$nombre_archivo = "ActionReconteoInventario.php";
...
{	//Verifica si los datos vienen por POST o GET
	...
	{	if ($get)
		...
		//Validación de datos (del lado del servidor)
			$res = $Custom->ReconteoInventario($hidden_id_inventario, $txt_observaciones, $txt_fecha_inicio, $txt_fecha_fin, $txt_fecha_reg,$txt_tipo_inventario, $txt_id_almacen, $txt_id_responsable_almacen, $txt_id_almacen_ep, $txt_id_almacen_logico,$txt_estado,$txt_id_almacenero);
			if(!$res)
			{	//Se produjo un error
				$resp = new cls_manejo_mensajes(true, "406");
