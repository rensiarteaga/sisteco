...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarInventario.php
Propósito:				Permite eliminar registros de la tabla tal_inventario
...
$nombre_archivo = "ActionEliminarInventario.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarInventario($hidden_id_inventario);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
