...
Propósito:				Permite insertar y modificar datos en la tabla tal_motivo_ingreso_cuenta
...
$txt_id_financiador= $_POST["txt_id_financiador_$j"];
		...
		if ($hidden_id_motivo_ingreso_cuenta == "undefined" || $hidden_id_motivo_ingreso_cuenta == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tal_motivo_ingreso_cuenta
