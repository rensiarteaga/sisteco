...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarMotivoIngresoCuenta.php
Propósito:				Permite eliminar registros de la tabla tal_motivo_ingreso_cuenta
Tabla:					tal_tal_motivo_ingreso_cuenta
Parámetros:				$hidden_id_motivo_ingreso_cuenta


Valores de Retorno:    	Número de registros
Fecha de Creación:		2007-10-17 15:49:51
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarMotivoIngresoCuenta.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarMotivoIngresoCuenta($hidden_id_motivo_ingreso_cuenta);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
