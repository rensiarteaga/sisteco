...
$nombre_archivo = 'ActionListarGrupo.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	if($registro=='nuevo'){
		$criterio_filtro .= " AND g.registro = ''nuevo''";
	} elseif($registro=='antiguo'){
		$criterio_filtro .= " AND (g.registro is null or g.registro <> ''nuevo'')";
	}
	
	
	//Obtiene el criterio de orden de columnas
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,"al_grupo");
	...
	$res = $Custom->ListarGrupo($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	if($res)
	{
