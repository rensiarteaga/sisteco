...
/**
**********************************************************
Nombre de archivo:	    ActionListarId1.php
Propósito:				Permite desplegar los Id1
Tabla:					tal_id1
Parámetros:				$cant
$puntero
$sortcol
...
$nombre_archivo = 'ActionListarId1.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	if($registro=='nuevo'){
		$criterio_filtro .= " AND id1.registro = ''nuevo''";
	} elseif($registro=='antiguo'){
		$criterio_filtro .= " AND (id1.registro is null or id1.registro <> ''nuevo'')";
	}
	
	//Obtiene el criterio de orden de columnas
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,"al_id1");
	...
	$res = $Custom->ListarId1($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	if($res)
	{
