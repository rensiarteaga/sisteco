...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			...
			$txt_superficie_m2				= $_GET["txt_superficie_m2_$j"];
		...
		else
		{
			...
			$txt_superficie_m2				= $_POST["txt_superficie_m2_$j"];
		...
		if ($hidden_id_almacen == "undefined" || $hidden_id_almacen == "")
		{
			...
			$res = $Custom->ValidarAlmacen("insert",$hidden_id_almacen, $txt_codigo, $txt_nombre, $txt_descripcion, $txt_direccion, $txt_via_fil_max, $txt_via_col_max, $txt_bloqueado, $txt_cerrado, $txt_nro_prest_pendientes, $txt_nro_ing_no_finalizados, $txt_nro_sal_no_finalizadas, $txt_observaciones, $txt_fecha_ultimo_inventario, $txt_fecha_reg, $txt_id_regional, $txt_superficie_m2);
