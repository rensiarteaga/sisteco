...
/**
**********************************************************
Nombre de archivo:	    ActionListarMotivoSalidaCuenta.php
Propósito:				Permite realizar el listado en tal_motivo_salida_cuenta
Tabla:					t_tal_motivo_salida_cuenta
Parámetros:				$cant
						$puntero
						$sortcol
						$sortdir
...
Fecha de Creación:		2007-10-18 10:10:46
Versión:				1.0.0
...
$nombre_archivo = 'ActionListarMotivoSalidaCuenta .php';
...
//Parámetros del filtro
	...
	if($sort == '') $sortcol = 'id_motivo_salida_cuenta';
	else $sortcol = $sort;
	...
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,'MotivoSalidaCuenta');
	$sortcol = $crit_sort->get_criterio_sort();
	

	//Obtiene el total de los registros
	$res = $Custom -> ContarMotivoSalidaCuenta($cant ,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);

	if($res) $total_registros= $Custom->salida;

	//Obtiene el conjunto de datos de la consulta
	$res = $Custom->ListarMotivoSalidaCuenta($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
