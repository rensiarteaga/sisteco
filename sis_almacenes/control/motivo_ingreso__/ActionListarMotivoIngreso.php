...
Propósito:				Permite desplegar los Parámetros de Almacén
Tabla:					tal_Motivo_ingreso
Parámetros:				$cant
$puntero
$sortcol
$sortdir
...
if($_SESSION['autentificado']=="SI")
{
	...
	$res = $Custom->ListarMotivoIngreso($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	if($res)
	{
