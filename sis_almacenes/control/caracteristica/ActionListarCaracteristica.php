...
if($_SESSION['autentificado']=="SI")
{
	...
	$cond->add_criterio_extra("CAR.id_tipo_caracteristica",$m_id_tipo_caracteristica);
	...
	$res = $Custom->ListarCaracteristica($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	if($res)
	{
		...
		foreach ($Custom->salida as $f)
		{
			...
			$xml->add_nodo('desc_tipo_unid_med', $f["desc_tipo_unid_med"]);
