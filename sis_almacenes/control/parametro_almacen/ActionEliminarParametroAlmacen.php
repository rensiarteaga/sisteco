...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarParametroAlmacen.php
...
$nombre_archivo = "ActionEliminarParametroAlmacen.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarParametroAlmacen($hidden_id_parametro_almacen);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
