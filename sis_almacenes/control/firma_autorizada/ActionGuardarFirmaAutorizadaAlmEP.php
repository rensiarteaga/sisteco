...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_firma_autorizada == "undefined" || $hidden_id_firma_autorizada == "")
		{
			...
			$res = $Custom->ValidarFirmaAutorizada("insert",$hidden_id_firma_autorizada, $txt_descripcion,$txt_prioridad,$txt_estado_reg,$txt_observaciones,$txt_fecha_reg,$txt_id_empleado_frppa,$txt_id_motivo_salida,$txt_id_motivo_ingreso,$txt_id_almacen_ep);
			...
			$res = $Custom -> InsertarFirmaAutorizada($hidden_id_firma_autorizada, $txt_descripcion, $txt_prioridad, $txt_estado_reg, $txt_observaciones, $txt_fecha_reg, $txt_id_empleado_frppa, $txt_id_motivo_salida, $txt_id_motivo_ingreso,$txt_id_almacen_ep);
		...
		{	///////////////////////Modificación////////////////////
			...
			//Validación de datos (del lado del servidor)
			$res = $Custom->ValidarFirmaAutorizada("update",$hidden_id_firma_autorizada, $txt_descripcion, $txt_prioridad, $txt_estado_reg, $txt_observaciones, $txt_fecha_reg, $txt_id_empleado_frppa, $txt_id_motivo_salida, $txt_id_motivo_ingreso,$txt_id_almacen_ep);
			...
			$res = $Custom->ModificarFirmaAutorizada($hidden_id_firma_autorizada, $txt_descripcion, $txt_prioridad, $txt_estado_reg, $txt_observaciones, $txt_fecha_reg, $txt_id_empleado_frppa, $txt_id_motivo_salida, $txt_id_motivo_ingreso,$txt_id_almacen_ep);
	...
	if($criterio_filtro == "") $criterio_filtro = "ALMAEP.id_almacen_ep=''$m_id_almacen_ep''";	
