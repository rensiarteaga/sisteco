...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarFirmaAutorizada.php
Propósito:				Permite eliminar registros de la tabla tal_firma_autorizada
...
$nombre_archivo = "ActionEliminarFirmaAutorizada.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarFirmaAutorizada($hidden_id_firma_autorizada);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
