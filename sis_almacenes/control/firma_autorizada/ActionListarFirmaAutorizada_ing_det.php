...
$nombre_archivo = 'ActionListarFirmaAutorizada_ing_det.php';
...
//Parámetros del filtro
	...
	$cond->add_criterio_extra("FIRAUT.id_motivo_ingreso",$m_id_motivo_ingreso);
	$criterio_filtro = $cond -> obtener_criterio_filtro();
	//Obtiene el criterio de orden de columnas
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,'FirmaAutorizadaIng');
