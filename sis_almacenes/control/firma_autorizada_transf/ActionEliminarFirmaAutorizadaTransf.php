...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarFirmaAutorizadaTransf.php
Propósito:				Permite eliminar registros de la tabla tal_firma_autorizada_transf
...
$nombre_archivo = "ActionEliminarFirmaAutorizadaTransf.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarFirmaAutorizadaTransf($hidden_id_firma_autorizada_transf);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
