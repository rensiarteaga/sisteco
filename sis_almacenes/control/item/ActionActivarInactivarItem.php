...
/*
**********************************************************
Nombre de archivo:	    ActionActivarInactivarItem.php
Proposito:				Permite insertar y modificar tal_item
Tabla:					tal_item
Parametros:				$hidden_id_item
$txt_descripcion
$txt_flag_comprobante
$txt_tipo_comprobante

Valores de Retorno:    	N�mero de registros
Fecha de Creacion:		17-06-2010
Version:				1.0.0
...
$nombre_archivo = 'ActionActivarInactivarItem.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	
			$res = $Custom->ActivarInactivarItem($id_item);
			if(!$res)
			{
				//Se produjo un error
				$resp = new cls_manejo_mensajes(true, "406");
