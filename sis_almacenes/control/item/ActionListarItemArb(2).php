	...
	if($node=='id' && $filtrar=='true'){
		...
		if($res)
		{
			...
			//preguntamos si el super grupo es uno nuevo
				//si lo es creamos u nuevo nodo
				if($id_spg!=$f["id_supergrupo"] || !$sw){
...
/*
				...
				//ID3
				if  ($id_id3!=$f["id_id3"] || !$sw){
					//detecto que existe un id_3 nuevo -> guardo el anterior
					//si no es la primera iteracion

					if($sw){
						//$_id2['children'][]=$_id3;
					//	echo "<br>  ID 3             ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ  ".$f["id_id3"];
						//echo $t_item;
...
/*
	...
	else
	{
		...
		}elseif($tipo=='supgrupo')
		{
			...
			$res = $Custom->ListarGrupo("NULL",0,'id_grupo','asc',$cond->obtener_criterio_filtro(),$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
			if($res)
			{
				foreach ($Custom->salida as $f)
				{
		...
		elseif($tipo=='grupo')
		{
			...
			$res = $Custom->ListarSubGrupo("NULL",0,'id_subgrupo','asc',$cond->obtener_criterio_filtro(),$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
			if($res)
			{
				foreach ($Custom->salida as $f)
				{
		...
		elseif($tipo=='subgrupo')
		{
			...
			$res = $Custom->ListarId1("NULL",0,'id_id1','asc',$cond->obtener_criterio_filtro(),$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
			if($res)
			{
				foreach ($Custom->salida as $f)
				{
		...
		elseif($tipo=='id1')
		{
			...
			$res = $Custom->ListarId2("NULL",0,'id_id2','asc',$cond->obtener_criterio_filtro(),$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
			if($res)
			{
				foreach ($Custom->salida as $f)
				{
		...
		elseif($tipo=='id2')
		{
			...
			$res = $Custom->ListarId3("NULL",0,'id_id3','asc',$cond->obtener_criterio_filtro(),$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
			if($res)
			{
				foreach ($Custom->salida as $f)
				{
		...
		elseif($tipo=='id3')
		{
			...
			$res = $Custom->ListarItem("NULL",0,'id_item','asc',$cond->obtener_criterio_filtro(),$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
			if($res)
			{
				foreach ($Custom->salida as $f)
				{
