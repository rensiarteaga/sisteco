...
/*			echo "id_ingreso".$hidden_id_ingreso;
		...
		{	///////////////////////Aprobación////////////////////
			...
			$res = $Custom->ValidarIngresoFin("fin",$hidden_id_ingreso);
			...
			$res = $Custom->FinalizarIngresoProy($hidden_id_ingreso);
	...
	$res = $Custom->ContarIngresoFin($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
