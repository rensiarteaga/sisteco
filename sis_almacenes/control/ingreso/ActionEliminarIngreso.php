...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarIngreso.php
Propósito:				Permite eliminar registros de la tabla tal_ingreso
...
$nombre_archivo = "ActionEliminarIngreso.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarOrdenIngresoSol($hidden_id_ingreso);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($criterio_filtro == "") if($criterio_filtro =="") {
