...
/**
**********************************************************
Nombre de archivo:	    ActionListarIngresoProyFin.php
...
Fecha de Creación:		07-07-2008 11:53
Versión:				1.0.0
...
if($_SESSION['autentificado']=='SI')
{
	...
	//Filtra solo los ingresos finalizados
	$cond->add_criterio_extra("INGRES.estado_ingreso","''Finalizado''");
