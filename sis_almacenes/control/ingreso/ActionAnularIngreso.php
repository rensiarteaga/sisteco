...
$nombre_archivo = "ActionAnularIngreso.php";
...
/*		echo "id_ingreso:".$hidden_id_ingreso."-----";
		echo "observaciones:".$txt_observaciones;
		exit;*/
		...
		else
		{
			...
			$res = $Custom->ValidarIngresoPend("anul",$hidden_id_ingreso,$txt_observaciones);
			...
			$res = $Custom->AnularIngreso($hidden_id_ingreso,$txt_observaciones);
	...
	$res = $Custom->ContarIngresoPend($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
