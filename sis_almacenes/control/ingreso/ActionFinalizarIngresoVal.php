...
if($_SESSION["autentificado"]=="SI")
{
	...
	elseif(sizeof($_POST) > 0)
	{
		...
		//prueba yucumo, solo elcomentario
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	///////////////////////Aprobación////////////////////
			...
			$res = $Custom->ValidarIngresoVal("fin",$hidden_id_ingreso);
			if(!$res)
			{
				//Error de validación
				$resp = new cls_manejo_mensajes(true, "406");
			...
			$res = $Custom->FinalizarIngresoVal($hidden_id_ingreso);
	...
	$res = $Custom->ContarIngresoVal($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
