...
//Parámetros del filtro
	...
	//AND  TIPOUC.estado=''Terminado'' AND 
	...
	$res = $Custom->ListarTipoUnidadConstructiva($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
