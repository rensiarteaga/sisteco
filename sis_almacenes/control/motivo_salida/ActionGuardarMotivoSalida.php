...
Propósito:				Permite insertar y modificar datos en la tabla tal_motivo_salida
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_motivo_salida == "undefined" || $hidden_id_motivo_salida == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tal_motivo_salida
