...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarMotivoSalida.php
Propósito:				Permite eliminar registros de la tabla tal_motivo_salida
Tabla:					tal_tal_motivo_salida
Parámetros:				$hidden_id_motivo_salida
...
$nombre_archivo = "ActionEliminarMotivoSalida.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarMotivoSalida($hidden_id_motivo_salida);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
