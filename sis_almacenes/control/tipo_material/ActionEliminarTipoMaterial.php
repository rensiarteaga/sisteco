...
/**
**********************************************************
Nombre de archivo:	   ActionEliminarTipoMaterial.php
...
$nombre_archivo = 'ActionEliminarTipoMaterial.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	
			...
			$res = $Custom->ValidarTipoMaterial("delete",$hidden_id_tipo_material,$txt_nombre,$txt_descripcion,$txt_observaciones,$txt_fecha_reg);
			if(!$res)
			{
				//Error de validación
				$resp = new cls_manejo_mensajes(true, "406");
			...
			//Eliminación
			$res = $Custom-> EliminarTipoMaterial($hidden_id_tipo_material);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
				$resp->mensaje_error = $Custom->salida[1] ;
