...
$nombre_archivo = 'ActionConsolidarSalida.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_salida == "undefined" || $hidden_id_salida == "")
		 ...
		 {  
		   $res = $Custom->ConsolidarSalida($hidden_id_salida);
			if(!$res)
			{
				//Se produjo un error
				$resp = new cls_manejo_mensajes(true, "406");
	...
	$res = $Custom->ContarSalidaConsolidada($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
