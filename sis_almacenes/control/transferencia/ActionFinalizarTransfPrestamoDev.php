...
$nombre_archivo = "ActionTransfPendiente.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		else
		{
			...
			$res = $Custom->ValidarTransferencia("prest",$hidden_id_transferencia,"","","","","","","","","","");
			...
			$res = $Custom->FinalizarTransfPrestamoDev($hidden_id_transferencia);
