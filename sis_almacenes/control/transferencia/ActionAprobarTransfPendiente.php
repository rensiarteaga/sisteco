...
/**
**********************************************************
Nombre de archivo:	    ActionAprobarTransfPendiente.php
...
$nombre_archivo = "ActionAprobarTransfPendiente.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		else
		{
			...
			$res = $Custom->AprobarTransfPendiente($hidden_id_transferencia);
	...
	$res = $Custom->ContarTransfPendiente($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
