...
$nombre_archivo = "ActionGuardarBajas.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_transferencia == "undefined" || $hidden_id_transferencia == "")
		{
			...
			/*
			$res = $Custom->ValidarTransferencia("baja",$hidden_id_transferencia, $txt_prestamo,$txt_motivo,$txt_descripcion,$txt_observaciones,$txt_id_empleado,$txt_id_almacen_logico,$txt_id_almacen_logico_destino,$txt_id_motivo_ingreso_cuenta,$txt_id_tipo_material,$txt_id_motivo_salida_cuenta);

			if(!$res)
			{
				//Error de validación
				$resp = new cls_manejo_mensajes(true, "604");
			...
			$res = $Custom->GuardarBajasPend($hidden_id_transferencia,$txt_motivo,$txt_descripcion,$txt_observaciones,$txt_id_empleado,$txt_id_almacen_logico,$txt_id_motivo_ingreso_cuenta,$txt_id_tipo_material);
