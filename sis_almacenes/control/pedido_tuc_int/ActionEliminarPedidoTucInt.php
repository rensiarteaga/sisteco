...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarPedidoTuc.php
...
$nombre_archivo = "ActionEliminarPedidoTuc.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			$hidden_id_pedido_tuc_int = $_GET["hidden_id_pedido_tuc_int_$j"];
		}
		else
		{
			$hidden_id_pedido_tuc_int = $_POST["hidden_id_pedido_tuc_int_$j"];				
		}

		if ($hidden_id_pedido_tuc_int == "undefined" || $hidden_id_pedido_tuc_int == "")
		{
			$resp = new cls_manejo_mensajes(true, "406");
		...
		{	//Eliminación
			$res = $Custom-> EliminarPedidoTucInt($hidden_id_pedido_tuc_int);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($criterio_filtro == "") $criterio_filtro = "pti.id_salida=''$m_id_salida''";
