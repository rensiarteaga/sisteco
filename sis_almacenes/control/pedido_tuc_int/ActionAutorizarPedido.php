...
/**
**********************************************************
Nombre de archivo:	    ActionAutorizaPedido.php
...
if($_SESSION["autentificado"]=="SI")
{
	...
	else
	{
		...
		if ($get)
		{
			$hidden_id_pedido_tuc_int = $_GET["hidden_id_pedido_tuc_int"];
		}
		else
		{
			$hidden_id_pedido_tuc_int = $_POST["hidden_id_pedido_tuc_int"];				
		}
		...
		{	//Eliminación
			$res = $Custom-> ActionAutorizaPedido($hidden_id_pedido_tuc_int);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
