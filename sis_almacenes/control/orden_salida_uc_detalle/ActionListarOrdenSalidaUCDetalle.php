...
/**
**********************************************************
Nombre de archivo:	    ActionListarOrdenSalidaUCDetalle.php
Propósito:				Permite desplegar los tipos de materiales
...
$nombre_archivo = 'ActionListarOrdenSalidaUCDetalle.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	if($sort == "") $sortcol = 'id_orden_salida_uc_detalle';
	else $sortcol = $sort;
	...
	$res = $Custom->ListarOrdenSalidaUCDetalle($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	if($res)
	{
