...
Propósito:				Permite insertar y modificar datos en la tabla tal_responsable_almacen
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_responsable_almacen == "undefined" || $hidden_id_responsable_almacen == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tal_responsable_almacen
