...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarResponsableAlmacen.php
Propósito:				Permite eliminar registros de la tabla tal_responsable_almacen
Tabla:					tal_tal_responsable_almacen
Parámetros:				$hidden_id_responsable_almacen
...
$nombre_archivo = "ActionEliminarResponsableAlmacen.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarResponsableAlmacen($hidden_id_responsable_almacen);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
