...
/**
**********************************************************
Nombre de archivo:	    ActionListarAlmacenVista.php
Propósito:				Permite desplegar kardex segun el almacen logico

Parámetros:				

Valores de Retorno:    	Listado de Procesos y total de registros listados
Fecha de Creación:		19-11-2007
Versión:				1.0.0
...
if($_SESSION['autentificado']=='SI')
{
	...
	$cond->add_criterio_extra("id_almacen",$m_id_almacen);
	/*echo "esto:";
	echo $m_id_almacen_logico;*/
	
	$criterio_filtro = $cond -> obtener_criterio_filtro();
	//Obtiene el criterio de orden de columnas
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,'AlmacenVista');
	$sortcol = $crit_sort->get_criterio_sort();
	

	//Obtiene el total de los registros
	$res = $Custom ->ContarAlmacenVista($cant ,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);

	if($res) $total_registros= $Custom->salida;

	//Obtiene el conjunto de datos de la consulta
	$res = $Custom->ListarAlmacenVista($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
