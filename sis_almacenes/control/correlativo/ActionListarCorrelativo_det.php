...
Propósito:				Permite realizar el listado en tal_correlativo
Tabla:					tal_correlativo
Parámetros:				$cant
						$puntero
						$sortcol
						$sortdir
...
Fecha de Creación:		2007-10-18 15:38:54
Versión:				1.0.0
...
//Parámetros del filtro
	...
	$cond->add_criterio_extra("CORREL.id_parametro_almacen",$m_id_parametro_almacen);
	...
	if($res)
	{
		...
		foreach ($Custom->salida as $f)
		{
			...
			$xml->add_nodo('desc_parametro_almacen',$f["desc_parametro_almacen"]);
