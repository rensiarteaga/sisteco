...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCorrelativo.php
Propósito:				Permite eliminar registros de la tabla tal_correlativo
...
$nombre_archivo = "ActionEliminarCorrelativo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCorrelativo($hidden_id_correlativo);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
