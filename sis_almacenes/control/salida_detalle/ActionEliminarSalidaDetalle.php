...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarSalidaDetalle.php
Propósito:				Permite eliminar registros de la tabla tal_salida_detalle
Tabla:					tal_tal_salida_detalle
Parámetros:				$hidden_id_salida_detalle


Valores de Retorno:    	Número de registros
Fecha de Creación:		2007-10-25 10:40:56
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarSalidaDetalle.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarSalidaDetalle($hidden_id_salida_detalle);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
