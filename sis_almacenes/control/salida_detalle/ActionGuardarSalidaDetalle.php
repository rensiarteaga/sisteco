...
$nombre_archivo = "ActionGuardarSalidaDetalle.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_salida_detalle == "undefined" || $hidden_id_salida_detalle == "")
		{
			...
			$res = $Custom->ValidarSalidaDetalle("insert",$hidden_id_salida_detalle, $txt_costo,$txt_costo_unitario,$txt_precio_unitario,$txt_cant_solicitada,$txt_cant_entregada,$txt_cant_consolidada,$txt_descripcion,$txt_observaciones,$txt_fecha_solicitada,$txt_fecha_entregada,$txt_fecha_consolidada,$txt_fecha_reg,$txt_id_item,$txt_id_salida,$txt_id_unidad_constructiva,$txt_estado_item);
		...
		{	///////////////////////Modificación////////////////////
			...
			//Validación de datos (del lado del servidor)
			$res = $Custom->ValidarSalidaDetalle("update",$hidden_id_salida_detalle, $txt_costo, $txt_costo_unitario, $txt_precio_unitario, $txt_cant_solicitada, $txt_cant_entregada, $txt_cant_consolidada, $txt_descripcion, $txt_observaciones, $txt_fecha_solicitada, $txt_fecha_entregada, $txt_fecha_consolidada, $txt_fecha_reg, $txt_id_item, $txt_id_salida, $txt_id_unidad_constructiva,$txt_estado_item);
			...
			$res = $Custom->ModificarSalidaDetalle($hidden_id_salida_detalle, $txt_costo, $txt_costo_unitario, $txt_precio_unitario, $txt_cant_solicitada, $txt_cant_entregada, $txt_cant_consolidada, $txt_descripcion, $txt_observaciones, $txt_fecha_solicitada, $txt_fecha_entregada, $txt_fecha_consolidada, $txt_fecha_reg, $txt_id_item, $txt_id_salida, $txt_id_unidad_constructiva,$txt_estado_item);
