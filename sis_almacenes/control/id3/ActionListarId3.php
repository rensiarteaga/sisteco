...
/**
**********************************************************
Nombre de archivo:	    ActionListarId3.php
Propósito:				Permite desplegar los Identificadores Id3
Tabla:					tal_id3
Parámetros:				$cant
$puntero
$sortcol
...
$nombre_archivo = 'ActionListarId3.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	if($registro=='nuevo'){
		$criterio_filtro .= " AND id3.registro = ''nuevo''";
	} elseif($registro=='antiguo'){
		$criterio_filtro .= " AND (id3.registro is null or id3.registro <> ''nuevo'')";
	}
	
	 $crit_sort = new cls_criterio_sort($sortcol,$sortdir,'Id3');
	...
	$res = $Custom->ListarId3($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
