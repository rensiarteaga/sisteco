...
/*
**********************************************************
Nombre de archivo:	    ActionGuardarId3.php
Propósito:				Permite insertar y modificar Identificadores Id3
Tabla:					tal_id3
Parámetros:				$hidden_id_id3
$txt_descripcion
...
$nombre_archivo = 'ActionGuardarId3.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{					
         ...
         {
         	$txt_codigo=substr($txt_codigo,7,1);
         }*/
		if ($hidden_id_id3 == "undefined" || $hidden_id_id3 == "")
		{
			...
			$res = $Custom->ValidarId3("insert",$hidden_id_id3,$txt_codigo,$txt_nombre,$txt_descripcion,$txt_nivel_convertido,$txt_convertido,$txt_observaciones,$txt_estado_registro,$txt_fecha_reg,$hidden_id_id2,$hidden_id_id1,$hidden_id_subgrupo,$hidden_id_grupo,$hidden_id_supergrupo);
			if(!$res)
			{
				//Error de validación
				$resp = new cls_manejo_mensajes(true, "406");
			...
			//Validación satisfactoria, se ejecuta la inserción identificadores Id3
			$res = $Custom->InsertarId3($hidden_id_id3,$txt_codigo,$txt_nombre,$txt_descripcion,$txt_nivel_convertido,$txt_convertido,$txt_observaciones,$txt_estado_registro,$txt_fecha_reg,$hidden_id_id2,$hidden_id_id1,$hidden_id_subgrupo,$hidden_id_grupo,$hidden_id_supergrupo,$txt_id_unidad_medida_base,$txt_costo_estimado,$txt_precio_estimado,$txt_stock_min,$registro);
			if(!$res)
			{
				//Se produjo un error
				$resp = new cls_manejo_mensajes(true, "406");
		...
		{	///////////////////////Modificación////////////////////
			...
			//Validación de datos (del lado del servidor)
			$res = $Custom->ValidarId3("update",$hidden_id_id3,$txt_codigo,$txt_nombre,$txt_descripcion,$txt_nivel_convertido,$txt_convertido,$txt_observaciones,$txt_estado_registro,$txt_fecha_reg,$hidden_id_id2,$hidden_id_id1,$hidden_id_subgrupo,$hidden_id_grupo,$hidden_id_supergrupo);
			if(!$res)
			{
				//Error de validación
				$resp = new cls_manejo_mensajes(true, "406");
			...
			$res = $Custom->ModificarId3($hidden_id_id3,$txt_codigo,$txt_nombre,$txt_descripcion,$txt_nivel_convertido,$txt_convertido,$txt_observaciones,$txt_estado_registro,$txt_fecha_reg,$hidden_id_id2,$hidden_id_id1,$hidden_id_subgrupo,$hidden_id_grupo,$hidden_id_supergrupo,$txt_id_unidad_medida_base,$txt_costo_estimado,$txt_precio_estimado,$txt_stock_min);
			if(!$res)
			{
				//Se produjo un error
				$resp = new cls_manejo_mensajes(true, "406");
