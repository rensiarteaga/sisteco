...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarIngresoDetalle.php
Propósito:				Permite eliminar registros de la tabla tal_ingreso_detalle
...
$nombre_archivo = "ActionEliminarIngresoDetalle.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarIngresoDetalle($hidden_id_ingreso_detalle);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
