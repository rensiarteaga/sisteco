...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarItemReemplazo.php
Propósito:				Permite eliminar registros de la tabla tal_item_reemplazo
Tabla:					tal_tal_item_reemplazo
Parámetros:				$hidden_id_item_reemplazo
...
$nombre_archivo = "ActionEliminarItemReemplazo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarItemReemplazo($hidden_id_item_reemplazo);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
