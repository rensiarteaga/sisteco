...
class cls_DBFeriado
{
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tca_feriado_sel';
		...
		$this->var->add_def_cols('dia_feriado','integer');
		$this->var->add_def_cols('mes_feriado','integer');
	...
	function ContarListaFeriado_($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
{
	...
	*/
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tca_feriado_iud';
