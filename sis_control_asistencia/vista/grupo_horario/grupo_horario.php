<?php
/**
* Nombre de archivo:	    grupo_horario.php
...
?>
   ...
   <script type="text/javascript" src="js/grupo_horario_js.php"></script>	
   ...
   <!-- para armar el data combo -->
   	  ...
   	  <!--Basic dialog-->
   		 ...
   		 <div id="dlgInfo" style="visibility:hidden;position:absolute;top:0px;">
			  <div class="x-dlg-hd">Grupo de Horarios</div>
          		<div class="x-dlg-bd">
          			<!--formulario-->
