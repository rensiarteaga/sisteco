...
var elemento={pagina:new PaginaLecturaDepuradaAprobado(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
 ...
 * Fecha creación:		2008-01-17 15:14:26
 */
function PaginaLecturaDepuradaAprobado(idContenedor,direccion,paramConfig){
	...
	ds=new Ext.data.Store({
		proxy:new Ext.data.HttpProxy({url:direccion+'../../../control/lectura_depurada/ActionListarLecturaDepuradaAprobado.php'}),
	...
	ds_empleado=new Ext.data.Store({proxy:new Ext.data.HttpProxy({url:direccion+'../../../control/lectura_depurada/ActionListarLecturaDepuradaEmpleado.php'}),
			reader:new Ext.data.XmlReader({record:'ROWS',id:'id_empleado',totalRecords:'TotalCount'},['id_empleado','apellido_paterno','desc_empleado','email1'])
	});
	//FUNCIONES RENDER
