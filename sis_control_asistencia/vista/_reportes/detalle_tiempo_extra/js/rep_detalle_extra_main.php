...
var elemento={pagina:new GenerarReporteDetalleExtra(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);
function GenerarReporteDetalleExtra(idContenedor,direccion,paramConfig)
{
...
///////// fecha_ini /////////
	...
	// ---------- Inicia Layout ---------------//
	var config = {
		titulo_maestro:"Detalle Diario de Tiempo Extra Trabajado"
	};
	layout_rep_detalle_extra=new DocsLayoutProceso(idContenedor);
	layout_rep_detalle_extra.init(config);
    ...
    this.pagina(paramConfig,vectorAtributos,layout_rep_detalle_extra,idContenedor);
...
function iniciarEventosFormularios()
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Detalle Diario de Tiempo Extra Trabajado "+ ContPes;
		ContPes ++;
		return titulo;
	}
...
function gerencia(resp){
		...
		var paramFunciones={
			...
			url:direccion+'../../../../../sis_control_asistencia/control/_reportes/detalle_tiempo_extra/DetalleExtra.php',
