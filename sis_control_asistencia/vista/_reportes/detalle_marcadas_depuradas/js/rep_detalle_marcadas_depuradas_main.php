...
var elemento={pagina:new GenerarReporteDetalleMarcadasDepuradas(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);
function GenerarReporteDetalleMarcadasDepuradas(idContenedor,direccion,paramConfig)
{
...
///////// fecha_ini /////////
	...
	// ---------- Inicia Layout ---------------//
	var config = {
		titulo_maestro:"Entrada / Salida Diaria"
	};
	layout_rep_detalle_marcas=new DocsLayoutProceso(idContenedor);
	layout_rep_detalle_marcas.init(config);
    ...
    this.pagina(paramConfig,vectorAtributos,layout_rep_detalle_marcas,idContenedor);
...
function eventosAjax(){
	...
	function obtenerTitulo(){
		...
		var titulo = "Entrada / Salida Diaria "+ ContPes;
		ContPes ++;
		return titulo;
	}
	...
	function gerencia(resp){
		...
		var paramFunciones={
			...
			url:direccion+'../../../../../sis_control_asistencia/control/_reportes/detalle_marcas/DetalleMarcadasDepuradas.php',
