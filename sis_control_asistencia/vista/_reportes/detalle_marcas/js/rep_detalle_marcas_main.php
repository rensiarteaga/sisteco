...
var elemento={pagina:new GenerarReporteDetalleMarcas(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);
function GenerarReporteDetalleMarcas(idContenedor,direccion,paramConfig)
{
...
function eventosAjax(){
	...
	function gerencia(resp){
		...
		var paramFunciones={
			...
			url:direccion+'../../../../../sis_control_asistencia/control/_reportes/detalle_marcas/DetalleMarcas.php',
