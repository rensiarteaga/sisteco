...
var elemento={pagina:new GenerarReporteTiempoNoTrab(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);
function GenerarReporteTiempoNoTrab(idContenedor,direccion,paramConfig)
{
...
///////// fecha_ini /////////
	...
	// ---------- Inicia Layout ---------------//
	var config = {
		titulo_maestro:"Total de Tiempo No Trabajado"
	};
	layout_rep_tiempo_no_trab=new DocsLayoutProceso(idContenedor);
	layout_rep_tiempo_no_trab.init(config);
	//---------         INICIAMOS HERENCIA           -----------//
	this.pagina=BaseParametrosReporte;
    this.pagina(paramConfig,vectorAtributos,layout_rep_tiempo_no_trab,idContenedor);
...
function eventosAjax(){
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Total de Tiempo No Trabajado "+ ContPes;
		ContPes ++;
		return titulo;
	}
...
function gerencia(resp){
		...
		var paramFunciones={
			...
			url:direccion+'../../../../../sis_control_asistencia/control/_reportes/tiempo_no_trab/TiempoNoTrab.php',
