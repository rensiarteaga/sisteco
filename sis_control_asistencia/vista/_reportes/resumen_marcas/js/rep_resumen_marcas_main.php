...
var elemento={pagina:new GenerarReporteResumenMarcas(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);
function GenerarReporteResumenMarcas(idContenedor,direccion,paramConfig)
{
...
///////// fecha_ini /////////
	...
	layout_rep_resumen_marcas=new DocsLayoutProceso(idContenedor);
	layout_rep_resumen_marcas.init(config);
    ...
    this.pagina(paramConfig,vectorAtributos,layout_rep_resumen_marcas,idContenedor);
...
function eventosAjax(){
	...
	function gerencia(resp){
		...
		var paramFunciones={
			...
			url:direccion+'../../../../../sis_control_asistencia/control/_reportes/resumen_marcas/ResumenMarcas.php',
