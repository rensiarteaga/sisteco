...
var elemento={pagina:new GenerarReporteLecturaOriginal(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);
function GenerarReporteLecturaOriginal(idContenedor,direccion,paramConfig){
	...
	var h_txt_fecha_ini;
	var	h_txt_fecha_fin;
    var txt_id_empleado,txt_nombre_completo,txt_button,combo_empleado,txt_rol;
	//////////////////////////////////////////////////////////////
	// ------------------  PARÁMETROS --------------------------//
...
///////// fecha_ini /////////
	...
	// ---------- Inicia Layout ---------------//
	var config = {
		titulo_maestro:"Marcas Registradas en Dispositivo"
	};
	layout_rep_lectura_original=new DocsLayoutProceso(idContenedor);
	layout_rep_lectura_original.init(config);
    ...
    this.pagina(paramConfig,vectorAtributos,layout_rep_lectura_original,idContenedor);
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Marcas Registradas en Dispositivo "+ ContPes;
		ContPes ++;
		return titulo;
	}
...
function gerencia(resp){
		...
		var paramFunciones={
			...
			url:direccion+'../../../../../sis_control_asistencia/control/_reportes/lectura_original/LecturaOriginal.php',
