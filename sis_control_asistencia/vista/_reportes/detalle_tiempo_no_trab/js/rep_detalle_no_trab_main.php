...
var elemento={pagina:new GenerarReporteDetalleNoTrab(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);
function GenerarReporteDetalleNoTrab(idContenedor,direccion,paramConfig)
{
...
///////// fecha_ini /////////
	...
	// ---------- Inicia Layout ---------------//
	var config = {
		titulo_maestro:"Detalle Diario de Tiempo No Trabajado"
	};
	layout_rep_detalle_no_trab=new DocsLayoutProceso(idContenedor);
	layout_rep_detalle_no_trab.init(config);
    ...
    this.pagina(paramConfig,vectorAtributos,layout_rep_detalle_no_trab,idContenedor);
...
function eventosAjax(){
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Detalle Diario de Tiempo No Trabajado "+ ContPes;
		ContPes ++;
		return titulo;
	}
...
function gerencia(resp){
		...
		var paramFunciones={
			...
			url:direccion+'../../../../../sis_control_asistencia/control/_reportes/detalle_tiempo_no_trab/DetalleNoTrab.php',
