<?php
/**
* Nombre de archivo:	    lectura_procesada.php
* Propósito:				Contenedor HTML de los objetos de la vista
* Autor:					Fernando Prudencio Cardona
* Fecha de Creación:		22-08-2007
*/
session_start();
?>
...
?> 
   ...
   <script type="text/javascript" src="js/lectura_procesada_js.php"></script>	
   ...
   <!-- para armar el data combo -->
   	  ...
   	  <!--Basic dialog-->
   		 ...
   		 <div id="dlgInfo" style="visibility:hidden;position:absolute;top:0px;">
			  <div class="x-dlg-hd">Lectura Procesada</div>
          		<div class="x-dlg-bd">
          			<!--formulario-->
