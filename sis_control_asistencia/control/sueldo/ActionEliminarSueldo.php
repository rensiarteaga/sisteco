...
/*
**********************************************************
Nombre de archivo:	    ActionEliminarSueldo.php
Propósito:				Permite eliminar registros de la tabla de tca_sueldo
Tabla:					tca_sueldo
Parámetros:				$hidden_id_sueldo	--> id del campo a eliminar
...
$nombre_archivo = 'ActionEliminarSueldo.php';
...
if($_SESSION['autentificado']=="SI")
{
		...
		for($j = 0;$j < $cont; $j++)
		{
			...
			{	//Eliminación
				...
				$res = $Custom->EliminarSueldo($hidden_id_sueldo);
