...
{    //Cargar los datos
	...
	$this->Ln(8);
		...
		$this->Cell(200,10,'TOTAL DE TIEMPO EXTRA TRABAJADO',0,0,'C');
		$this->Ln(7);
		...
		$this->Cell(70,8,'TOTAL DE TIEMPO EXTRA TRABAJADO',1,0,'C',1);
		$this->Ln(8);
	}
	...
	$Custom->ListarTiempoExtra($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	$var1=$Custom->salida;
	return $var1;
	}
