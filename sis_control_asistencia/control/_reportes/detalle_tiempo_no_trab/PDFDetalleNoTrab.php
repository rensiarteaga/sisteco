...
{    //Cargar los datos
	...
	$this->Ln(8);
		...
		$this->Cell(200,10,'DETALLE DIARIO DE TIEMPO NO TRABAJADO',0,0,'C');
		$this->Ln(7);
		...
		$this->Cell(35,8,'MINUTOS ATRASADOS',1,0,'C',1);
		$this->Cell(35,8,'MINUTOS FALTANTES',1,0,'C',1);
		$this->Cell(65,8,'TOTAL TIEMPO NO TRABAJADO',1,0,'C',1);
		$this->Ln(8);
	}
	...
	$Custom->ListarDetalleNoTrab($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	$var1=$Custom->salida;
	return $var1;
	}
