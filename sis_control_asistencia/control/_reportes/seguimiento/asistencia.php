...
if($_SESSION['autentificado']=="SI")
{
			...
			$tipo_reporte=$txt_tipo_reporte;
			 ...
			 if($tipo_reporte=='dispositivo'){
			 	header("location:../lectura_original/PDFLecturaOriginal.php?id_empleado=".$id_empleado."&fecha_ini=".$fecha_ini."&fecha_fin=".$fecha_fin); 			
			 }else{
			 	header("location:../detalle_marcas/PDFDetalleMarcas.php?id_empleado=".$id_empleado."&fecha_ini=".$fecha_ini."&fecha_fin=".$fecha_fin); 			
			 }
