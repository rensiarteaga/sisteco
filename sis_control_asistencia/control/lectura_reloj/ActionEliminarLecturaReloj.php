...
/*
**********************************************************
Nombre de archivo:	    ActionEliminarLecturaReloj.php
Propósito:				Permite eliminar registros de la tabla de lectura_reloj
Tabla:					tca_lectura_reloj
Parámetros:				$hidden_id_lectura_reloj	--> id del campo a eliminar
...
$nombre_archivo = 'ActionEliminarLecturaReloj.php';
...
if($_SESSION['autentificado']=="SI")
{
		...
		for($j = 0;$j < $cont; $j++)
		{
			...
			{	//Eliminación
				...
				$res = $Custom->EliminarLecturaReloj($hidden_id_lectura_reloj);
