...
$nombre_archivo='ActionListarLecturaReloj.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	if($sort == "") $sortcol = 'id_lectura_reloj';
	else $sortcol = $sort;
	...
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,"ca_lectura");
	...
	$res = $Custom->ListarLecturaReloj($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	...
	if($res)
	{
		...
		{
			$xml->add_rama('ROWS');
			$xml->add_nodo('id_lectura_reloj', $f["id_lectura_reloj"]);
