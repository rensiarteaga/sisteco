...
if($_SESSION['autentificado']=="SI")
{
	...
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,"ca_lectura_depurada_resumen");
	$sortcol = $crit_sort->get_criterio_sort();
	$criterio_filtro=$criterio_filtro." AND LECDEP.id_empleado=".$id_empleado." AND LECDEP.fecha=''$fecha_marca''";
