...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarResumenMarcasDia.php
Propósito:				Permite eliminar registros de la tabla tca_resumen_marcas_dia
...
$nombre_archivo = "ActionEliminarResumenMarcasDia.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarResumenMarcasDia($hidden_id_resumen_marcas_dia);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
