...
/*
**********************************************************
Nombre de archivo:	    ActionEliminarHorario.php
Propósito:				Permite eliminar registros de la tabla de horario
Tabla:					tca_horario
Parámetros:				$hidden_id_codigo_horario	--> id del campo a eliminar
...
$nombre_archivo = 'ActionEliminarHorario.php';
...
if($_SESSION['autentificado']=="SI")
{
		...
		for($j = 0;$j < $cont; $j++)
		{
			...
			{	//Eliminación
				...
				$res = $Custom->EliminarHorario($hidden_id_codigo_horario);
