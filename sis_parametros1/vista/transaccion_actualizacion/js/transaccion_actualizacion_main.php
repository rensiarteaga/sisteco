<?php
/**
 * Nombre:		  	   transaccion_actualizacion_main.php
...
var maestro={id_actualizacion_detalle:<?php echo $id_actualizacion_detalle;?>};
	
var elemento={idContenedor:idContenedor,pagina:new pag_tra_act(idContenedor,direccion,paramConfig,idContenedorPadre,maestro)};
