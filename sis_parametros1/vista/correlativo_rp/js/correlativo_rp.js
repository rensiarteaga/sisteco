/**
 * Nombre:		  	    pagina_correlativo_rp.js
 * Propósito: 			pagina objeto principal
 * Autor:				Generado Automaticamente
 * Fecha creación:		2008-09-08 09:53:38
 */
function pagina_correlativo_rp(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
	...
	var ds = new Ext.data.Store({
		...
		proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/correlativo_rp/ActionListarCorrelativoRp.php'}),
...
// txt id_regional
	...
	var layout_correlativo_rp = new DocsLayoutDetalle(idContenedor,idContenedorPadre);
