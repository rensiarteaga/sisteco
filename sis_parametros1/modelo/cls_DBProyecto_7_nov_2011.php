 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tpm_tpm_proyecto
 * Autor:				(autogenerado)
...
class cls_DBProyecto
{
	 ...
	 * Propósito:				Desplegar los registros de tpm_proyecto
	 * Autor:				    (autogenerado)
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpm_proyecto_sel';
		$this->codigo_procedimiento = "'PM_PROYEC_SEL'";
	 ...
	 * Propósito:				Contar los registros de tpm_proyecto
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-06 15:33:00
	 */
	function ContarProyecto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpm_proyecto_sel';
		$this->codigo_procedimiento = "'PM_PROYEC_COUNT'";
	 ...
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tpm_proyecto
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-06 15:33:00
	 */
	function InsertarProyecto($id_proyecto,$codigo_proyecto,$nombre_proyecto,$descripcion_proyecto,$fecha_registro,$hora_registro,$fecha_ultima_modificacion,$hora_ultima_modificacion,$nombre_corto,$codigo_sisin)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpm_proyecto_iud';
		$this->codigo_procedimiento = "'PM_PROYEC_INS'";

		//Instancia la clase midlle para la ejecución de la función de la BD
		$this->var = new cls_middle($this->nombre_funcion,$this->codigo_procedimiento,$this->decodificar);
		$this->var->add_param("NULL");
		$this->var->add_param("'$codigo_proyecto'");
		$this->var->add_param("'$nombre_proyecto'");
		$this->var->add_param("'$descripcion_proyecto'");
	 ...
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tpm_proyecto
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-06 15:33:00
	 */
	function ModificarProyecto($id_proyecto,$codigo_proyecto,$nombre_proyecto,$descripcion_proyecto,$fecha_registro,$hora_registro,$fecha_ultima_modificacion,$hora_ultima_modificacion,$nombre_corto,$codigo_sisin)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpm_proyecto_iud';
		$this->codigo_procedimiento = "'PM_PROYEC_UPD'";
	 ...
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tpm_proyecto
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-06 15:33:00
	 */
	function EliminarProyecto($id_proyecto)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpm_proyecto_iud';
		$this->codigo_procedimiento = "'PM_PROYEC_DEL'";
	...
	/**
	 * Nombre de la función:	ListarProyectoEP
	 * Propósito:				Desplegar los registros de tpm_proyecto en función de los parámetros del filtro
	...
	function ListarProyectoEP($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpm_proyecto_sel';
		$this->codigo_procedimiento = "'PM_PROYEC_SELEP'";
	...
	/**
	 * Nombre de la función:	ContarListaProyectoEP
	...
	function ContarProyectoEP($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpm_proyecto_sel';
		$this->codigo_procedimiento = "'PM_PROYEC_COUNTEP'";
	 ...
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tpm_proyecto
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-06 15:33:00
	 */
	function ValidarProyecto($operacion_sql,$id_proyecto,$codigo_proyecto,$nombre_proyecto,$descripcion_proyecto,$fecha_registro,$hora_registro,$fecha_ultima_modificacion,$hora_ultima_modificacion)
	{
		...
		if($operacion_sql=='insert' || $operacion_sql=='update')
		{
			...
			//Validar codigo_proyecto - tipo varchar
			$tipo_dato->_reiniciar_valor();
			$tipo_dato->set_Columna("codigo_proyecto");
			$tipo_dato->set_MaxLength(10);
			if(!$valid->verifica_dato($tipo_dato->TipoDatoText(), "codigo_proyecto", $codigo_proyecto))
			{
				$this->salida = $valid->salida;
				return false;
			}

			//Validar nombre_proyecto - tipo varchar
			$tipo_dato->_reiniciar_valor();
			$tipo_dato->set_Columna("nombre_proyecto");
			$tipo_dato->set_MaxLength(100);
			$tipo_dato->set_AllowBlank(false);
			if(!$valid->verifica_dato($tipo_dato->TipoDatoText(), "nombre_proyecto", $nombre_proyecto))
			{
				$this->salida = $valid->salida;
				return false;
			}

			//Validar descripcion_proyecto - tipo text
			$tipo_dato->_reiniciar_valor();
			$tipo_dato->set_Columna("descripcion_proyecto");
			$tipo_dato->set_MaxLength(300);
			$tipo_dato->set_AllowBlank(false);
			if(!$valid->verifica_dato($tipo_dato->TipoDatoText(), "descripcion_proyecto", $descripcion_proyecto))
			{
				$this->salida = $valid->salida;
				return false;
			}
	...
	function ListarProyectoEmpleadoEP($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpm_proyecto_sel';
		$this->codigo_procedimiento = "'PM_PROYEMP_SELEP'";
	...
	function ContarProyectoEmpleadoEP($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpm_proyecto_sel';
		$this->codigo_procedimiento = "'PM_PROYEMP_COUNTEP'";
...
/**
	...
	function ListarProyectoDepto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpm_proyecto_sel';
		$this->codigo_procedimiento = "'PM_PRYDEP_SEL'";
	...
	function ContarProyectoDepto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpm_proyecto_sel';
		$this->codigo_procedimiento = "'PM_PRYDEP_COUNT'";
