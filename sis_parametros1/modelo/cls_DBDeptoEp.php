...
class cls_DBDeptoEp
{
	...
	/**
	 * Nombre de la función:	ListarDepartamentoEP
	...
	/**
	 * Nombre de la función:	ListarDepartamentoEPFA
	 * Propósito:				Desplegar los registros de tpm_depto_ep
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2009-01-23 10:58:13
	 */
	...
	/**
	 * Nombre de la función:	ContarDepartamentoEPFA
	 * Propósito:				Contar los registros de tpm_depto_ep
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2009-01-23 10:58:13
	 */
	...
	/**
	 * Nombre de la función:	InsertarDepartamentoEP
	...
	/**
	 * Nombre de la función:	ModificarDepartamentoEP
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tpm_depto_ep
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2009-01-23 10:58:13
	 */
	...
	/**
	 * Nombre de la función:	EliminarDepartamentoEP
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tpm_depto_ep
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2009-01-23 10:58:13
	 */
	...
	/**
	 * Nombre de la función:	ValidarDepartamentoEP
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tpm_depto_ep
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2009-01-23 10:58:13
	 */
