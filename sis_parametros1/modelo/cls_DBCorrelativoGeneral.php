 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tpm_tpm_correlativo_general
 * Autor:				(autogenerado)
 * Fecha creación:		2008-09-08 10:46:44
 */
...
class cls_DBCorrelativoGeneral
{
	...
	/**
	 * Nombre de la función:	ListarCorrelativoGeneral
	 * Propósito:				Desplegar los registros de tpm_correlativo_general
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-09-08 10:46:44
	 */
	...
	/**
	 * Nombre de la función:	ContarCorrelativoGeneral
	 * Propósito:				Contar los registros de tpm_correlativo_general
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-09-08 10:46:44
	 */
	...
	/**
	 * Nombre de la función:	InsertarCorrelativoGeneral
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tpm_correlativo_general
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-09-08 10:46:44
	 */
	...
	/**
	 * Nombre de la función:	ModificarCorrelativoGeneral
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tpm_correlativo_general
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-09-08 10:46:44
	 */
	...
	/**
	 * Nombre de la función:	EliminarCorrelativoGeneral
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tpm_correlativo_general
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-09-08 10:46:44
	 */
	...
	/**
	 * Nombre de la función:	ValidarCorrelativoGeneral
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tpm_correlativo_general
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-09-08 10:46:44
	 */
