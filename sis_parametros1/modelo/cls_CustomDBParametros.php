...
class cls_CustomDBParametros
{
	...
	function __construct()
	{
		...
		//22.07.2015
		include_once("cls_DBParametroBancarizacion.php");
	} 
...
*/
	...
	/********************Parametro Bancarizacion: 22.07.2015*************************/
	...
	{
		$this->salida = "";
		$dbParametroBancarizacion = new cls_DBParametroBancarizacion($this->decodificar);
		$res = $dbParametroBancarizacion ->ListarParametroBancarizacion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbParametroBancarizacion ->salida;
		$this->query = $dbParametroBancarizacion ->query;
		return $res;
	}
	...
	function ContarParametroBancarizacion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$dbParametroBancarizacion = new cls_DBParametroBancarizacion($this->decodificar);
		$res = $dbParametroBancarizacion ->ContarParametroBancarizacion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbParametroBancarizacion ->salida;
		$this->query = $dbParametroBancarizacion ->query;
		return $res;
	}
	...
	function InsertarParametroBancarizacion($id_parametro_bancarizacion,$monto, $id_moneda,$fecha_ini)
	{
		$this->salida = "";
		$dbParametroBancarizacion = new cls_DBParametroBancarizacion($this->decodificar);
		$res = $dbParametroBancarizacion ->InsertarParametroBancarizacion($id_parametro_bancarizacion,$monto, $id_moneda,$fecha_ini);
		$this->salida = $dbParametroBancarizacion ->salida;
		$this->query = $dbParametroBancarizacion ->query;
		return $res;
	}
	...
	function ModificarParametroBancarizacion($id_parametro_bancarizacion,$monto, $id_moneda,$estado_reg,$fecha_ini,$fecha_fin)
	{
		$this->salida = "";
		$dbParametroBancarizacion = new cls_DBParametroBancarizacion($this->decodificar);
		$res = $dbParametroBancarizacion ->ModificarParametroBancarizacion($id_parametro_bancarizacion,$monto, $id_moneda,$estado_reg,$fecha_ini,$fecha_fin);
		$this->salida = $dbParametroBancarizacion ->salida;
		$this->query = $dbParametroBancarizacion ->query;
		return $res;
	}
	
	function EliminarParametroBancarizacion($id_parametro_bancarizacion)
	{
		$this->salida = "";
		$dbParametroBancarizacion = new cls_DBParametroBancarizacion($this->decodificar);
		$res = $dbParametroBancarizacion -> EliminarParametroBancarizacion($id_parametro_bancarizacion);
		$this->salida = $dbParametroBancarizacion ->salida;
		$this->query = $dbParametroBancarizacion ->query;
		return $res;
	}
	...
	function ValidarParametroBancarizacion($operacion_sql,$id_parametro_bancarizacion,$monto, $id_moneda,$fecha_ini)
	{
		$this->salida = "";
		$dbParametroBancarizacion = new cls_DBParametroBancarizacion($this->decodificar);
		$res = $dbParametroBancarizacion ->ValidarParametroBancarizacion($operacion_sql,$id_parametro_bancarizacion,$monto, $id_moneda,$fecha_ini);
		$this->salida = $dbParametroBancarizacion ->salida;
		$this->query = $dbParametroBancarizacion ->query;
		return $res;
	}
	
	/********************Parametro Bancarizacion*************************/
}?>