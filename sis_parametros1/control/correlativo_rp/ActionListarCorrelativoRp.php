...
/**
**********************************************************
Nombre de archivo:	    ActionListarCorrelativoRp.php
Propósito:				Permite realizar el listado en tpm_correlativo_rp
Tabla:					t_tpm_correlativo_rp
Parámetros:				$cant
						$puntero
						$sortcol
						$sortdir
...
Fecha de Creación:		2008-09-08 09:53:40
Versión:				1.0.0
...
$nombre_archivo = 'ActionListarCorrelativoRp .php';
...
//Parámetros del filtro
	...
	if($sort == '') $sortcol = 'id_correlativo_rp';
	else $sortcol = $sort;
	...
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,'CorrelativoRp');
	$sortcol = $crit_sort->get_criterio_sort();
	

	//Obtiene el total de los registros
	$res = $Custom -> ContarCorrelativoRp($cant ,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);

	if($res) $total_registros= $Custom->salida;

	//Obtiene el conjunto de datos de la consulta
	$res = $Custom->ListarCorrelativoRp($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
	...
	if($res)
	{
		...
		{
			$xml->add_rama('ROWS');
			$xml->add_nodo('id_correlativo_rp',$f["id_correlativo_rp"]);
