...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEmpresa.php
Propósito:				Permite eliminar registros de la tabla tpm_empresa
...
$nombre_archivo = "ActionEliminarEmpresa.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEmpresa($id_empresa);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
