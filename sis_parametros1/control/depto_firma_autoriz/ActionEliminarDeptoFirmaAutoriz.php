...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDeptoFirmaAutoriz.php
Propósito:				Permite eliminar registros de la tabla tpm_depto_usuario
...
$nombre_archivo = "ActionEliminarDeptoFirmaAutoriz.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDeptoFirmaAutoriz($id_depto_firma_autoriz);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
