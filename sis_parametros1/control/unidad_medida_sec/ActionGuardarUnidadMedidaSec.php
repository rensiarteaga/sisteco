...
Propósito:				Permite insertar y modificar datos en la tabla tpm_unidad_medida_sec
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_unidad_medida_sec == "undefined" || $hidden_id_unidad_medida_sec == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tpm_unidad_medida_sec
