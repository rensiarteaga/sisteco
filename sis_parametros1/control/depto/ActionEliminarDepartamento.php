...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDepartamento.php
Propósito:				Permite eliminar registros de la tabla tpm_depto
Tabla:					tpm_tpm_depto
Parámetros:				$id_depto
...
$nombre_archivo = "ActionEliminarDepartamento.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDepartamento($id_depto);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
