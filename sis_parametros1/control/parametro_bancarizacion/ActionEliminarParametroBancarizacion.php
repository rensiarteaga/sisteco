...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarParametroBancarizacion.php
Propósito:				Permite eliminar registros de la tabla tpm_ParametroBancarizacion
...
$nombre_archivo = "ActionEliminarParametroBancarizacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarParametroBancarizacion($id_parametro_bancarizacion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
