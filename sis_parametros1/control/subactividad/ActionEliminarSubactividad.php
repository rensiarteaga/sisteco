...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarSubactividad.php
Propósito:				Permite eliminar registros de la tabla tpm_subactividad
Tabla:					tpm_tpm_subactividad
Parámetros:				$hidden_id_subactividad
...
$nombre_archivo = "ActionEliminarSubactividad.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarSubactividad($hidden_id_subactividad);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
