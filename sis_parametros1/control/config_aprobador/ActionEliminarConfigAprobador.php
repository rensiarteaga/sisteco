...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarConfigAprobador.php
Propósito:				Permite eliminar registros de la tabla tpm_config_aprobador
Tabla:					tpm_tpm_config_aprobador
Parámetros:				$hidden_id_config_aprobador
...
$nombre_archivo = "ActionEliminarConfigAprobador.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarConfigAprobador($hidden_id_config_aprobador);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
