 ...
 * Propósito:			Permite ejecutar la funcionalidad de la tabla tkp_tipo_horario
...
class cls_DBTipoHorario
{
	...
	/**
	 * Nombre de la función:	ListarTipoHorario
	 * Propósito:				Desplegar los registros de tkp_tipo_horario en función de los parámetros del filtro
	...
	/**
	 * Nombre de la función:	ContarListaTipoHorario
	...
	/**
	 * Nombre de la función:	InsertarTipoHorario
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tkp_tipo_horario
	 * Autor:				    Fernando Prudencio Cardona
	...
	/**
	 * Nombre de la función:	ModificarTipoHorario
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tkp_tipo_horario
	 * Autor:				    Fernando Prudencio
	...
	/**
	 * Nombre de la función:	EliminarTipoHorario
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tkp_tipo_horario
	 * Autor:				    Fernando Prudencio 
	 * Fecha de creación:		2010-08-10 09:06:56
	 */
