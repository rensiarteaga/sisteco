...
class cls_DBObligacion
{
	 ...
	 * Fecha de creación:		11-08-2010
	 */
	function ModificarObligacion($id_obligacion,$id_tipo_obligacion,$id_planilla,$id_comprobante,$monto,$estado_reg,$observaciones,$id_cuenta_bancaria,$tipo_pago,$id_cuenta,$id_auxiliar)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tkp_obligacion_iud';
