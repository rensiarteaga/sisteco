 ...
 * Propósito:			Permite ejecutar la funcionalidad de la tabla tkp_EventoPlanilla
...
class cls_DBEventoPlanilla
{
	...
	/**
	 * Nombre de la función:	ListarEventoPlanilla
	 * Propósito:				Desplegar los registros de tkp_EventoPlanilla en función de los parámetros del filtro
	 * Autor:					Mercedes Zambrana Meneses
	...
	/**
	 * Nombre de la función:	ContarEventoPlanilla
	...
	/**
	 * Nombre de la función:	InsertarEventoPlanilla
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tkp_EventoPlanilla
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		11-08-2010
	...
	/**
	 * Nombre de la función:	ModificarEventoPlanilla
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tkp_EventoPlanilla
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		11-08-2010
	 */
	...
	/**
	 * Nombre de la función:	EliminarEventoPlanilla
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tkp_EventoPlanilla
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		11-08-2010
	 */
	...
	/**
	 * Nombre de la función:	ValidarEventoPlanilla
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tkp_EventoPlanilla
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		11-08-2010
	 */
