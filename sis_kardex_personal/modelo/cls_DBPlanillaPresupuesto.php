 ...
 * Fecha creaci�n:		12-10-2010
 *
 */
class cls_DBPlanillaPresupuesto
{
	...
	//Nombre del archivo
	var $nombre_archivo = "cls_DBPlanillaPresupuesto.php";
	...
	/**
	 * Nombre de la funci�n:	ListarAfp
	 * Prop�sito:				Desplegar los registros de tkp_Afp en funci�n de los par�metros del filtro
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tkp_planilla_presupuesto_sel';
		$this->codigo_procedimiento = "'KP_PLAPRE_SEL'";
		...
		//Carga la definici�n de columnas con sus tipos de datos
         ...
         $this->var->add_def_cols("id_planilla_presupuesto",'INTEGER');
	...
	/**
	 * Nombre de la funci�n:	ContarAfp
	...
	function ContarPlanillaPresupuesto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tkp_planilla_presupuesto_sel';
		$this->codigo_procedimiento = "'KP_PLAPRE_COUNT'";
	...
	/**
	 * Nombre de la funci�n:	InsertarAfp
	 * Prop�sito:				Permite ejecutar la funci�n de inserci�n de la tabla tkp_Afp
	 * Autor:				    (autogenerado)
	 * Fecha de creaci�n:		11-08-2010
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tkp_planilla_presupuesto_iud';
		$this->codigo_procedimiento = "'KP_PLAPRE_INS'";
	...
	/**
	 * Nombre de la funci�n:	ModificarAfp
	 * Prop�sito:				Permite ejecutar la funci�n de modificaci�n de la tabla tkp_Afp
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creaci�n:		11-08-2010
	 */
	function ModificarPlanillaPresupuesto($id_planilla_presupuesto,$id_planilla,$id_presupuesto,$porcentaje)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tkp_planilla_presupuesto_iud';
		$this->codigo_procedimiento = "'KP_PLAPRE_UPD'";
		...
		$this->var->add_param($id_planilla_presupuesto);
		$this->var->add_param($id_planilla);
		$this->var->add_param($id_presupuesto);
		$this->var->add_param($porcentaje);
		$this->var->add_param("NULL");
	...
	/**
	 * Nombre de la funci�n:	EliminarAfp
	 * Prop�sito:				Permite ejecutar la funci�n de eliminaci�n de la tabla tkp_Afp
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creaci�n:		11-08-2010
	 */
	function EliminarPlanillaPresupuesto($id_planilla_presupuesto)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tkp_planilla_presupuesto_iud';
		$this->codigo_procedimiento = "'KP_PLAPRE_DEL'";
	...
	function ComprometerPptoPlanilla($id_planilla_presupuesto,$accion)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tkp_planilla_presupuesto_iud';
		$this->codigo_procedimiento = "'KP_COMPPTOPLA_UPD'";
	...
	function ListarRepPlanillaPpto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		...
		$this->codigo_procedimiento = "'KP_PLAPRE_REP'";
		...
		$this->var->add_def_cols('partida','text');
 		...
 		$this->var->add_def_cols('nomeda','VARCHAR');
