...
class cls_CustomDBKardexPersonal
{
	...
	function ModificarEmpleadoCorreo($id_empleado,$mail,$nro_interno, $nro_celular_empresa)
	{
		$this->salida = "";
		$dbEmpleado = new cls_DBEmpleado($this->decodificar);
		$res = $dbEmpleado ->ModificarEmpleadoCorreo($id_empleado,$mail,$nro_interno, $nro_celular_empresa);
		$this->salida = $dbEmpleado ->salida;
		$this->query = $dbEmpleado ->query;
		return $res;
	}
...
/// --------------------- tkp_vacacion --------------------- ///
	...
	function ListaPlanillaDatosEmpleadoCaja($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$dbRepPlanilla = new cls_DBRepPlanilla($this->decodificar);
		$res = $dbRepPlanilla ->ListaPlanillaDatosEmpleadoCaja($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbRepPlanilla ->salida;
		$this->query = $dbRepPlanilla ->query;
		return $res;
	}
	...
	function SumEmpleadoDistritoCaja($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$dbRepPlanilla = new cls_DBRepPlanilla($this->decodificar);
		$res = $dbRepPlanilla ->SumEmpleadoDistritoCaja($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbRepPlanilla ->salida;
		$this->query = $dbRepPlanilla ->query;
		return $res;
	}
	...
	function ListarRepPlanillaDetCaja($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$dbRepPlanilla = new cls_DBRepPlanilla($this->decodificar);
		$res = $dbRepPlanilla ->ListarRepPlanillaDetCaja($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbRepPlanilla ->salida;
		$this->query = $dbRepPlanilla ->query;
		return $res;
	}
	...
	function ListarRepPlanillaSumCaja($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$dbRepPlanilla = new cls_DBRepPlanilla($this->decodificar);
		$res = $dbRepPlanilla ->ListarRepPlanillaSumCaja($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbRepPlanilla ->salida;
		$this->query = $dbRepPlanilla ->query;
		return $res;
	}
