...
/**
	...
	function RepEmpleadoContratosCargosDetalle($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		...
		$this->var->add_def_cols('id_lugar','integer'); 
 		...
 		$this->var->add_def_cols('nro_celular','integer');
 		
 		//(id_lugar integer,nombre_lugar varchar,tipo_contrato VARCHAR,gerencia varchar,unidad varchar,id_empleado integer, 
 		//nombre_completo varchar,cargo varchar,nro_interno integer, nro_celular integer)
		//Ejecuta la funciï¿½n de consulta
		$res = $this->var->exec_query();
