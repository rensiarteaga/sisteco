 ...
 * Propósito:			Permite ejecutar la funcionalidad de la tabla tkp_Cargo
...
class cls_DBCargo
{
	...
	/**
	 * Nombre de la función:	ListarCargo
	 * Propósito:				Desplegar los registros de tkp_Cargo en función de los parámetros del filtro
	 * Autor:					Mercedes Zambrana Meneses
	...
	/**
	 * Nombre de la función:	ContarCargo
	...
	/**
	 * Nombre de la función:	InsertarCargo
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tkp_Cargo
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		11-08-2010
	...
	/**
	 * Nombre de la función:	ModificarCargo
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tkp_Cargo
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		11-08-2010
	 */
	...
	/**
	 * Nombre de la función:	EliminarCargo
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tkp_Cargo
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		11-08-2010
	 */
	...
	/**
	 * Nombre de la función:	ValidarCargo
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tkp_Cargo
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		11-08-2010
	 */
