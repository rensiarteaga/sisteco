 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tkp_empleado_cta_bancaria
...
class cls_DBEmpleadoCtaBancaria
{
	...
	/**
	 * Nombre de la función:	ListarEmpleadoCtaBancaria
	 * Propósito:				Desplegar los registros de tkp_empleado_CtaBancaria
	 * Autor:				    Mercedes Zambrana Meneses
	...
	/**
	 * Nombre de la función:	ContarEmpleadoCtaBancaria
	 * Propósito:				Contar los registros de tkp_empleado_CtaBancariaCtaBancaria
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		12-08-2010
	 */
	...
	/**
	 * Nombre de la función:	InsertarEmpleadoCtaBancaria
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tkp_empleado_CtaBancaria
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		12-08-2010
	 */
	...
	/**
	 * Nombre de la función:	ModificarEmpleadoCtaBancaria
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tkp_empleado_CtaBancaria
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		12-08-2010
	 */
	...
	/**
	 * Nombre de la función:	EliminarEmpleadoCtaBancaria
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tkp_empleado_CtaBancaria
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		12-08-2010
	 */
	...
	/**
	 * Nombre de la función:	ValidarEmpleadoCtaBancaria
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tkp_empleado_CtaBancaria
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		12-08-2010
	 */
