...
class PDF extends FPDF
{
	...
	{		
		...
		$res=$Custom->ContarEmpleadoPlanillaDinamica($cant ,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
		
    	if($res) $total_count= $Custom->salida;
		
		while($total_count>=$puntero)
    	{	
    		$res = $Custom->ListarEmpleadoPlanillaDinamica($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
			//echo "aqui";
    		//echo $res; exit;
    		if($res)
    		{
