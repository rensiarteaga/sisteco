...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarClasificadorRetenciones.php
Propósito:				Permite eliminar registros de la tabla tkp_clasificador_retenciones
...
$nombre_archivo = "ActionEliminarClasificadorRetenciones.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($_id_clasificador_retenciones == "undefined" || $id_clasificador_retenciones == "")
		{
			$resp = new cls_manejo_mensajes(true, "406");
		...
		{	//Eliminación
			$res = $Custom-> EliminarClasificadorRetenciones($id_clasificador_retenciones);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
