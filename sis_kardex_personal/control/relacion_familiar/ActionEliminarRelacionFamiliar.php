...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarContrato.php
Propósito:				Permite eliminar registros de la tabla tkp_Contrato
Tabla:					tkp_Contrato
Parámetros:				$id_Contrato


Valores de Retorno:    	Número de registros
Fecha de Creación:		2010-08-13
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarContrato.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarRelacionFamiliar($id_relacion_familiar);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($cont>0) $mensaje_exito = "Se eliminaron los registros especificados.";
