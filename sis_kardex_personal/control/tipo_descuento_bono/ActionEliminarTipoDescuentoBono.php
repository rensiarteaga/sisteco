...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarTipoDescuentoBono.php
Propósito:				Permite eliminar registros de la tabla tkp_TipoDescuentoBono
Tabla:					tkp_TipoDescuentoBono
Parámetros:				$id_TipoDescuentoBono
...
$nombre_archivo = "ActionEliminarTipoDescuentoBono.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			...
			$res = $Custom-> EliminarTipoDescuentoBono($id_tipo_descuento_bono);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
