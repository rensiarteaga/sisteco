...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarResumenHorarioMes.php
...
$nombre_archivo = "ActionEliminarResumenHorarioMes.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarResumenHorarioMes($hidden_id_resumen_horario_mes);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
