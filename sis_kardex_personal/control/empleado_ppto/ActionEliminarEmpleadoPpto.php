...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEmpleadoPpto.php
Propósito:				Permite eliminar registros de la tabla tkp_empleado_ppto
...
$nombre_archivo = "ActionEliminarEmpleadoPpto.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEmpleadoPpto($id_empleado_ppto);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($criterio_filtro == "") $criterio_filtro = "EMPPTO.id_empleado=$m_id_empleado";
