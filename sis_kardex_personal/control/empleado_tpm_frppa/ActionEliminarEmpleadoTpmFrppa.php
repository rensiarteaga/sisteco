...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEmpleadoTpmFrppa.php
Propósito:				Permite eliminar registros de la tabla tkp_empleado_tpm_frppa
Tabla:					tkp_tkp_empleado_tpm_frppa
Parámetros:				$hidden_id_empleado_frppa


Valores de Retorno:    	Número de registros
Fecha de Creación:		2007-10-18 09:44:25
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarEmpleadoTpmFrppa.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEmpleadoTpmFrppa($hidden_id_empleado_frppa);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
