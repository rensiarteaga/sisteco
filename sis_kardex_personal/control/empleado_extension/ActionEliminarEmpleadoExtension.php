...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEmpleadoExtension.php
Propósito:				Permite eliminar registros de la tabla tkp_empleado_extension
...
$nombre_archivo = "ActionEliminarEmpleadoExtension.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEmpleadoExtension($hidden_id_empleado_extension);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
