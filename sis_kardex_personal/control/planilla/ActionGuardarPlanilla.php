...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		else
		{
			...
			$retirado= $_POST["retirado_$j"];
			$tipo_a= $_POST["tipo_a_$j"];
		}
		...
		if ($id_planilla == "undefined" || $id_planilla == "")
		{
			...
			//solo para planillas de reposicion para consultores deberia entrar==>  
			if(isset($_POST["tipo_a_0"]) && $_POST["tipo_a_0"]=='no'){
				$numero='no';
			}else{
				$numero='si';
			}
