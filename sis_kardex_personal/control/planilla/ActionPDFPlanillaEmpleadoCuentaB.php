   ...
   // $m_id_planilla=47;
	...
	exit;
	 ...
	 if ($_GET['reporte']=='global'){
	      ...
	      $res_detalle1 = $Custom->ListarSumEmpleadoBonos($cant,$m_id_planilla,$sortcol,$sortdir,"  emppla.id_planilla=".$m_id_planilla." and col.codigo = ''LIQPAG'' and emppla.pago_liquido=''si'' ",$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
