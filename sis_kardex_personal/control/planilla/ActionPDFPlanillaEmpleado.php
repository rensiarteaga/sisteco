...
//Parámetros del filtro
	...
	$res_detalle = array();
	$res_detalle = $Custom->ListaPlanillaDatosEmpleado($cant,$puntero,$sortcol,$sortdir," emppla.id_planilla=".$m_id_planilla,$id_financiador,$id_regional,$id_programa,$id_proyecto,$m_id_planilla);
	...
	exit;*///	print_r($Custom->salida); exit;
	...
	$_SESSION["id_planilla_sueldo"]=$m_id_planilla;
