...
$nombre_archivo = 'ActionPDFBoletaPrima.php';
...
//Par�metros del filtro
	...
	// $puntero=79;
			...
			//if($_SESSION['ss_id_usuario']==120){echo $criterio_filtro; exit;}
		 			$res_detalle = $Custom->ListaPapeletaPrima($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
					$_SESSION["PDF_lista_papeleta_prima"]=$Custom->salida;
			
			 header("location: ../../vista/_reportes/planilla/PDFPapeletaSueldoPrima.php");
			 //header("location: ../../vista/_reportes/planilla/PDFPapeletaSueldoAguinaldo.php");
