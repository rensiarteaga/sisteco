...
$nombre_archivo = 'ActionPDFSumPlanillaEmpleado.php';
...
*/   
	...
	$res_detalle = $Custom->ListarSumRepPlanillaDet($cant,$puntero,$sortcol,$sortdir," planil.id_planilla=".$m_id_planilla,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		//print_r($Custom->salida); exit;
	$_SESSION["PDF_sum_det_rep_planilla"]=$Custom->salida;
	
	/*print_r($_SESSION["PDF_sum_det_rep_planilla"]);
	exit;*/
	$res_detalle = array();
	$res_detalle = $Custom->SumEmpleadoDistrito($cant,$puntero,$sortcol,$sortdir," emppla.id_planilla=".$m_id_planilla,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	
	$_SESSION["PDF_sum_empleados_distrito"]=$Custom->salida;
	/*print_r($_SESSION["PDF_sum_empleados_distrito"]);
	exit;*/
	...
	$_SESSION["id_planilla_sum"]=$m_id_planilla;
	if($res) $total_registros = $Custom->salida;

	
	if($res)
	{
		header("location:../../vista/_reportes/planilla/PDFSumPlanillaEmpleado.php");
	}
	else
	{
		//Se produjo un error
