...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCompensacion.php
Propósito:				Permite eliminar registros de la tabla tkp_compensacion
Tabla:					tkp_compensacion
Parámetros:				$id_compensacion, $id_empleado


Valores de Retorno:    	Número de registros
Fecha de Creación:		2011-05-13
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarCompensacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCompensacion($id_compensacion,$id_empleado);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($sortcol == "") $sortcol = "id_contrato";
