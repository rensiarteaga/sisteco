...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			...
			$id_tipo_horario= $_GET["m_id_tipo_horario"];
		...
		else
		{
			...
			$id_tipo_horario=$_POST["m_id_tipo_horario"];
		...
		if ($id_horario == "undefined" || $id_horario == "")
		{
			...
			$res = $Custom -> InsertarReformularSolicitudLicenciaDet($id_horario,$id_tipo_horario,$id_vacacion,$num_solicitud,$fecha_inicio,$fecha_fin,$tipo_periodo,$observaciones);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarReformularSolicitudLicenciaDet($id_horario,$id_tipo_horario,$id_vacacion,$num_solicitud,$fecha_inicio,$fecha_fin,$tipo_periodo,$observaciones);
