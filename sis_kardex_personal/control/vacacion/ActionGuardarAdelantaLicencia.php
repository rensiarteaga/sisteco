...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			...
			$fecha_inicio= $_GET["txt_fecha_desde_$j"];
			$fecha_fin=$_GET["txt_fecha_hasta_$j"];
			$tipo_periodo= $_GET["txt_periodo_$j"];
		...
		else
		{
			...
			$res = $Custom -> InsertarAdelantaLicencia($id_vacacion,$fecha_inicio,$fecha_fin,$tipo_periodo,$observaciones);
