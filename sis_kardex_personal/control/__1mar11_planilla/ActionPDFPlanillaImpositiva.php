...
//Parámetros del filtro
	...
	//print_r()
	//;
	$res_detalle = $Custom->ListaPlanillaImpositiva($cant,$puntero,$sortcol,$sortdir,' emppla.id_planilla=47  ',$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
