...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarParametroKardex.php
Propósito:				Permite eliminar registros de la tabla tkp_parametro_kardex
...
$nombre_archivo = "ActionEliminarParametroKardex.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarParametroKardex($id_parametro_kardex);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
