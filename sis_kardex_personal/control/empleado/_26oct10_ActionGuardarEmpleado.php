...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_empleado == "undefined" || $hidden_id_empleado == "")
		{
			...
			$res = $Custom -> InsertarEmpleado($hidden_id_empleado, $txt_id_persona, $txt_codigo_empleado,$id_cuenta,$id_auxiliar,$estado_reg,$fecha_reg,$id_depto,$id_lugar,$fecha_ingreso,$antiguedad_ant);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarEmpleado($hidden_id_empleado, $txt_id_persona, $txt_codigo_empleado,$id_cuenta,$id_auxiliar,$estado_reg,$fecha_reg,$id_depto,$id_lugar,$fecha_ingreso,$antiguedad_ant);
