...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEmpleadoHorario.php
Propósito:				Permite eliminar registros de la tabla tkp_empleado_horario
Tabla:					tkp_tkp_empleado_horario
Parámetros:				$hidden_id_empleado_horario
...
$nombre_archivo = "ActionEliminarEmpleadoHorario.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEmpleadoHorario($hidden_id_empleado_horario);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
