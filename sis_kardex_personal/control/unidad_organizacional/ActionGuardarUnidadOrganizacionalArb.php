...
if($_SESSION["autentificado"]=="SI")
{
	...
	elseif($proc==='add'){
		...
		if($nodo['id_p']=='' || $nodo['id_p']=='undefined' || $nodo['id_p']=='null'){
			$res = $Custom -> InsertarUnidadOrganizacionalRaiz($nodo['id'],$nodo['id_p'],$nodo['relacion'],$nodo['observaciones'],$nodo['nombre_unidad'],$nodo['codigo'],$nodo['centro'],$nodo['cargo_individual'],$nodo['descripcion'],$nodo['id_nivel_organizacional'],$nodo['id_pn'],$nodo['estado_reg'],$nodo['importe_max_apro'],$nodo['importe_max_pre']);
			if(!$res){
				$resp = new cls_manejo_mensajes(true, "406");
				$resp->mensaje_error = $Custom->salida[1] ;
				$resp->origen = $Custom->salida[2];
			...
			$res = $Custom -> InsertarUnidadOrganizacionalArb($nodo['id'],$nodo['id_p'],$nodo['relacion'],$nodo['observaciones'],$nodo['nombre_unidad'],$nodo['codigo'],$nodo['centro'],$nodo['cargo_individual'],$nodo['descripcion'],$nodo['id_nivel_organizacional'],$nodo['id_pn'],$nodo['estado_reg'],$nodo['importe_max_apro'],$nodo['importe_max_pre'],$nodo['sw_presto'],$nodo['prioridad'],$nodo['area'],$nodo['correspondencia']);
			if(!$res){
				$resp = new cls_manejo_mensajes(true, "406");
				$resp->mensaje_error = $Custom->salida[1] ;
				$resp->origen = $Custom->salida[2];
	...
	elseif($proc==='upd'){
		...
		$res=$Custom->ModificarUnidadOrganizacionalArb($nodo['id'],$nodo['id_p'],$nodo['relacion'],$nodo['observaciones'],$nodo['nombre_unidad'],$nodo['codigo'],$nodo['centro'],$nodo['cargo_individual'],$nodo['descripcion'],$nodo['id_nivel_organizacional'],$nodo['id_pn'],$nodo['estado_reg'],$nodo['importe_max_apro'],$nodo['importe_max_pre'],$nodo['sw_presto'],$nodo['prioridad'],$nodo['area'],$nodo['correspondencia']);
			if(!$res){
				$resp = new cls_manejo_mensajes(true, "406");
				$resp->mensaje_error = $Custom->salida[1] ;
				$resp->origen = $Custom->salida[2];
