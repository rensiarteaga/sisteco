<?php
/**
 * Nombre:		  	    empleado_cta_bancaria_main.php
...
var elemento={idContenedor:idContenedor,pagina:new pagina_empleado_cta_bancaria(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
