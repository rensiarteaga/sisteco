...
var elemento={pagina:new pagina_preaprobar_solicitud_licencia(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
// txt id_gestion
	...
	function btn_aprobar(){
		...
		if(NumSelect!=0){
			...
			if(confirm("Está seguro de preaprobar la solicitud del funcionario "+SelectionsRecord.data.nombre_completo+"?")){
	...
	function finaliza_aprobacion(){
		Ext.MessageBox.alert('Estado','La solicitud se preaprobó satisfactoriamente');	
	...
	this.AdicionarBoton('../../../lib/imagenes/ok.png','Preaprobar Solicitud',btn_aprobar,true,'aprobar_solicitud','Preaprobación');
