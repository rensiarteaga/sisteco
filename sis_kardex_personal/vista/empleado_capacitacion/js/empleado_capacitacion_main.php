<?php 
/**
 * Nombre:		  	    empleado_capacitacion_main.php
...
var elemento={idContenedor:idContenedor,pagina:new pagina_empleado_capacitacion(idContenedor,direccion,paramConfig,idContenedorPadre,busqueda)};
