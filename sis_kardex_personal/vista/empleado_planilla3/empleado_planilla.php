...
function pagina_empleado_planilla_matriz(idContenedor,direccion,paramConfig,maestro,idContenedorPadre,Atributos,defStore)
{
	...
	var ds = new Ext.data.Store({
		...
		proxy: new Ext.data.HttpProxy({url: direccion+'../../../sis_kardex_personal/control/empleado_planilla/ActionListarEmpleadoPlanillaDinamica.php'}),
...
var config={titulo_maestro:' (Maestro)',grid_maestro:'grid-'+idContenedor};
	...
	var paramFunciones={
	Save:{url:direccion+'../../../sis_kardex_personal/control/empleado_planilla/ActionGuardarEmpleadoPlanilla.php'},
	ConfirmSave:{url:direccion+'../../../sis_kardex_personal/control/empleado_planilla/ActionGuardarEmpleadoPlanilla.php'},
	...
	this.reload=function(m){
		...
		function btn_papeleta_sueldo(){
				...
				if(NumSelect!=0){
					...
					window.open(direccion+'../../../sis_kardex_personal/control/planilla/ActionPDFBoletaPago.php?'+data)
				}
				else{
	...
	var onChange=function(c,i,h){  
		...
		Ext.Ajax.request({
								url:direccion+"../../../sis_kardex_personal/control/empleado_planilla/ActionGuardarEmpleadoPlanilla.php?id_grid="+c.getDataIndex(i)+'&id_planilla='+maestro.id_planilla+'&accion='+sw,
								method:'POST',
		//						success:terminadoD,
	...
	function btn_resumen_horario_mes(){
		...
		if(NumSelect!=0){
			...
			data= data +'&m_id_planilla='+maestro.id_planilla;
...
this.ConfirmSave=function(){
		...
		if(filas.length >0){//cant de regis modif > 0?
			if(confirm("Esta seguro de guardar los cambios?"))
			{
				...
				Ext.Ajax.request({
					url:direccion+'../../../sis_kardex_personal/control/empleado_planilla/ActionGuardarEmpleadoPlanillaMatriz.php',
