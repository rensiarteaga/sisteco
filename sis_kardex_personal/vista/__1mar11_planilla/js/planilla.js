...
// txt fecha_reg
	...
	function iniciarEventosFormularios(){
		...
		var calendario=function(combo, record, index){
			...
			//txt_fecha_planilla.setValue(record.data.periodo+'/'+t_dia+'/'+(parseFloat(t_gestion)));
     ...
     function btn_planilla_presupuesto(){
		...
		if(NumSelect!=0){
			...
			if(SelectionsRecord.data.estado_anticipo!='' && SelectionsRecord.data.estado_anticipo!=null && SelectionsRecord.data.estado_anticipo!=undefined && SelectionsRecord.data.estado_anticipo!='pagado'){
				...
				if(SelectionsRecord.data.estado=='calculado'||SelectionsRecord.data.estado=='comprometido'){
	...
	function btn_reporte_planilla(){
				...
				if(SelectionsRecord.data.desc_tipo_planilla=='auxiliar'){
					window.open(direccion+'../../../control/planilla/ActionPDFPlanillaSueldoNeto.php?'+data)
						...
						window.open(direccion+'../../../control/planilla/ActionPDFPlanillaImpositiva.php?'+data)
	...
	this.AdicionarMenuBotonSimple({text:'Datos x Empleado', 
		                           nombre:'cálculos',
    ...
    */
	...
	this.AdicionarBoton('../../../lib/imagenes/procsim.png','Presupuesto',btn_planilla_presupuesto,true,'planilla_presupuesto','Presupuesto');
	...
	this.AdicionarMenuBotonSimple({text:'Resumen Horario', 
		  ...
		  this.AdicionarMenuBotonSimple({text:'Reportes', 
		                           ...
		                           cls: 'x-btn-text-icon bmenu', // icon and text class
		                           items:[{ text:'Reporte de Planilla',
		                        	       nombre:'ver_reporte_planilla',
		                        	       handler:btn_reporte_planilla,
		                        	       icon:'../../../lib/imagenes/print.gif',
		                        	      // cls:'x-btn-text-icon'
		                        	       cls: 'x-btn-icon',
		                        	      },
		                        	       {text:'Reporte Resumen UO',
			                        	       nombre:'ver_reporte_planilla_uo',
			                        	       handler:btn_reporte_planilla_uo,
			                        	       icon:'../../../lib/imagenes/print.gif',
			                        	       // cls:'x-btn-text-icon'
			                        	        cls: 'x-btn-icon',
			                        	    },
