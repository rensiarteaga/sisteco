<?php
/**
 * Nombre:		  	    resumen_horario_mes_main.php
...
var maestro={id_planilla:<?php echo $m_id_planilla;?>,nombre_completo:'<?php echo $m_nombre_completo;?>'};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_resumen_horario_mes(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
