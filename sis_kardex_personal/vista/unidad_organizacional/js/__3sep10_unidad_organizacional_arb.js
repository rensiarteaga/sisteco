...
//datos extra a los Atributos declarados se manejaran en las operaciones basicas que maneja en las operacion
	...
	var paramFunciones={
		Basicas:{url:direccion+'../../../../sis_kardex_personal/control/unidad_organizacional/ActionGuardarUnidadOrganizacionalArb.php',add_success:guardarSuccessSc,edit:sEdit},
...
// parametros del menu //
	...
	function btn_historico_asignacion(){
		...
		if(n&&n.attributes.tipo=='empresa'){
			...
			var ven=layout_unidad_organizacional_arb.loadWindows(direccion+'../../../vista/historico_asignacion/historico_asignacion_det.php?'+data,'Asignación de Funcionarios',Param,idContenedor)
		}
	}
   this.getLayout=function(){
	...
	this.AdicionarBoton('../../../lib/imagenes/user_otro.png','Asignación de Funcionarios',btn_historico_asignacion,true,'hist_asig','Funcionarios');
	iniciarEventos()
}