<?php 
/**
 * Nombre:		  	    unidad_organizacional_main.php
...
var elemento={pagina:new pagina_unidad_organizacional(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
