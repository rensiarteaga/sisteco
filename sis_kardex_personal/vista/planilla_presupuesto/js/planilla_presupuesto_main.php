...
var maestro={id_planilla:<?php echo $id_planilla;?>,id_gestion:'<?php echo $id_gestion;?>'};

idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_planilla_presupuesto(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
...
Atributos[3]={
		validacion:{
			...
			selectOnFocus:true,
			vtype:'texto',
			grid_visible:false,//13feb12: para que no vean el porcentaje asignado al ppto
			grid_editable:false,
			width_grid:150,
			width:150
		},
	...
	var paramMenu={
		...
		//editar:{crear:true,separador:false},  //13feb12: quitamos para que no modifiquen el porcentaje 
...
//para que los hijos puedan ajustarse al tamaï¿½o
	...
	function btn_rep_ppto(){
				...
				if(NumSelect!=0){
					...
					window.open(direccion+'../../../control/planilla_presupuesto/ActionPDFPlanillaPresupuesto.php?'+data)
