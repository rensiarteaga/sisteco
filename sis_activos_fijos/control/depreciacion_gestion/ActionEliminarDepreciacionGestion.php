...
/**
 * **********************************************************
 * Nombre de archivo: 		ActionEliminarDepreciacionGestion.php
 * Propósito:				Permite eliminar registros de la tabla actif.taf_depreciacion_gestion
 * Tabla:					taf_depreciacion_gestion
 * Parámetros:				$h_id_depreciacion_gestion	--> id 
...
$nombre_archivo = 'ActionEliminarDepreciacionGestion.php';
...
if ($_SESSION['autentificado'] == "SI") 
{
	...
	for($j = 0; $j < $cont; $j ++) {
		...
		if ($id_depreciacion_gestion == "undefined" || $id_depreciacion_gestion == "") {
			...
			$res = $Custom->EliminarDepreciacionGestion($id_depreciacion_gestion);
			if (! $res) {
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if ($puntero == "")
		$puntero = 0;
	if ($sortcol == "")
		$sortcol ='dg.id_depreciacion_gestion';
	if ($sortdir == "")
		$sortdir = 'asc';
	if ($criterio_filtro == "")
		$criterio_filtro = '0=0';
