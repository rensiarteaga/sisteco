...
if($_SESSION['autentificado']=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	
			...
			$res = $CustomActivos->ModificarActivoFijoGrupoProceso($id_activo_fijo_proceso,$id_grupo_proceso,$id_activo_fijo,$monto_revalorizacion,$vida_util_revalorizacion,$fecha_ini_dep,$observaciones);
