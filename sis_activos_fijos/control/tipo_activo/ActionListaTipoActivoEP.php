...
$nombre_archivo = 'ActionListaTipoActivoEP.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	if($sort == "") $sortcol = 'TIPO.descripcion';
	else $sortcol = $sort;
	...
	$res = $Custom->ContarListaTipoActivoEP($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	if($res) $total_registros= $Custom->salida;
		
	//Obtiene el conjunto de datos de la consulta
	$res = $Custom->ListarTipoActivoEP($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
