...
if($_SESSION['autentificado']=="SI")
{
	...
	$criterio_filtro="afe.estado=''activo'' AND afe.id_empleado is NOT NULL";	
	...
	if($res)
	{
		...
		foreach ($Custom->salida as $f)
		{
			...
			$xml->add_nodo('id_empleado_anterior', $f["id_empleado_anterior"]);
			$xml->add_nodo('desc_empleado_anterior', $f["desc_empleado_anterior"]);
