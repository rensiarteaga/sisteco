...
if($_SESSION['autentificado']=="SI")
{
	...
	if($sort == "") $sortcol = 'tab_1.id_tipo_activo_cuenta';
	else $sortcol = $sort;
	...
	if($res)
	{
		...
		foreach ($Custom->salida as $f)
		{
			...
			$xml->add_nodo('id_cta_activo', $f["id_cta_activo"]);
			$xml->add_nodo('id_cta_activo_auxiliar', $f["id_cta_activo_auxiliar"]);
			...
			$xml->add_nodo('id_cta_dep_acum', $f["id_cta_dep_acum"]);
			$xml->add_nodo('id_cta_dep_acum_auxiliar', $f["id_cta_dep_acum_auxiliar"]);
			$xml->add_nodo('id_cta_gasto', $f["id_cta_gasto"]);
			$xml->add_nodo('id_cta_gasto_auxiliar', $f["id_cta_gasto_auxiliar"]);
