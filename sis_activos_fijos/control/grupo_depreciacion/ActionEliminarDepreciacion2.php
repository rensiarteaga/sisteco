...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDepreciacion2.php
Propósito:				Permite eliminar registros de la tabla taf_grupo_depreciacion
...
$nombre_archivo = "ActionEliminarDepreciacion2.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDepreciacion2($id_grupo_depreciacion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
