...
{    //Cargar los datos
	...
	{   $this->SetDrawColor(190,190,190);
		...
		$this->Cell(185,10,'Fecha Asignación (inicio) :  '.$_SESSION['rep_af_det_fecha_asig1'],0,0,'L');
		$this->Ln(5);
		$this->Cell(185,10,'Fecha Asignación (fin)      :  '.$_SESSION['rep_af_det_fecha_asig2'],0,0,'L');
		$this->Ln(8);
...
$header=array('NUM','CÓDIGO','DESCRIPCIÓN','RESPONSABLE ANTERIOR','UNI.ORGANIZACIONAL ANTERIOR','RESPONSABLE NUEVO','UNI.ORGANIZACIONAL NUEVO');//toodo lo que quiero mostrar en mis columnas
