...
{    //Cargar los datos
	...
	{ 
		...
		$this->Ln(3);
		$this->Cell(250,10,'Por Estructura Programática y Funcionario',0,0,'C');
		$this->Ln(10);
	    $num=count($data);
	    $pag=0;
	  foreach ($data as $row){
...
$header=array('NRO','CÓDIGO','TIPO','SUB TIPO','DENOMINACIÓN','FECHA ALTA','ORDEN COMPRA','VALOR COMPRA','DEP. ACUM.','VALOR ACTUAL','VIDA UTIL');//toodo lo que quiero mostrar en mis columnas
 /*echo $id_empleado;
	exit;*/
