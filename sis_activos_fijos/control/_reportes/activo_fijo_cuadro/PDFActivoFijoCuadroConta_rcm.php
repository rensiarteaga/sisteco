...
class PDF extends FPDF{
	...
	function FancyTable($header,$data)
	{
		...
		foreach($data as $row){
			...
			$this->Cell($w[10],4,number_format($row['valor_neto'],2,$this->sep_decim,$this->sep_miles),'',1,'R');//monto_vigente
...
$header=array('CÓDIGO','DESCRIPCIÓN','VALOR ACTIVO','ACTUALIZ UFV','VALOR ACTUALIZ','DEPRE.ACU. INICIAL','ACTUALIZ UFV','DEPRE.ACU.ACTUALIZ','DEP MENSUAL','DEP. ACUM','VALOR NETO');//toodo lo que quiero mostrar en mis columnas
/*echo $fecha_inicio;
exit;*/
