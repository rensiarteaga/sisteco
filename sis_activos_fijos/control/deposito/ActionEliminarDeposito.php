...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDeposito.php
Propósito:				Permite eliminar registros de la tabla taf_deposito
Tabla:					taf_deposito
Parámetros:				$id_deposito


Valores de Retorno:    	
Fecha de Creación:		2011-01-07 11:18:00
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarDeposito.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDeposito($id_deposito);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($sortcol == "") $sortcol = "id_deposito";
