...
/*
**********************************************************
Nombre de archivo:	    ActionEliminaProcesoMotivo.php
Propósito:				Permite eliminar registros de la tabla de ProcesoMotivo
Tabla:					taf_proceso_motivo
Parámetros:				$hidden_id_motivo	--> id del motivo del proceso
...
$nombre_archivo = 'ActionEliminaProcesoMotivo.php';
...
if($_SESSION['autentificado']=="SI")
{
		...
		for($j = 0;$j < $cont; $j++)
		{
			...
			{	//Eliminación
				...
				$res = $CustomActivos ->EliminarProcesoMotivo($hidden_id_motivo);
