...
if($_SESSION['autentificado']=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			...
			$res = $CustomActivos->EliminarCbteDeptoDetalle($id);
	...
	if($sortcol == "") $sortcol = 'id_cbte_depto_det';
	if($sortdir == "") $sortdir = 'desc';
	if($criterio_filtro == "") $criterio_filtro = '0=0';

	$res = $CustomActivos->ContarCbteDeptoDetalle($cant,$puntero,$sortcol,$sortdir,$criterio_filtro);
