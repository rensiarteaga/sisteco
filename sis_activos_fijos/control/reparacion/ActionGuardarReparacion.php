...
Propósito:				Permite insertar y modificar datos en la tabla tad_reparacion
Tabla:					tad_tad_Reparacion
Parámetros:				$id_Reparacion
						$nombre
						$descripcion
						$fecha_reg
						$id_tipo_activo
	...
	if ($hidden_id_reparacion == "undefined" || $hidden_id_reparacion == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tad_Reparacion
