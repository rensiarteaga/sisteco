<?php
/**
 * Nombre:		  	    af_proceso.php
 * Propósito: 			pagina que arranca la configuracion de la vista del Hijo
 * Autor:				Generado Automaticamente
 * Fecha creación:		2010-07-05 17:32:14
 *
 */
session_start();
?>
...
var elemento={idContenedor:idContenedor,pagina:new pag_af_proceso(idContenedor,direccion,paramConfig,idContenedorPadre)};
...
function pag_af_proceso(idContenedor,direccion,paramConfig,idContenedorPadre){
	...
	Atributos[1] = {
		...
		form:false,
		filtro_0:true,
		filterColValue:'codigo#descripcion' 
	};
	...
	{
		/*if(maestro !== null && maestro !== "" && maestro !== undefined)
		{
			if(maestro.id_activo_fijo > 0)
			{
				window.open(direccion+'../../../../sis_activos_fijos/control/activo_fijo_proceso/ActionPDFActivoFijoHistorialDepreciaciones.php?txt_id_activo_fijo='+maestro.id_activo_fijo);
			}
		}
		else
		{
			Ext.MessageBox.alert('Estado', 'No se tiene seleccionado un registro.')
		}*/
