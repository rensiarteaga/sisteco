...
var elemento={idContenedor:idContenedor,pagina:new pag_af_grupo_proceso(idContenedor,direccion,paramConfig,idContenedorPadre,estado_pagina)};
...
function pag_af_grupo_proceso(idContenedor,direccion,paramConfig,idContenedorPadre,estado_pagina){
	...
	//-------------- FIN DEFINICIï¿½N DE FUNCIONES PROPIAS --------------//
		...
		this.reload=function(m){
				...
				else if(proceso == 'DEPAF')
				{
					ds_activo_fijo.baseParams.estado_activo='DEPAF';
					ds_activo_fijo.baseParams.proyecto='no';
					ds_activo_fijo.baseParams.id_ppto='';
					ds_activo_fijo.baseParams.id_depto='';
					ds_activo_fijo.baseParams.asignado='';
				}
