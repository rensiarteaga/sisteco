<?php
/**
 * Nombre:		  	    af_caracterisitcas_det_main.php
...
var maestro={id_activo_fijo:<?php echo $m_id_activo_fijo;?>,codigo_activo:'<?php echo $m_codigo_activo;?>',descripcion:'<?php echo $m_descripcion;?>',descripcion_larga:'<?php echo $m_descripcion_larga;?>',id_tipo_activo:<?php echo $m_id_tipo_activo;?>,id_subtipo_activo:<?php echo $m_id_subtipo_activo;?>};idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_af_caracteristicas(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
