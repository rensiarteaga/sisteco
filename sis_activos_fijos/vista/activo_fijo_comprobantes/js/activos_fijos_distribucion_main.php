<?php 
/**
 * Nombre:		  	  activos_fijos_distribucion_main.php 
 * Propósito: 		  	
 * Autor:				
 * Fecha creación:		
 *
...
var maestro={
		...
		desc_proceso:'<?php echo $maestro_proceso;?>'
		};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_activos_fijos_distribucion(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
...
/**
* Nombre:				pagina_activos_fijos_distribucion.js  	  
* Propósito: 			pagina objeto principal		
* Autor:				Elmer Velasquez	
* Fecha creación:		01/02/2013
*/
function pagina_activos_fijos_distribucion(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
	...
	var ds =  new Ext.data.Store({
		...
		proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/activo_fijo_comprobantes/activos_fijos_distribucion/ActionListarActivoFijoDistGrupoProceso.php'}),
	...
	var data_maestro=[['Proceso',maestro.id_grupo_proceso+'										'],['',''],['Descripcion',maestro.desc_proceso]];
	...
	Atributos[1]={
			...
			form:false,
			tipo: 'Field',
			filterColValue:'taf.id_activo_fijo',
			filtro_0:true
	...
	Atributos[2]={
			validacion:{
				...
				grid_visible:true, // se muestra en el grid
				grid_editable:false, //es editable en el grid,
				width_grid:380, // ancho de columna en el grid
				grid_indice:2
			},
			form:false,
			tipo: 'Field',
			filtro_0:true,
			filterColValue:'taf.codigo#taf.descripcion'
	...
	tipo: 'ComboBox',
	filtro_0:true,
	filterColValue:'ttaf.descripcion',
	id_grupo:0
	};
	Atributos[4]={
			validacion:{
	...
	var paramFunciones={
			...
			Formulario:{
						html_apply:'dlgInfo-'+idContenedor,height:370,width:'50%',minWidth:180,minHeight:100,closable:true,titulo:'Activos Fijos Distribucion',
						columnas:['50%'],
						grupos:[{	tituloGrupo:'Activos Fijos Distribucion',columna:0,id_grupo:0}]	
				}
			};
		...
		this.reload=function(params)
		{
			...
			maestro.desc_proceso=datos.maestro_desc_proceso;
			...
			this.btnActualizar();
			data_maestro=[['Proceso',maestro.id_grupo_proceso+'										'],['',''],['Descripcion',maestro.desc_proceso]];//[['Proceso ',maestro.id_grupo_proceso],];
			Ext.DomHelper.overwrite('grid_detalle-'+idContenedor,EstehtmlMaestro(data_maestro));
