...
var paramDepreciacion_acum_2 = {
	validacion:{
		...
		fieldLabel: 'Depreciación acumulada Sec.',
		allowBlank: false,
		maxLength:500,
		minLength:0,
		selectOnFocus:true,
...
var paramDepreciacion_acum_ant_2 = {
	validacion:{
		...
		fieldLabel: 'Depreciación Acumulada anterior Sec.',
		allowBlank: false,
		maxLength:500,
		minLength:0,
		selectOnFocus:true,
...
var paramDepreciacion_periodo_2 = {
	validacion:{
		...
		fieldLabel: 'Depreciación período Sec.',
		allowBlank: false,
		maxLength:500,
		minLength:0,
		selectOnFocus:true,
...
var paramFunciones = {
	...
	Formulario:{
		...
		{	tituloGrupo:'Datos Depreciación Secundaria',columna:1,	id_grupo:8	},
