...
var elemento={pagina:new pagina_tipo_activo(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
function pagina_tipo_activo(idContenedor,direccion,paramConfig){
	...
	function enable(sm,row,rec){
		...
		this.btnNew = function()
			...
			this.AdicionarBoton('../../../lib/imagenes/excel_16x16.gif','Reporte Tipo Activos',btn_tipo_activo,true,'rep_tipo_af','');

			function btn_tipo_activo()
			{
				window.open(direccion+'../../../../sis_activos_fijos/control/_reportes/tipo_activo/ActionReporteTipoActivoXLS.php');
			}
