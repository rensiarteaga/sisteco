//<script>
function GenerarReporteActivoFijoEstadoEP()
{	var vectorAtributos = new Array;
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Rep. Estado Aactivos Fijos por EP "+ ContPes;
		ContPes ++;
		return titulo;
	}
	...
	var paramFunciones = {
		...
		Formulario:{
			...
			url:'../../../control/_reportes/activo_fijo_estado_ep/ActionPDFActivoFijoEstadoEP.php',
...
{	//obj_proceso = new ProcesoDepreciacion();
	obj_pagina = new GenerarReporteActivoFijoEstadoEP();
}
