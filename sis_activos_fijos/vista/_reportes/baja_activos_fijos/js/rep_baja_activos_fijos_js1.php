//<script>
function GenerarReporteBajaActivosFijos()
...
ds_sub_tipo = new Ext.data.Store({
	...
	ds_unidad_organizacional = new Ext.data.Store({
		// asigna url de donde se cargaran los datos
		proxy: new Ext.data.HttpProxy({url: '../../../control/unidad_organizacional/ActionListaUnidadOrganizacional.php'}),
		reader: new Ext.data.XmlReader({
			record: 'ROWS',
...
function formatDate(value){
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Reporte Baja de Activos Fijos "+ ContPes;
		ContPes ++;
		return titulo;
	}
	...
	var paramFunciones = {
		...
		Formulario:{
			...
			url:'../../../control/_reportes/activo_fijo_baja/ActionPDFActivoFijoBaja.php',
...
function main ()
{
	...
	obj_pagina = new GenerarReporteBajaActivosFijos();
}
