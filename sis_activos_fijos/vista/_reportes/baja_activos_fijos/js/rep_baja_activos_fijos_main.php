...
var elemento={pagina:new GenerarReporteBajaActivosFijos(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
 * Nombre:		  	    GenerarReporteBajaActivosFijos.js
 * Propósito: 			pagina objeto principal
 * Autor:				Grover Velasquez Colque
 * Fecha creación:		22/07/2010
 */
function GenerarReporteBajaActivosFijos(idContenedor,direccion,paramConfig)
{	var vectorAtributos=new Array;
   ...
   //proxy:new Ext.data.HttpProxy({url:direccion+'../../../../../sis_parametros/control/depto/ActionListarDepartamento.php?oc=si'}),
	...
	vectorAtributos[7] = {
		validacion:{
			name: 'fecha_proceso',
			fieldLabel: 'Fecha de Baja (Inicio)',
			allowBlank: false,
	...
	//añadido 29/04/2014  txt_activo_proyecto
	vectorAtributos[9] = {
			validacion: {
				name: 'proyecto_af',
				fieldLabel: 'Proyecto',
				...
				triggerAction:'all',
				emptyText:'Proyecto...',
				store:new Ext.data.SimpleStore({fields:['id','valor'],data:[['%', 'AMBOS'],['si', 'SI'],['no', 'NO']]}),
				valueField:'id',
				displayField:'valor',
				lazyRender:true,
				forceSelection:true,
	...
	//Inicia Layout
	var config={
		titulo_maestro:'Parámetros Para la Baja de Activos'
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Reporte Baja de Activos Fijos";
		return titulo;
	}
	...
	var paramFunciones = {
		...
		height:'70%',	
		url:direccion+'../../../../control/_reportes/activo_fijo_baja/ActionPDFActivoFijoBaja.php',	
		...
		width:'60%',
		columnas:['35%','35%'],
		minWidth:150,minHeight:200,	closable:true,titulo:'Reporte Baja de Activos Fijos',
