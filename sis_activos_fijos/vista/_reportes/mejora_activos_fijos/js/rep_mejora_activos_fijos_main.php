...
var elemento={pagina:new GenerarReporteMejoraActivosFijos(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
 * Nombre:		  	    GenerarReporteMejoraActivosFijos.js
 * Propósito: 			pagina objeto principal
 * Autor:				Grover Velasquez Colque
 * Fecha creación:		22/07/2010
 */
function GenerarReporteMejoraActivosFijos(idContenedor,direccion,paramConfig)
