...
var elemento={pagina:new GenerarReporteTransferenciaActivosFijos(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
 * Nombre:		  	    GenerarReporteTransferenciaActivosFijos.js
 * Propósito: 			pagina objeto principal
 * Autor:				Grover Velasquez Colque
 * Fecha creación:		22/07/2010
 */
function GenerarReporteTransferenciaActivosFijos(idContenedor,direccion,paramConfig)
{	var vectorAtributos=new Array;
   ...
   //proxy:new Ext.data.HttpProxy({url:direccion+'../../../../../sis_parametros/control/depto/ActionListarDepartamento.php?oc=si'}),
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Reporte Transferencia de Activos Fijos";
		return titulo;
	}
	...
	var paramFunciones = {
	    ...
	    url:direccion+'../../../../control/_reportes/activo_fijo_transferencia/ActionPDFActivoFijoTransferencia.php',
		...
		width:'60%',
		columnas:['35%','35%'],
		minWidth:150,minHeight:200,	closable:true,titulo:'Reporte Transferencia de Activos Fijos',
