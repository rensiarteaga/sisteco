...
var elemento={pagina:new GenerarReporteCodigoBarras(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
 ...
 */
function GenerarReporteCodigoBarras(idContenedor,direccion,paramConfig)
   ...
   //proxy:new Ext.data.HttpProxy({url:direccion+'../../../../../sis_parametros/control/depto/ActionListarDepartamento.php?oc=si'}),
	...
	vectorAtributos[7] = {
		validacion: {
			...
			loadMask: true,
			triggerAction: 'all',
			//store: new Ext.data.SimpleStore({fields: ['ID', 'Valor'],data : Ext.CodigoBarrasCombo.tamano }),
	...
	layout_codigo_barras=new DocsLayoutProceso(idContenedor);
	layout_codigo_barras.init(config);
	////////////////////////
	// INICIAMOS HERENCIA //
	////////////////////////
	...
	this.pagina(paramConfig,vectorAtributos,layout_codigo_barras,idContenedor);
	...
	var paramFunciones = {
		...
		height:'70%',
		url:direccion+'../../../../control/_reportes/codigo_barras/ActionRptCodigoBarras.php',
...
*/
   ...
   //para que los hijos puedan ajustarse al tamaño
	this.getLayout=function(){return layout_codigo_barras.getLayout();};
