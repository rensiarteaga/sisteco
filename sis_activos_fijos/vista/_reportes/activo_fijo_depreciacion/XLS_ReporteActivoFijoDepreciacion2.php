<?php
	...
	/**
	 * Nombre:				XLS_ReporteActivoFijoDepreciacion2.php
	...
	$nombre_archivo='XLS_ReporteActivoFijoDepreciacion2.xls';
	...
	foreach($titulos_columnas as $key => $columna){
		...
		if($id_grupo_dep != null){
			$criterio_filtro = array("$id_grupo_dep","$fecha_desde","$fecha_hasta");
		}
		...
		$Custom = new cls_CustomDBActivoFijo();
			...
			$res = $Custom->ReporteActivosFijosDepreciacion2($cant, $puntero, $sortdir, $sortcol, $criterio_filtro);
