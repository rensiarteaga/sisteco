...
{    
	...
	function Header() 
	{
		...
		$this->SetX(1);
	 	...
	 	$this->SetFont('Arial','',6);
	 	$this->Cell(50,3,utf8_decode($_SESSION["pdf_tdd_dist"][0][14]),0,1,'L');
	 ...
	 /*
	 	$this->SetX(42);
	 	$this->SetFont('Arial','B',6);
	 	$this->Cell(30,3,' A�o Fin:',0,0,'L');
	 	$this->SetFont('Arial','',6);
	 	$this->Cell(50,3,utf8_decode($_SESSION['datos_respaldo'][1]),0,1,'L');
	 	...
	 	*/
	 	...
	 	/*$this->SetX(180);
	 	$this->SetFont('Arial','B',6);
	 	$this->Cell(30,3,'Fecha Registro:',0,0,'L');
	 	$this->SetFont('Arial','',6);
	 	$this->Cell(50,3,utf8_decode($_SESSION['datos_respaldo'][4]),0,1,'L');
	 	*/
...
$detalle = $_SESSION["pdf_tdd_otros"];
...
$detalle = $_SESSION["pdf_tdd_dist_pedt"];
