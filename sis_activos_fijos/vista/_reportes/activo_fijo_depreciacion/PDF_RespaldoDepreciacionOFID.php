...
{    
	...
	function Header() 
	{
		...
		$this->SetX(1);
	 	...
	 	$this->SetFont('Arial','',6);
	 	$this->Cell(50,3,utf8_decode($_SESSION["PDF_RESP_OFID"][0][14]),0,1,'L');
	 	...
	 	$this->SetDecimales(array(0,0,0,0,0,2,2,2,2));
