...
{	var vectorAtributos=new Array;
	...
	var cabecera_3 = [['Responsable','EMPLEA.nombre_completo'],['Custodio','COALESCE(person.apellido_paterno,\'\'\'\')||\'\' \'\' ||COALESCE(person.apellido_materno,\'\' \'\')|| COALESCE(person.nombre,\'\' \'\')'],
		              ...
		              ['Departamento AF','depto.nombre_depto'],['ID Cbte.Alta','comp.id_comprobante'],['Fecha Cbte.','comp.fecha_cbte'],['Unidad Organizacional Activo Fijo','ppto.nombre_unidad']]; //size 13
	...
	vectorAtributos[14] = {
		validacion:{
			...
			queryParam: 'filterValue_0',
			filterCol:'ubi.ubicacion#ubi.codigo',
			//filterCols:filterCols_tipo_activo,
			//filterValues:filterValues_tipo_activo,
			tpl:tpl_ubicacion,
