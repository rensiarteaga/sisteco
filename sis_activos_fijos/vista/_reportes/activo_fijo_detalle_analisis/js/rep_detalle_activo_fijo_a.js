...
{	var vectorAtributos=new Array;
	...
	var cabecera_1 = [['Codigo','DISTINCT ACTIVO.codigo'],['Nombre','ACTIVO.descripcion'],['Descripcion','ACTIVO.descripcion_larga'],['Tipo','taf.descripcion'],['Subtipo','saf.descripcion'],
	                 ...
	                 ['Fecha Ini Dep','to_char(ACTIVO.fecha_ini_dep, \'\'dd-mm-yyyy\'\')as fecha_inicio_depreciacion'],['Monto Compra','ACTIVO.monto_compra'],['Numero factura','ACTIVO.num_factura']]; //size 11
	...
	var cabecera_3 = [['Responsable','EMPLEA.nombre_completo'], ['Unidad Organizacional','(SELECT uo.nombre_unidad from kard.tkp_unidad_organizacional uo where uo.id_unidad_organizacional = (select kard.f_kp_obtener_gerencia_x_funcionario(emplea.id_empleado,NULL))) as unidad_organizacional'],
		              ...
		              ['Departamento AF','depto.nombre_depto']]; //size 9
	...
	ds_unidad_organizacional = new Ext.data.Store({
	 ...
	 var ds_ubicacion = new Ext.data.Store({
			// asigna url de donde se cargaran los datos
			proxy: new Ext.data.HttpProxy({url:direccion+'../../../../control/ubicacion/ActionListarUbicacion.php?origen=filtro'}), 
			reader: new Ext.data.XmlReader({
				record: 'ROWS',
				id: 'id_ubicacion',
				totalRecords: 'TotalCount'
	...
	*/
	...
	vectorAtributos[14] = {
			...
			filtro_0:true,
			filtro_1:true,
			filterColValue:'ubic.id_ubicacion',
			save_as:'txt_ubicacion_fisica',
			id_grupo:0
		};
