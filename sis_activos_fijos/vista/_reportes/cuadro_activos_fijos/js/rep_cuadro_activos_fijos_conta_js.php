...
var paramTipoDat = {
	validacion: {
		...
		store: new Ext.data.SimpleStore({
			fields: ['valor', 'desc'],
			data : Ext.proc_cuadroCombo.tipo
		}),
		valueField:'valor',
		displayField:'desc',
		lazyRender:true,
	...
	tipo:'ComboBox',
	defecto: 'Actual',
	save_as:'txt_tipo_rep_cua'

}
vectorAtributos[7] = paramTipoDat;
...
var paramTipoDatoRep = {
	validacion: {
		...
		store: new Ext.data.SimpleStore({
			fields: ['valor', 'desc'],
			data : Ext.proc_cuadroCombo.tipo_data
		}),
		valueField:'valor',
		displayField:'desc',
		lazyRender:true,
...
vectorAtributos[8] = paramTipoDatoRep;
