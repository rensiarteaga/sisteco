//<script>
function GenerarReporteRevalorizacionActivosFijos()
...
function formatDate(value){
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Reporte Revalorizacion de Activos Fijos "+ ContPes;
		ContPes ++;
		return titulo;
	}
	...
	var paramFunciones = {
		...
		Formulario:{
			...
			url:'../../../control/_reportes/activo_fijo_revalorizacion/ActionPDFActivoFijoRevalorizacion.php',
...
function main ()
{
	...
	obj_pagina = new GenerarReporteRevalorizacionActivosFijos();
}
