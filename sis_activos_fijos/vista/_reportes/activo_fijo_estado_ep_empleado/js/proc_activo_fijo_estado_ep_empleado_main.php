...
var elemento={pagina:new GenerarReporteActivoFijoEstadoEPEmpleado(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
 * Nombre:		  	    GenerarReporteActivoFijoEstadoEPEmpleado.js
 * Propósito: 			pagina objeto principal
 * Autor:				Ana Maria Villegas Quispe
 * Fecha creación:		16/09/2009
 */
function GenerarReporteActivoFijoEstadoEPEmpleado(idContenedor,direccion,paramConfig)
{	var vectorAtributos=new Array;
   ...
   //proxy:new Ext.data.HttpProxy({url:direccion+'../../../../../sis_parametros/control/depto/ActionListarDepartamento.php?oc=si'}),
	...
	layout_estado_activo_ep_empleado=new DocsLayoutProceso(idContenedor);
	layout_estado_activo_ep_empleado.init(config);
	////////////////////////
	// INICIAMOS HERENCIA //
	////////////////////////
	...
	this.pagina(paramConfig,vectorAtributos,layout_estado_activo_ep_empleado,idContenedor);
	...
	function obtenerTitulo()
	{
		...
		var titulo = "Rep. Estado Activos Fijos Empleado";
		return titulo;
	}
	...
	var paramFunciones = {
		...
		height:'70%',		
		url:direccion+'../../../../control/_reportes/activo_fijo_estado_ep_empleado/ActionPDFActivoFijoEstadoEPEmpleado.php',			
		...
		width:'60%',
		columnas:['47%','47%'],
		minWidth:150,minHeight:200,	closable:true,titulo:'Rep. Estado Activos Fijos Empleados',
   ...
   //para que los hijos puedan ajustarse al tamaño
	this.getLayout=function(){return layout_estado_activo_ep_empleado.getLayout();};
