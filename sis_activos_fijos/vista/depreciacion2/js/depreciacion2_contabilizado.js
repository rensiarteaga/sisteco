function pagina_depreciacion_finalizado(idContenedor,direccion,paramConfig)
{
	...
	function btn_comprobante(){		
		...
		if(NumSelect!=0)
		{
			...
			data = data + "&maestro_desc_usuario=" + SelectionsRecord.data.usuario_reg;
			...
			layout_gestion.loadWindows(direccion+'../../../../sis_activos_fijos/vista/depreciacion2_comprobante/depreciacion2_comprobante.php?'+data,'Caracteristicas AF',ParamVentana);
