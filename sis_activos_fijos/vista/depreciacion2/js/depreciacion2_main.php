...
var elemento={pagina:new pagina_depreciacion2(idContenedor,direccion,paramConfig,usuario),idContenedor:idContenedor};
...
// txt id_usuario_reg2
	...
	//12092016this.AdicionarBoton('../../../lib/imagenes/a_table.png','Generar Comprobantes',btn_comprobante,true,'comprobante','Generar Comprobantes');

	this.AdicionarBoton('../../../lib/imagenes/a_table.png','Comprobantes',btn_depreciacion_depto,true,'cbte_reg','Comprobantes Contables');

	function btn_depreciacion_depto()
	{
		var sm=getSelectionModel();
		var NumSelect=sm.getCount();
		if(NumSelect!=0){
			...
			layout_depreciacion2.loadWindows(direccion+'../../../../sis_activos_fijos/vista/depreciacion_depto/depreciacion_depto.php?'+data,'CBTES REGIONAL AF',ParamVentana);
			layout_depreciacion2.getVentana().on('resize',function(){
			layout_depreciacion2.getLayout().layout();})
		}else{
			Ext.MessageBox.alert('Estado','Antes debe seleccionar un registro');
