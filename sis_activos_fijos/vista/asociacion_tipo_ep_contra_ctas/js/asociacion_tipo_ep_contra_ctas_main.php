<?php 
/**
 * Nombre:		  	  asociacion_tipo_ep_param_ctas_main.php 
 * Propï¿½sito: 			
 * Autor:				
 * Fecha creaciï¿½n:		
 *
...
var elemento={pagina:new ParametrizacionContraCtasActifConin(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
 * Nombre:		 	asociacion_tipo_ep_contra_ctas.js  	  
 * Proposito: 		vista,parametrizacion de cuentas ACTIF-CONIN		
 * Autor:			Elmer Velasquez			
 * Fecha creacion:	01/02/2013  
 */
 
function ParametrizacionContraCtasActifConin(idContenedor,direccion,paramConfig)
{	 
	...
	var ds = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/asociacion_tipo_ep_contra_ctas/ActionListarContraCuenta.php'}),
	...
	var paramFunciones={ 
		btnEliminar:{url:direccion+'../../../control/asociacion_tipo_ep_contra_ctas/ActionEliminarContraCuenta.php'},
		Save:{url:direccion+'../../../control/asociacion_tipo_ep_contra_ctas/ActionGuardarContraCuenta.php'},
		ConfirmSave:{url:direccion+'../../../control/asociacion_tipo_ep_contra_ctas/ActionGuardarContraCuenta.php'},
		Formulario:{html_apply:'dlgInfo-'+idContenedor,height:450,columnas:['90%'],
			...
			minHeight:200,	
			closable:true,
			titulo:'Parametrizacion Contra Cuentas ACTIF-CONIN'
