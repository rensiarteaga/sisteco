function pagina_cuentas_arb212(idContenedor, direccion, paramConfig) {
	...
	var config = {
			titulo : 'Unidad Constructiva',
				area : 'south',
				urlHijo : '../../../sis_almacenes/vista/detalle_unidad_constructiva/detalle_unidad_constructiva.php'	
		};
...
//		_CP.getPagina(layout_unidad_constructiva_arb.getIdContentHijo()).pagina
...
//		 * //var botonClasificacion = CM_getBoton('clasificacion-'+
//		 * idContenedor);
//		 * 
//		 * //alert(nodoSeleccionado.attributes.id_unidad_constructiva_fk);
//		 * if(valorNodo == '' || valorNodo == null || valorNodo == undefined)
//		 * cm_getBoton('clasificacion-'+ idContenedor).disable(); else
//		 * if(valorNodo >= 0) { cm_getBoton('clasificacion-'+
//		 * idContenedor).enable(); }
//		 */
//	};
...
//		}	
	...
	var paramFunciones = {
			Basicas : {
				url : direccion+ '../../../control/unidad_constructiva/ActionGuardarUnidadConstructivaArb.php',
			...
			Listar : {
				...
				clearOnLoad : true,
				enableDD : false },
			Eliminar : {url : direccion+ "../../../control/unidad_constructiva/ActionEliminarUnidadConstructivaArb.php"}
		};
...
//			layout_det_unidad_constructiva.loadWindows(direccion+'../../../../sis_almacenes/vista/clasificacion_arb/clasificacion_arb_uc.php?'+data,'Clasificacion Items',ParamVentana)
//			
//			//Docs.loadTab('../caracteristicas/caracteristicas_det.php?'+data, "Caracter�sticas por SubTipo ["+ SelectionsRecord.data.codigo +"]");
//		}
//		else
//		{
