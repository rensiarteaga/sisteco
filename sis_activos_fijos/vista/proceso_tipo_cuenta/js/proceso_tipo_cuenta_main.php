<?php
/**
 * Nombre:		  	    af_proceso_tipo_cuenta.php
...
var elemento={idContenedor:idContenedor,pagina:new pag_af_proceso_tipo_cuenta(idContenedor,direccion,paramConfig,idContenedorPadre)};
