<?php
/**
 * Nombre de la clase:	cls_DBTipoCuenta.php
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla taf_taf_tipo_cuenta
 * Autor:				(autogenerado)
 * Fecha creación:		2010-11-08 18:08:55
 */

 
class cls_DBTipoCuenta
{
	var $salida;
	var $query;
	var $var;
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_taf_tipo_cuenta_sel';
		$this->codigo_procedimiento = "'AF_AF_TIPCU_SEL'";
	...
	/**
	 * Nombre de la función:	ContarTipoCuenta
	 * Propósito:				Contar los registros de taf_tipo_cuenta
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2010-11-08 18:08:55
	 */
	function ContarTipoCuenta($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_taf_tipo_cuenta_sel';
		$this->codigo_procedimiento = "'AF_AF_TIPCU_COUNT'";
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_taf_tipo_cuenta_iud';
		$this->codigo_procedimiento = "'AF_AF_TIPCU_INS'";
	...
	function ModificarTipoCuenta($id_tipo_cuenta,$codigo,$descripcion)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_taf_tipo_cuenta_iud';
		$this->codigo_procedimiento = "'AF_AF_TIPCU_UPD'";
	...
	function EliminarTipoCuenta($id_tipo_cuenta)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_taf_tipo_cuenta_iud';
		$this->codigo_procedimiento = "'AF_AF_TIPCU_DEL'";
	...
	/**
	 * Nombre de la función:	ValidarTipoCuenta
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla taf_tipo_cuenta
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2010-11-08 18:08:55
	 */
	function ValidarTipoCuenta($operacion_sql,$id_tipo_cuenta,$codigo,$descripcion)
	{
		...
		if($operacion_sql=='insert' || $operacion_sql=='update')
		{
			...
			{
				//Validar id_tipo_cuenta - tipo int4
				$tipo_dato->_reiniciar_valor();
				$tipo_dato->set_MaxLength(10);
				$tipo_dato->set_Columna("id_tipo_cuenta");

				if(!$valid->verifica_dato($tipo_dato->TipoDatoInteger(), "id_tipo_cuenta", $id_tipo_cuenta))
				{
