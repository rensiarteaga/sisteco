...
class cls_DBGrupoProceso
{
	 ...
	 * @return unknown
	 */
	function InsertarGrupoProceso($id_proceso, $descripcion, $flag_comprobante, $tipo_comprobante)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_taf_grupo_proceso_iud';
		$this->codigo_procedimiento = "'AF_GRPROC_INS'";
  ...
  "af_id_grupo_proceso" integer,
  "af_id_depto" integer,
  "af_id_proceso" integer,
  "af_id_comprobante" integer,
  "af_id_tipo_activo" integer,
  "af_id_sub_tipo_activo" integer,
  "af_id_cuenta_org" integer,
  "af_id_auxiliar_org" integer,
  "af_id_cuenta_des" integer,
  "af_id_auxiliar_des" integer,
  "af_id_fina_regi_prog_proy_acti_org" integer,
  "af_id_unidad_organizacional_org" integer,
  "af_id_fina_regi_prog_proy_acti_des" integer,
  "af_id_unidad_organizacional_des" integer,
  "af_estado" varchar,
  "af_estado" varchar,
  "af_descripcion" text,
  "af_agrupador" varchar
