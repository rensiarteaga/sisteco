...
{    //Cargar los datos
	...
	$this->Ln(8);
		...
		$this->Cell(30,8,'DIA',1,0,'C',1);
		$this->Cell(40,8,'ENTRADA A.M.',1,0,'C',1);
		$this->Cell(40,8,'SALIDA A.M.',1,0,'C',1);
		$this->Cell(40,8,'ENTRADA P.M.',1,0,'C',1);
		$this->Cell(40,8,'SALIDA P.M.',1,0,'C',1);
		$this->Ln(8);
	}
	...
	$Custom->ListarDetalleMarcas($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	$var1=$Custom->salida;
	return $var1;
	}
