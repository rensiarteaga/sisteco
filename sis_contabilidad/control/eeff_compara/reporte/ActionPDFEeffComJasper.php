<?php
	...
	if($_SESSION['autentificado']=='SI'){
		...
		if ($sw_rep == 1){
			$reporte=new ReportDriver('repeeff_Compara.jasper','sci',$tipo_reporte);
		}
		if ($sw_rep == 2){
			$reporte=new ReportDriver('repeeff_ComparaNiv.jasper','sci',$tipo_reporte);
		}
		if ($sw_rep == 3){
			$reporte=new ReportDriver('repeeff_ComparaNota.jasper','sci',$tipo_reporte);
		}
