...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			...
			//2016
			$importe_descuento=$_GET["importe_descuento_$j"];
			$importe_exportaciones=$_GET["importe_exportaciones_$j"];
			$importe_ventas_gravadas_tasa_0=$_GET["importe_ventas_gravadas_tasa_0_$j"];
			//ndc
			$ndc_fecha_documento_orig=$_GET["ndc_fecha_documento_orig_$j"];
			$ndc_nro_autorizacion_factura_orig=$_GET["ndc_nro_autorizacion_factura_orig_$j"];
			$ndc_nro_documento_orig=$_GET["ndc_nro_documento_orig_$j"];
			$ndc_importe_total_orig=$_GET["ndc_importe_total_orig_$j"];
		...
		}else
		{
			...
			if($m_sw_documento=="si"){
				...
				if ($id_transaccion==''){$id_transaccion= $_GET["id_transaccion"];}
			}
			//2016
			$importe_descuento=$_POST["importe_descuento_$j"];
			$importe_exportaciones=$_POST["importe_exportaciones_$j"];
			$importe_ventas_gravadas_tasa_0=$_POST["importe_ventas_gravadas_tasa_0_$j"];
			
			//ndc
			$ndc_fecha_documento_orig=$_POST["ndc_fecha_documento_orig_$j"];
			$ndc_nro_autorizacion_factura_orig=$_POST["ndc_nro_autorizacion_factura_orig_$j"];
			$ndc_nro_documento_orig=$_POST["ndc_nro_documento_orig_$j"];
			$ndc_importe_total_orig=$_POST["ndc_importe_total_orig_$j"];
		...
		if ($id_documento == "undefined" || $id_documento == "")
		{
			...
			$res = $Custom -> InsertarRegistroDocumento($id_documento,$id_transaccion,$tipo_documento,$nro_documento,$fecha_documento,
					$razon_social,$nro_nit,$nro_autorizacion,$codigo_control,$poliza_dui,
					$formulario,$tipo_retencion,$id_moneda,$importe_credito,$importe_debito,
					$importe_ice,$importe_it,$importe_iue,$importe_sujeto,$importe_total,
					$importe_no_gravado,$estado_documento
					//2016
