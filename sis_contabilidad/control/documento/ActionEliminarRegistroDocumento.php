...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarRegistroDocumento.php
...
$nombre_archivo = "ActionEliminarRegistroDocumento.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarRegistroDocumento($id_documento);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($criterio_filtro == "") $criterio_filtro = "TRANSC.id_transaccion=''$id_transaccion''";
