...
session_start();
	...
	if($_SESSION['autentificado']=='SI'){
		...
		if($tipo_reporte=='xls'){ $tipo='xls';
			if($sw_vista=='consolida'){
				//$reporte=new ReportDriver('repeeff_Consolida_xls.jasper','sci',$tipo_reporte);
			     $nombre='repeeff_Consolida_xls.jasper';
			}
			if($sw_vista=='periodo'){
			//	$reporte=new ReportDriver('repeeff_Periodo_xls.jasper','sci',$tipo_reporte);
				$nombre='repeeff_Periodo_xls.jasper';
			}
			if($sw_vista=='sumasal'){
				//$reporte=new ReportDriver('repeeff_Sumas_xls.jasper','sci',$tipo_reporte);
				$nombre='repeeff_Sumas_xls.jasper';
			}
		}
		if($tipo_reporte=='xlsp'){$tipo='xls';
			if($sw_vista=='consolida'){
				//$reporte=new ReportDriver('repeeff_ConsPpto_xls.jasper','sci','xls');
				$nombre='repeeff_ConsPpto_xls.jasper';
		...
		if($tipo_reporte=='pdf'){ $tipo='pdf';
			if($sw_vista=='consolida'){
				//$reporte=new ReportDriver('repeeff_Consolida.jasper','sci',$tipo_reporte);
				$nombre='repeeff_Consolida.jasper';
			}
			if($sw_vista=='periodo'){
				//$reporte=new ReportDriver('repeeff_Periodo.jasper','sci',$tipo_reporte);
				$nombre='repeeff_Periodo.jasper';
			}
			if($sw_vista=='sumasal'){
			//	$reporte=new ReportDriver('repeeff_Sumas.jasper','sci',$tipo_reporte);
				$nombre='repeeff_Sumas.jasper';
			}
			
			//$reporte->addParametro('imagen_ende','../../../../lib/images/logo_reporte_corp.jpg');
		}
		if($tipo_reporte=='pdfp'){$tipo='pdf';
			if($sw_vista=='consolida'){
			//	$reporte=new ReportDriver('repeeff_ConsPpto.jasper','sci','pdf');
				$nombre='repeeff_ConsPpto.jasper';
		...
		$reporte=new ReportDriver($nombre,'sci',$tipo);
