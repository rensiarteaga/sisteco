...
//Parámetros del filtro
	...
	*/
	...
	//oct2016:para vista FE
	if($m_sw_vista=='libro_diario' || $m_sw_vista=='cbte_fe'){ 	
	...
	if($res)
	{
		...
		$xml->add_nodo('sw_bancariza',$f["sw_bancariza"]);//ago2015
		$xml->add_nodo('sw_omite_fe',$f["sw_omite_fe"]);//oct2016
			$xml->fin_rama();
		}
		$xml->mostrar_xml();
	}
