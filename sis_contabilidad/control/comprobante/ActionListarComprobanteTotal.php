...
$nombre_archivo = 'ActionListarComprobanteTotal.php';
...
//Parámetros del filtro
	...
	$cond->add_criterio_extra("tra.id_comprobante",$m_id_comprobante);
	$cond->add_criterio_extra("trv.id_moneda",$m_id_moneda);
	...
	$res = $Custom->ListarComprobanteTotal($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
