...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarRegistroComprobante.php
Propósito:				Permite eliminar registros de la tabla tct_comprobante
...
$nombre_archivo = "ActionEliminarRegistroComprobante.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarRegistroComprobante($id_comprobante,$observacion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
