...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDocCbteUsuario.php
Propósito:				Permite eliminar registros de la tabla tct_doc_cbte_usuario
Tabla:					tct_tct_doc_cbte_usuario
Parámetros:				$id_doc_cbte_usuario


Valores de Retorno:    	Número de registros
Fecha de Creación:		2011-03-15 11:05:11
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarDocCbteUsuario.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDocCbteUsuario($id_doc_cbte_usuario);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
