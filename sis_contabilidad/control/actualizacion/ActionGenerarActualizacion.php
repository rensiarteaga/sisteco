...
/**
**********************************************************
Nombre de archivo:	    ActionGenerarActualizacion.php
Propósito:				Genera la Actualización de Saldos
...
$nombre_archivo = "ActionGenerarActualizacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	$res = $Custom->GenerarActualizacion($m_id_actualizacion, $m_sw_proce);
	if(!$res)
	{
		//Se produjo un error
		$resp = new cls_manejo_mensajes(true, "406");
