...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarOrdenTrabajo.php
Propósito:				Permite eliminar registros de la tabla tct_orden_trabajo
...
$nombre_archivo = "ActionEliminarOrdenTrabajo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarOrdenTrabajo($id_orden_trabajo);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
