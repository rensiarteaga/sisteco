...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarRubro.php
Propósito:				Permite eliminar registros de la tabla tct_rubro
Tabla:					tct_tct_rubro
Parámetros:				$id_rubro
...
$nombre_archivo = "ActionEliminarRubro.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarRubro($id_rubro);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
