...
/**
**********************************************************
Nombre de archivo:	    ActionGuardarReplicaTransacion.php
...
$nombre_archivo = "ActionGuardarReplicaTransacion.php";
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_transaccion == "undefined" || $id_transaccion == "")
		{
			////////////////////Inserción/////////////////////
				...
				//Se produjo un error
				$resp = new cls_manejo_mensajes(true, "406");
				$resp->mensaje_error = "No se seleccionó la transacción a replicar";
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ReplicarRegistroTransacion($id_transaccion , $cantidad);
