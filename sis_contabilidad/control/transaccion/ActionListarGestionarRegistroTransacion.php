	...
	{	//recupera los valores de las columnas
		...
		if($res){ 
			...
			foreach ($Custom->salida as $f){
				...
				$xml->add_nodo('importe_debe_flujo',$f["importe_debe_flujo"]);
				$xml->add_nodo('importe_haber_flujo',$f["importe_haber_flujo"]);
				...
				$total_debe_flujo=$total_debe_flujo+$f["importe_debe_flujo"];
				$total_haber_flujo=$total_haber_flujo+$f["importe_haber_flujo"];
			}
		 	if($total_registros>0){
				...
				$xml->add_nodo('importe_debe_flujo',number_format($total_debe_flujo,2,'','.'));
				$xml->add_nodo('importe_haber_flujo',number_format($total_haber_flujo,2,'','.'));
