...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarPlantillaCalculo.php
Propósito:				Permite eliminar registros de la tabla tct_plantilla_calculo
...
$nombre_archivo = "ActionEliminarPlantillaCalculo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarPlantillaCalculo($id_plantilla_calculo);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
