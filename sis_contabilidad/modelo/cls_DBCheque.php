...
/**
	...
	//agosto2016:REQ11082016100646
	function SubirChequeCsv($id_transaccion, $id_cuenta_bancaria, $fecha, $agencia,$descripcion ,$nro_deposito,$monto)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tct_cheque_csv_iud';
		$this->codigo_procedimiento = "'CT_CHEQUECSV_INS'";
