...
,{name: 'ndc_fecha_documento_orig',type:'date',dateFormat:'Y-m-d'},'ndc_nro_autorizacion_factura_orig','ndc_nro_documento_orig'
,'ndc_importe_total_orig'
  	]);
	...
	Atributos[21]={
			validacion:{
				name:'ndc_nro_documento_orig',
				fieldLabel:'Nro.Documento Original',
				allowBlank:true,
				maxLength:50,
				align:'right', 
				minLength:0,
			...
			form: true,
			filtro_0:true,
			filterColValue:'DOCUME.ndc_nro_documento_orig',
			save_as:'ndc_nro_documento_orig'
		};
		
		// txt nro_autorizacion
		Atributos[22]={
			validacion:{
				name:'ndc_nro_autorizacion_factura_orig',
				fieldLabel:'Nro.Autorización Original',
				allowBlank:true,
				maxLength:20,
				minLength:0,
				selectOnFocus:true,
			...
			form: true,
			filtro_0:true,
			filterColValue:'DOCUME.ndc_nro_autorizacion_factura_orig',
			save_as:'ndc_nro_autorizacion_factura_orig'
		};

		
		Atributos[23]={
				validacion:{
					name:'ndc_importe_total_orig',
				...
				filtro_0:true,
				defecto:0,
				filterColValue:'DOCVAL.ndc_importe_total_orig',
				save_as:'ndc_importe_total_orig'
			};

		Atributos[24]= {
				validacion:{
					name:'ndc_fecha_documento_orig',
					fieldLabel:'Fecha Doc.Original',
					allowBlank:true,
					format: 'd/m/Y', //formato para validacion
					minValue: '01/01/1900',
					disabledDaysText: 'Día no válido',
				...
				tipo:'DateField',
				filtro_0:true,
				filterColValue:'DOCUME.ndc_fecha_documento_orig',
				dateFormat:'m-d-Y',
				defecto: new Date(),
				save_as:'ndc_fecha_documento_orig'
			};
	...
	function InitRegistroDocumento(){ 
		...
		//notas de DC
		txt_ndc_fecha_documento_orig=ClaseMadre_getComponente('ndc_fecha_documento_orig');	
		txt_ndc_nro_autorizacion_factura_orig =ClaseMadre_getComponente('ndc_nro_autorizacion_factura_orig');
		txt_ndc_nro_documento_orig=ClaseMadre_getComponente('ndc_nro_documento_orig');
		txt_ndc_importe_total_orig=ClaseMadre_getComponente('ndc_importe_total_orig');
	...
	//fin 2016
	function filtrarCamposDocumento(combo, record, index){ console.log(record.data['tipo']);
		if(record.data['tipo']==4){ 
				CM_mostrarComponente(txt_ndc_fecha_documento_orig);
				CM_mostrarComponente(txt_ndc_nro_autorizacion_factura_orig);
				CM_mostrarComponente(txt_ndc_nro_documento_orig);
				CM_mostrarComponente(txt_ndc_importe_total_orig);

				txt_ndc_fecha_documento_orig.allowBlank=false;
				txt_ndc_nro_autorizacion_factura_orig.allowBlank=false;
				txt_ndc_nro_documento_orig.allowBlank=false;
				txt_ndc_importe_total_orig.allowBlank=false;

				CM_ocultarComponente(txt_importe_descuento);
				CM_ocultarComponente(txt_importe_exportaciones);
				CM_ocultarComponente(txt_importe_ventas_gravadas_tasa_0);
				

		}else{ //OCULTAR
			
			CM_ocultarComponente(txt_ndc_fecha_documento_orig);
			CM_ocultarComponente(txt_ndc_nro_autorizacion_factura_orig);
			CM_ocultarComponente(txt_ndc_nro_documento_orig);
			CM_ocultarComponente(txt_ndc_importe_total_orig);

			txt_ndc_fecha_documento_orig.allowBlank=true;
			txt_ndc_nro_autorizacion_factura_orig.allowBlank=true;
			txt_ndc_nro_documento_orig.allowBlank=true;
			txt_ndc_importe_total_orig.allowBlank=true;

			txt_ndc_fecha_documento_orig.setValue('');
			txt_ndc_nro_autorizacion_factura_orig.setValue('');
			txt_ndc_nro_documento_orig.setValue('');
			txt_ndc_importe_total_orig.setValue('');


			

			CM_mostrarComponente(txt_importe_descuento);
			CM_mostrarComponente(txt_importe_exportaciones);
			CM_mostrarComponente(txt_importe_ventas_gravadas_tasa_0);
