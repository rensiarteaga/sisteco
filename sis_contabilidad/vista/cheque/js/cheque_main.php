...
// txt id_cuenta_bancaria
	...
	//ago2016: REQ11082016100646
	function btn_archivo(){
		var data='';
		var ParamVentana={ventana:{width:400,height:200}}
		
		data=data+'&id_transaccion='+maestro.id_transaccion;
		data=data+'&id_cuenta='+maestro.id_cuenta;
		data=data+'&id_auxiliar='+maestro.id_auxiliar;
		layout_cheque.loadWindows(direccion+'../../../vista/cheque/cheque_upload.php?'+data,'Datos',ParamVentana);
		layout_cheque.getVentana().on('resize',function(){
			layout_cheque.getLayout().layout()
		})
	}
	...
	this.AdicionarBoton('../../../lib/imagenes/brick_bl.png','Subir Archivo',btn_archivo,true,'archivo_filial','Archivo Datos');
