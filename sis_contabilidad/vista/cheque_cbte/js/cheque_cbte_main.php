...
var paramConfig={TamanoPagina:_CP.getConfig().ss_tam_pag,TiempoEspera:_CP.getConfig().ss_tiempo_espera,CantFiltros:1,FiltroEstructura:false,FiltroAvanzado:fa,idSub:idSub};
var usuario={id_usuario:<?php echo $_SESSION['ss_id_usuario'];?>}

var elemento={pagina:new pagina_cheque_cbte(idContenedor,direccion,usuario,paramConfig),idContenedor:idContenedor};
