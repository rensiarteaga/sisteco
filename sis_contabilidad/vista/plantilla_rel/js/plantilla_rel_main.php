...
var maestro={id_plantilla:<?php echo $m_id_plantilla;?>,desc_plantilla:'<?php echo $m_desc_plantilla;?>'};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_plantilla_rel(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
