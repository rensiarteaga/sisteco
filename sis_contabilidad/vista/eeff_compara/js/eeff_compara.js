...
function pagina_eeff_compara(idContenedor,direccion,paramConfig){
	...
	var ds_firma = new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/gestion_firma/ActionListarGestionFirma.php'}),
		reader: new Ext.data.XmlReader({record:'ROWS',id:'id_gestion_firma',totalRecords: 'TotalCount'},['id_gestion_firma','id_gestion','sw_firma','id_empleado','nombre_completo','id_cargo','nombre_cargo','mat_contador'])
	});
   ...
   Atributos[4]={
	...
	var paramFunciones={
		...
		Formulario:{html_apply:'dlgInfo-'+idContenedor,height:400,width:480,minWidth:150,minHeight:200,closable:true,titulo:'EEFF Comparativo',
			grupos:[{	
