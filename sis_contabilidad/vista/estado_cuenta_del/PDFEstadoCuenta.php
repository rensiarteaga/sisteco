...
//$this->SetXY(40,5);
$this->Cell(210,15,'ESTADO DE CUENTAS',0,0,'C');
...
$this->Ln(5);
//$this->SetFont('Arial','B',10);
$this->Cell(30,5,'Nombre Cuenta:',0,0);
$this->SetFont('Arial','I',8);
$this->Cell(55,5,$data[0][2],0,0);
$this->Cell(30,5,'',0,0);
...
$this->ln(5);
$this->SetFont('Arial','B',10);
$this->Cell(30,5,'Cuenta:',0,0);
$this->SetFont('Arial','I',8);
$this->Cell(55,5,$data[0][1],0,0);
$this->SetFont('Arial','B',10);
$this->Cell(30,5,'',0,0);
...
$this->Cell(15,7,'Auxiliar','TB',0,'C');
$this->Cell(70,7,'Descripción del Auxiliar','TB',0,'C');
	...
	
	{
	   ...
	   foreach($data as $row)
	    {	$this->SetFont('Arial','',6);    		
		        ...
		        //nombre
		        $this->Cell(18,5,$row[6],0,0,'C',$fill);
		        //direccion
		        $this->Cell(70,5,$row[7],0,0,'L',$fill);
		        //meses
	        	...
	        	if($contador==$total_count-1)
		    	{
		    		...
		    		//$this->total_valorado+=$row[6];
		       		...
		       		$this->Cell(30,4,"TOTAL CUENTA: ",0,0,'R',0);
