...
$this->SetXY(40,5);
$this->Cell(140,15,'Estado de Cuentas por Estructura Programática',0,0,'C');
...
$this->Ln(5);
//$this->SetFont('Arial','B',10);
$this->Cell(50,5,'Estructura Programática:',0,0);
$this->SetFont('Arial','I',8);
$this->Cell(55,5,$data[0][5],0,0);
$this->SetFont('Arial','B',10);
$this->Cell(30,5,'',0,0);
...
$this->ln(5);
 $this->SetFont('Arial','B',6);
    ...
    $this->Cell(60,6,'UNIDAD ORGANIZACIONAL','LTRB',0,'C',0);
       ...
       //echo "total ".$total_count."contador =".$contador; 
        	if($contador==$total_count-1)
	    	{
	    		...
	    		$this->total_valorado_total+=$this->total_valorado;
	       		...
	       		$this->Cell(30,4,"Total Estructura Programática: ",0,0,'R',0);
	...
	//	 		$total_valorado=$row[6];
		    ...
		    //unidad organizacional
		    $this->Cell(60,5,$row[3],'T',0,'L',$fill);
		    //saldo
