 ...
 * Fecha Ultima Modificación : 26/01/2010
 * Se añadió el concepto de la transacción
...
/*$detalle_haber[4][0]= $vtransaccion_haber[$i][12];
$detalle_haber[4][1]= '';
$detalle_haber[4][2]= '';
$detalle_haber[4][3]= '';
$detalle_haber[4][4]= '';
...
/*$a=$pdf->NbLines(109,$vtransaccion_haber[$i][1]);
$a1=$pdf->NbLines(109,$vtransaccion_haber[$i][2]);
$a2=$pdf->NbLines(109,$vtransaccion_haber[$i][11]);
$a3=$pdf->NbLines(109,$vtransaccion_haber[$i][3]);
$haber_total_lineas=$a+$a1+$a2+$a3;*/
