...
// txt id_fuente_financiamiento
	Atributos[2]={
		...
		filtro_0:true,
		id_grupo:1,
		filterColValue:'FUNFIN.codigo_fuente#FUNFIN.denominacion',
...
// txt id_moneda
	...
	Atributos[12]= {
		...
		filtro_0:true,
		id_grupo:5,
		filterColValue:'TRANSC.fecha_trans',
		dateFormat:'m-d-Y',
		defecto:'',
		save_as:'fecha_cbte'
	};
...
/*guardar:{crear:true,separador:false},
   ...
   this.reload=function(m,Padre){
	...
	ds.lastOptions={
				...
				this.btnActualizar();
				monedas.setValue(maestro.id_moneda);
