<?php
/**
 * Nombre:		  	    plantilla_calculo_main.php
...
var maestro={
	id_plantilla:'<?php echo $m_id_plantilla;?>',
	desc_plantilla:'<?php echo $m_desc_plantilla;?>'
};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_plantilla_calculo(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
...
{	var Atributos=new Array,sw=0;
	...
	gestion.on('select',function (combo, record, index){
		var g_id_gestion=gestion.getValue();
		cmbGestion.setValue(g_id_gestion);
		getComponente('id_gestion_plantilla').setValue(g_id_gestion);
	...
	function iniciarEventosFormularios(){//para iniciar eventos en el formulario
	    ...
	    cmbGestion=getComponente('id_gestion_plantilla');
	...
	this.btnNew=function(){
		Atributos[10].defecto=getComponente('id_gestion_plantilla').getValue();
		CM_btnNew();
