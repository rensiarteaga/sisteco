<?php
/**
 * Nombre:		  	    devengado_dcto_main.php
...
function main(){
	...
	var maestro={
		id_devengado:<?php echo $m_id_devengado;?>,
		desc_concepto_ingas:decodeURIComponent('<?php echo $m_desc_concepto_ingas;?>'),
		desc_moneda:decodeURIComponent('<?php echo $m_desc_moneda;?>'),
		importe_devengado:decodeURIComponent('<?php echo $m_importe_devengado;?>'),
		estado_devengado:decodeURIComponent('<?php echo $m_estado_devengado;?>'),
		tipo_devengado:decodeURIComponent('<?php echo $m_tipo_devengado;?>'),
		id_moneda:decodeURIComponent('<?php echo $m_id_moneda;?>'),
		nit:decodeURIComponent('<?php echo $m_nit;?>'),
		tipoFormDev:decodeURIComponent('<?php echo $tipoFormDev;?>'),
		razon_social:decodeURIComponent('<?php echo $m_razon_social;?>'),
		proforma:decodeURIComponent('<?php echo $m_proforma;?>'),
		solo_lectura:decodeURIComponent('<?php echo $m_solo_lectura;?>'),
		tipo_doc_fijo:decodeURIComponent('<?php echo $m_tipo_doc_fijo;?>'),
		id_cotizacion:decodeURIComponent('<?php echo $m_id_cotizacion;?>'),
		id_plan_pago:decodeURIComponent('<?php echo $m_id_plan_pago;?>')
	};
	idContenedorPadre='<?php echo $idContenedorPadre;?>';
	var elemento={idContenedor:idContenedor,pagina:new pagina_devengado_dcto(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
