<?php
/**
 * Nombre:		  	    devengado_detalle_main.php
...
function main(){
	...
	var elemento={idContenedor:idContenedor,pagina:new pagina_devengado_detalle(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
