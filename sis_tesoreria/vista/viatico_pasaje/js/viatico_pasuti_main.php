...
function main(){
	...
	var elemento={pagina:new pagina_viatico_pasuti(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
* Nombre:		  	    pagina_viatico_pasuti.js
* Propósito: 			pagina objeto principal
* Autor:				Generado Automaticamente
* Fecha creación:		2008-10-21 15:59:44
*/
function pagina_viatico_pasuti(idContenedor,direccion,paramConfig,tipoFormDev){
	...
	var paramFunciones={
		...
		ConfirmSave:{url:direccion+'../../../control/viatico_pasaje/ActionGuardarViaPasaje.php?tipo=utipasaje'},
		Formulario:{
	...
	gestion.on('select',function (combo, record, index){
		...
		ds.baseParams={m_gestion:g_id_gestion};
  		...
  		comp_id_presupuesto.setValue('');*/ // comentado 17nov2014: genera error por no estar declarado la asignacion a comp_id_presupuesto
  	});
	...
	function btn_RepPasaje() {
		...
		if(sm.getCount()!=0){
			...
			window.open(direccion+'../../../../sis_tesoreria/control/_reportes/devengado/ActionPasajeUti_Jasper.php?id_cuenta_doc_det='+id_cuenta_doc_det)
		}else{
	...
	this.AdicionarBoton('../../../lib/imagenes/print.gif','Detalle de Pasajes No Utilizados',btn_RepPasaje,false,'reporte','Reporte Detalle');
