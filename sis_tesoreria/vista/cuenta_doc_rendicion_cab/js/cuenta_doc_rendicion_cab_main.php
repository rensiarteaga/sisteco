...
var maestro={
	id_cuenta_doc:<?php echo $id_cuenta_doc;?>,
	desc_empleado:decodeURIComponent('<?php echo $desc_empleado;?>'),
	desc_categoria:decodeURIComponent('<?php echo $desc_categoria;?>'),
	nro_documento:decodeURIComponent('<?php echo $nro_documento;?>'),
	desc_depto:decodeURIComponent('<?php echo $desc_depto;?>'),
	observacion:decodeURIComponent('<?php echo $observacion;?>'),
	tipo_contrato:decodeURIComponent('<?php echo $tipo_contrato;?>'),
	vista:decodeURIComponent('<?php echo $vista;?>')
};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_cuenta_doc_rendicion_cab(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
