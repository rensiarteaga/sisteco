...
// txt observaciones
	...
	function iniciarEventosFormularios(){	
		...
		/*dteFechaIni=ClaseMadre_getComponente('fecha_ini');
		dteFechaFin=ClaseMadre_getComponente('fecha_fin');*/
		...
		//dteFechaIni.on('select',onFechaIniSelect);
	}
	/*************************ana ********************/
	/*var onFechaIniSelect = function(e) {
		//var id = dte_fecha_ini.getValue();
		//if(fecha_ini.store.getById(id)!=undefined){
			//intGestion=cmbGestion.store.getById(id).data.gestion;
		
			//dte_fecha_ini_valid = '01/01/'+intGestion+' 00:00:00';
			dte_fecha_fin_valid = '12/19/2014'+' 00:00:00';
	...
	//dteFechaFin.maxValue=dte_fecha_fin_valid; 
