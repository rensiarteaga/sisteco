 ...
 * Fecha ultima de actualizacion: 18/08/2009,29/01/2010
...
$this->SetXY(45,1);
$y_cab=$this->GetY();
$this->Cell(125,7,'RENDICION DE CUENTAS',0,1,'C');
$this->SetFont('Arial','B',10);
$this->SetXY(45,8);
$this->MultiCell(125,4,$_SESSION['PDF_subtitulo'],0,'C');
$x=$this->GetX();

$this->Line(1,16,215,16);
$this->Line(45,1,45,16);
$this->Line(170,1,170,16);
$this->SetFont('Arial','B',8);
$this->SetXY($x+170,$y_cab);
$this->Cell(50,5,'No.'.$_SESSION['PDF_nro_avance'],0,1);
$this->SetXY($x+170,$y_cab+5);
...
$y=$this->GetY();
$this->SetFont('Arial','B',8);
$this->MultiCell(150,3.5,'CONCEPTO:'.$_SESSION['PDF_concepto'],'R','L');
$yfin_cab=$this->GetY();
$this->SetXY(151,$y);
...
$this->Cell(53,4,'Analista Contable',1,0,'C');
$this->Cell(53,4,'Contabilidad',1,1,'C');
...
$this->Cell(54,4,$_SESSION['PDF_nombre_completo'],1,0,'C');
$this->Cell(54,4,$_SESSION['PDF_firma_autorizada'],1,0,'C');
$this->Cell(53,4,$_SESSION['PDF_revisado_por'],1,0,'C');
$this->Cell(53,4,$_SESSION['PDF_contabilidad'],1,1,'C');
...
$suma_cargo=0;
$suma_descargo=0;
/*print_r($array_detalle_rendicion_cuentas);
exit;*/
