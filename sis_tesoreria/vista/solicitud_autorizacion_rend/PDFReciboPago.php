...
$pdf->SetFont('Arial','',8);	
             $pdf->SetWidths(array(20,20,20,20,20,20,20,20));
             $pdf->SetAligns(array('R','R','L','R','R','R','R','R'));
             $pdf->SetVisibles(array(1,1,1,1,1,1,1,1));
             $pdf->SetFontsSizes(array(7,7,7,7,7,7,7,7));
             $pdf->SetDecimales(array(0,0,0,2,0,2,0,2));
