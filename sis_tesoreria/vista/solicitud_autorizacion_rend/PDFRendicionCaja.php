...
$pdf->Cell(180,5,'RECIBO PROVISIONAL DE ENTREGA DE FONDOS EN EFECTIVO',0,1,'C'); 
...
$pdf->Cell(25,5,'FECHA ','TLR',0,'C');
$pdf->Cell(25,5,'HORA ','TLR',0,'C'); 
$pdf->Cell(25,5,'MONEDA ','TLR',0,'C'); 
$pdf->Cell(65,5,'No','TLR',1,'C'); 

$pdf->SetFont('Arial','',8);

$pdf->Cell(50,5,$_SESSION['PDF_nombre_lugar'],'BLR',0,'C'); 
$pdf->Cell(25,5,$_SESSION['PDF_fecha'],'BLR',0,'C'); 
$pdf->Cell(25,5,$_SESSION['PDF_hora'],'BLR',0,'C'); 
$pdf->Cell(25,5,$_SESSION['PDF_nombre_moneda'],'BLR',0,'C'); 
$pdf->Cell(65,5,$_SESSION['PDF_nro_documento'],'BLR',1,'C');
...
$pdf->Cell(60,4,'DOCUMENTO ','LTR',0,'C');  
 $pdf->Cell(26,4,'FACTURA ','LTR',0,'C');  
 $pdf->Cell(26,4,'NIT ','LTR',0,'C');  
 $pdf->Cell(26,4,'Nº AUTORIZACION','LTR',0,'C');  
 $pdf->Cell(26,4,'IMPORTE ','LTR',0,'C'); 
 $pdf->Cell(26,4,'IMPORTE ','LTR',1,'C'); 
 
 $pdf->Cell(60,4,' ','LBR',0,'C');  
 $pdf->Cell(26,4,' ','LBR',0,'C');  
 $pdf->Cell(26,4,' ','LBR',0,'C');  
 $pdf->Cell(26,4,' ','LBR',0,'C');  
 $pdf->Cell(26,4,'TOTAL','LBR',0,'C'); 
 $pdf->Cell(26,4,'RENDICION','LBR',1,'C'); 
 ...
 $pdf->Cell(60,5,$_SESSION["PDF_tipo_documento_$i"],1,0,'C');      				
 $pdf->Cell(60,5,$_SESSION["PDF_nro_documento_$i"],1,0,'C');  
 $pdf->Cell(26,5,$_SESSION["PDF_nro_nit_$i"],1,0,'C');  
 $pdf->Cell(26,5,$_SESSION["PDF_nro_autorizacion_$i"],1,0,'C');  
 $pdf->Cell(26,5,$_SESSION["PDF_importe_total_$i"],1,0,'C'); 
 $pdf->Cell(26,5,$_SESSION["PDF_importe_rendicion_$i"],1,1,'C'); 

$pdf->Cell(55,5,'DESCRIPCIÓN ',1,0,'C');  
 $pdf->Cell(18,5,'IMPORTE ',1,0,'C');  
 $pdf->Cell(59,5,'PRESUPUESTO ',1,0,'C');  
 $pdf->Cell(38,5,'OBSERVACIONES',1,0,'C');  
 $pdf->Cell(20,5,'DISPONIBLE',1,1,'C');  
 		
		$pdf->SetWidths(array(0,55,18,59,38,20));
		$pdf->SetFills(array(0,0,0,0,0,0));
 		$pdf->SetAligns(array('L','L','R','L','L','L'));
		...
		for ($i=0;$i<sizeof($solicitud_detalle);$i++){
 	 		if($solicitud_detalle[$i][5]=='NO DISPONIBLE'){
