<?php
/**
 * Nombre:		  	    categoria_tipo_destino_main.php
...
var maestro={id_tipo_destino:<?php echo $id_tipo_destino;?>,descripcion:decodeURIComponent('<?php echo $descripcion;?>')};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_categoria_tipo_destino(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
