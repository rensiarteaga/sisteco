<?php 
/**
 * Nombre:		  	    viatico_calculo_main.php
...
var maestro={
		...
		detalle_otros:'<?php echo utf8_decode($m_detalle_otros);?>'
	};
	
	idContenedorPadre='<?php echo utf8_decode($idContenedorPadre);?>';	

var elemento={idContenedor:idContenedor,pagina:new pagina_viatico_calculo(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
