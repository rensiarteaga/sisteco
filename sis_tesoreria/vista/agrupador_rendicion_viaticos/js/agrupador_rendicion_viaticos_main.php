<?php 
/**
 * Nombre:		  	    agrupador_rendicion_viaticos_main.php
...
var maestro={
		...
		motivo_viaje:'<?php echo utf8_decode($m_motivo_viaje);?>'	
	};
...
var elemento={pagina:new pagina_agrupador_rendicion_viaticos(idContenedor,direccion,paramConfig,maestro,idContenedorPadre),idContenedor:idContenedor};
