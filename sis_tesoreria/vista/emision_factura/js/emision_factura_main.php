<?php 
/**
 * Nombre:		  	    emision_factura_main.php
...
var elemento={pagina:new pagina_emision_factura(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
 * Nombre:		  	    pagina_emision_factura.js
 * Propósito: 			pagina objeto principal
 * Autor:				Generado Automaticamente
 * Fecha creación:		2008-10-29 17:35:04
 */
function pagina_emision_factura(idContenedor,direccion,paramConfig){
	var Atributos=new Array,sw=0;
	
	//---DATA STORE
	var ds = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/factura_recibo/ActionListarEmisionFactura.php'}),
...
// txt codigo_control
	...
	var config={titulo_maestro:'emision_factura',grid_maestro:'grid-'+idContenedor};
	var layout_emision_factura=new DocsLayoutMaestroEP(idContenedor);
	layout_emision_factura.init(config);
	...
	this.pagina(paramConfig,Atributos,ds,layout_emision_factura,idContenedor);
	...
	var paramFunciones={
		btnEliminar:{url:direccion+'../../../control/factura_recibo/ActionEliminarEmisionFactura.php',mensaje:'Esta seguro de anular la factura?'},
		Save:{url:direccion+'../../../control/factura_recibo/ActionGuardarEmisionFactura.php'},
		ConfirmSave:{url:direccion+'../../../control/factura_recibo/ActionGuardarEmisionFactura.php'},
		Formulario:{html_apply:'dlgInfo-'+idContenedor,height:400,columnas:['47%','47%'],grupos:[{tituloGrupo:'Datos Generales',columna:0,id_grupo:0},{tituloGrupo:'Estructura Programatica',columna:0,id_grupo:1},{tituloGrupo:'Datos de Factura',columna:1,id_grupo:2},{tituloGrupo:'Datos Deposito',columna:1,id_grupo:3}],width:'70%',minWidth:150,minHeight:200,	closable:true,titulo:'emision_factura'}};
	...
	this.getLayout=function(){return layout_emision_factura.getLayout()};
	...
	this.AdicionarBoton('../../../lib/imagenes/cancel.png','Anular Factura',btn_anular,true,'anular_factura','Anulación');
	var CM_getBoton=this.getBoton;
	CM_getBoton('anular_factura-'+idContenedor).enable();
			...
			var record=selected.data;
				...
				if(selected&&record!=-1){
        			   ...
        			   if(record.razon_social=='ANULADO'){
					       		CM_getBoton('anular_factura-'+idContenedor).disable();
	...
	layout_emision_factura.getLayout().addListener('layout',this.onResize);//aregla la forma en que se ve el grid dentro del layout
