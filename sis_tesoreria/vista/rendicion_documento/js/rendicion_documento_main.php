<?php
/**
 * Nombre:		  	    rendicion_documento_main.php
...
function main(){
	...
	var paramConfig={TamanoPagina:25,TiempoEspera:10000,CantFiltros:1,FiltroEstructura:false,FiltroAvanzado:fa};
	//var maestro={id_cuenta_doc:<?php echo $id_cuenta_doc;?>};
	var idContenedorPadre='<?php echo $idContenedorPadre;?>';
	var elemento={idContenedor:idContenedor,pagina:new pagina_rendicion_documento(idContenedor,direccion,paramConfig,idContenedorPadre)};
