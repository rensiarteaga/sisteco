...
var elemento={pagina:new pagina_pago_viaticos(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
// txt importe_regis
	...
	var config={titulo_maestro:'Pago de Viáticos',grid_maestro:'grid-'+idContenedor};
	...
	var paramFunciones={
		...
		{tituloGrupo:'Depósito',columna:0,id_grupo:4}		
		],
		height:'55%',
		width:'55%',		
		minWidth:150,
	...
	this.btnEdit = function()
	{
		...
		{
			 Ext.MessageBox.alert('Estado','Solo viáticos en estado VERIFICACIÓN pueden ser editados')
		}			
	}
	...
	{			
		...
		if(NumSelect==1)
		{
			...
			{
				var sw=false;
				if(confirm('Esta seguro de finalizar la solicitud de viáticos?'))
				{
					sw=true
				}
				if(sw)	//confirma la finalizacion del viatico
				{
					...
					{	
						alert('El saldo del viático es igual a cero, la solicitud sera finalizada');
	...
	//this.AdicionarBoton('../../../lib/imagenes/menu-show.gif','Emitir Pago de Viáticos',btn_pago,true,'emitir_pago','Emisión de Pago');
	...
	//this.AdicionarBoton('../../../lib/imagenes/print.gif','Imprime la rendición de viáticos',btn_reporte_rendicion,true,'rendicion_viaticos','Rendición');
	...
	this.AdicionarBoton('../../../lib/imagenes/book_next.png','Finalizar Viático',btn_finalizar,true,'fin_viatico','Finalizar'); //tucrem
	this.AdicionarBoton('../../../lib/imagenes/print.gif','Imprime cheque por saldo a favor del empleado',btn_imprime_cheque_fin,true,'impresion_cheque_fin','Cheque Finalización');
