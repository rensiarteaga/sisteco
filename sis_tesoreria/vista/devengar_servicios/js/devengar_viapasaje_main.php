...
function main(){
	...
	var elemento={pagina:new pagina_devengar_viapasaje(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
* Nombre:		  	    pagina_devengar_viapasaje
* Propósito: 			pagina objeto principal
* Autor:				Generado Automaticamente
* Fecha creación:		2008-10-21 15:59:44
*/
function pagina_devengar_viapasaje(idContenedor,direccion,paramConfig,tipoFormDev){
	...
	var paramFunciones={
		Save:{url:direccion+'../../../control/viatico_pasaje/ActionGuardarViaPasaje.php?tipo=edita'},
		ConfirmSave:{url:direccion+'../../../control/viatico_pasaje/ActionGuardarViaPasaje.php?tipo=edita'},
		Formulario:{
	...
	this.AdicionarBoton("../../../lib/imagenes/list-items.gif",'Modiicar los datos del Pago',btnPagaPasaje,true, 'pasaje','Editar Pago');
