<?php
/**
 * Nombre:		  	    detalle_viatico_main.php
...
//<script>
	...
	function main(){
		...
		echo "\nvar direccion='$dir';";
		if($vista=='recibo'){
		 	echo "var vista='efectivo';";
		 	echo "var vista_padre='recibo';";
		 	echo "var idContenedor='$idContenedor';";
	    	echo "var m_id_cuenta_doc=$id_cuenta_doc;";
	    	echo "var m_id_presupuesto=$id_presupuesto;";
	    	echo "var m_desc_presupuesto='$desc_presupuesto';";
	    	echo "var m_id_parametro=$id_parametro;";
	    	echo "var m_desc_parametro='$desc_parametro';";
		}
		 else{ 
		 	echo "var vista='$vista';";
		 	echo "var vista_padre='ninguno';";
		 }
...
if(vista_padre=='recibo'){
	var m={id_cuenta_doc:m_id_cuenta_doc,id_presupuesto:m_id_presupuesto,desc_presupuesto:m_desc_presupuesto,id_parametro:m_id_parametro,desc_parametro:m_desc_parametro};
	
}
else{
	var m=undefined;
}
var elemento={idContenedor:idContenedor,pagina:new pagina_detalle_viatico(idContenedor,direccion,paramConfig,vista,m)};
...
// txt tipo_transporte
	Atributos[6]={
			...
			loadMask:true,
			triggerAction:'all',
			store:new Ext.data.SimpleStore({fields:['ID','valor'],data:[['ninguno','ninguno'],['aereo','aereo'],['terrestre','terrestre'],['fluvial_maritimo','fluvial_maritimo']]}),
			valueField:'ID',
			displayField:'valor',
			lazyRender:true,
			forceSelection:true,
...
//DEFINICIÓN DE FUNCIONES
	...
	//para iniciar eventos en el formulario
		...
		if(vista=='viatico'){
			...
			componentes[17].on('blur',obtenerImporte);
	...
	function obtenerImporte(combo,record,index){
		...
		if(componentes[8].getValue()=='' || componentes[9].getValue()=='' || componentes[17].getValue()=='' || componentes[18].getValue()==''){
			...
			Ext.Ajax.request({
						...
						params:{id_cuenta_doc:maestro.id_cuenta_doc,id_cobertura:componentes[9].getValue(),
								id_tipo_destino:componentes[8].getValue(),fecha_ini:componentes[17].getValue().dateFormat('m-d-Y'),
								fecha_fin:componentes[18].getValue().dateFormat('m-d-Y')},
