...
var maestro={id_parametro:<?php echo $m_id_parametro;?>,gestion_tesoro:decodeURIComponent('<?php echo $m_gestion_tesoro;?>'),estado_gestion:decodeURIComponent('<?php echo $m_estado_gestion;?>')};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_nivel_oec(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
