...
// txt gestion_pres
	...
	Atributos[11]={
		validacion: {
			...
			loadMask:true,
			triggerAction:'all',
			store:new Ext.data.SimpleStore({fields:['ID','valor'],data:[['0','Ninguno'],['EF','Efectivo'],['SV','Viáticos'],['FA','Fondos Avance'],['EF-SV','Efectivo y Viático'],
			                                                            ['EF-FA','Efectivo y F.Avance'],['SV-FA','Viático y F.Avance'],['ALL','Todos']]}),
			valueField:'ID',
			displayField:'valor',
			lazyRender:true,
