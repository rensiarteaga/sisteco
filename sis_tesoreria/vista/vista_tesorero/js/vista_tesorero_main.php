...
var elemento={pagina:new pagina_vista_tesorero(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
	...
	Atributos[8]={
		...
		Atributos[12]={
				...
				onSelect:function(record){
					...
					ds_cajero.baseParams={
					  m_id_caja:record.data.id_caja,
					  vista:'tesorero'
					}
