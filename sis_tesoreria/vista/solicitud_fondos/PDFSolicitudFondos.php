...
$pdf->SetFont('Arial','',7);
$pdf->SetY($y_motivo);	
$pdf->MultiCell(207,4,'                                                           : '.$pdf->preview_text($_SESSION['PDF_concepto_avance'],490,0),'LBR');
$pdf->SetFont('Arial','B',8);
$pdf->Cell(30,10,'COMISIÓN',1,0,'C');
$pdf->Cell(45,5,'Lugar',1,0,'C');
$pdf->Cell(45,5,'Fecha Iniciación',1,0,'C');
//$pdf->Cell(30,5,'Fecha Conclusión',1,0,'C');
$pdf->Cell(87,5,'Monto (Bs)',1,1,'C');
$pdf->SetX(35);
$pdf->SetFont('Arial','',8);
$y=$pdf->GetY();

$pdf->Cell(45,5,$_SESSION['PDF_lugar'],1,0,'C');
$pdf->Cell(45,5,$_SESSION['PDF_fecha_ini'],1,0,'C');
//$pdf->Cell(30,5,'',1,0,'C');
$pdf->MultiCell(87,15,number_format($_SESSION['PDF_monto'],2),1,'C');
$pdf->SetFont('Arial','B',8);
$pdf->SetY($y+5);
$pdf->Cell(120,5,'MONTO: (Literal)','LRT',1);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(120,5,$_SESSION['PDF_monto_literal'],'LR');
...
$pdf->SetY($y_obs);
$pdf->SetFont('Arial','',7);
$pdf->MultiCell(207,3.5,'                                      : '.$pdf->preview_text($_SESSION['PDF_observacion_avance'],510,0),'LRB',1);
$pdf->SetFont('Arial','B',8);
