...
var maestro={
id_avance:<?php echo $m_id_avance;?>,
id_empleado:<?php echo $m_id_empleado;?>,
desc_empleado:decodeURIComponent('<?php echo $m_desc_empleado;?>'),
id_depto:<?php echo $m_id_depto;?>,
desc_depto:decodeURIComponent('<?php echo $m_desc_depto;?>')
};
idContenedorPadre='<?php echo $idContenedorPadre;?>';

var elemento={idContenedor:idContenedor,pagina:new avance_solicitud(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
