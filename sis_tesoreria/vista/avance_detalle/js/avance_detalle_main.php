...
var maestro={id_avance:<?php echo $m_id_avance;?>,
             fecha_avance:'<?php echo $m_fecha_avance;?>',
             importe_avance:'<?php echo $m_importe_avance;?>',
             id_empleado_reg:'<?php echo $m_id_empleado_reg;?>',
             id_depto:<?php echo $m_id_depto;?>};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_avance_detalle(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
