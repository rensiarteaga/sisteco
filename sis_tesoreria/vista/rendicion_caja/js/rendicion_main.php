...
var elemento={idContenedor:idContenedor,pagina:new pagina_rendicion(idContenedor,direccion,paramConfig)};
...
// txt estado
	...
	var paramFunciones={
		...
		Formulario:{html_apply:'dlgInfo-'+idContenedor,height:'50%',width:'50%',minWidth:350,minHeight:400,	closable:true,titulo:'Rendicion de cajas',
	...
	enable=function(sm,row,rec){
		...
		else if(rec.data['estado']=='pago_cheque'){
			//CM_getBoton('reposicion-'+idContenedor).enable();
			//CM_getBoton('corregir_rendicion-'+idContenedor).enable();
			CM_getBoton('reporte_documentos_respaldo-'+idContenedor).enable();		
		}
