...
var paramConfig={TamanoPagina:20,TiempoEspera:_CP.getConfig().ss_tiempo_espera,CantFiltros:2,FiltroEstructura:false,FiltroAvanzado:fa};
var elemento={pagina:new pagina_concepto_ingas(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
