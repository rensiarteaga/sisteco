...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarReposicionCaja.php
Propósito:				Permite eliminar registros de la tabla tts_caja_regis
...
$nombre_archivo = "ActionEliminarReposicionCaja.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarReposicionCaja($id_caja_regis);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
