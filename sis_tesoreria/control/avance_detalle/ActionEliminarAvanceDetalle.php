...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarAvanceDetalle.php
Propósito:				Permite eliminar registros de la tabla tts_avance_detalle
...
$nombre_archivo = "ActionEliminarAvanceDetalle.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarAvanceDetalle($id_avance_detalle);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
