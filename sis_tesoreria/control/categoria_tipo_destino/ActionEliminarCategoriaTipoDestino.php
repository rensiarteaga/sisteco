...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCategoriaTipoDestino.php
Propósito:				Permite eliminar registros de la tabla tts_categoria_tipo_destino
...
$nombre_archivo = "ActionEliminarCategoriaTipoDestino.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCategoriaTipoDestino($id_categoria_tipo_destino);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
