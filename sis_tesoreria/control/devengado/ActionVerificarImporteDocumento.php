...
/**
**********************************************************
Nombre de archivo:	    ActionVerificarImporteDocumento.php
...
$nombre_archivo = "ActionVerificarImporteDocumento.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		else
		{
			...
			$res = $Custom -> VerificaImporteDocumento($id_devengado);
