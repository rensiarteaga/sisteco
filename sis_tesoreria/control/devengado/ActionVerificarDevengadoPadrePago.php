...
/**
**********************************************************
Nombre de archivo:	    ActionVerificarDevengadoPadrePago.php
...
$nombre_archivo = "ActionVerificarDevengadoPadrePago.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		else
		{
			...
			$res = $Custom -> VerificarDevengadoPadrePago($id_devengado);
			...
			foreach ($Custom->salida as $f)
			{
				...
				$xml->add_nodo('tipo_doc',$f["tipo_doc"]);
				$xml->fin_rama();
			}	
			$xml->mostrar_xml();
		}
