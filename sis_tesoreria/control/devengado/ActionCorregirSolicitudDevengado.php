...
/**
**********************************************************
Nombre de archivo:	    ActionCorregirSolicitudDevengado.php
...
$nombre_archivo = "ActionCorregirSolicitudDevengado.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		else
		{
			...
			$res = $Custom -> CorregirSolicitudDevengado($id_devengado);
			/*echo "<pre>";
