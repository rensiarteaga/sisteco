...
/**
**********************************************************
Nombre de archivo:	    ActionContabilizarPago.php
Propósito:				Permite eliminar registros de la tabla tts_devengado
...
$nombre_archivo = "ActionContabilizarPago.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> ContabilizarPago($id_devengado,$tipo_plantilla,$id_cuenta_bancaria);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($cont>1) $mensaje_exito = "Pago contabilizado.";
