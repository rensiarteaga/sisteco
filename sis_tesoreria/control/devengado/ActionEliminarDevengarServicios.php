...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDevengarServicios.php
...
$nombre_archivo = "ActionEliminarDevengarServicios.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDevengarServicios($id_devengado);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
