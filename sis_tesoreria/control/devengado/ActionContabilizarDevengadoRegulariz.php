...
/**
**********************************************************
Nombre de archivo:	    ActionContabilizarDevengadoRegulariz.php
...
$nombre_archivo = "ActionContabilizarDevengadoRegulariz.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		else
		{
			...
			$res = $Custom->ContabilizarDevengadoRegulariz($id_devengado);
			/*echo "<pre>";
