...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCorteMoneda.php
Propósito:				Permite eliminar registros de la tabla tts_corte_moneda
...
$nombre_archivo = "ActionEliminarCorteMoneda.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCorteMoneda($id_corte);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
