...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDevengadoConcepto.php
...
$nombre_archivo = "ActionEliminarDevengadoConcepto.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDevengadoConcepto($id_devengado_concepto);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
