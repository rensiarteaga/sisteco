...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarSolicitudViaticos.php
Propósito:				Permite eliminar registros de la tabla tts_viatico
...
$nombre_archivo = "ActionEliminarSolicitudViaticos.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarSolicitudViaticos($id_viatico);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
