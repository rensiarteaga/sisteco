...
/**
**********************************************************
Nombre de archivo:	    ActionListarPagoViaticos.php
...
$nombre_archivo = 'ActionListarPagoViaticos.php';
...
//Parámetros del filtro
	...
	if($filtro_tipo_vista=='2')//Vista Pago de Viaticos
	{		 
		$criterio_filtro=$criterio_filtro." and VIATIC.tipo_viatico in (1,2) and VIATIC.estado_viatico in (5,12,13,14,15) ";	//filtramos solamente las solicitudes y ampliaciones en estos estados
	}
	...
	$res = $Custom -> ContarPagoViaticos($cant ,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
 
	if($res) $total_registros= $Custom->salida;

	//Obtiene el conjunto de datos de la consulta
	$res = $Custom->ListarPagoViaticos($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
