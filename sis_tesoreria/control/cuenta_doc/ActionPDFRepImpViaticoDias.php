...
$nombre_archivo = 'ActionPDFRepImpViaticoDias.php';
...
//Se obtiene el criterio del filtro con formato sql para mandar a la BD
	...
	$DetImpViatDias= array();
	   
        $DetImpViatDias=$Custom->RepImpViaticoDias($cant, $puntero, $sortcol, $sortdir, $criterio_filtro, $id_empleado, $fecha_inicio, $fecha_fin);
        $_SESSION['PDF_detImpViaticoDias']=$Custom->salida;
    
	 	if(count($Custom->salida)!=0)
	 	{
			header("location: ../../vista/solicitud_viaticos2/PDFRepImpViaticoDias.php");
		}
		else
		{
