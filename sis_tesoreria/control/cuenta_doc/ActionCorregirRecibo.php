...
Propósito:				Permite corregir registros de la tabla tts_cuenta_doc
Tabla:					tts_tts_cuenta_doc
Valores de Retorno:    	Número de registros
Fecha de Creación:		10
Versión:				1.0.0
Autor:					avq
**********************************************************
*/
...
if($_SESSION["autentificado"]=="SI")
{
	...
	if($cont>1) $mensaje_exito = "Se realizó la correción del recibo específicada";
