...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	
			...
			$res = $Custom-> CambiarEstadoCuentaDoc($id_cuenta_doc,$accion,$id_caja,$id_cajero,$id_cuenta_bancaria,$nombre_cheque);
			if(!$res)
			{
	...
	$res = $Custom->ContarDatosTesorero($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
