...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarSolicitudViaticos2.php
...
$nombre_archivo = "ActionEliminarSolicitudViaticos2.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarSolicitudViaticos2($id_cuenta_doc);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	$res = $Custom->ContarSolicitudViaticos2($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$vista,"");
