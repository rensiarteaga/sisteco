...
//Se obtiene el criterio del filtro con formato sql para mandar a la BD
	...
	$datosCabecera['valor'][7]='importe_viaticorendido';
	//$datosCabecera['valor'][8]='nombre_afp';
	
	$datosCabecera['columna'][0]='Fecha Inicio';
	$datosCabecera['columna'][1]='Fecha Fin';
	$datosCabecera['columna'][2]='Empleado';
	$datosCabecera['columna'][3]='Nro. Viatico';
	...
	$impviat = $Custom->RepImpViatico($cant, $puntero, $sortcol, $sortdir, $criterio_filtro, $id_empleado, $fecha_inicio, $fecha_fin);
