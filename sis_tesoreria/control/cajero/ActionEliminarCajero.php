...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCajero.php
Propósito:				Permite eliminar registros de la tabla tts_cajero
...
$nombre_archivo = "ActionEliminarCajero.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCajero($id_cajero);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
