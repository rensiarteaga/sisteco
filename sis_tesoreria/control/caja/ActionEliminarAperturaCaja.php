...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarAperturaCaja.php
Propósito:				Permite eliminar registros de la tabla tts_caja
Tabla:					tts_tts_caja
Parámetros:				$id_caja
...
$nombre_archivo = "ActionEliminarAperturaCaja.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//para el cierre
			$res = $Custom-> EliminarAperturaCaja($id_caja);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
