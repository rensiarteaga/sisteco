...
$nombre_archivo = 'ActionPDFRendicionCuenta.php';
...
//Se obtiene el criterio del filtro con formato sql para mandar a la BD
	...
	$CabRendicionCuenta= $Custom-> CabeRendicionCuentas($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad,$id_avance);
	...
	foreach ($Custom->salida as $f)
			{   
                ...
                /* Para el detalle*/            
                $DetRendicionCuenta=$Custom->DetalleRendicionCuentas($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad,$id_avance);
 ...
 if(count($Custom->salida)!=0){
		   header("location: ../../../vista/descargo/PDFRendicionCuentas.php");
	}else{
