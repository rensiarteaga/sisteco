...
Propósito:				Permite insertar y modificar datos en la tabla tts_cuenta_bancaria
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_cuenta_bancaria == "undefined" || $id_cuenta_bancaria == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tts_cuenta_bancaria
