...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCuentaBancaria.php
Propósito:				Permite eliminar registros de la tabla tts_cuenta_bancaria
Tabla:					tts_tts_cuenta_bancaria
Parámetros:				$id_cuenta_bancaria


Valores de Retorno:    	Número de registros
Fecha de Creación:		2008-10-16 11:07:13
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarCuentaBancaria.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCuentaBancaria($id_cuenta_bancaria);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
