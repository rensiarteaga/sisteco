...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDescargoDetalle.php
...
$nombre_archivo = "ActionEliminarDescargoDetalle.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDescargoDetalle($id_avance);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($sortcol == "") $sortcol = "id_avance";
	if($sortdir == "") $sortdir = "asc";
	if($criterio_filtro == "") $criterio_filtro = "AVANPA.id_avance=''$m_id_avance''";
