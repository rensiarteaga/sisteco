...
$id_usuario=$_SESSION["ss_id_usuario"];
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			...
			$concepto_avance=$_GET["concepto_avance_$j"];
			$observacion_avance=$_GET["observacion_avance_$j"];
			}
		else
		{
			...
			$concepto_avance=$_POST["concepto_avance_$j"];
			$observacion_avance=$_POST["observacion_avance_$j"];
			}
		...
		if ($id_avance == "undefined" || $id_avance == "")
		{
			...
			$res = $Custom->ValidarSolicitudFondos("insert",$id_avance,$id_empleado,$tipo_avance,$fecha_avance,$importe_avance,$estado_avance,$id_moneda,$id_cheque,$id_documento,$id_comprobante,$fk_avance,$id_depto,$id_caja,$id_cajero);
			...
			$res = $Custom -> InsertarSolicitudFondos($id_avance,$id_empleado,$tipo_avance,$fecha_avance,$importe_avance,$estado_avance,$id_moneda,$id_cheque,$id_documento,$id_comprobante,$fk_avance,$id_depto,$id_caja,$avance_solicitud,$id_cajero,$nro_avance,$concepto_avance,$observacion_avance);
		...
		{	///////////////////////Modificación////////////////////
			...
			//Validación de datos (del lado del servidor)
			$res = $Custom->ValidarSolicitudFondos("update",$id_avance,$id_empleado,$tipo_avance,$fecha_avance,$importe_avance,$estado_avance,$id_moneda,$id_cheque,$id_documento,$id_comprobante,$fk_avance,$id_depto,$id_caja,$id_cajero);
			...
			$res = $Custom->ModificarSolicitudFondos($id_avance,$id_empleado,$tipo_avance,$fecha_avance,$importe_avance,$estado_avance,$id_moneda,$id_cheque,$id_documento,$id_comprobante,$fk_avance,$id_depto,$id_caja,$avance_solicitud,$id_cajero,$nro_avance,$concepto_avance,$observacion_avance);
