...
$nombre_archivo = "ActionGuardarValeAvance.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	//Realiza el bucle por todos los ids mandados
		...
		if ($get)
		{
			...
			$importe_avance= $_GET["importe_avance"];
		...
		else
		{
			...
			$importe_avance=$_POST["importe_avance"];
...
$id_usuario=$_SESSION["ss_id_usuario"];
			$res = $Custom->InsertarValeAvance($id_avance,$tipo,$id_empleado,$importe_avance,$id_moneda,$id_caja,$id_cajero);
