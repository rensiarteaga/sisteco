...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarViaticoCalculo.php
Propósito:				Permite eliminar registros de la tabla tts_viatico_calculo
...
$nombre_archivo = "ActionEliminarViaticoCalculo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarViaticoCalculo($id_viatico_calculo);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
