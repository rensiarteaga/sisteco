...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarRegistroConciliacion.php
Propósito:				Permite eliminar registros de la tabla tts_cheque
...
$nombre_archivo = "ActionEliminarRegistroConciliacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarRegistroConciliacion($id_cheque);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
