...
class PDF extends FPDF
{
	...
	function Header()
	{
	    ...
	    $this->Ln(3);
	    $this->Cell(0,4,'Estado Rendición: '.$_SESSION['PDF_estado_rendicion'],0,0,'C'); //dibuja una celad con contenido y orientacion  x, y 
		...
		$this->Ln(2);
 		...
 		$this->Cell(15,3,'RENDICIÓN','LRB',0,'C',true);  
 		$this->Cell(22,3,'RENDICIÓN','LRB',0,'C',true); 		 
 		$this->Cell(30,3,'','LRB',0,'C',true); 
 		$this->Cell(18,3,'RENDICIÓN','LRB',0,'C',true);  
...
/*$pdf->Ln(3);
		...
		$pdf->Ln(2);
 		...
 		$pdf->Cell(15,3,'RENDICIÓN','LRB',0,'C',true);  
 		$pdf->Cell(22,3,'RENDICIÓN','LRB',0,'C',true); 		 
