...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->Cell(200,5,'SOLICITUD DE VIAJE',0,1,'C');
...
//----------------------
		...
		$this->Cell(30,5,'Nº SOLICITUD:  ','L',0,'R');
		...
		$this->Cell(30,5,'MOTIVO DEL VIAJE:  ','L',0,'R');
...
//----------------------
		...
		$this->SetFillColor(200, 200, 200);	//Plomo oscuro
		$this->SetFont('Arial','B',8);
		$this->Cell(200,5,'INFORMACIÓN DE VIAJE','LTBR',1,'C',true);
...
//----------------------		
		...
		$this->Cell(30,5,'OBSERVACIÓN:  ','L',0,'R');	
