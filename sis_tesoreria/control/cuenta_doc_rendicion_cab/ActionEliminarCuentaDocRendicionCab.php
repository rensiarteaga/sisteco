...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCuentaDocRendicionCab.php
...
$nombre_archivo = "ActionEliminarCuentaDocRendicionCab.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCuentaDocRendicionCab($id_cuenta_doc);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
