...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEmisionFactura.php
Propósito:				Permite eliminar registros de la tabla tts_factura_recibo
...
$nombre_archivo = "ActionEliminarEmisionRecibo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEmisionRecibo($id_factura_recibo);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
