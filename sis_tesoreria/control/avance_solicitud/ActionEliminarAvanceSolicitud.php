...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarAvanceSolicitud.php
Propósito:				Permite eliminar registros de la tabla tts_avance
...
$nombre_archivo = "ActionEliminarAvanceSolicitud.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			$id_solicitud = $_GET["id_solicitud_compra_$j"];
		}
		else
		{
			$id_solicitud = $_POST["id_solicitud_compra_$j"];				
		}
		...
		{	//Eliminación
			$res = $Custom-> EliminarAvanceSolicitud($id_avance,$id_solicitud);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
