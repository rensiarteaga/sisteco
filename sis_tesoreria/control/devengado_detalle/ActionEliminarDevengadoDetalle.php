...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDevengadoDetalle.php
...
$nombre_archivo = "ActionEliminarDevengadoDetalle.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDevengadoDetalle($id_devengado_detalle);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
