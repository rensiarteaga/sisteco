...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCartaRegistro.php
Propósito:				Permite eliminar registros de la tabla tts_carta
Tabla:					tts_tts_carta
Parámetros:				$id_carta
...
$nombre_archivo = "ActionEliminarCartaRegistro.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCartaRegistro($id_carta);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
