 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tts_tts_tipo_destino
 * Autor:				(autogenerado)
 * Fecha creación:		2009-10-27 12:25:01
 */
...
class cls_DBTipoDestino
{
	...
	/**
	 * Nombre de la función:	ListarTipoDestino
	 * Propósito:				Desplegar los registros de tts_tipo_destino
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2009-10-27 12:25:01
	 */
	...
	/**
	 * Nombre de la función:	ContarTipoDestino
	 * Propósito:				Contar los registros de tts_tipo_destino
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2009-10-27 12:25:01
	 */
	...
	/**
	 * Nombre de la función:	InsertarTipoDestino
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tts_tipo_destino
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2009-10-27 12:25:01
	 */
	...
	/**
	 * Nombre de la función:	ModificarTipoDestino
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tts_tipo_destino
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2009-10-27 12:25:01
	 */
	...
	/**
	 * Nombre de la función:	EliminarTipoDestino
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tts_tipo_destino
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2009-10-27 12:25:01
	 */
	...
	/**
	 * Nombre de la función:	ValidarTipoDestino
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tts_tipo_destino
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2009-10-27 12:25:01
	 */
