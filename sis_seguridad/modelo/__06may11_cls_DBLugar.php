...
/*	    echo $this->query;
	 ...
	 * Fecha de creación:		2007-10-25 16:40:30
	 */
	function InsertarLugar($id_lugar,$fk_id_lugar,$nivel,$codigo,$nombre,$ubicacion,$telefono1,$telefono2,$fax,$observacion,$sw_municipio,$sw_impuesto)
	{
		$this->salida = "";
...
//		exit;
	 ...
	 * Fecha de creación:		2007-10-25 16:40:30
	 */
	function ModificarLugar($id_lugar,$fk_id_lugar,$nivel,$codigo,$nombre,$ubicacion,$telefono1,$telefono2,$fax,$observacion,$sw_municipio,$sw_impuesto)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tsg_lugar_iud';
