...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarRol.php
Propósito:				Permite eliminar registros de la tabla tsg_rol
Tabla:					tsg_tsg_rol
...
$nombre_archivo = "ActionEliminarRol.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarRol($hidden_id_rol);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
