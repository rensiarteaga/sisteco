...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarHistClave.php
Propósito:				Permite eliminar registros de la tabla tsg_hist_clave
Tabla:					tsg_tsg_hist_clave
Parámetros:				$hidden_id_hist_clave


Valores de Retorno:    	Número de registros
Fecha de Creación:		2007-10-26 17:45:46
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarHistClave.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarHistClave($hidden_id_hist_clave);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
