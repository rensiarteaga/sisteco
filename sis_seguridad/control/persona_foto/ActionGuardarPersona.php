...
/*	$hidden_id_persona = $HTTP_POST_FILES["id_persona"];
	...
	$hidden_id_tipo_doc_identificacion_value = $_POST["id_tipo_doc_identificacion_value"];
	$hidden_id_tipo_doc_identificacion = $_POST["id_tipo_doc_identificacion"];
	
	$foto_persona = $_HTTP_POST_FILES['foto_persona']['name'];
    $arch = $HTTP_POST_FILES['foto_persona']['tmp_name'];
    echo "persona:".$hidden_id_persona;
    
     $direccion = $f->carga_archivo($HTTP_POST_FILES['foto_persona'],'../../control/persona/archivo/' );
   if ($hidden_id_persona == "undefined" || $hidden_id_persona == "")
    ...
    $res = $Custom->InsertarPersonaFoto($hidden_id_persona,$txt_apellido_paterno,$txt_apellido_materno,
                                        ...
                                        $txt_hora_ultima_modificacion,$txt_observaciones,$hidden_id_tipo_doc_identificacion_value);
 		if(!$res)
			{
				//Se produjo un error
...
*/
			$res = $Custom->ModificarPersona($hidden_id_persona,$txt_apellido_paterno,$txt_apellido_materno,
                                        $txt_nombre,$txt_fecha_nacimiento,$HTTP_POST_FILES['foto_persona'],$txt_doc_id,
                                        $txt_genero,$txt_casilla,$txt_telefono1,$txt_telefono2,
                                        $txt_celular1,$txt_celular2,$txt_pag_web,$txt_email1,$txt_email2,$txt_email3,
                                        $txt_fecha_registro,$txt_hora_registro,$txt_fecha_ultima_modificacion,
