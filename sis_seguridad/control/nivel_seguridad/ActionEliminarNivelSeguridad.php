...
Propósito:				Permite eliminar registros de la tabla tsg_persona
...
$nombre_archivo = "ActionEliminarNivelSeguridad.php";
...
for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarNivelSeguridad($id_nivel_seguridad);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
