...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEnvioAlerta.php
Propósito:				Permite eliminar registros de la tabla tsg_envio_alerta
...
$nombre_archivo = "ActionEliminarEnvioAlerta.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEnvioAlerta($hidden_id_envio_alerta);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
