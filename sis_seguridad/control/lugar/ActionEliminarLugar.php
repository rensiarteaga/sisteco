...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarLugar.php
Propósito:				Permite eliminar registros de la tabla tsg_lugar
Tabla:					tsg_tsg_lugar
Parámetros:				$hidden_id_lugar
...
$nombre_archivo = "ActionEliminarLugar.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarLugar($hidden_id_lugar);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
