...
//Parámetros del filtro
	...
	if($txt_usuario>0){
		$criterio_filtro= $criterio_filtro ." AND LUGARR.id_lugar not in (select id_lugar from tsg_usuario_lugar where id_usuario=$txt_usuario)";
		
	}
	
	
	//06.2014
	if(isset($txt_municipio)){
		$criterio_filtro= $criterio_filtro ." AND LUGARR.sw_municipio=''$txt_municipio'' " ;
