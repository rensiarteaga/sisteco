...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarTipoDocIdentificacion.php
Propósito:				Permite eliminar registros de la tabla tsg_tipo_doc_identificacion
Tabla:					tsg_tsg_tipo_doc_identificacion
Parámetros:				$hidden_id_tipo_doc_identificacion
...
$nombre_archivo = "ActionEliminarTipoDocIdentificacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarTipoDocIdentificacion($hidden_id_tipo_doc_identificacion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
