...
Propósito:				Permite insertar y modificar datos en la tabla tsg_tipo_doc_identificacion
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_tipo_doc_identificacion == "undefined" || $hidden_id_tipo_doc_identificacion == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tsg_tipo_doc_identificacion
