...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarTareaPendiente.php
Propósito:				Permite eliminar registros de la tabla tsg_tarea_pendiente
...
$nombre_archivo = "ActionEliminarTareaPendiente.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarTareaPendiente($hidden_id_tarea_pendiente);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
