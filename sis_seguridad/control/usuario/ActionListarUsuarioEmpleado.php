...
$nombre_archivo = 'ActionListarUsuarioEmpleado.php';
...
//Parámetros del filtro
	...
	if($m_sw_presupuesto=='si')
	{
		$criterio_filtro= $criterio_filtro." and UNIORG.vigente=''si''  ";
	} 

	//Obtiene el total de los registros
	$res = $Custom -> ContarUsuarioEmpleado($cant ,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);

	if($res) $total_registros= $Custom->salida;

	//Obtiene el conjunto de datos de la consulta
	$res = $Custom->ListarUsuarioEmpleado($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
