...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarRegistroEvento.php
Propósito:				Permite eliminar registros de la tabla tsg_registro_evento
Tabla:					tsg_tsg_registro_evento
Parámetros:				$hidden_id_registro_eventos


Valores de Retorno:    	Número de registros
Fecha de Creación:		2007-10-26 16:05:03
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarRegistroEvento.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarRegistroEvento($hidden_id_registro_eventos);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
