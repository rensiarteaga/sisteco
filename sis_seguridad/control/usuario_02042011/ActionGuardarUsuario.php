...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{//echo $j;
			...
			$res = $Custom->ValidarUsuario("insert",$hidden_id_usuario, $txt_id_persona,$txt_login,$txt_contrasenia,$txt_fecha_registro,$txt_hora_registro,$txt_fecha_ultima_modificacion,$txt_hora_ultima_modificacion,$txt_estado_usuario,$txt_estilo_usuario,$txt_filtro_avanzado);
			...
			$res = $Custom -> InsertarUsuario($hidden_id_usuario, $txt_id_persona, $txt_login, $txt_contrasenia, $txt_fecha_registro, $txt_hora_registro, $txt_fecha_ultima_modificacion, $txt_hora_ultima_modificacion, $txt_estado_usuario, $txt_estilo_usuario, $txt_filtro_avanzado,$txt_fecha_expiracion);
		...
		else
		{
			...
			///////////////////////Modificación////////////////////
			  //Validación de datos (del lado del servidor)
					$res = $Custom->ValidarUsuario("update",$hidden_id_usuario, $txt_id_persona, $txt_login, $txt_contrasenia, $txt_fecha_registro, $txt_hora_registro, $txt_fecha_ultima_modificacion, $txt_hora_ultima_modificacion, $txt_estado_usuario, $txt_estilo_usuario, $txt_filtro_avanzado);
					if(!$res)
					{
						//Error de validación
						$resp = new cls_manejo_mensajes(true, "406");
					...
					$res = $Custom->ModificarUsuario($hidden_id_usuario, $txt_id_persona, $txt_login, $txt_contrasenia, $txt_fecha_registro, $txt_hora_registro, $txt_fecha_ultima_modificacion, $txt_hora_ultima_modificacion, $txt_estado_usuario, $txt_estilo_usuario, $txt_filtro_avanzado,$txt_fecha_expiracion);
					if(!$res)
					{
						//Se produjo un error
						$resp = new cls_manejo_mensajes(true, "406");
