...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			...
			$tipo= $_GET["tipo_$j"];
			$empleado_modifica=$_GET["empleado_modifica_$j"];
		...
		else
		{
			...
			$tipo= $_POST["tipo_$j"];
			$empleado_modifica=$_POST["empleado_modifica_$j"];
		}
...
*/       //13Abr11: para generar mail1 en funcionarios de acuerdo a estandar de creacion de correos
		...
		{	///////////////////////Modificación////////////////////
			...
			//echo $txt_foto_persona; exit;

			if($empleado_modifica==1){
