<?php
/**
 * Nombre:		  	    usuario_rol_det_main.php
 * Propósito: 			pagina que arranca la configuracion de la vista del Hijo
 * Autor:				Generado Automaticamente
 * Fecha creación:		2007-10-26 17:44:28
 *
 */
session_start();
?>
...
var elemento={idContenedor:idContenedor,pagina:new pagina_usuario_rol_det(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
...
// txt id_usuario
	...
	Formulario:{html_apply:'dlgInfo-'+idContenedor,height:'20%',
		width:'15%',columnas:['95%'],
