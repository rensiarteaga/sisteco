...
function pagina_usuario_rol_det(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
	...
	ds = new Ext.data.Store({
		...
		proxy: new Ext.data.HttpProxy({url: direccion+'../../../sis_seguridad/control/usuario_rol/ActionListarUsuarioRol_det.php'}),
    ...
    ds_rol = new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: direccion+'../../../sis_seguridad/control/rol/ActionListarRol_det.php'}),
			reader: new Ext.data.XmlReader({
			record: 'ROWS',
			id: 'id_rol',
			totalRecords: 'TotalCount'
...
// txt id_usuario
	...
	vectorAtributos[4]= {
		...
		filtro_0:false,
		filtro_1:false,
		filterColValue:'USUROL.descripcion',
		save_as:'descripcion',
		id_grupo:1
	};
	*/
	...
	var paramFunciones={
	btnEliminar:{url:direccion+'../../../sis_seguridad/control/usuario_rol/ActionEliminarUsuarioRol.php',parametros:'&m_id_usuario='+maestro.id_usuario},
	Save:{url:direccion+'../../../sis_seguridad/control/usuario_rol/ActionGuardarUsuarioRol.php',parametros:'&m_id_usuario='+maestro.id_usuario,
	success:miFuncionSuccess
	},
	ConfirmSave:{url:direccion+'../../../sis_seguridad/control/usuario_rol/ActionGuardarUsuarioRol.php'},
	...
	this.reload=function(params){
		...
		maestro.apellido_paterno=datos.apellido_paterno;
		maestro.apellido_materno=datos.apellido_materno;
