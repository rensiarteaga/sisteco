...
var maestro={id_tabla:<?php echo $m_id_tabla;?>,nombre:decodeURIComponent('<?php echo $m_nombre;?>'),desc_metaproceso:decodeURIComponent('<?php echo $m_desc_metaproceso;?>')};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_campo(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
