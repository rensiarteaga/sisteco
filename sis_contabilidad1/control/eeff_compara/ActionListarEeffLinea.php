...
//Parámetros del filtro
	...
	if($res)
	{
		...
		foreach ($Custom->salida as $f)
		{
			...
			$xml->add_nodo('id_cuenta_act',$f["id_cuenta_act"]);
			$xml->add_nodo('descta_act',$f["descta_act"]);
			$xml->add_nodo('id_cuenta_uno',$f["id_cuenta_uno"]);
			$xml->add_nodo('descta_ant',$f["descta_ant"]);
