...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarParametro.php
Propósito:				Permite eliminar registros de la tabla tct_parametro
...
$nombre_archivo = "ActionEliminarParametro.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarParametro($id_parametro);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
