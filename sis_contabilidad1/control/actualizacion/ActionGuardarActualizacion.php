...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			$id_actualizacion= $_GET["id_actualizacion_$j"];
		...
		{
			$id_actualizacion= $_POST["id_actualizacion_$j"];
		...
		if ($id_actualizacion == "undefined" || $id_actualizacion == "")
		{ 
			
			////////////////////Inserción/////////////////////

			//Validación de datos (del lado del servidor)
			//ValidarActualizacion($operacion_sql,$id_actualizacion,$id_depto,$fecha,$descripcion,$fecha_reg,$id_usuario,$id_moneda,$id_comprobante)
			$res = $Custom->ValidarActualizacion("insert",$id_actualizacion,$id_depto,$fecha,$descripcion,$fecha_reg,$id_usuario,$id_moneda,$id_comprobante);
			...
			$res = $Custom -> InsertarActualizacion($id_actualizacion,$id_depto,$fecha,$descripcion,$fecha_reg,$id_usuario,$id_moneda,$id_comprobante);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarActualizacion($id_actualizacion,$id_depto,$fecha,$descripcion,$fecha_reg,$id_usuario,$id_moneda,$id_comprobante);
