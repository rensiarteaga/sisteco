...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_plantilla_calculo == "undefined" || $id_plantilla_calculo == "")
		{
			...
			$res = $Custom -> InsertarPlantillaCalculo($id_plantilla_calculo, $id_plantilla,$tipo_cuenta,$id_ejercicio,$debe_haber,$porcen_calculo,$campo_doc,$sw_porcentaje,$sw_retencion,$sw_contabilizacion);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarPlantillaCalculo($id_plantilla_calculo, $id_plantilla,$tipo_cuenta,$id_ejercicio,$debe_haber,$porcen_calculo,$campo_doc,$sw_porcentaje,$sw_retencion,$sw_contabilizacion);
