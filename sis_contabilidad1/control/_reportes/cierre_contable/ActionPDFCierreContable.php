...
$nombre_archivo = 'ActionPDFCierreContable.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	$validacionLibroMayor = $Custom->ReporteCierreContable($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$ids_deptos,$fecha_ini,$fecha_fin);
