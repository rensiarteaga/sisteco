...
/*
**********************************************************
Nombre de archivo:	    ActionGuardarBeneificiarios.php
Propósito:				Permite insertar
Tabla:					tfv_beneficiarios_vejez
...
$nombre_archivo = 'ActionGuardarBeneficiariosGral.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	//{
		...
		$res = $Custom->InsertarBeneficiarios($dt_id_archivo_control,$dt_mes_periodo,$dt_anio_periodo);
