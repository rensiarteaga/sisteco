...
/**
**********************************************************
Nombre de archivo:	   ActionEliminarCuentaSigma.php
Propósito:				Permite eliminar registros de la tabla tct_cuenta_sigma
Tabla:					tct_cuenta
Parámetros:				$hidden_id_cuenta_sigma
...
$nombre_archivo = "ActionEliminarCuentaSigma.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCuentaSigma($hidden_id_cuenta_sigma);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
