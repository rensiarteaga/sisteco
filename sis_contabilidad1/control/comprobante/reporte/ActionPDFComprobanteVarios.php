...
include_once('../../../vista/registro_comprobante/PDFComprobanteVarios.php');
...
//Se obtiene el criterio del filtro con formato sql para mandar a la BD
	...
	//$count=0;	
	$InforComprobante = $Custom->ListarVariosCbte($cant,$puntero,$sortcol,$sortdir," 0=0 ",$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);		
	//var_dump($Custom->salida);
	foreach ($Custom->salida as $m){
		...
		$m_momento_cbte=$m['momento_cbte'];
	 	...
	 	$m_simbolo=$m['simbolo'];
	 	$m_id_comprobante=$m['id_comprobante'];
	 	$_SESSION['PDF_nombre_Archivo']=$m['nombre_archivo'];
	 	$Transaccion = array();
	    ...
	    $Comprobante = $Custom-> ReporteComprobante($cant,$puntero,$sortcol,$sortdir,"COMPROB.id_comprobante=$m_id_comprobante",$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
