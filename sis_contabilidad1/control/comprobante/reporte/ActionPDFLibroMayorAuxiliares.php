...
$nombre_archivo = 'ActionPDFLibroMayorAuxiliares.php';
...
//	$Comprobante = $Custom-> ReporteLibroMayor($cant,$puntero,$sortcol,$sortdir,' CUENTA.id_cuenta='.$id_cuenta,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
	...
	{   $id_comprobante=$f["id_comprobante"];
        ...
        $_SESSION['PDF_fecha_inicio']=$fecha_inicio;
        $_SESSION['PDF_fecha_fin']=$fecha_fin; 	}*/
 	$Transaccion = $Custom->ReporteLibroMayorDetalleAuxiliares($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$id_cuenta,$id_moneda,$fecha_inicio_b,$fecha_fin_b,$id_depto,$cuenta_ini,$cuenta_fin,$por_rango,$id_gestion);
 	
//echo $Custom->query;
//exit;
 	
    $_SESSION['PDF_transaccion_auxiliares']=$Custom->salida;
    
    header("location: ../../../vista/libro_mayor/PDFLibroMayorAuxiliares.php");
	}
else
	{
