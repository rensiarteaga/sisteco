...
$nombre_archivo = 'ActionPDFLibretaBancaria.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	//echo "       ".$m_sw_actualizacion;
	//exit;
	$res = $Custom->ListarLibretaBancaria(1000000,0,'fecha_libreta asc',$sortdir,'0=0',$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad,$m_id_cuenta_bancaria,$m_id_moneda,$m_fecha_inicio,$m_fecha_fin,$_SESSION['PDF_sw_actualizacion']);
	
     $_SESSION['PDF_libreta_bancaria']=$Custom->salida;
     
      //echo ($Custom->query); exit() ;
 /*   print_r($Custom->salida);
      exit;   */
    
    header("location: ../../../vista/libreta_bancaria/PDFLibretaBancaria.php");
	}
else
	{
