...
//	echo 'llega '; exit();
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	///////////////////////Modificación////////////////////
	 		if($tipo_cheque=='cheque'){
	 			$nro_cheque=$nro_cheque;
	 		}elseif ($tipo_cheque=='transferencia'){
	 			$nro_doc=$nro_transaccion;
	 		}else{
	 			$nro_doc=$nro_deposito;
	 		}
			$res = $Custom->ModificarChequeAnula($id_cheque,$estado_cheque,$nombre_cheque,$observaciones_anulacion,$tipo_cheque,$id_cuenta_bancaria,$nro_cheque,$fecha,$nro_doc);
