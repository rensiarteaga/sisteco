...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCheque.php
Propósito:				Permite eliminar registros de la tabla tct_cheque
...
$nombre_archivo = "ActionEliminarCheque.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCheque($id_cheque);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
