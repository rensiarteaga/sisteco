...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_transaccion == "undefined" || $id_transaccion == "")
		{
			...
			$res = $Custom -> InsertarGestionarRegistroTransacion($id_transaccion,$concepto_tran,$id_auxiliar ,$id_comprobante,$id_oec,$id_orden_trabajo,$id_partida,$id_cuenta,$id_presupuesto,$importe_debe,$importe_haber,$importe_gasto,$importe_recurso);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarGestionarRegistroTransacion($id_transaccion,$concepto_tran,$id_auxiliar ,$id_comprobante,$id_oec,$id_orden_trabajo,$id_partida,$id_cuenta,$id_presupuesto,$importe_debe,$importe_haber,$importe_gasto,$importe_recurso);
