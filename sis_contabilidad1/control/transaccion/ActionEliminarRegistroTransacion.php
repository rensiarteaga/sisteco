...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarRegistroTransacion.php
Propósito:				Permite eliminar registros de la tabla tct_transaccion
...
$nombre_archivo = "ActionEliminarRegistroTransacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarRegistroTransacion($id_transaccion);
	...
	$res = $Custom->ContarRegistroTransacion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$m_id_combrobante,$m_id_moneda);
