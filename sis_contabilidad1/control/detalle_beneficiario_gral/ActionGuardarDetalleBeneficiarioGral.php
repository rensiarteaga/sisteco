...
Propósito:				Permite insertar y modificar datos en la tabla tfv_detalle_beneficiario
...
$nombre_archivo = "ActionGuardarDetalleBeneficiarioGral.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_beneficiario_vejez == "undefined" || $id_beneficiario_vejez == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tfv_respuesta_reclamo
