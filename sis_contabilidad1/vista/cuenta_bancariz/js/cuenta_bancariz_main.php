<?php
/**
 * Nombre:		  	    cuenta_bancariz_main.php
...
var maestro={id_parametro:<?php echo $m_id_parametro;?>,id_gestion:<?php echo $m_id_gestion;?>};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_cuenta_bancariz(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
