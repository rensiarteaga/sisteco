 ...
 */
function paginaEstadoCuentaEpeUoOtCuentaAuxiliar(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
	...
	var ds = new Ext.data.Store({
		...
		proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/estadoCuentaEpeUoOtCuentaAuxiliar/estadoCuentaEpeUoOtCuentaAuxiliar.php'}),
...
function btn_imprimir(){
	var data='start=0';
		...
		window.open(direccion+'../../../control/estadoCuentaEpeUoOtCuentaAuxiliar/ActionEstadoEpeUoOtCuentaAuxiliar.php?'+data);
	}
	/*******************/
...
this.AdicionarBoton('../../../lib/imagenes/print.gif','Imprime el listado de la pantalla',btn_imprimir,true,'imprimir','Imprimir');
