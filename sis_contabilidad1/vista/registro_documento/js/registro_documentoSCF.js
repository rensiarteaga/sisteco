 ...
 */
function pagina_registro_documentoSCf(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
  ...
  var Documento = Ext.data.Record.create(['id_documento','nro_nit','nro_documento','nro_autorizacion','codigo_control','razon_social',{name: 'fecha_documento',type:'date',dateFormat:'Y-m-d'},'importe_total','importe_ice','importe_no_gravado','importe_sujeto','id_moneda','nombre']);
...
componentes_grid[8].on('blur',actualizarImportesBlur); 
componentes_grid[9].on('blur',actualizarImportesBlur); 
componentes_grid[10].on('blur',actualizarImportesBlur); 
};
