 ...
 */
function pagina_registro_documentoCDF(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
...
var_record.data.importe_debito=var_record.data.importe_sujeto*ds_parametro.getAt(0).data.porcen_iva/100;
