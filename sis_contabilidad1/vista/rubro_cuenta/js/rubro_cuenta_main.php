...
var maestro={
id_rubro:<?php echo $m_id_rubro;?>,
nombre_rubro:decodeURIComponent('<?php echo $m_nombre_rubro;?>'),
nombre_eeff:decodeURIComponent('<?php echo $m_nombre_eeff;?>')
};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_rubro_cuenta(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
