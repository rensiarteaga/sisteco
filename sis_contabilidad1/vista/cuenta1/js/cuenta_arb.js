function pagina_cuenta_arb(idContenedor,direccion,paramConfig){
   ...
   function btn_cuenta_auxiliar(){
		...
		if(!n || n.attributes.sw_transaccional==2){
			...
			layout_cuenta_arb.loadWindows(direccion+'../../../vista/cuenta_auxiliar/cuenta_auxiliar_det.php?'+data,'Auxiliar de Cuentas',Param)
			//layout_cuenta_arb.loadWindows(direccion+'../../../sis_kardex_personal/vista/historico_asignacion/historico_asignacion_det.php?'+data,'Auxiliar de Cuentas',Param)
			
			
			
			
			layout_cuenta_arb.getVentana().on('resize',function(){
				layout_cuenta_arb.getLayout().layout();
