...
function pagina_cuenta_arb(idContenedor,direccion,paramConfig){
	...
	Atributos[22]={
			validacion:{
				...
				fieldLabel:'Al debe',
				emptyText:'Partida...',
				store:ds_partida_gasto,
				desc:'codigo_partida',
				valueField:'id_partida_flu_debe',
				displayField:'codigo_partida',
				filterCol:'PARTID.codigo_partida',
				typeAhead:false,
				forceSelection:false,
				tpl:resultTplPartidaGasto,
				mode:'remote',
				queryDelay:50,
				pageSize:5,
				width:200,
	...
	Atributos[23]={
			validacion:{
				...
				desc:'codigo_partida',
				valueField:'id_partida_flu_haber',
				displayField:'codigo_partida',
				filterCol:'PARTID1.codigo_partida',
				typeAhead:false,
				forceSelection:false,
				tpl:resultTplPartidaRecurso,
				mode:'remote',
				queryDelay:50,
				pageSize:5,
				width:200,
   ...
   function btn_plan_cuenta(){
		var data='m_id_gestion='+g_id_gestion;
		//alert (g_id_gestion);
   ...
   gestion.on('select',function (combo, record, index){
	...
	this.AdicionarBoton('../../../lib/imagenes/print.gif','Plan de Cuentas Y Auxiliares',btn_plan_cuenta_auxiliar,true,'plan de cuenta y auxiliar','');
