/**
 * Nombre:		  	    pagina_bancarizacion_det.js
 * Propósito: 			pagina objeto principal
 * Autor:				Generado Automaticamente
 * Fecha creación:		2007-10-18 09:06:57
 */
function pagina_bancarizacion_det(idContenedor,direccion,paramConfig,idContenedorPadre){
	...
	ds=new Ext.data.Store({
		...
		reader:new Ext.data.XmlReader({record:'ROWS',id:'id_bancarizacion_det',totalRecords:'TotalCount'},
		[
		'id_lectura_depurada',
		'id_empleado',
		'codigo_empleado',
 ...
 /////////// txt observaciones //////
	vectorAtributos[1]={
		validacion:{
			...
			allowBlank:true,
			triggerAction:'all',
			store:new Ext.data.SimpleStore({fields:['ID','nombre'],data:Ext.marcasCombo.observaciones}),
			valueField:'ID',
			displayField:'nombre',
			lazyRender:true,
			forceSelection:true,
	...
	vectorAtributos[2]={
		validacion:{
			...
			triggerAction:'all',
			disabled:true,
			store:new Ext.data.SimpleStore({fields:['ID','nombre'],data:Ext.marcasCombo.turno}),
			valueField:'ID',
			displayField:'nombre',
			lazyRender:true,
			forceSelection:true,
   ...
   ///////// txt tipo_movimiento //////
	vectorAtributos[4]={
		validacion:{
			...
			disabled:false,
			triggerAction:'all',
			store:new Ext.data.SimpleStore({fields:['ID','nombre'],data:Ext.marcasCombo.tipo_movimiento}),
			valueField:'ID',
			displayField:'nombre',
			lazyRender:true,
			grid_visible:true,
