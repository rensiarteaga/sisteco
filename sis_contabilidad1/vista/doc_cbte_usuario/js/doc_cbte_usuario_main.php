...
var maestro={
		...
		id_periodo_subsistema:'<?php echo utf8_decode($m_id_periodo_subsistema);?>',
		nombre_largo:'<?php echo utf8_decode($m_nombre_largo);?>',
		desc_periodo:'<?php echo utf8_decode($m_desc_periodo);?>',	
		fecha_inicio:'<?php echo utf8_decode($m_fecha_inicio);?>',
		fecha_final:'<?php echo utf8_decode($m_fecha_final);?>'	
			};
  var idContenedorPadre='<?php echo $idContenedorPadre;?>';
  var elemento;

  elemento={idContenedor:idContenedor,pagina:new pagina_doc_cbte_usuario(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
