	...
	function Footer(){
		...
		if ($_SESSION['desc_clases']=='COMPROBANTE PAGO'){
			...
			if ($_SESSION[ss_id_usuario]!=131){
				...
				$firmas[1][2]='PARDO IRIARTE JAVIER ROLANDO';
				$firmas[1][3]='ESCRIVA VARGAS TERESA GUADALUPE';
				$firmas[1][4]='';
				$firmas[2][0]='';
				$firmas[2][1]='JEFE DIVISION CONTABILIDAD';
				$firmas[2][2]='RESPONSABLE DE GESTION ADMINISTRATIVA';
				$firmas[2][3]='JEFE DEPARTAMENTO RECURSOS HUMANOS';
				$firmas[2][4]='';
			}
