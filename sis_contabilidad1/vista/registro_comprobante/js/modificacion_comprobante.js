...
/************/ 
		...
		var ds_depto = new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: direccion+'../../../../sis_parametros/control/depto/ActionListarDepartamentoEPUsuario.php?subsistema=sci'}),
...
// txt glosa_cbte
	...
	var config={titulo_maestro:'registro_comprobante',grid_maestro:'grid-'+idContenedor,urlHijo:'../../../sis_contabilidad/vista/registro_transaccion/modificacion_transaccion.php'};
	...
	if (sw_vista=='validacionGenerados'||sw_vista=='validacionGeneradosAuxiliar'){var paramMenu={eliminar:{crear:true,separador:false},editar:{crear:true,separador:false},actualizar:{crear:true,separador:false}};}
...
if(id_subsistema==26){return 'PSPRO';}
	 ...
	 /*********************************************************************************/
if( sw_vista=='validacionGenerados'||sw_vista=='validacionGeneradosAuxiliar'){
	...
	function btn_validar(){
			...
			if(NumSelect!=0){
				...
				componentes[15].setValue('1');
				 // alert('llega a validacion='+componentes[0].getValue(););
			 	//  ClaseMadre_btnEdit();
			 	 ClaseMadre_save();	
				} });		
			}
...
if(sw_vista=='validacion'||sw_vista=='validacionGeneradosAuxiliar'){
	this.AdicionarBoton('../../../lib/imagenes/menu-show.gif','Todos',btn_todos,true,'todos','Todos');
 	this.AdicionarBoton('../../../lib/imagenes/menu-show.gif','Editar Transacción',btn_editar_transaccion,true,'todos','Editar Transacción');
	this.AdicionarBoton('../../../lib/imagenes/print.gif','Reporte Comprobante',btn_reporte_comprobante,true,'reporte_comprobante','');
 	this.AdicionarBoton('../../../lib/imagenes/menu-show.gif','Documento de Respaldo ',btn_documento_respaldo,true,'documento_respaldo','');
