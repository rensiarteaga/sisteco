...
function paginaConsolidacionPresupuesto(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
	...
	config_fuente_financiamiento={nombre:'Fuente de Financiamiento',descripcion:'denominacion',id:'id_fuente_financiamiento',selectAceptar:true,selectTodo:true,selectLimpiar:true,funcion:menuBotones};
	config_unidad_organizacional={nombre:'Unidad Organizacional',descripcion:'desc_unidad_organizacional',id:'id_unidad_organizacional',selectAceptar:true,selectTodo:true,selectLimpiar:true,funcion:menuBotones};
	...
	config_colectivo={nombre:'Concepto Colectivo',descripcion:'desc_colectivo',id:'id_concepto_colectivo',selectAceptar:true,selectTodo:true,selectLimpiar:false,funcion:menuBotones};
...
//DEFINICIÓN DE FUNCIONES
	...
	/**/
		...
		maestro.sw_vista=datos.m_sw_vista;
	 	/**/
	...
	maestro.id_moneda=datos.m_id_moneda;
		...
		this.btnActualizar();
		data_maestro=[['Presupuesto de ',maestro.desc_pres+tabular(44-maestro.desc_pres.length),'Moneda',maestro.desc_moneda+tabular(44-maestro.desc_moneda.length),'Gestión',maestro.gestion_pres+" "+maestro.desc_estado_gral+tabular(44-maestro.gestion_pres.length-maestro.desc_estado_gral.length)],
					   ['Estructura Programatica','Todos'] ,
					   ['Estructura Organizacional','Todos' ] ,
					   ['Fuente de Financiamiento','Todos']];
...
padre.AdicionarBoton('../../../lib/imagenes/print.gif',' ',btn_imprimir,true,'imprimir','Imprimir');															
