/**
 * Nombre:		  	    pagina_libro_mayor_partida_transacion.js
 * Propósito: 			pagina objeto principal
 * Autor:				ana maria
 * Fecha creación:		2008-12-8 17:57:09
 */
function pagina_libro_mayor_partida_transaccion(idContenedor,direccion,paramConfig,idContenedorPadre){
...
// txt concepto_tran
	...
	*///////////////////////////////////////////////////////////////
	...
	//var config={titulo_maestro:'Mayor Transacción',grid_maestro:'grid-'+idContenedor};
	
	var config={titulo_maestro:'Comprobante (Maestro)',titulo_detalle:'Detalle Transacción (Detalle)',grid_maestro:'grid-'+idContenedor};
	
	var layout_libro_mayor_partida_detalle=new DocsLayoutMaestro(idContenedor);
		
	layout_libro_mayor_partida_detalle.init(config);	
	...
	this.pagina(paramConfig,Atributos,ds,layout_libro_mayor_partida_detalle,idContenedor);
...
/*guardar:{crear:true,separador:false},
   ...
   this.reload=function(m,id_moneda){
	...
	this.getLayout=function(){return layout_libro_mayor_partida_detalle.getLayout()};
...
/**********************************************************************************/	
	...
	layout_libro_mayor_partida_detalle.getLayout().addListener('layout',this.onResize);
