<?php 
/**
 * Nombre:		  	    recuperacion_vejez_gral_main.php
...
var elemento={pagina:new pagina_recuperacion_vejez_gral(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
