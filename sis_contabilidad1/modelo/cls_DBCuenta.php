 ...
 * Prop�sito:			Permite ejecutar la funcionalidad de la tabla tct_cuenta
...
/*******************--------------------------------------------------------------*/	
	/**
	 * Nombre de la funci�n:	ListarCuenta
	...
	/**
	 * Nombre de la funci�n:	ContarCuenta
	...
	/**
	 * Nombre de la funci�n:	InsertarCuenta
	...
	/**
	 * Nombre de la funci�n:	ModificarCuenta
	...
	/**
	 * Nombre de la funci�n:	EliminarCuenta
	...
	/**
	 * Nombre de la funci�n:	ValidarCuenta
	 * Prop�sito:				Permite ejecutar la validaci�n del lado del servidor de la tabla tct_cuenta
	 * Autor:				    (autogenerado)
	 * Fecha de creaci�n:		2007-10-31 11:01:39
	 */
