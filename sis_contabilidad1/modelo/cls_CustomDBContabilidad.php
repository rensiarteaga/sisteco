...
class cls_CustomDBcontabilidad
{
	...
	function InsertarPlantillaCalculo($id_plantilla_calculo,$id_plantilla,$tipo_cuenta,$id_ejercicio,$debe_haber,$porcen_calculo,$campo_doc,$sw_porcentaje,$sw_rendicion,$sw_contabilizacion)
	{
		$this->salida = "";
		$dbPlantillaCalculo = new cls_DBPlantillaCalculo($this->decodificar);
		$res = $dbPlantillaCalculo ->InsertarPlantillaCalculo($id_plantilla_calculo,$id_plantilla,$tipo_cuenta,$id_ejercicio,$debe_haber,$porcen_calculo,$campo_doc,$sw_porcentaje,$sw_rendicion,$sw_contabilizacion);
		$this->salida = $dbPlantillaCalculo ->salida;
		$this->query = $dbPlantillaCalculo ->query;
		return $res;
	}
	
	function ModificarPlantillaCalculo($id_plantilla_calculo,$id_plantilla,$tipo_cuenta,$id_ejercicio,$debe_haber,$porcen_calculo,$campo_doc,$sw_porcentaje,$sw_rendicion,$sw_contabilizacion)
	{
		$this->salida = "";
		$dbPlantillaCalculo = new cls_DBPlantillaCalculo($this->decodificar);
		$res = $dbPlantillaCalculo ->ModificarPlantillaCalculo($id_plantilla_calculo,$id_plantilla,$tipo_cuenta,$id_ejercicio,$debe_haber,$porcen_calculo,$campo_doc,$sw_porcentaje,$sw_rendicion,$sw_contabilizacion);
		$this->salida = $dbPlantillaCalculo ->salida;
		$this->query = $dbPlantillaCalculo ->query;
		return $res;
	}
...
/// --------------------- tct_gestion --------------------- ///
   ...
   function ListarCuentaArb($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$agrupador,$gestion)
	...
	function InsertarCuentaArb($id_cuenta,$nro_cuenta,$nombre_cuenta,$desc_cuenta,$nivel_cuenta,$tipo_cuenta,$sw_transaccional,$id_cuenta_padre,$id_parametro,$id_moneda,$sw_oec,$sw_aux,$cuenta_sigma,$sw_sigma,$id_cuenta_actualizacion,$id_auxiliar_actualizacion,$sw_sistema_actualizacion,$id_cuenta_dif,$id_auxiliar_dif,$cuenta_flujo_sigma,$nota_eeff,$id_cuenta_sigma,$id_partida_flu_debe,$id_partida_flu_haber,$sw_caif,$sw_siet)
	{
		$this->salida = "";
		$dbCuentaArb = new cls_DBCuentaArb($this->decodificar);
		$res = $dbCuentaArb ->InsertarCuentaArb($id_cuenta,$nro_cuenta,$nombre_cuenta,$desc_cuenta,$nivel_cuenta,$tipo_cuenta,$sw_transaccional,$id_cuenta_padre,$id_parametro,$id_moneda,$sw_oec,$sw_aux,$cuenta_sigma,$sw_sigma,$id_cuenta_actualizacion,$id_auxiliar_actualizacion,$sw_sistema_actualizacion,$id_cuenta_dif,$id_auxiliar_dif,$cuenta_flujo_sigma,$nota_eeff,$id_cuenta_sigma,$id_partida_flu_debe,$id_partida_flu_haber,$sw_caif,$sw_siet);
		$this->salida = $dbCuentaArb ->salida;
		$this->query = $dbCuentaArb ->query;
		return $res;
	}
	function ModificarCuentaArb($id_cuenta,$nro_cuenta,$nombre_cuenta,$desc_cuenta,$nivel_cuenta,$tipo_cuenta,$sw_transaccional,$id_cuenta_padre,$id_parametro,$id_moneda,$sw_oec,$sw_aux,$cuenta_sigma,$sw_sigma,$id_cuenta_actualizacion,$id_auxiliar_actualizacion,$sw_sistema_actualizacion,$id_cuenta_dif,$id_auxiliar_dif,$cuenta_flujo_sigma,$nota_eeff,$id_cuenta_sigma,$id_partida_flu_debe,$id_partida_flu_haber,$sw_caif,$sw_siet)
	{
		$this->salida = "";
		$dbCuentaArb = new cls_DBCuentaArb($this->decodificar);
...
//añadido ana 19/11/2012 para el cierre contable
	...
	function InsertarEeffCom($id_eeff,$id_gestion_act,$id_gestion_ant,$eeff_texto,$mat_contador,$id_empleado_fc,$id_empleado_f1,$id_empleado_f2,$id_empleado_f3,$id_reporte_eeff,$id_moneda,$eeff_actual,$eeff_fecran,$eeff_nivel)
	{
		$this->salida = "";
		$dbEeffCom = new cls_DBEeffCompara($this->decodificar);
		$res = $dbEeffCom ->InsertarEeffCom($id_eeff,$id_gestion_act,$id_gestion_ant,$eeff_texto,$mat_contador,$id_empleado_fc,$id_empleado_f1,$id_empleado_f2,$id_empleado_f3,$id_reporte_eeff,$id_moneda,$eeff_actual,$eeff_fecran,$eeff_nivel);
		$this->salida = $dbEeffCom ->salida;
		$this->query = $dbEeffCom ->query;
		return $res;
	}
	
	function ModificarEeffCom($id_eeff,$id_gestion_act,$id_gestion_ant,$eeff_texto,$mat_contador,$id_empleado_fc,$id_empleado_f1,$id_empleado_f2,$id_empleado_f3,$id_reporte_eeff,$id_moneda,$eeff_actual,$eeff_fecran,$eeff_nivel)
	{
		$this->salida = "";
		$dbEeffCom = new cls_DBEeffCompara($this->decodificar);
		$res = $dbEeffCom ->ModificarEeffCom($id_eeff,$id_gestion_act,$id_gestion_ant,$eeff_texto,$mat_contador,$id_empleado_fc,$id_empleado_f1,$id_empleado_f2,$id_empleado_f3,$id_reporte_eeff,$id_moneda,$eeff_actual,$eeff_fecran,$eeff_nivel);
		$this->salida = $dbEeffCom ->salida;
		$this->query = $dbEeffCom ->query;
		return $res;
	}
	...
	function ValidarEeffCom($operacion_sql,$id_eeff,$id_gestion_act,$id_gestion_ant,$eeff_texto,$mat_contador,$id_empleado_fc,$id_empleado_f1,$id_empleado_f2,$id_empleado_f3,$id_reporte_eeff,$id_moneda,$eeff_actual,$eeff_fecran,$eeff_nivel)
	{
		$this->salida = "";
		$dbEeffCom = new cls_DBEeffCompara($this->decodificar);
		$res = $dbEeffCom ->ValidarEeffCom($operacion_sql,$id_eeff,$id_gestion_act,$id_gestion_ant,$eeff_texto,$mat_contador,$id_empleado_fc,$id_empleado_f1,$id_empleado_f2,$id_empleado_f3,$id_reporte_eeff,$id_moneda,$eeff_actual,$eeff_fecran,$eeff_nivel);
		$this->salida = $dbEeffCom ->salida;
		$this->query = $dbEeffCom ->query;
		return $res;
	}
