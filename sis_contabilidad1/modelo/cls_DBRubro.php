 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tct_tct_rubro
 * Autor:				(autogenerado)
...
class cls_DBRubro
{
	...
	/**
	 * Nombre de la función:	ListarRubro
	 * Propósito:				Desplegar los registros de tct_rubro
	 * Autor:				    (autogenerado)
	...
	/**
	 * Nombre de la función:	ContarRubro
	 * Propósito:				Contar los registros de tct_rubro
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-10-02 11:34:33
	 */
	...
	/**
	 * Nombre de la función:	InsertarRubro
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tct_rubro
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-10-02 11:34:33
	 */
	...
	/**
	 * Nombre de la función:	ModificarRubro
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tct_rubro
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-10-02 11:34:33
	 */
	...
	/**
	 * Nombre de la función:	EliminarRubro
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tct_rubro
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-10-02 11:34:33
	 */
	...
	/**
	 * Nombre de la función:	ValidarRubro
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tct_rubro
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-10-02 11:34:33
	 */
