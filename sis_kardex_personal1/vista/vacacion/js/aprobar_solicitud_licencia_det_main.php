...
var elemento={pagina:new pagina_aprobar_solicitud_licencia_det(idContenedor,direccion,paramConfig,idContenedorPadre),idContenedor:idContenedor};
 ...
 * Fecha creación:		2010-08-17 09:25:59
 */
function pagina_aprobar_solicitud_licencia_det(idContenedor,direccion,paramConfig,idContenedorPadre){
	var Atributos=new Array,sw=0;
	var elementos=new Array();
	var componentes=new Array;
	var layout_aprobar_solicitud_licencia_det;
	var maestro=new Array();
	var sw=0;
	//---DATA STORE
	var ds=new Ext.data.Store({
		proxy:new Ext.data.HttpProxy({url: direccion+'../../../control/vacacion/ActionListarAprobarSolicitudLicenciaDet.php?tipo=aprobar'}),
...
// txt total_dias
	...
	layout_aprobar_solicitud_licencia_det=new DocsLayoutMaestro(idContenedor,idContenedorPadre);
	layout_aprobar_solicitud_licencia_det.init(config);
	////////////////////////
	// INICIAMOS HERENCIA //
	////////////////////////
	this.pagina=Pagina;
	//-- pagina (array PARAMETROS DE CONFIGURACION, array DEFINICION DE ATRIBUTOS, SELECTION MODEL, DATA STORE, COLUM MODEL)
	this.pagina(paramConfig,Atributos,ds,layout_aprobar_solicitud_licencia_det,idContenedor);
	...
	this.getLayout=function(){return layout_aprobar_solicitud_licencia_det.getLayout()};
	...
	this.bloquearMenu();
	layout_aprobar_solicitud_licencia_det.getLayout().addListener('layout',this.onResize);//aregla la forma en que se ve el grid dentro del layout
