<?php 
/**
 * Nombre:		  	    solicitud_licencia_main.php
...
var elemento={pagina:new pagina_solicitud_licencia_rrhh(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);
/**
 * Nombre:		  	    pagina_solicitud_licencia_rrhh.js
 * Propósito: 			pagina objeto principal
 * Autor:				Generado Automaticamente
 * Fecha creación:		2007-10-18 09:06:57
 */
function pagina_solicitud_licencia_rrhh(idContenedor,direccion,paramConfig){
	...
	ds=new Ext.data.Store({
		...
		proxy:new Ext.data.HttpProxy({url:direccion+'../../../control/vacacion/ActionListarSolicitudLicencia.php?tipo=rrhh'}),
	...
	var ds_empleado = new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/empleado/ActionListarEmpleadoLicencia.php'}),
			reader:new Ext.data.XmlReader({record:'ROWS',id:'id_empleado',totalRecords: 'TotalCount'},['id_empleado','desc_persona','tipo_contrato'])
	    });
	...
	var paramFunciones={
		btnEliminar:{url:direccion+'../../../control/vacacion/ActionEliminarSolicitudLicencia.php',parametros:'&m_tipo='+g_tipo_contrato},
		Save:{url:direccion+'../../../control/vacacion/ActionGuardarSolicitudLicenciaG.php',parametros:'&m_tipo='+g_tipo_contrato},
		ConfirmSave:{url:direccion+'../../../control/vacacion/ActionGuardarSolicitudLicenciaG.php',parametros:'&m_tipo='+g_tipo_contrato},
  ...
  tipo_contrato.on('select',function (combo, record, index){g_tipo_contrato=tipo_contrato.getValue();
  	//carga datos XML
  ds.load({
		params:{
			start:0,
			...
			m_tipo_contrato:g_tipo_contrato
		}
	});	
  });
