...
if($_SESSION['PDF_total_reg'] > 1)
{
	...
	$total_x_tomar = $_SESSION['PDF_dias_disp'] + $suma;
}
else 
{
...
{
	$dias_gestion_ant = 0;
	$dias_gestion_act = $total_x_tomar;
}
else 
{
	$dias_gestion_act = 15;
	$dias_gestion_ant = $total_x_tomar - $dias_gestion_act;
}
...
$pdf->Cell(200,4,'INFORME DE ADMINISTRACION DE PERSONAL PARA VACACION',1,1,'C');

$pdf->SetFont('Arial','B',5);
$pdf->Cell(30,3,'FECHA DE INGRESO','TLR',0,'C');

$pdf->Cell(70,3,'ANTIGUEDAD','LTR',0,'C');
...
$pdf->SetXY(107,57);
$pdf->Cell(30,6,'Le corresponde tomar: ','L',0,'R');

$pdf->SetXY(137,57);
$pdf->Cell(10,6,$dias_gestion_ant,0,0,'C');

$pdf->SetXY(147,57);
$pdf->Cell(30,6,' días ',0,0,'L');

$pdf->SetXY(177,57);
$pdf->Cell(30,6,'Gestión: 2009 - 2010','R',1,'L');
...
$pdf->SetXY(137,60);
$pdf->Cell(10,6,$dias_gestion_act,0,0,'C');

$pdf->SetXY(147,60);
$pdf->Cell(30,6,' días ',0,0,'L');

$pdf->SetXY(177,60);
$pdf->Cell(30,6,'Gestión: 2010 - 2011','R',1,'L');
...
$pdf->SetXY(177,66);
$pdf->Cell(30,6,'Saldo: '.$_SESSION['PDF_dias_disp'],'R',1,'L');                                                   
...
$pdf->SetFont('Arial','B',5);
$pdf->Cell(50,15,'','LRB',0,'C');

$pdf->Cell(50,15,'','LRB',0,'C');

$pdf->Cell(50,15,'','LRB',0,'C');

$pdf->Cell(50,15,'','LRB',1,'C');
...
$pdf->SetFont('Arial','B',5);
$pdf->Cell(200,10,'OBSERVACIONES: ',1,1,'L');
