...
$pdf->Cell(10,4,'',0,0,'R');  		
$pdf->Cell(50,4,number_format($sum_salario_tram_jub,2),0,1,'R'); 
...
$pdf->Cell(10,4,'',0,0,'R');  		
$pdf->Cell(50,4,number_format($sum_devengado_may65,2),0,1,'R'); 
...
$pdf->Cell(50,4,''.number_format($total_salario_devengado * 0.1,2),0,1,'R'); 	 	

$pdf->Cell(100,4,'Total Seguro de Riesgo Comun',0,0); 	 		
$pdf->Cell(10,4,'1.71 %',0,0,'R');  		
//$pdf->Cell(50,4,''. number_format($v_afps[0][1],2),0,1,'R'); 	 	
$pdf->Cell(50,4,''. number_format($total_salario_devengadob * 0.0171,2),0,1,'R'); 	 	
...
$pdf->Cell(50,4,''. number_format($v_importe * 0.005,2),0,1,'R'); 	 	

$pdf->Cell(100,4,'Total Aporte Solidario:',0,0); 	 		
$pdf->Cell(10,4,'0.50 %','B',0,'R');  		
$pdf->Cell(50,4,''.number_format( $v_importe * 0.005,2),'B',1,'R'); 	 	
$pdf->SetFont('Arial','B',6);
...
$pdf->Cell(50,4,''.number_format( $v_importe * 0.02,2),0,1,'R'); 	 	

$pdf->Cell(100,4,'Total Aporte Solidario:',0,0); 	 		
$pdf->Cell(10,4,'3.00%','B',0,'R');  		
$pdf->Cell(50,4,''.number_format( $v_importe * 0.03,2),'B',1,'R'); 		 	
$pdf->SetFont('Arial','B',6);
