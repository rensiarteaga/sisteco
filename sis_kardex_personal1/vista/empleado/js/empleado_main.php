...
// txt fecha_nacimiento
	...
	var paramFunciones={
		...
		grupos:
			...
			{tituloGrupo:'Correo',columna:0,id_grupo:1}
	...
	if(tipo=='empleado'){
		...
		this.AdicionarBoton('../../../lib/imagenes/mail-forward.png','Correo',btn_correo,true,'Correo','Correo');
	}else{
