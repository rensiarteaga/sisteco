...
var elemento={idContenedor:idContenedor,pagina:new pagina_empleado_trabajo_hv(idContenedor,direccion,paramConfig,busqueda,idContenedorPadre)};
 ...
 * Fecha creación:		02-09-2010
 */
function pagina_empleado_trabajo_hv(idContenedor,direccion,paramConfig, busqueda,idContenedorPadre){
...
vectorAtributos[7]={
	...
	var config={titulo_maestro:'Trabajo',grid_maestro:'grid-'+idContenedor,urlHijo:'../../../sis_kardex_personal/vista/empleado_capacitacion/empleado_capacitacion.php?buscar=si',title_hijo:'Estudios Realizados'};	
	  ...
	  var config={titulo_maestro:'Trabajo',grid_maestro:'grid-'+idContenedor};	
		...
		layout_empleado_trabajo=new DocsLayoutMaestro(idContenedor,idContenedorPadre);
