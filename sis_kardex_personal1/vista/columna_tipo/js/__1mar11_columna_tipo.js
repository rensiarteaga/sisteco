...
{ 
	...
	var ds = new Ext.data.Store({
		...
		Atributos[9]= {
			...
			filtro_0:true,
			filtro_1:true,
			filterColValue:'AUXILIAR.nombre_auxiliar#AUXILIAR.codigo_auxiliar',
			defecto: '',
		...
		Atributos[21]= {
				validacion:{
					...
					loadMask:true,
					triggerAction:'all',
					store:new Ext.data.SimpleStore({fields:['id','valor'],data:Ext.columna_tipo_combo.movimiento_contable}), 	//llamada a _combo.js para cargar datos al combo
					valueField:'id',
					displayField:'valor',
					lazyRender:true,
					grid_visible:true,
		...
		Atributos[22]= {
				validacion:{
					...
					loadMask:true,
					triggerAction:'all',
					store:new Ext.data.SimpleStore({fields:['id','valor'],data:Ext.columna_tipo_combo.prorratea}), 	//llamada a _combo.js para cargar datos al combo
					valueField:'id',
					displayField:'valor',
					lazyRender:true,
					grid_visible:true,
