<?php
/**
 * Nombre:		  	    parametro_prorrateo_horas_main.php
...
var elemento={idContenedor:idContenedor,pagina:new pagina_parametro_prorrateo_horas(idContenedor,direccion,paramConfig,idContenedorPadre)};
