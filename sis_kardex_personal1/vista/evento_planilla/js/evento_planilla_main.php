<?php
/**
 * Nombre:		  	    evento_planilla_main.php
...
var elemento={idContenedor:idContenedor,pagina:new pagina_evento_planilla(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
