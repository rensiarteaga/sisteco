 ...
 * Propï¿½sito:			Permite ejecutar toda la funcionalidad de la tabla tkp_tkp_planilla
 * Autor:				avillegas
 * Fecha creaciï¿½n:		01/09/2010
 */
...
class cls_DBRepPlanilla
{
	...
	/**
	 * Nombre de la funciï¿½n:	ListarPlanilla la cabecera del reporte
	 * Propï¿½sito:				Desplegar los registros de tkp_planilla
	 * Autor:				    avillegas
	 * Fecha de creaciï¿½n:		01/09/2010
	 */ 
	...
	/**
	 * Nombre de la funciï¿½n:	ListarPlanilla suma de totales de la planilla
	 * Propï¿½sito:				Desplegar los registros de tkp_planilla
	 * Autor:				    avillegas
	 * Fecha de creaciï¿½n:		08/12/2010
	 */
	...
	/*	$this->var->add_def_cols('id',' VARCHAR'); 
		...
		/**
	 * Nombre de la funciï¿½n:	ListarPlanilla el detalle de columnas
	 * Propï¿½sito:				Desplegar los registros de tkp_planilla
	 * Autor:				    avillegas
	 * Fecha de creaciï¿½n:		03/09/2010
	 */
	...
	/**
	 * Nombre de la funciï¿½n:	ListarPlanillaAguinaldo el detalle de columnas
	 * Propï¿½sito:				Desplegar los registros de tkp_planilla
	 * Autor:				    avillegas
	 * Fecha de creaciï¿½n:		16/01/2012
	 */
...
/**
	 * Nombre de la funciï¿½n:	ListarPapeletaPrima el detalle de columnas
	 * Propï¿½sito:				Desplegar los registros de tkp_planilla
	 * Autor:				    avillegas
	 * Fecha de creaciï¿½n:		07/05/2013
	 */
	...
	/**
	 * Nombre de la funciï¿½n:	ListarSumPlanillaDet  detalle
	 * Propï¿½sito:				Desplegar los registros de tkp_planilla
	 * Autor:				    avillegas
	 * Fecha de creaciï¿½n:		21/01/2011
	 */
...
/**
	 * Nombre de la funciï¿½n:	ListarPlanillaImpositiva el detalle de columnas
	 * Propï¿½sito:				Desplegar los registros de tkp_planilla
	 * Autor:				    avillegas
	 * Fecha de creaciï¿½n:		01/02/2011
	 */
	...
	*/
	...
	/**
	 * Nombre de la funciï¿½n:	SumEmpleadoDistrito
	 * Propï¿½sito:				Desplegar los registros de tkp_planilla
	 * Autor:				    avillegas
	 * Fecha de creaciï¿½n:		25/03/2011
	 */
	...
	/**
	 * Nombre de la funciï¿½n:	ListarPlanillaDatosEmpleado el detalle de columnas
	 * Propï¿½sito:				Desplegar los registros de tkp_planilla
	 * Autor:				    avillegas
	 * Fecha de creaciï¿½n:		21/03/2011
	 */
	...
	/**
	 * Nombre de la funciï¿½n:	Asignaciones de empleados
	 * Propï¿½sito:				Desplegar los registros de tkp_planilla
	 * Autor:				    avillegas
	 * Fecha de creaciï¿½n:		10/04/2011
	 */
