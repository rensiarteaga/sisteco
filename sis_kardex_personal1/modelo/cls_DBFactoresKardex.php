 ...
 * Propósito:			Permite ejecutar la funcionalidad de la tabla tkp_FactoresKardex
...
class cls_DBFactoresKardex
{
	...
	/**
	 * Nombre de la función:	ListarFactoresKardex
	 * Propósito:				Desplegar los registros de tkp_FactoresKardex en función de los parámetros del filtro
	 * Autor:					Mercedes Zambrana Meneses
	...
	/**
	 * Nombre de la función:	ContarFactoresKardex
	...
	/**
	 * Nombre de la función:	InsertarFactoresKardex
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tkp_FactoresKardex
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		11-08-2010
	...
	/**
	 * Nombre de la función:	ModificarFactoresKardex
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tkp_FactoresKardex
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		11-08-2010
	 */
	...
	/**
	 * Nombre de la función:	EliminarFactoresKardex
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tkp_FactoresKardex
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		11-08-2010
	 */
	...
	/**
	 * Nombre de la función:	ValidarFactoresKardex
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tkp_FactoresKardex
	 * Autor:				    Mercedes Zambrana Meneses
	 * Fecha de creación:		11-08-2010
	 */
