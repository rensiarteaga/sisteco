...
Propósito:				Permite realizar el listado en tkp_Tipocapacitacion
...
//Parámetros del filtro
	...
	//filtro añadido para filtrar carreras en GEstion de Hoja de Vida (27jun11)
		...
		if($res)
	{
		...
		if($todos>0){
			...
			$xml->add_rama('ROWS');
			$xml->add_nodo('id_tipo_capacitacion', '-1');
			//$xml->add_nodo('id_persona','');
			$xml->add_nodo('nombre','NINGUNO');
			//$xml->add_nodo('codigo_empleado','Ninguno');
			$xml->add_nodo('descripcion','NINGUNO');
			$xml->add_nodo('carrera','NINGUNO');			
