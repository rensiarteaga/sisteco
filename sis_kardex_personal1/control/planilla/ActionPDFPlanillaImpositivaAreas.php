...
//Parámetros del filtro
	...
	//print_r()
	//;
	$res_detalle = $Custom->ListaPlanillaImpositivaAreas($cant,$puntero,$sortcol,$sortdir,' emppla.id_planilla='.$m_id_planilla,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
