...
$nombre_archivo = 'ActionPDFPlanillaAguinaldo.php';
  ...
  /*  echo $_GET["tipo_reporte"];
   ...
   // $m_id_planilla=47;
     if($_GET["tipo_planilla"]=='aguinaldo2'){
     	...
     	$titulo='PLANILLA SEGUNDO AGUINALDO - ESFUERZO POR BOLIVIA';
     }
     else{
	 	...
	 	switch ($_GET["tipo_reporte"]) {
      		...
      		case 'REP_AGUIN':
      	        ...
      	        $titulo='PLANILLA DE AGUINALDOS DEL PERSONAL';        
	...
	//if ($_GET["tipo_reporte"]=='AFCOOP' || $_GET["tipo_reporte"]=='APCOOP'){
		...
		$res_detalle = $Custom->ListarRepPlanillaAguinaldo($cant,$puntero,$sortcol,$sortdir,'0=0',$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$m_id_planilla);
	$_SESSION["PDF_lista_planilla_aguinaldo"]=$Custom->salida;
	
	
	header("location:../../vista/_reportes/planilla/PDFPlanillaAguinaldo.php");
	/*}
