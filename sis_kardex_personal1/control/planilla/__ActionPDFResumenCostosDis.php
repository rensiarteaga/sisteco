...
{    //Cargar los datos
	...
	{  
		...
		$suma_total_gral=0.00;
	        	    ...
	        	    $this->Cell($w[0],5,number_format($row[1],2),1,0,'L',$relleno);//desc_detalle
					$this->Cell($w[2],5,number_format($row[2],2),1,0,'L',$relleno);//desc_ret_incor
