...
/**
**********************************************************
Nombre de archivo:	    ActionGenerarPlanillaConsultores.php
...
$nombre_archivo = "ActionGenerarPlanillaConsultores.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_planilla == "undefined" || $id_planilla == "")
		{
			...
			echo "Es necesario seleccionar alguna planilla";
		}
		else
		{	///////////////////////Modificaci�n////////////////////
				...
				$res = $Custom->GenerarPlanillaConsultores($id_planilla);
