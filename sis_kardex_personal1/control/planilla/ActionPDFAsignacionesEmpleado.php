...
$nombre_archivo = 'ActionPDFAsignacionesEmpleado.php';
   ...
   // $res = $Custom->ListarRepPlanillaCab($cant,$puntero,$sortcol,$sortdir,"  planil.id_planilla=".$m_id_planilla,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	...
	// $puntero=79;
		 		/*  if ( is_null($m_id_empleado_planilla)){
		 			...
		 			$res_detalle = $Custom->ListaHistoricosAsignacionesEmpleado($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
					$_SESSION["PDF_asignacionesEmpleado"]=$Custom->salida;
			
			 header("location: ../../vista/_reportes/planilla/PDFAsignacionesEmpleado.php");
