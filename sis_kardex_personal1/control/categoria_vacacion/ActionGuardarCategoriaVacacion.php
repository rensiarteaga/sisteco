...
Propósito:				Permite insertar y modificar datos en la tabla tkp_categoria_vacacion
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_categoria_vacacion == "undefined" || $id_categoria_vacacion == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tkp_categoria_vacacion
