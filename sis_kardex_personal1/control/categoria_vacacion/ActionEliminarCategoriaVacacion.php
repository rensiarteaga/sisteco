...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCategoriaVacacion.php
Propósito:				Permite eliminar registros de la tabla tkp_categoria_vacacion
Tabla:					tkp_tkp_categoria_vacacion
Parámetros:				$id_categoria_vacacion
...
$nombre_archivo = "ActionEliminarCategoriaVacacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCategoriaVacacion($id_categoria_vacacion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
