...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_columna_tipo == "undefined" || $id_columna_tipo == "")
		{
			...
			$res = $Custom->ValidarColumnaTipo("insert",$id_columna_tipo,$id_parametro_kardex,$id_partida,$nombre,$valor,$tipo_dato,$id_moneda,$tipo_aporte,$estado_reg,$fecha_reg,$cotizable,$descripcion,$descuento_incremento,$observacion,$formula,$movimiento_contable,$prorrateo);
