...
Propósito:				Permite insertar y modificar datos en la tabla tkp_planilla
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_planilla == "undefined" || $id_planilla == "")
		{
			...
			//Validació			$id_usuario=$_POST["id_usuario_$j"];n de datos (del lado del servidor)
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tkp_planilla
		...
		{	///////////////////////Modificaciï¿½n////////////////////
			...
			}else{ echo "else isset"; exit;
			//Validaciï¿½n de datos (del lado del servidor)
