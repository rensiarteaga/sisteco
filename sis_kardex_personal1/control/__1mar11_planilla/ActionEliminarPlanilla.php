...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarPlanilla.php
Propósito:				Permite eliminar registros de la tabla tkp_planilla
...
$nombre_archivo = "ActionEliminarPlanilla.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarPlanilla($id_planilla);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
