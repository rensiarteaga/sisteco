...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarUnidadOrganizacional.php
Propósito:				Permite eliminar registros de la tabla tkp_unidad_organizacional
...
$nombre_archivo = "ActionEliminarUnidadOrganizacional.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarUnidadOrganizacional($hidden_id_unidad_organizacional);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
