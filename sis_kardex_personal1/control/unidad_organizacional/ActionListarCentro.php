...
//	exit;
	...
	{ 
     ...
     $CustomAdq= new cls_CustomDBAdquisiciones();
			...
			$xml->add_nodo('id_unidad_organizacional_aprueba',$var1[1]);
			$xml->add_nodo('id_uo_ppto',$var1[3]);
	       ...
	       $var_adq->add_param($_SESSION["ss_id_usuario"]);
		...
		if($cadena_adq[2]=='congelado'){
	        ...
	        $hora= $fecha_sep[0];
			 ...
			 $xml->add_nodo('id_gestion',$cadena_adq[9]); //8ago11
			$xml->fin_rama();
