...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarColumna.php
Propósito:				Permite eliminar registros de la tabla tkp_columna
...
$nombre_archivo = "ActionEliminarColumna.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarColumna($id_columna);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
