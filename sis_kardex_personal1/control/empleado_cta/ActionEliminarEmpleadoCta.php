...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEmpleado.php
Propósito:				Permite eliminar registros de la tabla tkp_empleado_cta
...
$nombre_archivo = "ActionEliminarEmpleadoCta.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEmpleadoCta($hidden_id_empleado_cta);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
