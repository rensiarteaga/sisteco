...
/**
**********************************************************
Nombre de archivo:	    ActionValidaResumen.php
...
$nombre_archivo = "ActionValidaResumen.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> ValidaResumen($id_resumen_horario_mes,$horas_disp,$horas_normales,$horas_extra,$horas_nocturnas);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
