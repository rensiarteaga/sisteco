...
/**
**********************************************************
Nombre de archivo:	    ActionProrrateaHorasTodos.php
...
$nombre_archivo = "ActionProrrateaHorasTodos.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> ProrrateaHorasTodos($id_planilla);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($cont>1) $mensaje_exito = "Se valido el resumen de marcas de todos";
