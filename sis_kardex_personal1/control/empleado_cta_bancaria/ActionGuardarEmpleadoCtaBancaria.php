...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_empleado_cta_bancaria == "undefined" || $id_empleado_cta_bancaria== "")
		{
			...
			$res = $Custom -> InsertarEmpleadoCtaBancaria($id_empleado_cta_bancaria, $id_empleado,$id_institucion,$nro_cuenta,$fecha_reg,$estado_reg,$fecha_asignacion,$fecha_finalizacion);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarEmpleadoCtaBancaria($id_empleado_cta_bancaria, $id_empleado,$id_institucion,$nro_cuenta,$fecha_reg,$estado_reg,$fecha_asignacion,$fecha_finalizacion);
