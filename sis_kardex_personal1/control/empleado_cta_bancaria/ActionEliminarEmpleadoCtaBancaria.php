...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEmpleadoCtaBancaria.php
Propósito:				Permite eliminar registros de la tabla tkp_empleado_cta_bancaria
...
$nombre_archivo = "ActionEliminarEmpleadoCtaBancaria.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEmpleadoCtaBancaria($id_empleado_cta_bancaria);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
