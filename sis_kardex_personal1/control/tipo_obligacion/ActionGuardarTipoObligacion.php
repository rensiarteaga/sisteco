...
$nombre_archivo = "ActionGuardarTipoObligacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_tipo_obligacion == "undefined" || $id_tipo_obligacion== "")
		{
			...
			$res = $Custom -> InsertarTipoObligacion($id_tipo_obligacion,$codigo,$nombre);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarTipoObligacion($id_tipo_obligacion,$codigo,$nombre);
