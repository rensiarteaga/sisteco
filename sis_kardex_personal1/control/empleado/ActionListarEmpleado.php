...
if($autorizacion=='si' ){
		...
		if ((isset($id_presupuesto) && $id_presupuesto!='') && (isset($id_empleado)&&$id_empleado!='')){
		...
		elseif ($tipo=='solicitud_compra'){
			...
			if ($tipo=='devengados'){
				...
				$criterio_filtro=$criterio_filtro." AND EMPLEA.id_empleado = ANY (param.f_pm_obtener_aprobador(null,NULL,$id_parametro,''$concepto'',$importe,$id_empleado)) ";
