...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarParametroCuentaAuxiliar.php
Propósito:				Permite eliminar registros de la tabla tkp_parametro_cuenta_auxiliar
Tabla:					tkp_parametro_cuenta_auxiliar
Parámetros:				$id_parametro_cuenta_auxiliar
...
$nombre_archivo = "ActionEliminarParametroCuentaAuxiliar.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarParametroCuentaAuxiliar($id_parametro_cuenta_auxiliar);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($sortcol == "") $sortcol = "id_parametro_cuenta_auxiliar";
