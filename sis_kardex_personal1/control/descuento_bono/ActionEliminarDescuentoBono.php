...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEmpleadoDescuentoBono.php
Propósito:				Permite eliminar registros de la tabla tkp_empleado_DescuentoBono
Tabla:					tkp_tkp_empleado_DescuentoBono
Parámetros:				$id_empleado_DescuentoBono
...
$nombre_archivo = "ActionEliminarDescuentoBono.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDescuentoBono($id_descuento_bono);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
