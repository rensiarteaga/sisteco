...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarTipoColumnaBase.php
Propósito:				Permite eliminar registros de la tabla tkp_tipo_columna_base
...
$nombre_archivo = "ActionEliminarTipoColumnaBase.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarTipoColumnaBase($id_tipo_columna_base);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
