...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEmpleadoTrabajo.php
Propósito:				Permite eliminar registros de la tabla tkp_EmpleadoTrabajo
Tabla:					tkp_empleado_trabajo
Parámetros:				$id_empleado_trabajo
...
$nombre_archivo = "ActionEliminarEmpleadoTrabajo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEmpleadoTrabajo($id_empleado_trabajo);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
