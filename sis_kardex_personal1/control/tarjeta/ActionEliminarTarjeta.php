...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarTarjeta.php
Propósito:				Permite eliminar registros de la tabla tkp_Tarjeta
Tabla:					tkp_tarjeta
...
$nombre_archivo = "ActionEliminarTarjeta.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarTarjeta($hidden_id_tarjeta);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
