...
//Parámetros del filtro
	...
	//exit;
	$criterio_filtro=$criterio_filtro. " and ob.id_planilla=".$id_planilla;
	...
	//$xml->add_nodo('foto_persona',$f["foto_persona"]);
		foreach ($Custom->salida as $f)
		{
			...
			$xml->add_nodo('obs_pago',$f["obs_pago"]);
			$xml->add_nodo('acreedor',$f["acreedor"]);
			$xml->add_nodo('id_gestion',$f["id_gestion"]);
			$xml->add_nodo('gestion',$f["gestion"]);
			//06.2014
			$xml->add_nodo('id_institucion_acreedor',$f["id_institucion_acreedor"]);
			$xml->add_nodo('desc_institucion_acreedor',$f["desc_institucion_acreedor"]);
