...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			...
			$pago_liquido= $_GET["pago_liquido_$j"];
		}
		else
		{
			...
			$pago_liquido= $_POST["pago_liquido_$j"];
		}
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarEmpleadoPlanilla($id_empleado_planilla,$id_empleado,$id_planilla,$pago_liquido);
