...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEmpleadoAfp.php
Propósito:				Permite eliminar registros de la tabla tkp_empleado_afp
...
$nombre_archivo = "ActionEliminarEmpleadoAfp.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEmpleadoCapacitacion($id_empleado_capacitacion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($sortcol == "") $sortcol = "id_empleado_capacitacion";
