...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarParametroCostoPlanilla.php
Propósito:				Permite eliminar registros de la tabla tkp_parametro_costo_planilla
...
$nombre_archivo = "ActionEliminarParametroCostoPlanilla.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarParametroCostoPlanilla($id_parametro_costo_planilla);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
