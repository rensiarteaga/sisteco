...
class cls_CustomDBAdquisiciones
{
	...
	$txt_nombre_pago,$txt_direccion_proveedor,$txt_telefono1_proveedor,$txt_telefono2_proveedor,$txt_mail_proveedor,$txt_fax_proveedor,$txt_casilla_proveedor,
    		...
    		$txt_email_contacto,$txt_tipo_contacto,$txt_id_contacto,$txt_con_contacto,$id_depto,$rubro,$rubro1,$rubro2)
	{
		$this->salida = "";
		$dbProveedor = new cls_DBProveedor($this->decodificar);
...
/// --------------------- tad_categoria_adq --------------------- ///
	...
	function InsertarCategoriaAdq($id_categoria_adq,$nombre,$observaciones,$descripcion,$fecha_reg,$precio_min,$precio_max,$id_moneda,$norma,$simplificada,$defecto)
	{
		$this->salida = "";
		$dbCategoriaAdq = new cls_DBCategoriaAdq($this->decodificar);
		$res = $dbCategoriaAdq ->InsertarCategoriaAdq($id_categoria_adq,$nombre,$observaciones,$descripcion,$fecha_reg,$precio_min,$precio_max,$id_moneda,$norma,$simplificada,$defecto);
		$this->salida = $dbCategoriaAdq ->salida;
		$this->query = $dbCategoriaAdq ->query;
		return $res;
	}
	
	function ModificarCategoriaAdq($id_categoria_adq,$nombre,$observaciones,$descripcion,$fecha_reg,$precio_min,$precio_max,$id_moneda,$norma,$simplificada,$defecto)
	{
		$this->salida = "";
		$dbCategoriaAdq = new cls_DBCategoriaAdq($this->decodificar);
		$res = $dbCategoriaAdq ->ModificarCategoriaAdq($id_categoria_adq,$nombre,$observaciones,$descripcion,$fecha_reg,$precio_min,$precio_max,$id_moneda,$norma,$simplificada,$defecto);
		$this->salida = $dbCategoriaAdq ->salida;
		$this->query = $dbCategoriaAdq ->query;
		return $res;
	}
...
/// --------------------- tad_solicitud_compra --------------------- ///
	...
	function ModificarCompraRapida($id_solicitud_compra,$codigo_proceso,$observaciones_proceso,$id_empresa,$pago_variable)
	{
		$this->salida = "";
		$dbSolicitudCompra = new cls_DBSolicitudCompra($this->decodificar);
		$res = $dbSolicitudCompra ->ModificarCompraRapida($id_solicitud_compra,$codigo_proceso,$observaciones_proceso,$id_empresa,$pago_variable);
		$this->salida = $dbSolicitudCompra ->salida;
		$this->query = $dbSolicitudCompra ->query;
		return $res;
	}
	...
	function ModificarCompraRapidaSimplificada($id_solicitud_compra,$codigo_proceso,$observaciones_proceso,$id_empresa,$id_comprador,$tipo_recibo)
	{
		$this->salida = "";
		$dbSolicitudCompra = new cls_DBSolicitudCompra($this->decodificar);
		$res = $dbSolicitudCompra ->ModificarCompraRapidaSimplificada($id_solicitud_compra,$codigo_proceso,$observaciones_proceso,$id_empresa,$id_comprador,$tipo_recibo);
		$this->salida = $dbSolicitudCompra ->salida;
		$this->query = $dbSolicitudCompra ->query;
		return $res;
	}
...
//	function ReporteCotizacion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	...
	function FinalizarCotizacionAdj($id_cotizacion,$observaciones,$id_proceso_compra,$estado_vigente,$id_empleado_adjudicacion,$justificacion_adjudicacion)
	{
		$this->salida = "";
		$dbCotizacion = new cls_DBCotizacion($this->decodificar);
		$res = $dbCotizacion ->FinalizarCotizacionAdj($id_cotizacion,$observaciones,$id_proceso_compra,$estado_vigente,$id_empleado_adjudicacion,$justificacion_adjudicacion);
		$this->salida = $dbCotizacion ->salida;
		$this->query = $dbCotizacion ->query;
		return $res;
	}
	...
	function FinalizarCotizacionDir($id_cotizacion,$retencion,$id_empresa,$num_factura,$fecha_factura,$id_caja,$id_cajero,$impuestos,$precio_total,$id_responsable_adjudicacion){
	    $this->salida = "";
		$dbCotizacion = new cls_DBCotizacion($this->decodificar);
		$res = $dbCotizacion ->FinalizarCotizacionDir($id_cotizacion,$retencion,$id_empresa,$num_factura,$fecha_factura,$id_caja,$id_cajero,$impuestos,$precio_total,$id_responsable_adjudicacion);
		$this->salida = $dbCotizacion ->salida;
		$this->query = $dbCotizacion ->query;
		return $res;
	}
...
//	function RepCotizacionDet($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	...
	function InsertarPlanPago($id_plan_pago,$tipo_pago,$nro_cuota,$fecha_pago,$monto,$estado,$id_cotizacion,$id_gestion,$id_avance,$por_anticipo,$por_retgar)
	{
		$this->salida = "";
		$dbPlanPago = new cls_DBPlanPago($this->decodificar);
		$res = $dbPlanPago ->InsertarPlanPago($id_plan_pago,$tipo_pago,$nro_cuota,$fecha_pago,$monto,$estado,$id_cotizacion,$id_gestion,$id_avance,$por_anticipo,$por_retgar);
		$this->salida = $dbPlanPago ->salida;
		$this->query = $dbPlanPago ->query;
		return $res;
	}
	
		function ModificarPlanPago($id_plan_pago,$tipo_pago,$nro_cuota,$fecha_pago,$monto,$estado,$id_cotizacion,$fecha_pagado,$num_factura,$observaciones,$boleta_garantia,$num_autoriza_factura,$cod_control_factura,$fecha_factura,$multas,$impuestos,$id_gestion,$id_avance,$por_anticipo,$por_retgar,$descuento_anticipo)
	{
		$this->salida = "";
		$dbPlanPago = new cls_DBPlanPago($this->decodificar);
		$res = $dbPlanPago ->ModificarPlanPago($id_plan_pago,$tipo_pago,$nro_cuota,$fecha_pago,$monto,$estado,$id_cotizacion,$fecha_pagado,$num_factura,$observaciones,$boleta_garantia,$num_autoriza_factura,$cod_control_factura,$fecha_factura,$multas,$impuestos,$id_gestion,$id_avance,$por_anticipo,$por_retgar,$descuento_anticipo);
		$this->salida = $dbPlanPago ->salida;
		$this->query = $dbPlanPago ->query;
		return $res;
	}
...
function ListarAdjudicacion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$id_cotizacion,$id_item,$id_servicio)
	...
	function ListarCotizacionAdjudicada($id_proceso_compra)
	{
		$this->salida = "";
		$dbAdjudicacion= new cls_DBAdjudicacion($this->decodificar);
		$res = $dbAdjudicacion->ListarCotizacionAdjudicada($id_proceso_compra);
		$this->salida = $dbAdjudicacion->salida;
		$this->query = $dbAdjudicacion->query;
		return $res;
	}
	...
	function InsertarProveedorCuentaDetalle($id_proveedor_cuenta_auxiliar,$id_proveedor,$id_cuenta,$id_auxiliar,$id_gestion,$tipo,$id_cuenta_anticipo,$id_cuenta_garantia)
	{
		$this->salida = "";
		$dbProveedorCuentaAuxiliar = new cls_DBProveedorCuentaAuxiliar($this->decodificar);
		$res = $dbProveedorCuentaAuxiliar ->InsertarProveedorCuentaDetalle($id_proveedor_cuenta_auxiliar,$id_proveedor,$id_cuenta,$id_auxiliar,$id_gestion,$tipo,$id_cuenta_anticipo,$id_cuenta_garantia);
		$this->salida = $dbProveedorCuentaAuxiliar ->salida;
		$this->query = $dbProveedorCuentaAuxiliar ->query;
		return $res;
	}
	
	function ModificarProveedorCuentaDetalle($id_proveedor_cuenta_auxiliar,$id_proveedor,$id_cuenta,$id_auxiliar,$id_gestion,$tipo,$id_cuenta_anticipo,$id_cuenta_garantia)
	{
		$this->salida = "";
		$dbProveedorCuentaAuxiliar = new cls_DBProveedorCuentaAuxiliar($this->decodificar);
		$res = $dbProveedorCuentaAuxiliar ->ModificarProveedorCuentaDetalle($id_proveedor_cuenta_auxiliar,$id_proveedor,$id_cuenta,$id_auxiliar,$id_gestion,$tipo,$id_cuenta_anticipo,$id_cuenta_garantia);
		$this->salida = $dbProveedorCuentaAuxiliar ->salida;
		$this->query = $dbProveedorCuentaAuxiliar ->query;
		return $res;
	}
	...
	function InsertarPlanillaDet($id_planilla,$id_plan_pago,$tipo_plantilla,$fecha_pagado,$num_factura,$fecha_factura,$por_anticipo,$por_retgar)
	{
		$this->salida = "";
		$dbPlanilla = new cls_DBPlanilla($this->decodificar);
		$res = $dbPlanilla ->InsertarPlanillaDet($id_planilla,$id_plan_pago,$tipo_plantilla,$fecha_pagado,$num_factura,$fecha_factura,$por_anticipo,$por_retgar);
		$this->salida = $dbPlanilla ->salida;
		$this->query = $dbPlanilla ->query;
		return $res;
	}
