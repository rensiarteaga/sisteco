...
class cls_CustomDBAdquisiciones
{
	...
	function InsertarProveedor($id_proveedor,$codigo,$observaciones,$fecha_reg,$id_institucion,$id_persona,$nombre_pago,$usuario,$contrasena,$confirmado,$id_cuenta,$id_auxiliar,$id_depto,$rubro,$rubro1,$rubro2)
	{
		$this->salida = "";
		$dbProveedor = new cls_DBProveedor($this->decodificar);
		$res = $dbProveedor ->InsertarProveedor($id_proveedor,$codigo,$observaciones,$fecha_reg,$id_institucion,$id_persona,$nombre_pago,$usuario,$contrasena,$confirmado,$id_cuenta,$id_auxiliar,$id_depto,$rubro,$rubro1,$rubro2);
		$this->salida = $dbProveedor ->salida;
		$this->query = $dbProveedor ->query;
		return $res;
	}
...
//	function RepCotizacionDet($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	...
	function InsertarPlanPago($id_plan_pago,$tipo_pago,$nro_cuota,$fecha_pago,$monto,$estado,$id_cotizacion,$id_gestion,$id_avance)
	{
		$this->salida = "";
		$dbPlanPago = new cls_DBPlanPago($this->decodificar);
		$res = $dbPlanPago ->InsertarPlanPago($id_plan_pago,$tipo_pago,$nro_cuota,$fecha_pago,$monto,$estado,$id_cotizacion,$id_gestion,$id_avance);
		$this->salida = $dbPlanPago ->salida;
		$this->query = $dbPlanPago ->query;
		return $res;
	}
	...
	function ModificarPlanPago($id_plan_pago,$tipo_pago,$nro_cuota,$fecha_pago,$monto,$estado,$id_cotizacion,$fecha_pagado,$num_factura,$observaciones,$boleta_garantia,$num_autoriza_factura,$cod_control_factura,$fecha_factura,$multas,$impuestos,$id_gestion,$id_avance)
	{
		$this->salida = "";
		$dbPlanPago = new cls_DBPlanPago($this->decodificar);
		$res = $dbPlanPago ->ModificarPlanPago($id_plan_pago,$tipo_pago,$nro_cuota,$fecha_pago,$monto,$estado,$id_cotizacion,$fecha_pagado,$num_factura,$observaciones,$boleta_garantia,$num_autoriza_factura,$cod_control_factura,$fecha_factura,$multas,$impuestos,$id_gestion,$id_avance);
		$this->salida = $dbPlanPago ->salida;
		$this->query = $dbPlanPago ->query;
		return $res;
	}
	...
	function FinalizarDefPagos($id_cotizacion)
	{
		$this->salida = "";
		$dbPlanPago = new cls_DBPlanPago($this->decodificar);
		$res = $dbPlanPago ->FinalizarDefPagos($id_cotizacion);
		$this->salida = $dbPlanPago ->salida;
		$this->query = $dbPlanPago ->query;
		return $res;
	}
...
function ListarAdjudicacion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$id_cotizacion,$id_item,$id_servicio)
	...
	function ListarSolEstadosTiemposDetalle($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$dbRepSolicitudesTiemposEstados = new cls_DBRepSolicitudesTiemposEstados($this->decodificar);
		$res = $dbRepSolicitudesTiemposEstados -> ListarSolEstadosTiemposDetalle($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
