...
class cls_DBPlanPago
{
	 ...
	 * Fecha de creaci�n:		2008-05-28 17:32:18
	 */
	function ModificarPlanPago($id_plan_pago,$tipo_pago,$nro_cuota,$fecha_pago,$monto,$estado,$id_cotizacion,$fecha_pagado,$num_factura,$observaciones,$boleta_garantia,$num_autoriza_factura,$cod_control_factura,$fecha_factura,$multas,$impuestos,$id_gestion,$id_avance,$por_anticipo,$por_retgar)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tad_plan_pago_iud';
