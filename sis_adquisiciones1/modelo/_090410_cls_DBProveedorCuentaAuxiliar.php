...
class cls_DBProveedorCuentaAuxiliar
{
	 ...
	 * Fecha de creación:		2008-12-16 16:05:57
	 */
	function InsertarProveedorCuentaDetalle($id_proveedor_cuenta_auxiliar,$id_proveedor,$id_cuenta,$id_auxiliar,$id_gestion,$tipo,$id_cuenta_anticipo,$id_cuenta_garantia,$id_cuenta_descuento)
	{
		$this->salida = "";
	 ...
	 * Fecha de creación:		2008-12-16 16:05:57
	 */
	function ModificarProveedorCuentaDetalle($id_proveedor_cuenta_auxiliar,$id_proveedor,$id_cuenta,$id_auxiliar,$id_gestion,$tipo,$id_cuenta_anticipo,$id_cuenta_garantia,$id_cuenta_descuento)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tad_proveedor_cuenta_auxiliar_iud';
