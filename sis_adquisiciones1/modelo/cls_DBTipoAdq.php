 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tad_tad_tipo_adq
 * Autor:				(autogenerado)
 * Fecha creación:		2008-05-07 15:34:51
 */
...
class cls_DBTipoAdq
{
	...
	/**
	 * Nombre de la función:	ListarTipoAdq
	 * Propósito:				Desplegar los registros de tad_tipo_adq
	 * Autor:				    (autogenerado)
	...
	/**
	 * Nombre de la función:	ContarTipoAdq
	 * Propósito:				Contar los registros de tad_tipo_adq
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-07 15:34:51
	 */
	...
	/**
	 * Nombre de la función:	InsertarTipoAdq
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tad_tipo_adq
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-07 15:34:51
	 */
	...
	/**
	 * Nombre de la función:	ModificarTipoAdq
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tad_tipo_adq
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-07 15:34:51
	 */
...
exit;*/
	...
	/**
	 * Nombre de la función:	EliminarTipoAdq
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tad_tipo_adq
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-07 15:34:51
	 */
	...
	function ValidarTipoAdq($operacion_sql,$id_tipo_adq,$nombre,$observaciones,$tipo_adq,$descripcion,$fecha_reg,$codigo)
	{
		...
		if($operacion_sql=='insert' || $operacion_sql=='update')
		{
         ...
         //Validar observaciones - tipo varchar
			...
			{
				$this->salida[0] = "f";
				$this->salida[1] = "Error de validación en columna 'tipo_adq': El valor no está dentro del dominio definido";
