...
$this->MultiCell(68,4,'JEFE DIVISION REDES Y TELECOMUNICACIONES',1,'L',1);	
}else{
...
$this->SetFont('Arial','',6);
if($_SESSION["ss_id_usuario"]==1200){
$this->MultiCell(68,4,'GTI - GERENCIA DE TECNOLOGIAS DE INFORMACIÓN',1,'L',1); 	
}else{
	  ...
	  // $_SESSION['PDF_nombre_aprobacion']
	   $this->Cell(70,3,'Usuario: '.$_SESSION["ss_nombre_usuario"],0,0,'L');
		...
		if($_SESSION['PDF_tipo_reporte']=='1'){
			...
			//if($_SESSION["ss_id_usuario"]==1200){
				//$this->Cell(70,3,'90e40953bbdbc070bda693856e4b991a5d9ab7d3',0,0,'L'); //20sep11: a pedido de Erios en sol de serv. 1/101 de NValdez
			//}else{
