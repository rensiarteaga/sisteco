...
function pagina_solicitud_compra_item_det(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
	...
	var ds = new Ext.data.Store({
		...
		'detalle','id_cuenta','desc_cuenta','id_partida','codigo_partida','almacenable','descripcion_item',{name: 'ultima_fecha',type:'date',dateFormat:'Y-m-d'},'precio_referencial_total_as'
		]),remoteSort:true});
	...
	Atributos[23]={
		validacion:{
			...
			store:new Ext.data.SimpleStore({
				fields:['ID', 'valor'],
				data:Ext.solicitud_compra_det_combo.almacenable
			}),
			valueField:'ID',
			displayField:'valor',
			lazyRender:true,
...
//			alert(maestro.tipo_cambio);
	  ...
	  var CalcularCostoTotal = function(e) {
		...
		//txt_precio.on('blur',CalcularCostoTotal);
...
//		if(maestro.id_moneda==maestro.id_moneda_base){
//			CM_ocultarComponente(getComponente('precio_referencial_moneda_seleccionada'));
//			CM_ocultarComponente(getComponente('precio_total_moneda_seleccionada'));
//			CM_mostrarComponente(getComponente('precio_referencial_estimado'));
//			CM_mostrarComponente(getComponente('precio_total_referencial'));
//		}
//		else{
//			CM_ocultarComponente(getComponente('precio_referencial_estimado'));
//			CM_ocultarComponente(getComponente('precio_total_referencial'));
//			CM_mostrarComponente(getComponente('precio_referencial_moneda_seleccionada'));
//			CM_mostrarComponente(getComponente('precio_total_moneda_seleccionada'));
//			getComponente('precio_referencial_moneda_seleccionada').enable();
//		}
	}
	...
	this.btnEdit=function(){
		...
		if(NumSelect!=0){
			...
			//getComponente().disable();
			//alert(SelectionsRecord.data.especificaciones_tecnicas);
