...
function pagina_solicitud_proceso_compra(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
	...
	var ds = new Ext.data.Store({
		...
		function cargar_maestro(){
			Ext.DomHelper.overwrite('grid_detalle-'+idContenedor,EstehtmlMaestro([['id_proceso_compra',maestro.id_proceso_compra],['Código de Proceso',maestro.codigo_proceso],['Moneda Proceso',maestro.desc_moneda],['Tipo Adquisición',maestro.desc_tipo_adq]]));
		}
		cargar_maestro();
