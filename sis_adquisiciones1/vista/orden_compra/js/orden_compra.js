...
*/
function pagina_orden_compra(idContenedor,direccion,paramConfig,tipo){
	...
	var ds = new Ext.data.Store({
	   ...
	   Atributos[3]={
		...
		var layout_orden_compra=new DocsLayoutMaestroDeatalle(idContenedor);
			...
			function btn_orden_compra(){
				...
				if(NumSelect!=0){
					...
					if(SelectionsRecord.data.pago_variable=='si'){
						layout_orden_compra.loadWindows(direccion+'../../../../sis_adquisiciones/vista/orden_compra_det/orden_compra_tasa.php?'+data,'Detalle - Orden de Compra',ParamVentana);
					}
					else{
