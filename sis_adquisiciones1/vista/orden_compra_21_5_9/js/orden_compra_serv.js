...
function pagina_orden_compra_serv(idContenedor,direccion,paramConfig){
	...
	var ds = new Ext.data.Store({
		...
		'desc_tipo_adq',
		'tipo_adq',
		'id_tipo_adq','id_proceso_compra_ant','num_convocatoria','numeracion_periodo_proceso','numeracion_periodo_cotizacion','num_sol_por_proc','id_depto','avance'
		]),remoteSort:true});
			...
			function btn_orden_compra(){
				...
				if(NumSelect!=0){
					...
					var ParamVentana={Ventana:{width:'90%',height:'70%'}}
						layout_orden_compra_serv.loadWindows(direccion+'../../../../sis_adquisiciones/vista/orden_compra_det/orden_compra_det.php?'+data,'Detalle - Orden de Compra',ParamVentana);
