...
{
	//$numero=$j+1;
	$pdf->MultiTabla($cabecera[$i1],1,3,3.5,7);
...
$pdf->SetFont('Arial','',6); 
$pdf->SetWidths(array(6,10,10,132,20,20));
...
//$pdf->Line(14);
$pdf->Cell(178,5,'SON: '.$_SESSION['PDF_precio_total_literal'].'',1,0);
...
$pdf->SetFillColor(200,200,200);
$pdf->SetFont('Arial','B',8); 
$pdf->Cell(25,5,'Observaciones',0,0);
$pdf->SetFont('Arial','',6); 
//$pdf->SetDrawColor(255,255,255);
