...
{    
 ...
 //$this->SetX(15);
$this->Cell(213,6,'COMPRAS EN PROCESO DE '.$_SESSION['PDF_titulo'].'',0,1,'C');
...
$this->Cell(9,3,'Nº','LTR',0,'C');  
 ...
 $this->Cell(78,3,'Descripción ','TR',0,'C');  
 $this->Cell(35,3,'Estructura ','TR',0,'C');  
 $this->Cell(40,3,'Unidad ','TR',0,'C');  
 $this->Cell(30,3,'Estado','TR',0,'C');  
 $this->Cell(10,3,'Dias','TR',1,'C'); 
  $this->Cell(9,3,'Sol.','LRB',0,'C');  
 $this->Cell(12,3,'Solicitud','RB',0,'C');  
 $this->Cell(78,3,'Solicitud Detalle','RB',0,'C');  
 $this->Cell(35,3,'Prográmatica','RB',0,'C');  
 $this->Cell(40,3,'Organizacional','RB',0,'C');  
...
function Footer()
{
 ...
 $pdf->SetWidths(array(9,12,78,35,40,30,10));
