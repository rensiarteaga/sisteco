...
function pag_sol_ser_personal(idContenedor,direccion,empleado,paramConfig){
	...
	var ds = new Ext.data.Store({
		...
		'id_orden_trabajo','desc_orden','id_uo_gerencia','id_empleado','id_depto','desc_depto','proveedores_propuestos','comite_calificacion','comite_recepcion','avance','id_avance','nro_avance','tipo_presu'
