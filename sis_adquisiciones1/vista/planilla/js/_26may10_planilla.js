...
function pagina_planilla(idContenedor,direccion,paramConfig){
	...
	var ds = new Ext.data.Store({
		...
		,'plantilla','desc_plantilla','id_moneda','total_pagos_con_doc','descripcion','prov_sin_cta'
		]),remoteSort:true});
		...
		var paramFunciones={
			...
			function btn_reporte_planilla(){
				...
				if(NumSelect!=0){
					...
					var data=data+'&m_descripcion='+SelectionsRecord.data.descripcion;
					var data=data+'&m_periodo='+SelectionsRecord.data.periodo;
					var data=data+'&m_gestion='+SelectionsRecord.data.gestion;
