 ...
 * Fecha ultima de modificación:  04/08/2009
 * Cambio de nombres de sessiones y es específico para Cotizaciones con un proveedor.
...
$pdf->Cell(63,5,$_SESSION['PDF_tipo_entrega'],1,0,'L',1);
$pdf->Cell(35,5,'Moneda:',0,0);
$pdf->Cell(63,5,'',1,1,'L',1);
$pdf->Cell(35,5,'Validez de la Oferta:',0,0);
$pdf->Cell(63,5,$_SESSION['PDF_tiempo_validez_oferta'],1,0,'L',1);
$pdf->Cell(35,5,'Lugar de Entrega:',0,0);
$pdf->MultiCell(63,5,$_SESSION['PDF_lugar_entrega_0'],1,'L',1);
