...
$monto_original=$_SESSION['PDF_monto_original'];
...
//echo $_SESSION['PDF_impuestos'];
		...
		*///$pdf->SetX(130);
		...
		$pdf->SetFont('Arial','',10);
		$pdf->Cell(45,5,number_format($_SESSION['PDF_monto_sin_ret']-$monto_original,2,'.',','),0,1,'R');
		$pdf->SetFont('Arial','B',10);
		...
		$pdf->SetFont('Arial','',10);
		$pdf->Cell(45,5,number_format($_SESSION['PDF_monto_no_pagado'],2,'.',','),0,1,'R');
