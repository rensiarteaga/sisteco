...
//echo $_SESSION['PDF_impuestos'];
		...
		*///$pdf->SetX(130);
		...
		$pdf->SetFont('Arial','',10);
		$pdf->MultiCell(120,5,'28/01/2011',0);
		...
		$pdf->SetFont('Arial','',10);
		$pdf->MultiCell(120,5,"Factura de Proyectos",0);
		$pdf->SetFont('Arial','B',10);
		...
		$pdf->SetFont('Arial','',10);
		$pdf->Cell(45,5,number_format('2470',2,'.',','),0,1,'R');
...
foreach ($data as $linea){
	...
	$pdf->SetFont('Arial','',6);
	$pdf->MultiCell(70,4,''.number_format('2470',2).'',1,'L',1); 
