...
Propósito:				Permite insertar y modificar datos en la tabla tad_proveedor_cuenta_auxiliar
Tabla:					tad_tad_proveedor_cuenta_auxiliar
Parámetros:				$id_proveedor_cuenta_auxiliar
						$id_proveedor
						$id_cuenta
						$id_auxiliar
						$id_gestion
...
Fecha de Creación:		2008-12-16 16:05:58
Versión:				1.0.0
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_proveedor_cuenta_auxiliar == "undefined" || $id_proveedor_cuenta_auxiliar == "")
		{
			...
			$res = $Custom->ValidarProveedorCuentaDetalle("insert",$id_proveedor_cuenta_auxiliar, $id_proveedor,$id_cuenta,$id_auxiliar,$id_gestion);
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tad_proveedor_cuenta_auxiliar
			$res = $Custom -> InsertarProveedorCuentaDetalle($id_proveedor_cuenta_auxiliar, $id_proveedor,$id_cuenta,$id_auxiliar,$id_gestion,$tipo);
		...
		{	///////////////////////Modificación////////////////////
			...
			//Validación de datos (del lado del servidor)
			$res = $Custom->ValidarProveedorCuentaDetalle("update",$id_proveedor_cuenta_auxiliar, $id_proveedor,$id_cuenta,$id_auxiliar,$id_gestion);
			...
			$res = $Custom->ModificarProveedorCuentaDetalle($id_proveedor_cuenta_auxiliar, $id_proveedor,$id_cuenta,$id_auxiliar,$id_gestion,$tipo);
