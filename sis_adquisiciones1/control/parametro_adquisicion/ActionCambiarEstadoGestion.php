...
/**
**********************************************************
Nombre de archivo:	    ActionCambiarEstadoGestion.php
...
$nombre_archivo = "ActionCambiarEstadoGestion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		else
		{
            ...
            $res = $Custom->ModificarParametroAdquisicionEstado($id_gestion_subsistema, $estado);
