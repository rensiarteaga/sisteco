	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		else
		{
			...
			$obs_descuento= $_POST["obs_descuentos_$j"];
				...
				$res = $Custom->InsertarPlanillaDet($m_id_planilla,$id_plan_pago,$tipo_plantilla,$fecha_pagado,$num_factura,$fecha_factura,$por_anticipo,$por_retgar,$multas,$obs_descuento);
				  if(!$res)
					{
						//Se produjo un error
						$resp = new cls_manejo_mensajes(true, "406");
