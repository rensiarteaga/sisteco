<?php
		...
		require_once('../../../../lib/lib_modelo/ReportDriver.php');
		 ...
		 switch ($tipo_impresion) {
    			...
    			$reporte=new ReportDriver('reporte_procesos_en_curso.jasper','COMPRO','pdf');
       			   break;
    			case '1':
    			$reporte=new ReportDriver('reporte_procesos_en_curso.jasper','COMPRO','rtf');
       				
       			 break;
    			case '2'://excel
    			$reporte=new ReportDriver('reporte_procesos_en_curso.jasper','COMPRO','xls');
     			break;
				}	
	...
	//	if($tipo_adq=='Servicio'){
		...
		$reporte->addParametro('i_tipo_pres',$tipo_presto);
	    ...
	    $reporte->addParametro('b_id_partida',$id_partida);
