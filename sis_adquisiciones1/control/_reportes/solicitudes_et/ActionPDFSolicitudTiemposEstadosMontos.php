...
$nombre_archivo = 'ActionPDFSolicitudTiemposEstadosMontos.php';
...
//Se obtiene el criterio del filtro con formato sql para mandar a la BD
  ...
  /*
   ...
   $UOCabecera = array();
	...
	$sortcol= " ((soldet.precio_referencial_estimado * soldet.cantidad))>$monto_min AND ((soldet.precio_referencial_estimado * soldet.cantidad))<$monto_max";
	$SETDetalle = $Custom->ListarSolicitudesEstadosTiemposMon($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$id_fina_regi_prog_proy_acti,$id_unidad_organizacional,$txt_fecha_desde,$txt_fecha_hasta,$tipo_adq);
	
	
	$_SESSION['PDF_SETDetalle']=$Custom->salida;
	

	 header("location: ../../../vista/_reportes/solicitudes_et/PDFSolicitudEstadosTiempos_x_SolicitudMontos.php");
	}
else
	{
