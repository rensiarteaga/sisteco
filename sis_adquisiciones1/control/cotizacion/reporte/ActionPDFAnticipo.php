...
$nombre_archivo = 'ActionPDFAnticipo.php';
...
//	exit;
	...
	$criterio_filtro=$criterio_filtro." AND COTIZA.id_cotizacion=$id_cotizacion_rep_anticipo";
	/*echo $id_cotizacion_rep_anticipo;
	exit;*/
	$Pago= array();
    $Pago = $Custom-> RepSolicitudAnticipo($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad,$m_id_plan_pago);
			...
			$Pago_detalle = $Custom-> RepSolicitudAnticipoDetalle($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad,$id_cotizacion_rep_anticipo);
			$_SESSION['PDF_EP_solicitud']=$Custom->salida;
			header("location: ../../../vista/cotizacion/PDFAnticipo.php");	
			}else{
				header("HTTP/1.0 401 No autorizado");
				header('Content-Type: text/html; charset=iso-8859-1');
				echo "<p><b><i><font 	size='+2' color=red  face='Arial'> No existe ningún Anticipo relacionado al registro </font></i></b></p>";
