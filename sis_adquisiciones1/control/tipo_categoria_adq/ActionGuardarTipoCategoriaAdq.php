...
Propósito:				Permite insertar y modificar datos en la tabla tad_tipo_categoria_adq
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_tipo_categoria_adq == "undefined" || $id_tipo_categoria_adq == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tad_tipo_categoria_adq
