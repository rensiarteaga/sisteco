...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarServicio.php
Propósito:				Permite eliminar registros de la tabla tad_servicio
...
$nombre_archivo = "ActionEliminarServicio.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarServicio($id_servicio);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
