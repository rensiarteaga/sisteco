...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			...
			$id_depto=$_GET["id_depto_$j"];//adicionado 26sep11: debido a que un usuario podrá pertenecer a varios deptos de compro
		}
		else
		{
...
$id_depto=$_POST["id_depto_$j"]; //adicionado 26sep11: debido a que un usuario podrá pertenecer a varios deptos de compro
		}
		...
		if ($id_proceso_compra == "undefined" || $id_proceso_compra == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tad_proceso_compra
			//adicionado 26sep11: en el lugar donde se enviaba id_tipo_Categoria_adq se enviará id_depto debido a que un usuario podrá pertenecer a varios deptos de compro
