...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarItemProveedor.php
Propósito:				Permite eliminar registros de la tabla tad_item_proveedor
Tabla:					tad_tad_item_proveedor
Parámetros:				$hidden_id_item_proveedor


Valores de Retorno:    	Número de registros
Fecha de Creación:		2008-04-30 12:29:45
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarItemProveedor.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarItemProveedor($hidden_id_item_proveedor);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
