...
Propósito:				Permite insertar y modificar datos en la tabla tad_item_proveedor
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_item_proveedor == "undefined" || $hidden_id_item_proveedor == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tad_item_proveedor
