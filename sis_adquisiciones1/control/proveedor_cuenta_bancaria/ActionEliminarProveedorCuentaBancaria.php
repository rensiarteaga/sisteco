...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarProveedorCuentaDetalle.php
Propósito:				Permite eliminar registros de la tabla tad_proveedor_cuenta_auxiliar
...
$nombre_archivo = "ActionEliminarProveedorCuentaBancaria.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarProveedorCuentaBancaria($id_proveedor_cuenta_bancaria);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
