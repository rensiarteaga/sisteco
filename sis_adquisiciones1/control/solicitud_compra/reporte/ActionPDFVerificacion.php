...
//Se obtiene el criterio del filtro con formato sql para mandar a la BD
	...
	*/
	...
	$solicitud_det = array();
		...
		$criterio_filtro=' 0=0 ';
		$criterio_filtro="$criterio_filtro AND s.id_solicitud_compra=$id_solicitud_compra";	
		
		$solicitud_det = $Custom-> ReportePartidaDetalle($cant,$puntero,'codigo_partida',$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
		if($tipo_adq=='Bien'){
		...
		$_SESSION['PDF_partida']=$Custom->salida;
		
	
			
			header("location: ../../../vista/verificacion_presupuestaria/PDFVerificacion.php");
	}
else
	{
