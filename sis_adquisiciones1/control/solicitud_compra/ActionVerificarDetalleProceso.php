...
$nombre_archivo = 'ActionVerificarDetalleProceso .php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	$res = $Custom -> VerificarDetalleProceso($id_solicitud_compra);

	if($res) $valor= $Custom->salida;
	if ($valor==null)$valor='no existe';
