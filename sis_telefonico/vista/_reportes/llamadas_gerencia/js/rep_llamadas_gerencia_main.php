...
var elemento={pagina:new GenerarReporteLlamadasGerencia(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);
function GenerarReporteLlamadasGerencia(idContenedor,direccion,paramConfig){
	var vectorAtributos=new Array;
	var ContPes=1;
	var layout_rep_llamadas_gerencia,ds_gerencia,h_txt_fecha_ini,h_txt_fecha_fin,cmb_gerencia,txt_id_gerencia,txt_nombre,txt_descripcion_gerencia,txt_codigo,txt_button;
	// ------------------  PARÁMETROS --------------------------//
...
///////// fecha_ini /////////
	...
	var config={titulo_maestro:"Llamadas por Gerencia"};
	layout_rep_llamadas_gerencia=new DocsLayoutProceso(idContenedor);
	layout_rep_llamadas_gerencia.init(config);
	//---------         INICIAMOS HERENCIA           -----------//
	this.pagina=BaseParametrosReporte;
    this.pagina(paramConfig,vectorAtributos,layout_rep_llamadas_gerencia,idContenedor);
	...
	function obtenerTitulo(){
		var titulo="Llamadas por Gerencia "+ContPes;
		ContPes ++;
		return titulo
	}
	...
	function gerencia(resp){
		...
		var paramFunciones={
		Formulario:{labelWidth:50,url:direccion+'../../../../../sis_telefonico/control/_reportes/llamadas_gerencia/ActionRptLlamadasGerencia.php',abrir_pestana:true,titulo_pestana:obtenerTitulo,fileUpload:false,columnas:[380,280],
