...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarLinea.php
Propósito:				Permite eliminar registros de la tabla tst_linea
Tabla:					tst_tst_linea
...
$nombre_archivo = "ActionEliminarLinea.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarLinea($hidden_id_linea);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($m_id_tipo_llamada =='undefined'|| $m_id_tipo_llamada == ""){
		$m_id_tipo_llamada=2;
	}
	
	if($criterio_filtro == "") $criterio_filtro = "TIPLLA.id_tipo_llamada=''$m_id_tipo_llamada''";
