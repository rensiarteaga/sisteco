...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarPlanLlamada.php
Propósito:				Permite eliminar registros de la tabla tst_plan_llamada
...
$nombre_archivo = "ActionEliminarPlanLlamada.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarPlanLlamada($id_plan_llamada);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
