function DetalleEjecucionPartida(idContenedor,direccion,paramConfig,configConsolidacion)
{
	...
	var id_moneda , id_parametro, id_presupuesto, id_partida, tipo_presupuesto, f_f,e_p_e,u_o;
	...
	function evento_presupuesto( combo, record, index )	{
		...
		componentes[4].store.baseParams={sw_traspaso:'si',m_id_presupuesto:record.data.id_presupuesto};
		componentes[4].modificado=true;		
		componentes[4].setValue('');
