...
var paramConfig={TamanoPagina:50,TiempoEspera:_CP.getConfig().ss_tiempo_espera,CantFiltros:1,FiltroEstructura:false,FiltroAvanzado:fa,idSub:decodeURI(idSub)};
var maestro={
...
var elemento={idContenedor:idContenedor,pagina:new paginaConsolidacionPresupuesto(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
