<?php
/**
 * Nombre:		  	    memoria_calculo_main.php
 * Propósito: 			pagina que arranca la configuracion de la vista del Hijo
 * Autor:				Generado Automaticamente
 * Fecha creación:		2008-07-10 09:08:18
 *
 */
session_start();
?>
...
var paramConfig={TamanoPagina:_CP.getConfig().ss_tam_pag,TiempoEspera:_CP.getConfig().ss_tiempo_espera,CantFiltros:1,FiltroEstructura:false,FiltroAvanzado:fa, grid_html:'grid-'+idContenedor};

//var paramConfig={TamanoPagina:20, 						TiempoEspera:10000000,						CantFiltros:1,	FiltroEstructura:false,	FiltroAvanzado:fa, grid_html:'grid-'+idContenedor};

var maestro={
			/*id_partida_presupuesto:decodeURIComponent(<?php echo utf8_decode($id_partida_presupuesto);?>),
			...
			tipo_memoria:decodeURIComponent('<?php echo utf8_decode($tipo_memoria);?>'),
			id_partida:decodeURIComponent('<?php echo utf8_decode($id_partida);?>'),
			desc_partida:decodeURIComponent('<?php echo utf8_decode($desc_partida);?>')*/
			
			/*id_partida_presupuesto:(<?php echo urldecode($id_partida_presupuesto);?>),
			...
			tipo_pres:decodeURIComponent('<?php echo $tipo_pres;?>'),
			desc_moneda:decodeURIComponent('<?php echo $desc_moneda;?>'),
			id_moneda:decodeURIComponent('<?php echo $id_moneda;?>'),
			tipo_memoria:decodeURIComponent('<?php echo $tipo_memoria;?>'),
			id_partida:decodeURIComponent('<?php echo $id_partida;?>'),
			desc_partida:decodeURIComponent('<?php echo $desc_partida;?>')*/
			...
			id_partida_presupuesto:decodeURI(<?php echo $id_partida_presupuesto;?>),
			...
			tipo_memoria:decodeURI('<?php echo $tipo_memoria;?>'),
			id_partida:decodeURI('<?php echo $id_partida;?>'),
			desc_partida:decodeURI('<?php echo $desc_partida;?>'),
		...
		/*	
			...
			tipo_memoria:'<?php echo $tipo_memoria;?>',
			id_partida:'<?php echo $id_partida;?>',
			desc_partida:'<?php echo $desc_partida;?>',
			tipo_vista:'<?php echo $tipo_vista?>'*/
			
			
			/*id_partida_presupuesto:<?php echo urldecode($id_partida_presupuesto);?>,
			id_presupuesto:'<?php echo urldecode($id_presupuesto);?>',
	     	nombre_financiador:'<?php echo urldecode($nombre_financiador);?>',
	     	nombre_regional:'<?php echo urldecode($nombre_regional);?>',
	     	nombre_programa:'<?php echo urldecode($nombre_programa);?>',
	     	nombre_proyecto:'<?php echo urldecode($nombre_proyecto);?>',
	     	nombre_actividad:'<?php echo urldecode($nombre_actividad);?>',
	     	desc_unidad_organizacional:'<?php echo urldecode($desc_unidad_organizacional);?>',
			tipo_pres:'<?php echo urldecode($tipo_pres);?>',
			desc_moneda:'<?php echo urldecode($desc_moneda);?>',
			id_moneda:'<?php echo urldecode($id_moneda);?>',
			tipo_memoria:'<?php echo urldecode($tipo_memoria);?>',
			id_partida:'<?php echo urldecode($id_partida);?>',
			desc_partida:'<?php echo urldecode($desc_partida);?>'
*/
};
idContenedorPadre='<?php echo $idContenedorPadre;?>';

var elemento={idContenedor:idContenedor,pagina:new pagina_memoria_calculo(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
 ...
 * Autor:				Generado Automaticamente
 * Fecha creaciï¿½n:		2008-07-10 09:08:18
 */
...
{	
	...
	function render_moneda(value)
	{
		...
		if(value == 2){return "Dï¿½lares Americanos"}
	...
	var config={titulo_maestro:'Detalle de Partida Gasto (Maestro)',titulo_detalle:'Memoria de Cï¿½lculo (Detalle)',grid_maestro:'grid-'+idContenedor};
	...
	Formulario:{html_apply:'dlgInfo-'+idContenedor,height:340,width:480,minWidth:150,minHeight:200,	closable:true,titulo:'Memoria de Cï¿½lculo',
	grupos:[{
				tituloGrupo:'Datos Memoria Cï¿½lculo',
				columna:0,
				id_grupo:0
			},
			{
...
//Fin codigo de bloqueo de botones
	...
	this.AdicionarBoton('../../../lib/imagenes/list-items.gif','Memoria de Viï¿½ticos',btn_memoria_viaticos,false,'Viajes','Memoria de Viï¿½ticos');
