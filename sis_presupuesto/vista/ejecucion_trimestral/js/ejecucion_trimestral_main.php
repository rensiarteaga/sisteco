...
var elemento ={pagina:new EjecucionTrimestral(idContenedor,direccion,paramConfig,configConsolidacion),idContenedor:idContenedor};
...
function EjecucionTrimestral(idContenedor,direccion,paramConfig,configConsolidacion)
{   
	...
	vectorAtributos[4]=
	{
			validacion:{
				...
				loadMask:true,
				triggerAction:'all',
				store:new Ext.data.SimpleStore({fields:['id','valor'],data:[['1','Anual'],['2','Trimestral'],['3','Mensual'],['4','Mensual Acumulado']]}),				
				valueField:'id',
				displayField:'valor',
				lazyRender:true,								
				forceSelection:true,
	...
	vectorAtributos[9]=
	{
		validacion:{
			...
			loadMask:true,
			triggerAction:'all',
			store:new Ext.data.SimpleStore({fields:['id','valor'],data:[['1','PDF'],['2','Excel'] ]}),	   //solo el reportes trimestral existe en formato Excel.	
			valueField:'id',
			displayField:'valor',
			lazyRender:true,								
			forceSelection:true,				
		...
		Formulario:{
			...
			{					
				...
				{	//alert (g_id_partida);					
					...
					{
						window.open(direccion+'../../../control/_reportes/ejecucion_trimestral/ActionPDFEjecucionMensual.php?'+data);						
					}
				}
				else
				{
