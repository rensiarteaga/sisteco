<?php
/**
 * Nombre:		  	    estado_autorizado_main.php
...
var paramConfig={TamanoPagina:_CP.getConfig().ss_tam_pag,TiempoEspera:_CP.getConfig().ss_tiempo_espera,CantFiltros:0,FiltroEstructura:false,FiltroAvanzado:fa};
var maestro={
	id_usuario_autorizado:'<?php echo utf8_decode($m_id_usuario_autorizado);?>',
	desc_usuario:'<?php echo $m_desc_usuario;?>',
	desc_unidad_organizacional:'<?php echo utf8_decode($m_desc_unidad_organizacional);?>'};
	idContenedorPadre='<?php echo utf8_decode($idContenedorPadre);?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_estado_autorizado(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
