<?php 
/**
 * Nombre:		  	    autorizacion_presupuesto_main.php
...
var elemento={pagina:new pagina_autorizacion_presupuesto(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
function pagina_autorizacion_presupuesto(idContenedor,direccion,paramConfig){
	...
	var ds_unidad_organizacional = new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: direccion+'../../../../sis_kardex_personal/control/unidad_organizacional/ActionListarUnidadOrganizacional.php?m_sw_presupuesto=si_apre'}),
