...
function pagina_carga_excel(idContenedor, direccion, paramConfig, sw_vista) {
	...
	vectorAtributos[0]={
			validacion: {
				...
				loadMask:true,
				triggerAction:'all',
				store:new Ext.data.SimpleStore({fields:['ID','valor'],data:[['extracto_bancario','Extracto Bancario'],['partidas','Partidas'],['oec','OEC'],['reversiones','Reversiones'],['asoc_eb','Asociaciones de Extractos Bancarios']]}),
				valueField:'ID',
				displayField:'valor',
				lazyRender:true,
				forceSelection:true,
