...
var elemento ={pagina:new EjecucionReporte(idContenedor,direccion,paramConfig,configConsolidacion),idContenedor:idContenedor};
...
function EjecucionReporte(idContenedor,direccion,paramConfig,configConsolidacion)
{
	...
	vectorAtributos[2]={
			validacion:{
				...
				loadMask:true,
				triggerAction:'all',
				store:new Ext.data.SimpleStore({fields:['id','valor'],data:[['1','Presupuesto'],['2','Categoría Programática']]}),  //,['3','Fuente de Financiamiento y Organismo Financiador ']
				valueField:'id',
				displayField:'valor',
				lazyRender:true,								
				forceSelection:true,
