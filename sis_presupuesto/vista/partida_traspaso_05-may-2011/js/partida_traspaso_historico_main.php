<?php 
/**
 * Nombre:		  	    partida_traspaso_historico_main.php
...
var elemento={pagina:new pagina_partida_traspaso_historico(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
