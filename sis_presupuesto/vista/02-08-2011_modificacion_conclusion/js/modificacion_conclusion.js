...
function pagina_modificacion_conclusion(idContenedor,direccion,paramConfig)
{
	...
	var ds = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/modificacion/ActionListarModificacion.php?conclusion=si'}),
...
// txt fecha_conclusion
	...
	function btnDetalleModificaciones()
	{
		...
		if(NumSelect!=0)
		{
			...
			layout_modificacion_conclusion.loadWindows(direccion+'../../../../sis_presupuesto/vista/partida_modificacion_orig/partida_modificacion_orig.php?'+data,'Disminuciones',ParamVentana);
