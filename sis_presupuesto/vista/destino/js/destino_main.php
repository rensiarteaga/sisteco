...
var maestro={
	...
	desc_categoria:decodeURIComponent('<?php echo utf8_decode($m_desc_categoria);?>')
	};
	
idContenedorPadre='<?php echo utf8_decode($idContenedorPadre);?>';
	
var elemento={idContenedor:idContenedor,pagina:new pagina_destino(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
