...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarMemoria.php
Propósito:				Permite eliminar registros de la tabla tpr_mem_pasaje
Tabla:					tpr_tpr_mem_pasaje
Parámetros:				$id_mem_pasaje
...
$nombre_archivo = "ActionEliminarMemoriaPasaje.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarMemoriaPasaje($id_mem_pasaje);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
