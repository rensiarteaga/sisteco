...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarPartida.php
Propósito:				Permite eliminar registros de la tabla tpr_partida
...
$nombre_archivo = "ActionEliminarPartida.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarPartida($id_partida);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
