...
//Parámetros del filtro
	...
	if($filtro_aprobacion=='si')
	{		 
		$criterio_filtro=$criterio_filtro." and PARTRA.estado_traspaso in (3,5,6) and PARTRA.tipo_traspaso not in (3)";	//filtramos los traspasos en estado autorizacion sin filtrar por usuario
		...
		/*$criterio_filtro=$criterio_filtro." and (USUARI.id_usuario=".$_SESSION["ss_id_usuario"]." and PARTRA.estado_traspaso in (5) and PARTRA.tipo_traspaso not in (3))	
											or	(USUARI2.id_usuario=".$_SESSION["ss_id_usuario"]." and PARTRA.estado_traspaso in (6) and PARTRA.tipo_traspaso not in (3))	
											or  (USUARI.id_usuario=".$_SESSION["ss_id_usuario"]." and PARTRA.estado_traspaso in (3) and PARTRA.tipo_traspaso not in (3))";	//3=autorizacion  5=autorizacion origen 6=autorizacion destino
		*/
	}	
	else 
	{
