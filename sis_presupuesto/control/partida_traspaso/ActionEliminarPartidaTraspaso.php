...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarPartidaTraspaso.php
Propósito:				Permite eliminar registros de la tabla tpr_partida_traspaso
...
$nombre_archivo = "ActionEliminarPartidaTraspaso.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarPartidaTraspaso($id_partida_traspaso);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
