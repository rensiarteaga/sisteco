...
$nombre_archivo = 'ActionListarPartidaIngresoArb.php';
...
if($_SESSION['autentificado']=='SI')
{
	...
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,'PartidaIngresoArb');
	...
	if($node=='id'){
		...
		$res = $Custom->ListarPartidaIngresoRaiz($cant,$puntero,'id_partida desc','desc',$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad,$gestion);
	...
	else
	{
		...
		if($res)
		{
			foreach ($Custom->salida as $f)
			{
				...
				//$tmp['qtip'] = "TIPO DE MOVIMIENTO: ".$tmp['movimiento']." <br \/>DESCRIPCION: ".$tmp["desc_partida"];
