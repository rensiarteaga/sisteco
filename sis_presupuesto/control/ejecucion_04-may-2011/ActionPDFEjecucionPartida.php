...
//Se obtiene el criterio del filtro con formato sql para mandar a la BD
	...
	$SETDetalle = $Custom->ListarEjecucionPorPartida($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$fecha_fin,$tipo_pres1,$id_moneda);
