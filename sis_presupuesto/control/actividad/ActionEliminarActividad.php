...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarActividad.php
Propósito:				Permite eliminar registros de la tabla tpr_actividad
Tabla:					tpr_tpr_actividad
...
$nombre_archivo = "ActionEliminarActividad.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarActividad($id_actividad);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
