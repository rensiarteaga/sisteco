...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarFormulacionPresupuesto.php
Propósito:				Permite eliminar registros de la tabla tpr_presupuesto
...
$nombre_archivo = "ActionEliminarFormulacionPresupuesto.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarFormulacionPresupuesto($id_presupuesto);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
