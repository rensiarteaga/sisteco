...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		else if($sw_generacion==1)
		{
			...
			$res = $Custom->InsertarFormulacionPresupuestoPlantilla($id_presupuesto,$tipo_pres,$estado_pres,$id_unidad_organizacional,$id_fuente_financiamiento,$id_parametro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		...
		else if($id_concepto_colectivo>0)
		{
			...
			$res = $Custom->InsertarPresupuestoColectivoPartida($id_presupuesto,$tipo_pres,$estado_pres,$id_unidad_organizacional,$id_fuente_financiamiento,$id_parametro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$id_concepto_colectivo);
		...
		else if ($id_presupuesto == "undefined" || $id_presupuesto == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tpr_presupuesto
			$res = $Custom -> InsertarFormulacionPresupuesto($id_presupuesto,$tipo_pres,$estado_pres,$id_unidad_organizacional,$id_fuente_financiamiento,$id_parametro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarFormulacionPresupuesto($id_presupuesto,$tipo_pres,$estado_pres,$id_unidad_organizacional,$id_fuente_financiamiento,$id_parametro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
