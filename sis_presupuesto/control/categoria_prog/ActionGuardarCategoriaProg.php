...
Propósito:				Permite insertar y modificar datos en la tabla tpm_programa_proyecto_actividad
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_categoria_prog == "undefined" || $hidden_id_categoria_prog == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tpm_categoria_prog
