...
/**
**********************************************************
Nombre de archivo:	ActionEliminarCategoriaProg.php
Propósito:					Permite eliminar registros de la tabla tpr_categoria_prog
Tabla:						tpr_categoria_prog
Parámetros:				$hidden_id_categoria_prog
...
$nombre_archivo = "ActionEliminarCategoriaProg.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCategoriaProg($hidden_id_categoria_prog);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
