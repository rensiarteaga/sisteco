<?php
/**
 * Nombre de la Archivo:	LibModeloFactur
...
include_once(dirname(__FILE__)."../../modelo/cls_CustomDBPresto.php");

/*include_once(dirname(__FILE__)."../../modelo/avq_cls_CustomDBFactur.php");
include_once(dirname(__FILE__)."../../modelo/jgl_cls_CustomDBFactur.php");
include_once(dirname(__FILE__)."../../modelo/gvc_cls_CustomDBFactur.php");
include_once(dirname(__FILE__)."../../modelo/vsp_cls_CustomDBFactur.php");*/
