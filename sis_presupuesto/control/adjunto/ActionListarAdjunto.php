...
//Parámetros del filtro
	...
	$res = $Custom -> ListarAdjunto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_adjunto,$id_proyecto);
	...
	if($res)
	{
		...
		foreach ($Custom->salida as $f)
		{
			...
			$xml->add_nodo('tipo_adjunto',$f["tipo_adjunto"]);
			...
			$xml->add_nodo('tamano_adjunto',$f["tamano_adjunto"]);	
			$xml->fin_rama();
		}
		$xml->mostrar_xml();
	}
