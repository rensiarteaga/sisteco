...
$nombre_archivo='MemoriaCalculoViaje.php';
...
if($_SESSION['autentificado']=="SI"){
	        ...
	        $res=$Custom->ListarCabMemoriaCalculoViaje($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	        if($res)
	        {
	    		...
	    		{	
		        	...
		        	if($tipo_reporte=="Periodo"){
		         		header("location:PDFMemoriaCalculoViaje.php?id_partida_presupuesto=$id_partida_presupuesto&id_presupuesto=$id_presupuesto&tipo_memoria=$tipo_memoria&id_partida=$id_partida&id_moneda=$id_moneda&tipo_pres=$tipo_pres");	        			        	              
		        	}
		        	else{
		        		header("location:PDFMemoriaCalculoViajeGeneral.php?id_partida_presupuesto=$id_partida_presupuesto&id_presupuesto=$id_presupuesto&tipo_memoria=$tipo_memoria&id_partida=$id_partida&id_moneda=$id_moneda&tipo_pres=$tipo_pres");	        			        	              
		        	}	
		        }   
	    		else 
	    		{
