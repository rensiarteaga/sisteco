	        ...
	        if($res){
	    		...
	    		{	
		        	...
		        	if($tipo_reporte=="Periodo"){
		         		header("location:PDFMemoriaCalculoServicio.php?id_presupuesto=$id_presupuesto&tipo_memoria=$tipo_memoria&id_partida=$id_partida&id_moneda=$id_moneda&tipo_pres=$tipo_pres");	        			        	              
		        	}
		        	else{
		        		header("location:PDFMemoriaCalculoServicioGeneral.php?id_presupuesto=$id_presupuesto&tipo_memoria=$tipo_memoria&id_partida=$id_partida&id_moneda=$id_moneda&tipo_pres=$tipo_pres");	        			        	              
		        	}
		        }   
	    		else 
	    		{
