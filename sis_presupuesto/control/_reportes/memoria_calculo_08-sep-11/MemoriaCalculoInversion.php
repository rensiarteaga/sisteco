...
if($_SESSION['autentificado']=="SI"){
	        ...
	        $res=$Custom->ListarCabMemoriaInversion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	        //echo 'entra'; exit;
	        if($res){
	    		...
	    		{	
		        	...
		        	if($tipo_reporte=="Periodo"){
		         		header("location:PDFMemoriaCalculoInversion.php?id_partida_presupuesto=$id_partida_presupuesto&id_presupuesto=$id_presupuesto&tipo_memoria=$tipo_memoria&id_partida=$id_partida&id_moneda=$id_moneda&tipo_pres=$tipo_pres");	        			        	              
		        	}
		        	else{
		        		header("location:PDFMemoriaCalculoInversionGeneral.php?id_partida_presupuesto=$id_partida_presupuesto&id_presupuesto=$id_presupuesto&tipo_memoria=$tipo_memoria&id_partida=$id_partida&id_moneda=$id_moneda&tipo_pres=$tipo_pres");	        			        	              
		        	}
		        }   
	    		else 
	    		{
