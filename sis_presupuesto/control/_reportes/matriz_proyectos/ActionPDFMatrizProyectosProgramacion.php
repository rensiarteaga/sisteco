...
$nombre_archivo = 'ActionPDFMatrizProyectosProgramacion.php';
...
if($_SESSION['autentificado']=="SI")
{
	...
	$SETDetalle = $Custom->ListarEjecucionMatrizProyectos($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$id_parametro,$fecha_ini,$fecha_fin,$tipo_pres1,$id_moneda,$filtro,$id_presupuesto,$id_uo,$id_categoria_prog);
	...
	else								// Excel
	{
		switch ($_GET['tipo_reporte']) 
		{
			...
			break;
			case 3:
			header("location: ../../_reportes/matriz_proyectos/XLSMatrizProyectosProgramacion.php");
			break;		
		} 
	}
}
