...
class PDF extends FPDF
{
	...
	function LoadData($id_partida_presupuesto,$id_presupuesto,$tipo_memoria,$id_partida,$id_moneda,$tipo_pres,$cod_prog,$cod_proy,$cod_act,$cod_fuente_fin,$cod_organismo){
	    ...
	    {
	    	$criterio_filtro="PARPRE.id_partida=$id_partida AND VPRE.cod_prg = $cod_prog and vpre.cod_proy = $cod_proy and vpre.cod_act = $cod_act and vpre.cod_fin = $cod_fuente_fin and vpre.codigo_fuente = $cod_organismo AND MEMCAL.tipo_detalle= $tipo_memoria AND MONEDA.id_moneda=$id_moneda AND PRESUP.tipo_pres =$tipo_pres ";
	    }
