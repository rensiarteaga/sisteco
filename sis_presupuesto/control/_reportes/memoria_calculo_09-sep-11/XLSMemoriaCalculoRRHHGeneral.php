<?php
    ...
    $nuevahoja->write(18,2,'IMPORTE',$negritaCentrado);
    $nuevahoja->write(18,3,'PERIODO',$negritaCentrado);
	...
	$res = $Custom->ListarRepMemoriaCalculoRRHH($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
