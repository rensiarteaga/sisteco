<?php
	...
	$nombre_archivo='MEMORIA_CALC_INGRESO_GRAL.xls';
	...
	$res = $Custom->ListarRepGralMemoriaCalculoIngreso($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
	...
	if($res)
	{
		...
		$res2 = $CustomS->SumaCostoMemoriaCalculoIngreso(15,0,'','',$criterio_suma,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
