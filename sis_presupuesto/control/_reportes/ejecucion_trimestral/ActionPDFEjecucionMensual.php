...
if($_SESSION['autentificado']=="SI")
{
	...
	for($i=0;$i<$CantFiltros;$i++)
	{
		...
		$_SESSION['PDF_mes']=$_GET['mes'];
		$num_mes=$_GET['num_mes'];
	...
	{
		case 3:
		$SETDetalle = $Custom->ListarEjecucionMensual($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$id_parametro,$fecha_ini,$fecha_fin,$tipo_pres1,$id_moneda,$filtro,$id_presupuesto,$id_uo,$id_categoria_prog);
		break;
		case 4:
		$SETDetalle = $Custom->ListarEjecucionMensualAcumulada($num_mes,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$id_parametro,$fecha_ini,$fecha_fin,$tipo_pres1,$id_moneda,$filtro,$id_presupuesto,$id_uo,$id_categoria_prog);
		break;
	}
	...
	{ 	
		switch ($_GET['tipo_reporte']) 
		{
			...
			break;
			case 4:
			header("location: ../../_reportes/ejecucion_trimestral/PDFDetalleEjecucionMensualAcumulada.php");
			break;
		} 	
	}	
	else								// Excel
	{
		switch ($_GET['tipo_reporte']) 
		{
			...
			break;
			case 4:
			header("location: ../../_reportes/ejecucion_trimestral/XLSDetalleEjecucionMensualAcumulada.php");
			break;			
		} 
	}
}
