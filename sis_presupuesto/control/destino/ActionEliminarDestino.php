...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDestino.php
Propósito:				Permite eliminar registros de la tabla tpr_destino
...
$nombre_archivo = "ActionEliminarDestino.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDestino($id_destino);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
