...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarServicioGasto.php
Propósito:				Permite eliminar registros de la tabla tpr_mem_servicio
...
$nombre_archivo = "ActionEliminarServicioGasto.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarServicioGasto($id_mem_servicio);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
