...
if($_SESSION['autentificado']=="SI")
{
		...
		//$_SESSION['PDF_desc_pres']=$_GET['desc_pres'];
		...
		if($tipo_reporte=='false')
		{
			if($_GET['reporte'] == 1)
			{
				...
				//echo var_dump($Custom->salida); exit;
				...
				header("location: ../../vista/ejecucion_institucional/XLSEjecucionInstitucional.php");
		}
		else{
			$EjecucionInstitucional=array();
