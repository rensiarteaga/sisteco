	...
	{	$fecha= substr( $_GET['fecha_fin'],3,2)."/".substr( $_GET['fecha_fin'],0,2)."/".substr( $_GET['fecha_fin'],6,4);
       $fecha_ini= substr( $_GET['fecha_ini'],3,2)."/".substr( $_GET['fecha_ini'],0,2)."/".substr( $_GET['fecha_ini'],6,4);
		...
		for($i=0;$i<$nro_columnas;$i++){
			...
			/*echo $datosCabecera['valor'][$i]." c=".
			$datosCabecera['columna'][$i]." a=".
			$datosCabecera['align'][$i]." w=".
			$datosCabecera['width'][$i]	;
			*/
		}
		...
		$Excel->SetCabeceraDetalle($datosCabecera);//Colocamos el nombre de las columnas
		              ...
		              //ListarEjecucionPartida($cant,$puntero,$sortcol ,$sortdir,$criterio_filtro,$_POST['id_financiador'],$_POST['id_regional'],$_POST['id_programa'],$_POST['id_proyecto'],$_POST['id_actividad'],$_POST['tipo_pres'],$_POST['id_parametro'],$_POST['id_moneda'],$_POST['ids_fuente_financiamiento'],$_POST['ids_u_o'],$_POST['ids_financiador'],$_POST['ids_regional'],$_POST['ids_programa'],$_POST['ids_proyecto'],$_POST['ids_actividad'],$_POST['sw_vista'],$_POST['ids_concepto_colectivo'],$fecha,$fecha_ini);
		$res = $Custom->ListarEjecucionPartida($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$_GET['id_financiador'],$_GET['id_regional'],$_GET['id_programa'],$_GET['id_proyecto'],$_GET['id_actividad'],$_GET['tipo_pres'],$_GET['id_parametro'],$_GET['id_moneda'],$_GET['ids_fuente_financiamiento'],$_GET['ids_u_o'],$_GET['ids_financiador'],$_GET['ids_regional'],$_GET['ids_programa'],$_GET['ids_proyecto'],$_GET['ids_actividad'],$_GET['sw_vista'],$_GET['ids_concepto_colectivo'],$fecha,$fecha_ini,$id_categoria_prog,$filtro_niveles);
