...
class PDF extends FPDF
{
	...
	function Header()
	{
	    ...
	    {
	    	$this->Cell(37,5,'DEVENGADO',1,0,'C',0);		//DEVENGADO
		    $this->Cell(37,5,'INGRESADO',1,1,'C',0);		//INGRESADO
	    }
	...
	{   
		...
		{
			$w=array(15,100,25,25,25);//PRESUPUESTOS DE GASTO E INVERSION
		}
	    else 
	    {
	    	$w=array(15,100,37,37); //PRESUPUESTOS DE RECURSOS
	    }
