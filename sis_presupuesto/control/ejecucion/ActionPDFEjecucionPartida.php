...
//Se obtiene el criterio del filtro con formato sql para mandar a la BD
	...
	for($i=0;$i<$CantFiltros;$i++)
	{
		...
		$tipo_pres1=$_GET['id_tipo_pres'];
		$_SESSION['PDF_desc_partida_r']=utf8_decode($_GET['desc_partida']);
		$_SESSION['PDF_desc_pres_r']=utf8_decode($_GET['desc_pres']);
		$_SESSION['PDF_gestion_r']=$_GET['gestion_pres'];
		
		$id_categoria_prog=utf8_decode($_GET['id_categoria_prog']);
		$_SESSION['PDF_desc_categoria_prog']=utf8_decode($_GET['desc_categoria_prog']);
		
		$criterio_filtro= $criterio_filtro." and parpre.id_partida=$id_partida  and partde.id_moneda=$id_moneda";
		
	$SETDetalle = $Custom->ListarEjecucionPorPartida($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$fecha_fin,$fecha_ini,$tipo_pres1,$id_moneda,$id_categoria_prog);
	...
	if ($_GET['tipo_reporte'] == 1) 
		...
		header("location: ../../vista/ejecucion_reporte/XLSDetalleEjecucionPartida.php");
	}
else
	{
