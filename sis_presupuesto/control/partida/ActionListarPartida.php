...
//Parámetros del filtro
	...
	/***
	 * Fecha: 06/09/2016 Para el filtro de Partidas para las cuentas CAIF
	* Descripcion: Filtro de partidas solo de Flujo y que sean de movimiento y partidas de la gestion del plan de cuentas.
	*/
	if($m_id_gestion){
