...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarAutorizacionPresupuesto.php
Propósito:				Permite eliminar registros de la tabla tpr_usuario_autorizado
...
$nombre_archivo = "ActionEliminarAutorizacionPresupuesto.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarAutorizacionPresupuesto($id_usuario_autorizado);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
