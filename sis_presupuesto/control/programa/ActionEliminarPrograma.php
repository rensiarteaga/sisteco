...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarPrograma.php
Propósito:				Permite eliminar registros de la tabla tpr_programa
Tabla:					tpr_tpr_programa
...
$nombre_archivo = "ActionEliminarPrograma.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarPrograma($id_programa);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
