...
$nombre_archivo = "ActionEliminarConceptoIngas.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarConceptoIngas($id_concepto_ingas);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($criterio_filtro == "") $criterio_filtro = "PARTID.id_partida=''$m_id_partida''";
