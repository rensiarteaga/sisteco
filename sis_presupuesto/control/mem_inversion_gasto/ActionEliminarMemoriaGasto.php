...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarMemoriaGasto.php
Propósito:				Permite eliminar registros de la tabla tpr_mem_inversion_gasto
...
$nombre_archivo = "ActionEliminarMemoriaGasto.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarMemoriaGasto($id_mem_inversion_gasto);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
