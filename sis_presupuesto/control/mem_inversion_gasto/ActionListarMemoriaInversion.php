...
/**
**********************************************************
Nombre de archivo:	    ActionListarMemoriaGasto.php
Propósito:				Permite realizar el listado en tpr_mem_inversion_gasto
Tabla:					t_tpr_mem_inversion_gasto
Parámetros:				$cant
						$puntero
						$sortcol
						$sortdir
...
$nombre_archivo = 'ActionListarMemoriaInversion .php';
...
//Parámetros del filtro
	...
	if($filtro==1){
		$criterio_filtro=$criterio_filtro." AND MEMING.tipo_mem=2 AND MEMING.id_moneda=".$valor_filtro;
	}
