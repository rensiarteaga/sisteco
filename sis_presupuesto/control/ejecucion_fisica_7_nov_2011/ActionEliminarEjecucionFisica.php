...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarejecucionFisica.php
Propósito:				Permite eliminar registros de la tabla tpr_ejecucion_fisica
...
$nombre_archivo = "ActionEliminarEjecucionFisica.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEjecucionFisica($id_ejecucion_fisica);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
