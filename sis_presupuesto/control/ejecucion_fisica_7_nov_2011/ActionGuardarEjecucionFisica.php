...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_ejecucion_fisica == "undefined" || $id_ejecucion_fisica == "")
		{
			...
			$res = $Custom -> InsertarEjecucionFisica($id_ejecucion_fisica,$id_parametro,$id_proyecto,$periodo_pres,$porcentaje_ejecucion,$estado);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarEjecucionFisica($id_ejecucion_fisica,$id_parametro,$id_proyecto,$periodo_pres,$porcentaje_ejecucion,$estado);
