...
//Parámetros del filtro
	...
	{	
		$criterio_filtro=$criterio_filtro." and (MODIFI.estado_modificacion = ''Borrador'' or MODIFI.estado_modificacion = ''Autorizacion'' or MODIFI.estado_modificacion = ''Rechazado'' or MODIFI.estado_modificacion = ''Aprobado'')";
	}
	
	if($_GET['aprobacion'] == 'si')
	{	
		$criterio_filtro=$criterio_filtro." and MODIFI.estado_modificacion = ''Autorizacion''";
	}
