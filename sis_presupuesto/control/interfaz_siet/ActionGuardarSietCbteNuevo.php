...
/**
**********************************************************
Nombre de archivo:	    ActionGuardarSietCbteNuevo.php
Propósito:				Permite insertar y modificar datos en la tabla tpr_siet_cbte
Tabla:					tpr_siet_cbte
...
$nombre_archivo = "ActionGuardarSietCbteNuevo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{ 
        	...
        	if (($id_siet_cbte==null )and ($id_siet_cbte==null)){
        		
        	    $res = $Custom -> InsertarSietCbteNuevo($id_siet_declara,$id_siet_cbte,$importe,$id_cuenta_bancaria,$glosa,$id_cuenta_doc,$estado); //todos o uno por uno
        		if(!$res)
        		{
        			//Se produjo un error
        			$resp = new cls_manejo_mensajes(true, "406");
        		...
        		$res = $Custom -> ModificarSietCbteNuevo($id_siet_declara,$id_siet_cbte,$importe,$id_cuenta_bancaria,$glosa,$id_cuenta_doc,$estado); //todos o uno por uno
        		if(!$res)
        		{
        			//Se produjo un error
        			$resp = new cls_manejo_mensajes(true, "406");
