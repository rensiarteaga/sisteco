...
class cls_DBListarEjecucionInstitucional 
{
	...
	{		
        ...
        $this->var->add_def_cols('codigo_partida','varchar');  //2
        $this->var->add_def_cols('nombre_partida','TEXT');//3
        $this->var->add_def_cols('sw_transaccional','NUMERIC'); //4
        $this->var->add_def_cols('presupuestado','NUMERIC'); //5
        $this->var->add_def_cols('modificaciones','NUMERIC');//6
        $this->var->add_def_cols('presupuesto_vigente','NUMERIC');  //7
        $this->var->add_def_cols('compromiso','NUMERIC'); //8
        $this->var->add_def_cols('presupuesto_por_comprometer','NUMERIC');//9
        $this->var->add_def_cols('devengado','NUMERIC'); //10
		$this->var->add_def_cols('devengado_acumulado','NUMERIC');//11
        $this->var->add_def_cols('presupuesto_por_devengar','NUMERIC');//12
        $this->var->add_def_cols('pagado','NUMERIC'); //13
        $this->var->add_def_cols('pagado_acumulado','NUMERIC'); //14
        $this->var->add_def_cols('saldo_por_pagar','NUMERIC');	//15
