...
class cls_DBSietCbtePartida
{
	...
	function InsertarSietCbtePartida($id_siet_cbte_partida,$id_siet_cbte,$id_partida,$importe,$id_oec,$id_siet_ent_ua_transf)
	{
		...
		$this->var->add_param("'NULL'");//codigo_partida_siet
		$this->var->add_param("'NULL'");//codigo_oec_siet
      //Ejecuta la función
	...
	function InsertarSietCbtePartidaExcel($id_siet_cbte,$importe,$codigo_partida,$codigo_oec,$codigo_partida_siet,$codigo_oec_siet)
	{
		...
		$this->var->add_param("NULL");
		$this->var->add_param("NULL");
		$this->var->add_param("'$codigo_partida_siet'");//codigo_partida_siet
		$this->var->add_param("'$codigo_oec_siet'");//codigo_oec_siet
		//Ejecuta la función
		$res = $this->var->exec_non_query();
	...
	function InsertarSietCbteOecExcel($id_siet_cbte_partida,$importe,$codigo_oec,$codigo_oec_siet)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpr_siet_cbte_partida_iud';
		$this->codigo_procedimiento = "'PR_SIEOECEXC_INS'";
