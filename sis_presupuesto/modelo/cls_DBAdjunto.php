...
class cls_DBAdjunto
{
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpr_adjunto_sel';
		$this->codigo_procedimiento = "'PR_ADJUNT_SEL'";
	...
	function ContarAdjunto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_proyecto)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpr_adjunto_sel';
		$this->codigo_procedimiento = "'PR_ADJUNT_COUNT'";
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpr_adjunto_iud';
		$this->codigo_procedimiento = "'PR_ADJUNT_INS'";
	...
	function ModificarAdjunto($id_adjunto,$nombre_doc,$observacion,$id_proyecto,$tipo_adjunto,$nombre_arch,$extension,$nombre_original,$tamano_adjunto)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpr_adjunto_iud';
		$this->codigo_procedimiento = "'PR_ADJUNT_UPD'";
	...
	function EliminarAdjunto($id_adjunto)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpr_adjunto_iud';
		$this->codigo_procedimiento = "'PR_ADJUNT_DEL'";
