 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tpr_tpr_concepto_ingas
 * Autor:				(autogenerado)
...
class cls_DBConceptoIngas
{
	...
	/**
	 * Nombre de la función:	ListarConceptoIngas
	 * Propósito:				Desplegar los registros de tpr_concepto_ingas
	 * Autor:				    (autogenerado)
	...
	/**
	 * Nombre de la función:	ContarConceptoIngas
	 * Propósito:				Contar los registros de tpr_concepto_ingas
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-07-07 15:19:33
	 */
	...
	/**
	 * Nombre de la función:	InsertarConceptoIngas
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tpr_concepto_ingas
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-07-07 15:19:33
	 */
	...
	/**
	 * Nombre de la función:	ModificarConceptoIngas
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tpr_concepto_ingas
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-07-07 15:19:33
	 */
	...
	/**
	 * Nombre de la función:	EliminarConceptoIngas
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tpr_concepto_ingas
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-07-07 15:19:33
	 */
	...
	/**
	 * Nombre de la función:	ValidarConceptoIngas
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tpr_concepto_ingas
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-07-07 15:19:33
	 */
	function ValidarConceptoIngas($operacion_sql,$id_concepto_ingas,$desc_ingas,$id_partida,$id_item,$id_servicio,$id_cuenta,$sw_tesoro,$id_oec,$estado)
	{
		$this->salida = "";
