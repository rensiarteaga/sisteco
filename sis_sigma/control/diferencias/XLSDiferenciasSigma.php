...
$nombre_archivo = 'diferencias_sigma.xls';
...
$nuevahoja->write ( 0, 1, 'ID PAR.PRESTO',$format_titulo);
$nuevahoja->write ( 0, 2, 'PARTIDA PRESTO',$format_titulo );
$nuevahoja->write ( 0, 3, 'ID PAR.SIGMA',$format_titulo);
$nuevahoja->write ( 0, 4, 'PARTIDA SIGMA',$format_titulo );
$nuevahoja->write ( 0, 5, 'IMPORTE PRESTO (A)',$format_titulo);
$nuevahoja->write ( 0, 6, 'IMPORTE SIGMA (B)' ,$format_titulo);
$nuevahoja->write ( 0, 7, 'DIFERENCIA (A-B)',$format_titulo );

//OBTENCION DE LOS DATOS
$sigma = new cls_CustomDBSigma();
$res = $sigma->DiferenciaSigma('null', 'null', $_SESSION ['PDF_sortcol'], $_SESSION ['PDF_sortdir'], $criterio_filtro, $id_financiador, $id_regional, $id_programa, $id_proyecto, $id_actividad, $_SESSION ['PDF_id_declaracion'], $_SESSION ['PDF_id_partida'] );
