...
$nombre_archivo = 'diferencias_aumulado.xls';
$docexcel = new Spreadsheet_Excel_Writer ( );
$nuevahoja = & $docexcel->addWorksheet ( "DIFERENCIAS ACUMULADO - ".$_SESSION ['PDF_id_declaracion'] );
...
$nuevahoja->write ( 0, 4, 'VIGENTE' ,$format_titulo);
$nuevahoja->write ( 0, 5, 'COMPROMETIDO' ,$format_titulo);
$nuevahoja->write ( 0, 6, 'DEVENGADO',$format_titulo );
$nuevahoja->write ( 0, 7, 'PAGADO',$format_titulo );

//OBTENCION DE LOS DATOS
$sigma = new cls_CustomDBSigma();
$res = $sigma->DiferenciaAcumulado('null', 'null', $_SESSION ['PDF_sortcol'], $_SESSION ['PDF_sortdir'], $criterio_filtro, $id_financiador, $id_regional, $id_programa, $id_proyecto, $id_actividad, $_SESSION ['PDF_id_declaracion'], $_SESSION ['PDF_id_partida'] );
