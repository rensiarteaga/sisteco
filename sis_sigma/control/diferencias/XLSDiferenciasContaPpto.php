...
$nombre_archivo = 'diferencias_conta_ppto.xls';
$docexcel = new Spreadsheet_Excel_Writer ( );
$nuevahoja = & $docexcel->addWorksheet ( "DIFERENCIAS CONTA-PPTO" );
...
$fila = 0;
$columna = 0;
$nuevahoja->write ( 0, 0, 'ORIGEN',$format_titulo);
$nuevahoja->write ( 0, 1, 'ID CBTE.',$format_titulo);
...
$nuevahoja->write ( 0, 6, 'CONTABLE (A)',$format_titulo);
$nuevahoja->write ( 0, 7, 'DEVENGADO (B)' ,$format_titulo);
$nuevahoja->write ( 0, 8, 'DIFERENCIA (A-B)',$format_titulo );

//OBTENCION DE LOS DATOS
$sigma = new cls_CustomDBSigma();
$res = $sigma->DiferenciaContaPpto('null', 'null', $_SESSION ['PDF_sortcol'], $_SESSION ['PDF_sortdir'], $criterio_filtro, $id_financiador, $id_regional, $id_programa, $id_proyecto, $id_actividad, $_SESSION ['PDF_id_declaracion'], $_SESSION ['PDF_id_partida'] );
