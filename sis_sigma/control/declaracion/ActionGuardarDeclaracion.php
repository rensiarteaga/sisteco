...
/**
**********************************************************
Nombre de archivo:	    ActionGuardarDeclaracion.php
...
$nombre_archivo = "ActionGuardarDeclaracion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_declaracion == "undefined" || $id_declaracion == ""){
			////////////////////Inserción/////////////////////
			//Validación satisfactoria, se ejecuta la inserción en la tabla tct_Declaracion
			$res = $Custom -> InsertarDeclaracion($id_declaracion,$estado,$fecha_reg,$id_gestion,$id_empresa,$id_usuario,$id_periodo,$id_moneda);
			...
			///////////////////////Modificación////////////////////
			$res = $Custom->ModificarDeclaracion($id_declaracion,$estado,$fecha_reg,$id_gestion,$id_empresa,$id_usuario,$id_periodo,$id_moneda);
	...
	if($sortcol == "") $sortcol = "id_declaracion";
	if($sortdir == "") $sortdir = "asc";
	if($criterio_filtro == "") $criterio_filtro = "0=0";

	$res = $Custom->ContarDeclaracion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
