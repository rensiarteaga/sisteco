...
if($_SESSION['autentificado']=='SI')
{
	...
	if($var == 1) //internas
	{
		...
		$Rtf->addText('<TAB><TAB><TAB>'.$desc_empleado.'<BR><TAB><strong>'.$cargo_rem.'</strong><BR><BR><BR><BR>');		
		$Rtf->addText("$iniciales/");				
		$Rtf->addText("\n");
	...
	else //externas
	{
		...
		$Rtf->addText('<BR><TAB><strong>'.$cargo_rem.'</strong><BR>');
		$Rtf->addText('<BR><BR><BR>');
