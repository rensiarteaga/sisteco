...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		exit;*/
		/*
		 * EN ALG�N LUGAR SE EST� DECODIFICANDO LA CADENA A UTF8
		 */
		/*echo $accion_proceso;
		exit;*/
		if ($id_correspondencia == "undefined" || $id_correspondencia == "")
		{
		    ...
		    {		  
		    	//echo 'saving';exit;
					...
					//Modificaci�n Aayaviri 12/04/2011 - 23:45
					...
					if($extension=='pdf' || $extension=='PDF' || $extension=='' || $extension=='doc' || $extension=='DOC' ||$extension=='docx' || $extension=='DOCX' ){
							...
							//Validaci�n satisfactoria, se ejecuta la inserci�n en la tabla tfl_correspondencia
							  ...
							  $sw_subir_archivo = true;
							   if($_FILES["archivo"]["size"]==0){
								   ...
								   //RAC: 26/05/2011
								    ...
								    //////////////////////////////
							    if(($accion_proceso=='undefined'||$accion_proceso=='')&& $vista=='enviado')
							       	$accion_proceso='modificar_enviado';
							    
							   /* if(($accion_proceso=='activar_anulado'))
							    	$accion_proceso='activar_anulado';
							    */	
