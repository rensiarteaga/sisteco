...
//Parámetros del filtro
	...
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,'cant_doc');
	//var_dump($crit_sort);
...
//	exit;
	...
	*/
	...
	$res = $Custom->ListarDocumentoEnviado($cant,$puntero,$sortcol,$sortdir,$criterio_filtro);
	...
	if($res)
	{
		...
		{
			$xml->add_rama('ROWS');
			$xml->add_nodo('cant_doc',$f["cant_doc"]);
