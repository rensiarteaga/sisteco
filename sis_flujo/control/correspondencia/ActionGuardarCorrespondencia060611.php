		...
		if ($id_correspondencia == "undefined" || $id_correspondencia == "")
		{
		    ...
		    {		  
					...
					if($extension=='pdf' || $extension=='PDF' || $extension=='' || $extension=='doc' || $extension=='DOC' ||$extension=='docx' || $extension=='DOCX' ){
							...
							$res = $Custom -> InsertarCorrespondencia($id_depto,$id_documento,$id_empleado,$id_uo,$id_institucion,$id_persona,$referencia,$fecha_origen,$fecha_destino,$hora_destino,$id_tipo_accion,$empleados,$tipo,$nuevo,$mensaje,$accion_proceso,$nombre_arch,$extension,$id_correspondencia_fk,$acciones,$observaciones,$observaciones_estado,$cite);
					  ...
					  if($extension=='pdf' || $extension=='PDF' || $extension=='' || $extension=='doc' || $extension=='DOC' ||$extension=='docx' || $extension=='DOCX' ){
							  ...
							  $sw_subir_archivo = true;
							   if($_FILES["archivo"]["size"]==0){
								...
								$res = $Custom->ModificarCorrespondencia($id_correspondencia,$id_depto,$id_documento,$id_empleado,$id_uo,$id_institucion,$id_persona,$referencia,$fecha_origen,$fecha_destino,$hora_destino,$id_tipo_accion,$empleados,$tipo,$nuevo,$mensaje,$accion_proceso,$nombre_arch,$extension,$id_correspondencia_fk,$acciones,$observaciones,$observaciones_estado,$cite);
