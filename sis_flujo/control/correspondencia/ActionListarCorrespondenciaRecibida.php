...
//Parámetros del filtro
	...
	if(isset($id_uo)){
		$criterio_filtro.=" and CORR.id_uo=$id_uo ";
	}
	
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,'cant_tipo');
	//var_dump($crit_sort);
...
//	exit;
	...
	*/
	...
	$res = $Custom->ListarCorrespondenciaRecibida($cant,$puntero,$sortcol,$sortdir,$criterio_filtro);
	...
	if($res)
	{
		...
		{
			$xml->add_rama('ROWS');
			$xml->add_nodo('cant_tipo',$f["cant_tipo"]);
