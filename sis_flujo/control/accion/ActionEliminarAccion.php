...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarAccion.php
Propósito:				Permite eliminar registros de la tabla tfl_accion
Tabla:					tfl_accion
...
$nombre_archivo = "ActionEliminarAccion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarAccion($id_accion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
