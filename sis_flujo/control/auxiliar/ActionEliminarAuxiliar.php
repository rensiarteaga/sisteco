...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarAuxiliar.php
Propósito:				Permite eliminar registros de la tabla tfl_auxiliar
Tabla:					tfl_auxiliar
Parámetros:				$id_auxiliar
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarAuxiliar($id_auxiliar);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
