...
$nombre_archivo = "ActionGuardarTipoCircuito.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			...
			$id_tipo_nodo_inicio= $_GET["id_tipo_nodo_inicio_$j"];
			$id_tipo_nodo_fin= $_GET["id_tipo_nodo_fin_$j"];
			$tipo = $_GET["tipo_$j"];
		}
		else
		{
			$id_tipo_circuito=$_POST["id_tipo_circuito_$j"];
			$id_tipo_nodo_inicio=$_POST["id_tipo_nodo_inicio_$j"];
			$id_tipo_nodo_fin=$_POST["id_tipo_nodo_fin_$j"];
			$tipo = $_POST["tipo_$j"];
		}
		...
		if ($id_tipo_circuito == "undefined" || $id_tipo_circuito == "")
		{
			...
			$res = $Custom->ValidarTipoCircuito("insert",$id_tipo_circuito, $id_tipo_nodo_inicio, $id_tipo_nodo_fin,$tipo);
			...
			$res = $Custom -> InsertarTipoCircuito($id_tipo_nodo_inicio, $id_tipo_nodo_fin,$tipo);
		...
		{	///////////////////////Modificación////////////////////
			...
			//Validación de datos (del lado del servidor)
			$res = $Custom->ValidarTipoCircuito("update",$id_tipo_circuito, $id_tipo_nodo_inicio, $id_tipo_nodo_fin,$tipo);
			...
			$res = $Custom->ModificarTipoCircuito($id_tipo_circuito, $id_tipo_nodo_inicio, $id_tipo_nodo_fin,$tipo);
