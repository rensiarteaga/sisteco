...
$Custom = new cls_CustomDBTipoFormulario();

$nombre_archivo = 'ActionPDFReporteTipoFormulario.php';
...
/*	echo 'asdfsdf'.$supergrupo;
	exit;*/
	$_SESSION["PDF_titulo"]='TIPO FORMULARIO';
	if($sw_tipo_formulario_clasificacion==0){
		
	$criterio_filtro= $criterio_filtro ." and TIPFOR.id_tipo_formulario=$id_tipo_formulario";
	$_SESSION["PDF_clasificacion"]=0;
	}else{
	$criterio_filtro= $criterio_filtro ." and TIPFOR.id_tipo_proceso like ''$txt_id_tipo_proceso'' and TIPFOR.id_documento like ''$txt_id_grupo''
