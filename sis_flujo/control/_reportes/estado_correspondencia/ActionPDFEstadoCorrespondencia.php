...
if($_SESSION['autentificado']=='SI')
{
	...
	if($sort == '') $sortcol = 'uo.nombre_unidad,numero, fecha_origen';
	else $sortcol = $sort;
	...
	$criterio_filtro= $criterio_filtro." corr.id_uo like ''$id_unidad_organizacional'' and corr.fecha_origen >= ''$fecha_inicio'' and corr.fecha_origen <= ''$fecha_fin'' ";
