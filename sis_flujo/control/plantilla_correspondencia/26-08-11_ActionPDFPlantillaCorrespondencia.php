...
if($_SESSION['autentificado']=='SI')
{
	...
	{					
		...
		{
			//if($numero == 'CB-IN-DFI-7/4-11')
			if (eregi('IN-DFI', $numero)) 
			{
				$fuente = 'fonts_ttf/ariblk.ttf';			
				imagettftext($titulo_doc, 22, 0, 135, 130, $negro, $fuente, 'INFORME FINANCIERO');
			}
			else 
			{
				$fuente = 'fonts_ttf/ariblk.ttf';			
		...
		imagettftext($titulo_doc, 10, 0, 35, 18, $blanco, $fuente, 'ENDESIS');
		imagejpeg($titulo_doc,"/tmp/titulo_$id_correspondencia.jpg");
