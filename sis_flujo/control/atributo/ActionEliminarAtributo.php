...
/*
**********************************************************
Nombre de archivo:	    ActionEliminarAtributo.php
Propósito:				Permite eliminar registros de la tabla tfl_atributo
Tabla:					tfl_atributo
Parámetros:				
...
$nombre_archivo = "ActionEliminarAtributo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarAtributo($id_atributo);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
