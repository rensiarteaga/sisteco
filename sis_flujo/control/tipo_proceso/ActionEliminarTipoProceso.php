...
Propósito:				Permite eliminar registros de la tabla tfl_tipo_Proceso
...
$nombre_archivo = "ActionEliminarTipoProceso.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarTipoProceso($id_tipo_proceso);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
