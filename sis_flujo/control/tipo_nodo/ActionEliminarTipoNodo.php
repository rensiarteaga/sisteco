...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarTipoNodo.php
...
$nombre_archivo = "ActionEliminarTipoNodo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarTipoNodo($id_tipo_nodo);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($sortcol == "") $sortcol = "id_tipo_Nod";
	if($sortdir == "") $sortdir = "asc";
	if($criterio_filtro == "") $criterio_filtro = "TIPNOD.id_tipo_proceso=$maestro_id_tipo_proceso";//cuenta solo los hijos del ide padre
