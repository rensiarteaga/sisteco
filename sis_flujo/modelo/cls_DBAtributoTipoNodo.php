...
class cls_DBAtributoTipoNodo
{
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tfl_atributo_tipo_nodo_sel';
		$this->codigo_procedimiento = "'FL_ATRTIPNOD_SEL'";
	...
	function ContarAtributoTipoNodo($cant,$puntero,$sortcol,$sortdir,$criterio_filtro)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tfl_atributo_tipo_nodo_sel';
		$this->codigo_procedimiento = "'FL_ATRTIPNOD_COUNT'";
