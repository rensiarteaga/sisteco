...
class cls_DBTipoProcesoDepto
{
	...
	/**
	 * Nombre de la función:	ListarTipoProcesoDepto
	 * Propósito:				Desplegar los registros de tfl_tipo_proceso_depto
	 * Autor:				    Williams Escobar
	 * Fecha de creación:		2010-12-27 17:04:51
	 */
	function ListarTipoProcesoDepto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		...
		$this->var->add_def_cols('nombre_depto','varchar');//añadido 30_12_2010
	...
	/**
	 * Nombre de la función:	ContarTipoProcesoDepto
	 * Propósito:				Contar los registros de tfl_tipo_proceso_depto
	 * Autor:				    Williams Escobar
	 * Fecha de creación:		2010-12-27 17:04:51
	 */
	...
	/**
	 * Nombre de la función:	InsertarTipoProcesoDepto
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tfl_tipo_proceso_depto
	 * Autor:				    Williams Escobar
	...
	/**
	 * Nombre de la función:	ModificarTipoProcesoDepto
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tfl_tipo_proceso_depto
	 * Autor:				    Williams Escobar
	 * Fecha de creación:		2010-12-27 16:22:51
	 */
...
exit;*/
	...
	/**
	 * Nombre de la función:	ValidarTipoProcesoDepto
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tfl_tipo_proceso_depto
	 * Autor:				    Williams Escobar
	 * Fecha de creación:		2010-12-26 16:31:51
	 */
