 ...
 * Autor:				(autogenerado)
 * Fecha creación:		2007-10-03 19:30:59
 */
...
class cls_DBCodigoFabricante
{
	...
	function ListarCodigoFabricante($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		...
		$this->var->add_def_cols('año','varchar');
	...
	function ValidarCodigoFabricante($operacion_sql,$id_codigo_fabricante,$codigo,$estado_registro,$nombre,$año,$descripcion,$observaciones,$fecha_reg,$id_item)
	{
		...
		if($operacion_sql=='insert' || $operacion_sql=='update')
		{
			...
			//Validar año - tipo varchar
			$tipo_dato->_reiniciar_valor();
			$tipo_dato->set_Columna("año");
			if(!$valid->verifica_dato($tipo_dato->TipoDatoText(), "año", $año))
			{
				$this->salida = $valid->salida;
				return false;
			}
			...
			{
				$this->salida[0] = "f";
				$this->salida[1] = "Error de validación en columna 'codigo': El valor no está dentro del dominio definido";
