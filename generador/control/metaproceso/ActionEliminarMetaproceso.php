...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarMetaproceso.php
Propósito:				Permite eliminar registros de la tabla tsg_metaproceso
Tabla:					tsg_tsg_metaproceso
Parámetros:				$hidden_id_metaproceso


Valores de Retorno:    	Número de registros
Fecha de Creación:		2007-10-10 12:08:21
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarMetaproceso.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarMetaproceso($hidden_id_metaproceso);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
