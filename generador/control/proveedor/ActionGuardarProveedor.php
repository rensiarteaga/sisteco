...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			$hidden_id_proveedor						= $_GET["hidden_id_proveedor_$j"];
			$txt_nombre						= $_GET["txt_nombre_$j"];
			$txt_descripcion						= $_GET["txt_descripcion_$j"];
			$txt_telefono_ref						= $_GET["txt_telefono_ref_$j"];
		...
		{
			$hidden_id_proveedor						= $_POST["hidden_id_proveedor_$j"];
			$txt_nombre						= $_POST["txt_nombre_$j"];
			$txt_descripcion						= $_POST["txt_descripcion_$j"];
			$txt_telefono_ref						= $_POST["txt_telefono_ref_$j"];
			$txt_observaciones						= $_POST["txt_observaciones_$j"];
			$txt_fecha_reg						= $_POST["txt_fecha_reg_$j"];
			
		}

		if ($hidden_id_proveedor == "undefined" || $hidden_id_proveedor == "")
		{
			////////////////////Inserción/////////////////////

			//Validación de datos (del lado del servidor)
			$res = $Custom->ValidarProveedor("insert",$hidden_id_proveedor, $txt_nombre, $txt_descripcion, $txt_telefono_ref, $txt_observaciones, $txt_fecha_reg);
			...
			$res = $Custom -> InsertarProveedor($hidden_id_proveedor, $txt_nombre, $txt_descripcion, $txt_telefono_ref, $txt_observaciones, $txt_fecha_reg);
		...
		{	///////////////////////Modificación////////////////////
			...
			//Validación de datos (del lado del servidor)
			$res = $Custom->ValidarProveedor("update",$hidden_id_proveedor, $txt_nombre, $txt_descripcion, $txt_telefono_ref, $txt_observaciones, $txt_fecha_reg);
			...
			$res = $Custom->ModificarProveedor($hidden_id_proveedor, $txt_nombre, $txt_descripcion, $txt_telefono_ref, $txt_observaciones, $txt_fecha_reg);
