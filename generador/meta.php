...
$db = pg_connect("host=10.10.0.14 dbname=".$dbName.' user='.$dbUser." password='db_rcm' port=5432");
...
crearArchivo_BDSel($base,$db,$tableName,$prefijo,$codigo,$meta);
crearArchivo_BDIud($base,$tableName,$prefijo,$codigo,$meta);
crearModeloBD($modelo,$db,$sistema,$tableName,$prefijo,$codigo,$meta);
crearArchivo_ControlListar($control,$db,$sistema,$tableName,$prefijo,$codigo,$meta);
