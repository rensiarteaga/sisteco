 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tal_tal_motivo_ingreso
 * Autor:				(autogenerado)
...
class cls_DBMotivoIngreso
{
	 ...
	 * Propósito:				Desplegar los registros de tal_motivo_ingreso
	 * Autor:				    (autogenerado)
	...
	function ListarMotivoIngreso($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		...
		$this->var->add_def_cols('desc_cuenta','');
	 ...
	 * Propósito:				Contar los registros de tal_motivo_ingreso
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-11 12:14:40
	 */
	...
	/**
	 * Nombre de la función:	ValidarMotivoIngreso
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tal_motivo_ingreso
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-11 12:14:40
	 */
