...
***************************************************************************
 ...
 DESCRIPCIÓN: 	Permite registrar en la tabla tal_almacen_ep
   ...
   ELSIF pm_codigo_procedimiento = 'AL_ALMAEP_UPD' THEN
        ...
        BEGIN
            ...
            IF NOT EXISTS(SELECT 1 FROM tal_almacen_ep
                ...
                g_descripcion_log_error := 'Modificación no realizada: no existe el registro de tal_almacen_epno existente';
                g_nivel_error := '4';
                g_respuesta := f_pm_mensaje_error(g_descripcion_log_error, g_nombre_funcion, g_nivel_error, pm_codigo_procedimiento);
		...
		id_almacen=al_id_almacen
            ...
            -- DESCRIPCIÓN DE ÉXITO PARA GUARDAR EN EL LOG
            g_descripcion_log_error := 'Modificación exitosa en tal_almacen_ep';
            g_respuesta := 't'||g_separador||g_descripcion_log_error;
    ...
    BEGIN
            ...
            IF NOT EXISTS(SELECT 1 FROM tal_almacen_ep
                ...
                g_nivel_error := '4';
                g_descripcion_log_error := 'Eliminación no realizada: registro en tal_almacen_ep inexistente';
                g_respuesta := f_pm_mensaje_error(g_descripcion_log_error, g_nombre_funcion, g_nivel_error, pm_codigo_procedimiento);
                RETURN 'f'||g_separador||g_respuesta;
         ...
         --            
         --       g_nivel_error := '4';
         --       g_descripcion_log_error := 'Eliminación no realizada: El registro en tal_almacen_ep tiene regitros asociados en XXX';
         --       g_respuesta := f_pm_mensaje_error(g_descripcion_log_error, g_nombre_funcion, g_nivel_error, pm_codigo_procedimiento);
         --      RETURN 'f'||g_separador||g_respuesta;
         ...
         -- BORRADO DE DATO
            ...
            -- DESCRIPCIÓN DE ÉXITO PARA GUARDAR EN EL LOG
            g_descripcion_log_error := 'Eliminación exitosa del registro en tal_almacen_ep';
            g_respuesta := 't'||g_separador||g_descripcion_log_error;
        END;
