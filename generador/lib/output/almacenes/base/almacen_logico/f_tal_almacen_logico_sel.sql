	...
	CREATE OR REPLACE FUNCTION "public"."f_tal_almacen_logico_sel" (
...
***************************************************************************
 SCRIPT: 		f_tal_almacen_logico
 DESCRIPCIÓN: 	Devuelve las consultas a la tabla tal_almacen_logico
 AUTOR: 		(Generado Automaticamente)
 FECHA:			2007-10-12 16:30:39
 COMENTARIOS:	
***************************************************************************
...
BEGIN
    ...
    g_nombre_funcion := 'f_tal_almacen_logico_sel';
    ...
    IF pm_codigo_procedimiento  = 'AL_ALMLOG_SEL' THEN
        BEGIN
            g_consulta := 'SELECT 
							...
							ALMLOG.nombre,
							ALMLOG.descripcion,
							ALMLOG.estado_registro,
							ALMLOG.fecha_reg,
							ALMLOG.obsevaciones,
							ALMLOG.id_almacen_ep,
							ALMAEP.descripcion as desc_almacen_ep,
							ALMLOG.id_tipo_almacen,
							TIPALM.descripcion as desc_tipo_almacen
							FROM tal_almacen_logico ALMLOG
						  	INNER JOIN tal_almacen_ep ALMAEP
            				ON ALMAEP.id_almacen_ep=ALMLOG.id_almacen_ep
							INNER JOIN tal_tipo_almacen TIPALM
