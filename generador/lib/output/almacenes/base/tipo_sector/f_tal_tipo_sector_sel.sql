	...
	CREATE OR REPLACE FUNCTION "public"."f_tal_tipo_sector_sel" (
...
***************************************************************************
 SCRIPT: 		f_tal_tipo_sector
 DESCRIPCIÓN: 	Devuelve las consultas a la tabla tal_tipo_sector
...
BEGIN
    ...
    g_nombre_funcion := 'f_tal_tipo_sector_sel';
    ...
    IF pm_codigo_procedimiento  = 'AL_TIPSEC_SEL' THEN
        BEGIN
            g_consulta := 'SELECT 
							TIPSEC.id_tipo_sector,
							TIPSEC.codigo,
							TIPSEC.descripcion,
							TIPSEC.observaciones,
							TIPSEC.estado_registro,
							TIPSEC.fecha_reg

						  FROM tal_tipo_sector TIPSEC
...
/*            -- SE AUMENTA LAS RESTRICCIONES DE LA ESTRUCTURA PROGRAMÁTICA
    ...
    ELSIF pm_codigo_procedimiento  = 'AL_TIPSEC_COUNT' THEN

        BEGIN
        --Cuenta todos los registros
            g_consulta := 'SELECT
                          COUNT(TIPSEC.id_tipo_sector) AS total
                          FROM tal_tipo_sector TIPSEC
