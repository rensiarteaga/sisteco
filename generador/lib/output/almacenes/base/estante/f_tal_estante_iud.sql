...
***************************************************************************
 ...
 DESCRIPCIÓN: 	Permite registrar en la tabla tal_estante
   ...
   ELSIF pm_codigo_procedimiento = 'AL_ESTANT_UPD' THEN
        ...
        BEGIN
            ...
            IF NOT EXISTS(SELECT 1 FROM tal_estante
                ...
                g_descripcion_log_error := 'Modificación no realizada: no existe el registro de tal_estanteno existente';
                g_nivel_error := '4';
                g_respuesta := f_pm_mensaje_error(g_descripcion_log_error, g_nombre_funcion, g_nivel_error, pm_codigo_procedimiento);
		...
		id_almacen_sector=al_id_almacen_sector
            ...
            -- DESCRIPCIÓN DE ÉXITO PARA GUARDAR EN EL LOG
            g_descripcion_log_error := 'Modificación exitosa en tal_estante';
            g_respuesta := 't'||g_separador||g_descripcion_log_error;
    ...
    BEGIN
            ...
            IF NOT EXISTS(SELECT 1 FROM tal_estante
                ...
                g_nivel_error := '4';
                g_descripcion_log_error := 'Eliminación no realizada: registro en tal_estante inexistente';
                g_respuesta := f_pm_mensaje_error(g_descripcion_log_error, g_nombre_funcion, g_nivel_error, pm_codigo_procedimiento);
                RETURN 'f'||g_separador||g_respuesta;
         ...
         --            
         --       g_nivel_error := '4';
         --       g_descripcion_log_error := 'Eliminación no realizada: El registro en tal_estante tiene regitros asociados en XXX';
         --       g_respuesta := f_pm_mensaje_error(g_descripcion_log_error, g_nombre_funcion, g_nivel_error, pm_codigo_procedimiento);
         --      RETURN 'f'||g_separador||g_respuesta;
         ...
         -- BORRADO DE DATO
            ...
            -- DESCRIPCIÓN DE ÉXITO PARA GUARDAR EN EL LOG
            g_descripcion_log_error := 'Eliminación exitosa del registro en tal_estante';
            g_respuesta := 't'||g_separador||g_descripcion_log_error;
        END;
