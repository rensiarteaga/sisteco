...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarItemUbicacion.php
Propósito:				Permite eliminar registros de la tabla tal_item_ubicacion
...
$nombre_archivo = "ActionEliminarItemUbicacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarItemUbicacion($hidden_id_item_ubicacion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
