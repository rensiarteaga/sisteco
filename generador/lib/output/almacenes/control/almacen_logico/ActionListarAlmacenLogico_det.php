...
Propósito:				Permite realizar el listado en tal_almacen_logico dato el id proviniente del padre
...
Fecha de Creación:		2007-10-12 16:30:48
Versión:				1.0.0
...
//Parámetros del filtro
	...
	$cond->add_criterio_extra("ALMAEP.id_almacen_ep",$m_id_almacen_ep);
	...
	$res = $Custom -> ContarAlmacenLogico($cant ,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);

	if($res) $total_registros= $Custom->salida;

	//Obtiene el conjunto de datos de la consulta
	$res = $Custom->ListarAlmacenLogico($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
