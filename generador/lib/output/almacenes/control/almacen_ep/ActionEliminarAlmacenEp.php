...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarAlmacenEp.php
Propósito:				Permite eliminar registros de la tabla tal_almacen_ep
Tabla:					tal_tal_almacen_ep
Parámetros:				$hidden_id_almacen_ep


Valores de Retorno:    	Número de registros
Fecha de Creación:		2007-10-12 16:30:30
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarAlmacenEp.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarAlmacenEp($hidden_id_almacen_ep);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
