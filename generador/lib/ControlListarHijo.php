<?php
function crearArchivo_ControlListarHijo($direccion,$db,$sistema,$table,$prefijo,$codigo,$meta,$datos_generales){
	...
	$fp_handler=fopen("$direccion/ActionListar".$table_fjava."_det.php","w+");
...
Propósito:				Permite realizar el listado en ".$table." dato el id proviniente del padre
...
//Parámetros del filtro
	...
	\$cond->add_criterio_extra(\"".$padre["codigo_base"].".$id_table_padre\",\$m_$id_table_padre);
