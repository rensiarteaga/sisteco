...
***************************************************************************
 ...
 DESCRIPCIÓN: 	Permite registrar en la tabla tsg_subsistema
   ...
   ELSIF pm_codigo_procedimiento = 'SG_SUBSIS_UPD' THEN
        ...
        BEGIN
            ...
            IF NOT EXISTS(SELECT 1 FROM tsg_subsistema
                ...
                g_descripcion_log_error := 'Modificación no realizada: no existe el registro de tsg_subsistemano existente';
                g_nivel_error := '4';
                g_respuesta := f_pm_mensaje_error(g_descripcion_log_error, g_nombre_funcion, g_nivel_error, pm_codigo_procedimiento);
		...
		observaciones=sg_observaciones
            ...
            -- DESCRIPCIÓN DE ÉXITO PARA GUARDAR EN EL LOG
            g_descripcion_log_error := 'Modificación exitosa en tsg_subsistema';
            g_respuesta := 't'||g_separador||g_descripcion_log_error;
    ...
    BEGIN
            ...
            IF NOT EXISTS(SELECT 1 FROM tsg_subsistema
                ...
                g_nivel_error := '4';
                g_descripcion_log_error := 'Eliminación no realizada: registro en tsg_subsistema inexistente';
                g_respuesta := f_pm_mensaje_error(g_descripcion_log_error, g_nombre_funcion, g_nivel_error, pm_codigo_procedimiento);
                RETURN 'f'||g_separador||g_respuesta;
         ...
         --            
         --       g_nivel_error := '4';
         --       g_descripcion_log_error := 'Eliminación no realizada: El registro en tsg_subsistema tiene regitros asociados en XXX';
         --       g_respuesta := f_pm_mensaje_error(g_descripcion_log_error, g_nombre_funcion, g_nivel_error, pm_codigo_procedimiento);
         --      RETURN 'f'||g_separador||g_respuesta;
         ...
         -- BORRADO DE DATO
            ...
            -- DESCRIPCIÓN DE ÉXITO PARA GUARDAR EN EL LOG
            g_descripcion_log_error := 'Eliminación exitosa del registro en tsg_subsistema';
            g_respuesta := 't'||g_separador||g_descripcion_log_error;
        END;
