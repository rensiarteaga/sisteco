...
class cls_gen_funciones_bd
{
	var $direccion,$table,$prefijo,$codigo,$meta;
	
	function __construct($direccion,$table,$prefijo,$codigo,$meta)
	{
	...
	function crearArchivo_BDSel($direccion,$table,$prefijo,$codigo,$meta){
