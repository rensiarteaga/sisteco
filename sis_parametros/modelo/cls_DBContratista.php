 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tpm_tpm_contratista
 * Autor:				(autogenerado)
...
class cls_DBContratista
{
	...
	/**
	 * Nombre de la función:	ListarContratista
	 * Propósito:				Desplegar los registros de tpm_contratista
	 * Autor:				    (autogenerado)
	...
	/**
	 * Nombre de la función:	ContarContratista
	 * Propósito:				Contar los registros de tpm_contratista
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-06 21:05:09
	 */
	...
	/**
	 * Nombre de la función:	InsertarContratista
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tpm_contratista
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-06 21:05:09
	 */
	...
	/**
	 * Nombre de la función:	ModificarContratista
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tpm_contratista
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-06 21:05:09
	 */
	...
	/**
	 * Nombre de la función:	EliminarContratista
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tpm_contratista
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-06 21:05:09
	 */
	...
	/**
	 * Nombre de la función:	ValidarContratista
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tpm_contratista
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-06 21:05:09
	 */
