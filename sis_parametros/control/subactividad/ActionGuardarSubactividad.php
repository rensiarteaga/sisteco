...
Propósito:				Permite insertar y modificar datos en la tabla tpm_subactividad
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_subactividad == "undefined" || $hidden_id_subactividad == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tpm_subactividad
