...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarContratista.php
Propósito:				Permite eliminar registros de la tabla tpm_contratista
...
$nombre_archivo = "ActionEliminarContratista.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarContratista($hidden_id_contratista);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
