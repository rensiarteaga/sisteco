...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCorrelativoGeneral.php
Propósito:				Permite eliminar registros de la tabla tpm_correlativo_general
...
$nombre_archivo = "ActionEliminarCorrelativoGeneral.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCorrelativoGeneral($id_correlativo_general);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
