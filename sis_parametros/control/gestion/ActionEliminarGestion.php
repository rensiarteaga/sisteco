...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarGestion.php
Propósito:				Permite eliminar registros de la tabla tpm_gestion
...
$nombre_archivo = "ActionEliminarGestion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarGestion($id_gestion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
