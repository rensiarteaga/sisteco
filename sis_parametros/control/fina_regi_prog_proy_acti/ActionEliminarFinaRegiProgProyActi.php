...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarFinaRegiProgProyActi.php
Propósito:				Permite eliminar registros de la tabla tpm_fina_regi_prog_proy_acti
...
$nombre_archivo = "ActionEliminarFinaRegiProgProyActi.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarFinaRegiProgProyActi($hidden_id_fina_regi_prog_proy_acti);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
