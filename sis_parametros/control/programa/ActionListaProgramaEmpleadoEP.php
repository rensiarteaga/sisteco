...
if($id_empleado>0){ //para filtrar programas que coincidan con la EP programa del empleado solicitante del sistema de adquisiciones
	...
	$res = $Custom->ContarProgramaEmpleadoEP($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	...
	$res = $Custom->ListarProgramaEmpleadoEP($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
