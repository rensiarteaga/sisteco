...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCorrelativoRp.php
Propósito:				Permite eliminar registros de la tabla tpm_correlativo_rp
...
$nombre_archivo = "ActionEliminarCorrelativoRp.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCorrelativoRp($id_correlativo_rp);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
