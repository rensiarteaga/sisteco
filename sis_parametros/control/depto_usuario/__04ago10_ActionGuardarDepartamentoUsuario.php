...
Propósito:				Permite insertar y modificar datos en la tabla tpm_depto_usuario
Tabla:					tpm_tpm_depto_usuario
Parámetros:				$id_depto_usuario
						$id_depto
						$id_usuario
						$estado
	...
	if ($id_depto_usuario == "undefined" || $id_depto_usuario == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tpm_depto_usuario
			$res = $Custom -> InsertarDepartamentoUsuario($id_depto_usuario, $id_depto,$id_usuario,$estado);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarDepartamentoUsuario($id_depto_usuario, $id_depto,$id_usuario,$estado);
