...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDepartamentoUsuario.php
...
$nombre_archivo = "ActionEliminarDepartamentoUsuario.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDepartamentoUsuario($id_depto_usuario);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
