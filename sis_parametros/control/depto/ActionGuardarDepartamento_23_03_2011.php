...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_depto == "undefined" || $id_depto == "")
		{
			...
			$res = $Custom -> InsertarDepartamento($id_depto,$codigo_depto,$nombre_depto,$estado,$id_subsistema);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarDepartamento($id_depto,$codigo_depto,$nombre_depto,$estado,$id_subsistema);
