...
//Parámetros del filtro
	...
	//jrr:para filtrar por el subsistema
	if($subsistema!=''){
	...
	//echo $sortcol; exit();
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,'Depto_ep_usuario_listar');
...
//echo $crit_sort; exit();
	...
	$res = $Custom -> ContarDepartamentoEPUsuario($cant ,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);

	if($res) $total_registros= $Custom->salida;

	//Obtiene el conjunto de datos de la consulta
	$res = $Custom->ListarDepartamentoEPUsuario($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
