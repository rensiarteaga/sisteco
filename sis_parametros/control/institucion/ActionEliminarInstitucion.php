...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarInstitucion.php
Propósito:				Permite eliminar registros de la tabla tpm_institucion
...
$nombre_archivo = "ActionEliminarInstitucion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarInstitucion($hidden_id_institucion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
