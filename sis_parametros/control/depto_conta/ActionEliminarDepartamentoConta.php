...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDepartamentoConta.php
Propósito:				Permite eliminar registros de la tabla tpm_depto_conta
Tabla:					tpm_depto_conta
Parámetros:				$id_depto_conta


Valores de Retorno:    	Número de registros
Fecha de Creación:		2009-06-17 10:07:13
Versión:				1.0.0
Autor:					avq
**********************************************************
*/
...
$nombre_archivo = "ActionEliminarDepartamentoConta.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDepartamentoConta($id_depto_conta);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
