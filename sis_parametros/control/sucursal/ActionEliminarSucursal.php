...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarSucursal.php
Propósito:				Permite eliminar registros de la tabla tpm_sucursal
...
$nombre_archivo = "ActionEliminarSucursal.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarSucursal($hidden_id_sucursal);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
