...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarUnidadMedidaSec.php
Propósito:				Permite eliminar registros de la tabla tpm_unidad_medida_sec
Tabla:					tpm_tpm_unidad_medida_sec
Parámetros:				$hidden_id_unidad_medida_sec


Valores de Retorno:    	Número de registros
Fecha de Creación:		2007-10-23 10:02:46
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarUnidadMedidaSec.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarUnidadMedidaSec($hidden_id_unidad_medida_sec);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
