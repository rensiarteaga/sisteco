<?php
/**
 * Nombre:		  	    unidad_medida_base_det_main.php
 * Propósito: 			pagina que arranca la configuracion de la vista del Hijo
 * Autor:				Generado Automaticamente
 * Fecha creación:		2007-10-17 15:00:27
 *
 */
session_start();
?>
...
var maestro={id_tipo_unidad_medida:<?php echo $m_id_tipo_unidad_medida;?>,nombre:'<?php echo $m_nombre;?>',descripcion:'<?php echo $m_descripcion;?>',estado_registro:'<?php echo $m_estado_registro;?>'};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_unidad_medida_base_det(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
