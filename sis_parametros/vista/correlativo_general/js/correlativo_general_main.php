<?php
/**
 * Nombre:		  	    correlativo_general_main.php
...
var maestro={id_documento:<?php echo $m_id_documento;?>,descripcion:decodeURIComponent('<?php echo $m_descripcion;?>'),documento:decodeURIComponent('<?php echo $m_documento;?>')};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_correlativo_general(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
_CP.setPagina(elemento);
}
Ext.onReady(main,main);

/**
 * Nombre:		  	    pagina_correlativo_general.js
 * Propósito: 			pagina objeto principal
 * Autor:				Generado Automaticamente
 * Fecha creación:		2008-09-08 09:53:41
 */
function pagina_correlativo_general(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
	...
	var ds = new Ext.data.Store({
		...
		proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/correlativo_general/ActionListarCorrelativoGeneral.php'}),
	...
	ds.load({
		params:{
			...
			m_id_documento:maestro.id_documento
		}
	});
...
Atributos[7]={
	...
	var config={titulo_maestro:'Documento (Maestro)',titulo_detalle:'Correlativo General (Detalle)',grid_maestro:'grid-'+idContenedor};
	var layout_correlativo_general = new DocsLayoutDetalle(idContenedor,idContenedorPadre);
...
//DEFINICIÓN DE FUNCIONES
	...
	Formulario:{html_apply:'dlgInfo-'+idContenedor,height:340,width:480,minWidth:150,minHeight:200,	closable:true,titulo:'Correlativo General'}};
