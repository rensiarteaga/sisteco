...
var maestro={id_epe:<?php echo $id_epe;?>,codigo_epe:decodeURIComponent('<?php echo $codigo_epe;?>'),desc_epe:decodeURIComponent('<?php echo $desc_epe;?>')};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_epe_inv(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
