...
{	var vectorAtributos=new Array;
	...
	var tpl_uo=new Ext.Template('<div class="search-item">','<b>{nombre_unidad}</b>','<br><FONT COLOR="#B5A642"><b>Unidad de Aprobaci�n: </b>{centro}</FONT>','<br><FONT COLOR="#B5A642"><b>Jerarquia: </b>{nombre_nivel}</FONT>','</div>');
	...
	function render_concepto(value){
		...
		if(value=='rastreo'){value='Rastreo Vehicular'}
...
// txt id_persona6
	...
	vectorAtributos[2]= {
			...
			loadMask:true,
			triggerAction:'all',			
			store:new Ext.data.SimpleStore({fields:['ID','valor'],data:[['compro','Compro'],['viaticos','Viaticos'],['cajas','Cajas'],['avance','Fondo en Avance'],['diesel','Diesel'],['devengados','Pagos Devengados'],['rastreo','Rastreo Vehicular'],['todos','Todos']]}),
			valueField:'ID',
			displayField:'valor',
			lazyRender:true,
