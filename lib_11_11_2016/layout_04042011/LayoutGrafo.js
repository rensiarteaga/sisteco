...
**********************************************************
*/
function DocsLayoutGrafo(idContenedor){
	this.center;
	...
	this.init=function(param){
		...
		var div_ctree=Ext.DomHelper.append(div_layout,{tag:'div',id:'grafmenu-'+idContenedor});
		layout.add('north', new Ext.ContentPanel(div_ctree,{closable:false}));
		var div_tree=Ext.DomHelper.append(div_layout,{tag:'div',id:'graf-'+idContenedor, 'position':'relative'});
