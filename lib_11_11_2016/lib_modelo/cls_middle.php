...
/**
	 ...
	 * AUTOR: Rensi Arteaga Copari
	 * Descripci�n: Se agrega funcionalidad adiconal para el manejode tipo de datos bytea
					...
					{						
					    ...
					    if($salida_temp[$i][$this->extencion] == 'jpg' || $salida_temp[$i][$this->extencion] == 'jpeg')
					    {
						    ...
						    if($this->create_thumb){
								...
								$thumb = imagecreatetruecolor(70,70); // se crea una imagen peque�a de dimensiones 150 x 150
								...
								imagejpeg($thumb,$this->ruta_archivo.$nom_arch,90);// 90 es la calidad de compresi�n				
						...
						if($salida_temp[$i][$this->extencion] == 'gif')
					    {
						    ...
						    if($this->create_thumb){
								...
								//echo $carpeta_destino.$Custom->salida[$i]['numero'].'.'.$Custom->salida[$i]['extension']; exit;
								imagegif($thumb,$this->ruta_archivo.$nom_arch,90);// 90 es la calidad de compresi�n				
						...
						/*if($salida_temp[$i][$this->extencion] == 'png')
					    {
						    ...
						    if($this->create_thumb)
						    {
								...
								imagepng($thumb,$this->ruta_archivo.$nom_arch,5); // en png la compresi�n es de 0-9
							}
					    }*/
			         }
				}
