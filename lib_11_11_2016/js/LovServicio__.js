	...
	this.Seleccionar=function(){
		...
		if(NumSelect!=0){
			...
			ocultarLOV()
				...
				Ext.MessageBox.alert('Estado', 'Solo se pueden seleccionar Servicios y no Tipos de Servicio o Tipos de Adquisiciones')
			}			
		}
		else{
...
Ext.form.LovServicio=function(config){
	...
	var datos = ['id_servicio','desc_servicio','id_tipo_adq','id_tipo_servicio','codigo','nombre'];
	configuracion={
...
Ext.extend(Ext.form.LovServicio,Ext.form.TriggerField,{
