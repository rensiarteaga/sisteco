...
Ext.extend(Ext.form.LovPartida,Ext.form.ComboBox,{
	...
	//para dos disparadores
	 ...
	 resizable:true,
	 lazyRender:true,
	 filterCol:'codigo_partida#nombre_partida',
	 tpl:new Ext.Template('<div class="search-item">','<b>{desc_partida}</b>','<br><FONT COLOR="#B5A642"><b>Nombre:</b> {nombre_partida}</FONT>','<br><FONT COLOR="#B5A642"><b>Código:</b> {codigo_partida}</FONT>','</div>'),
