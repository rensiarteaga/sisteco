...
function LovOecs(paramConfig){
	...
	this.Seleccionar=function(){
		...
		if(NumSelect!=0){
			...
			Ext.MessageBox.alert('Status', 'Antes seleccione una OEC.')
		}
...
Ext.form.LovOec=function(config){
		
	Ext.form.LovOec.superclass.constructor.call(this, config);
	...
	/////////////////////
	var data=[{dataIndex:"id_oec",
	filterColValue:"id_oec",
	header:"ID",
	width:1
	},{
	dataIndex:"desc_oec", /// modificar con el de activo_fijo
	filterColValue:"desc_oec",
	header:"Descripción",
	width:1
	},{
		dataIndex:"nro_oec", /// modificar con el de activo_fijo
		filterColValue:"nro_oec",
		header:"Número de OEC",
		width:110
	},{	dataIndex:"nombre_oec", /// modificar con el de activo_fijo
	...
	var url=this.direccion+'../../../../sis_tesoreria/control/oec/ActionListarOecField.php';
	var datos = ['id_oec','desc_oec','nro_oec','nombre_oec','sw_transaccional'];
	if(this.tipo=='gasto'){
		var url=this.direccion+'../../../../sis_tesoreria/control/oec/ActionListarOecField.php';
	}
   var ds=new Ext.data.Store({
	...
	configuracion={
		...
		title:'Plan de OECs',//titulo que va en el GRID
	...
	///////////////
	this.lov=new LovOecs(configuracion);
...
Ext.extend(Ext.form.LovOec,Ext.form.ComboBox,{
...
dlgLOV:false,//dialogo para el formulario
	setValue:function(x) {
		...
		Ext.form.LovOec.superclass.setValue.call(this,v.desc)
	},
	setText:function(t){
		Ext.form.LovOec.superclass.setValue.call(this,t)
	},
	getValue : function(){
	...
	//para dos disparadores
	 ...
	 tpl:new Ext.Template('<div class="search-item">','<b>{desc_oec}</b>','<br><FONT COLOR="#B5A642"><b>Nombre:</b> {nombre_oec}</FONT>','<br><FONT COLOR="#B5A642"><b>Nro. Oec:</b> {nro_oec}</FONT>','</div>'),
