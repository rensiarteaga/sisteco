...
Propósito:				clse principal donde se definen todas las funcionalidas de una pagina
para ENDE
Valores de Retorno:		 invoca a funciones para el manejo de datos (insert, update y delete)
Fecha de Creación:		02 - 05 - 07
Versión:				1.0.0
...
function Pagina(paramConfig,parametrosDatos,ds,ContenedorLayout,idContenedor){
	...
	configuracion={
		TamanoPagina:12, //para definir el tamaño de la pagina
