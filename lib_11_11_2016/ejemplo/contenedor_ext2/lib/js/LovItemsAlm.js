...
function LovItems(paramConfig){
	...
	var cmb_spGrup,cmb_grup,cmb_sbGrup,cmb_id1,cmb_id2,cmb_id3;
...
//SELECTION MODEL
	...
	ds_supergrupo=new Ext.data.Store({proxy: new Ext.data.HttpProxy({url:paramConfig.direccion+'../../../control/supergrupo/ActionListarSuperGrupo.php?origen=filtro'}),reader:new Ext.data.XmlReader({record:'ROWS',id:'id_supergrupo',totalRecords:'TotalCount'},['id_supergrupo','nombre'])});
	ds_grupo=new Ext.data.Store({proxy:new Ext.data.HttpProxy({url:paramConfig.direccion+'../../../control/grupo/ActionListarGrupo.php?origen=filtro'}),reader:new Ext.data.XmlReader({record:'ROWS',id:'id_grupo',totalRecords:'TotalCount'},['id_grupo','nombre'])});
	ds_subgrupo=new Ext.data.Store({proxy: new Ext.data.HttpProxy({url:paramConfig.direccion+'../../../control/subgrupo/ActionListarSubGrupo.php?origen=filtro'}),reader:new Ext.data.XmlReader({record:'ROWS',id:'id_subgrupo',totalRecords:'TotalCount'},['id_subgrupo','nombre'])});
	ds_id1=new Ext.data.Store({proxy: new Ext.data.HttpProxy({url:paramConfig.direccion+'../../../control/id1/ActionListarId1.php?origen=filtro'}),reader:new Ext.data.XmlReader({record:'ROWS',id: 'id_id1',totalRecords:'TotalCount'},['id_id1','nombre'])});
	ds_id2=new Ext.data.Store({proxy:new Ext.data.HttpProxy({url:paramConfig.direccion+'../../../control/id2/ActionListarId2.php?origen=filtro'}),reader:new Ext.data.XmlReader({record:'ROWS',id:'id_id2',totalRecords:'TotalCount'},['id_id2','nombre'])});
	ds_id3=new Ext.data.Store({proxy:new Ext.data.HttpProxy({url:paramConfig.direccion+'../../../control/id3/ActionListarId3.php?origen=filtro'}),reader:new Ext.data.XmlReader({record:'ROWS',id:'id_id3',totalRecords:'TotalCount'},['id_id3','nombre'])});
...
Ext.form.LovItemsAlm=function(config){
	...
	var url=this.direccion+'/../../../../control/item/ActionListarItemSal.php';
	...
	if(this.tipo=='salida'){
		var url=this.direccion+'/../../../../control/item/ActionListarItemKardex.php';
...
Ext.extend(Ext.form.LovItemsAlm,Ext.form.TriggerField,
{
	...
	onTriggerClick:function(){this.lov.mostrarLOV(this)},
	initEvents:function(){
