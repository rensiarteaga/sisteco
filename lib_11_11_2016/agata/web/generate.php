...
# Reading the Report
$originalReport = $Report = Report::OpenReport($ReportName);
...
if ($Report)
{
    ...
    if ($SelectFields)
    {
        ...
        $Adjustments = Report::ExtractAdjustments($Report['Report']['DataSet']);
        $newindex = 1;
    ...
    if ($saveReport)
    {
        ...
        Report::SaveReport($ReportName, $originalReport);
    }
