...
//	enqueue(function(){self.redraw().listenAll();});
	...
	if (!this._opt.interactive){
		//Adici�n ariel ayaviri 11-01-2011
		this.dom.connection[0].mousedown(function(e){
			Joint.fixEvent(e);
			/// added by ariel ayaviri omonte - 11-01-2011
	...
	if(!this._opt.draggable){
		console.log("entra al draggable");
...
Joint.resetPaper = function resetPaper(){
    ...
    /*Estas funciones no ayudan (Ariel Ayaviri Omonte)
