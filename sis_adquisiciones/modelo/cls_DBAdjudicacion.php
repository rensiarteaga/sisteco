...
//		exit;
	...
	function RepAdjudicacionProceso($id_proceso_compra,$tipo)
	{
		...
		$this->var->add_def_cols('uo_adjudicado','text');
		//Ejecuta la función de consulta
...
//		exit;
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tad_reporte_compras_unidad_monto_sel';
    	...
    	$this->var->add_param("'$criterio'");//id_item
		$this->var->add_param("'$tipo'");//tipo

		
		$this->var->add_def_cols('id_cotizacion', 'integer');
		$this->var->add_def_cols('desc_proveedor', 'text');
		$this->var->add_def_cols('total_proveedor','numeric');
