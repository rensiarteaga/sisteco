...
class cls_DBSolicitudCompra
{
	...
	function ListarSolicitudCompra($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$id_empresa)
	{
		...
		$this->var->add_def_cols('encargado_pre_aprobacion','varchar');
		$this->var->add_def_cols('id_empleado_frppa_aprobacion','int4');
		$this->var->add_def_cols('encargado_aprobacion','varchar');
...
//       exit;
	...
	function ListarRepSolicitudCompra($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		...
		$this->var->add_def_cols('nombre_preaprobador','varchar');
		$this->var->add_def_cols('cargo_preaprobador','varchar');
		
		$this->var->add_def_cols('fecha_cert_pres','text');
		$this->var->add_def_cols('nombr_resp_pres','text');
		$this->var->add_def_cols('estado_vigente_solicitud','varchar');
		$this->var->add_def_cols('fecha_comprometido','text');
		$this->var->add_def_cols('moneda_solicitud','varchar');
		$this->var->add_def_cols('tipo_cambio','numeric');		
		$this->var->add_def_cols('ot','varchar');		
		//jun2015
	 ...
	 */
	function ListarRepSolicitudCompraCorr($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tad_solicitud_compra_sel';
		$this->codigo_procedimiento = "'AD_REPSOLCORR_SEL'";
...
//
	...
	function ModificarCompraRapida($id_solicitud_compra,$codigo_proceso,$observaciones_proceso,$id_empresa,$pago_variable,$fecha_reg)
	{
		...
		$this->var->add_param("NULL");
		$this->var->add_param("NULL");
		$this->var->add_param("$id_empresa");//id_empresa //30
		$this->var->add_param("NULL");//id_orden_trabajo//30
        ...
        $this->var->add_param("NULL");//id_correspondencia
...
//echo $this->query; exit;
	...
	function ModificarModalidadCompra($id_solicitud_compra,$id_tipo_categoria_adq,$p_agrupar)
	{
		...
		$this->var->add_param("NULL");//num_sol_sis
		$this->var->add_param("NULL");//id_ppto
		...
		$this->var->add_param("NULL");//id_depto
		$this->var->add_param("NULL");//proveedores_prop
        $this->var->add_param("NULL");//comite_c
        $this->var->add_param("NULL");//comite_r
        $this->var->add_param("NULL");//tipo_recibo
        $this->var->add_param("NULL");//id_corr
...
//			}
	...
	/*	$this->var->add_def_cols('codigo_financiador','varchar');
		...
		$this->var->add_def_cols('nro_solicitud_cadena','varchar');
		$this->var->add_def_cols('id_presupuesto','integer');//nuevo
		$this->var->add_def_cols('desc_presupuesto','text');
		$this->var->add_def_cols('es_item','integer');//jun21015
...
*/
	...
	function ModificarSeguimientoSolicitud($id_solicitud_compra,$operacion,$observaciones)
	{
		...
		if($operacion=='activar_anulado'){
			$this->codigo_procedimiento = "'AD_ACTSOL_UPD'";
		}
	...
	function RepSolicitudProceso($id_proceso_compra,$id_solicitud_compra,$tipo)
	{
		...
		$this->var->add_def_cols('simbolo','varchar');//26
...
//		exit;
	...
	function ContarTotalSolicitudCompra($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$id_solicitud_compra)
	{
		...
		$this->var->add_def_cols('diesel','varchar');
		//2016
		$this->var->add_def_cols('correo','varchar');
		//Ejecuta la función de consulta
		$res = $this->var->exec_query();
...
//if($_SESSION["ss_id_usuario"]==120){echo "..".$this->query; exit;}
	 ...
	 */
	function ListarSolicitudCompraActa($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$id_empresa)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tad_solicitud_compra_sel';
		$this->codigo_procedimiento = "'AD_ACTSOL_REP'";
