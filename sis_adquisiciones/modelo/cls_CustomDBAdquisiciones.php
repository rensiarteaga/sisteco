...
function ModificarCotizacionOrdenCompra($id_cotizacion, $lugar_entrega, $forma_pago, $fecha_entrega, $tipo_entrega, $observaciones, $id_proceso_compra,$num_pagos,$fecha_orden_compra,$id_empresa,$factura_total,$num_factura,$num_autoriza_factura,$cod_control_factura,$fecha_factura,$tipo_pago,$id_caja,$id_cajero,$id_depto_tesoro,$tipo_plantilla,$por_adelanto,$por_retgar,$nro_contrato,$monto_adelanto_moneda_cotizada,$fecha_ini_ctto, $fecha_fin_ctto
	...
	function 	ListarRepPlanillaAbono($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$dbCotizacion = new cls_DBCotizacion($this->decodificar);
		$res = $dbCotizacion ->ListarRepPlanillaAbono($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbCotizacion ->salida;
		$this->query = $dbCotizacion ->query;
		return $res;
	}
	...
	function ListarCotizacionAmpliacion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$dbCotizacion = new cls_DBCotizacion($this->decodificar);
		$res = $dbCotizacion ->ListarCotizacionAmpliacion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbCotizacion ->salida;
		$this->query = $dbCotizacion ->query;
		return $res;
	}
	...
	function ContarCotizacionAmpliacion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$dbCotizacion = new cls_DBCotizacion($this->decodificar);
		$res = $dbCotizacion ->ContarCotizacionAmpliacion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbCotizacion ->salida;
		$this->query = $dbCotizacion ->query;
		return $res;
	}
	...
	function ContarCotizacionCtto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$dbCotizacion = new cls_DBCotizacion($this->decodificar);
		$res = $dbCotizacion ->ContarCotizacionCtto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbCotizacion ->salida;
		$this->query = $dbCotizacion ->query;
		return $res;
	}
	function ListarCotizacionCtto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$dbCotizacion = new cls_DBCotizacion($this->decodificar);
		$res = $dbCotizacion -> ListarCotizacionCtto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbCotizacion ->salida;
		$this->query = $dbCotizacion ->query;
		return $res;
	}
	...
	{
		$this->salida = "";
		$dbCotizacionDet = new cls_DBCotizacion($this->decodificar);
		$res = $dbCotizacionDet ->InsertarCotizacionCtto($id_cotizacion_ctto, $id_cotizacion,$antecedentes,$controversias, $doc_integrantes, $fecha_ctto, $garantias, $legislacion, $multas, $nro_contrato, $obligaciones,$controversias,
		$partes,$vigencia);
		...
		$partes,$vigencia)
	{
		$this->salida = "";
		$dbCotizacionDet = new cls_DBCotizacion($this->decodificar);
		$res = $dbCotizacionDet ->ModificarCotizacionCtto($id_cotizacion_ctto, $id_cotizacion,$antecedentes,$controversias, $doc_integrantes, $fecha_ctto, $garantias, $legislacion, $multas, $nro_contrato, $obligaciones,$controversias,
		$partes,$vigencia);
		$this->salida = $dbCotizacionDet ->salida;
		$this->query = $dbCotizacionDet ->query;
		return $res;
	...
	function EliminarCotizacionCtto($id_cotizacion_ctto)
	{
		$this->salida = "";
		$dbCotizacion = new cls_DBCotizacion($this->decodificar);
		$res = $dbCotizacion -> EliminarCotizacionCtto($id_cotizacion_ctto);
		$this->salida = $dbCotizacion ->salida;
		$this->query = $dbCotizacion ->query;
		return $res;
	}
...
//	function RepCotizacionDet($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	...
	//ago2015
	function UnirPagos($id_cotizacion, $id_pp)
	{
		$this->salida = "";
		$dbPlanPago = new cls_DBPlanPago($this->decodificar);
		$res = $dbPlanPago ->UnirPagos($id_cotizacion, $id_pp);
		$this->salida = $dbPlanPago ->salida;
		$this->query = $dbPlanPago ->query;
		return $res;
	}
...
//		exit;
	...
	function ListarDetalleComprasUoMonto($criterio,$tipo)
	{
		$this->salida = "";
		$dbAdjudicacion= new cls_DBAdjudicacion($this->decodificar);
		$res = $dbAdjudicacion->ListarDetalleComprasUoMonto($criterio,$tipo);
		$this->salida = $dbAdjudicacion->salida;
		$this->query = $dbAdjudicacion->query;
		return $res;
	}
	
	function RepAdjudicacionDetCompra($criterio,$tipo)
	{
		$this->salida = "";
		$dbAdjudicacion= new cls_DBAdjudicacion($this->decodificar);
		$res = $dbAdjudicacion->RepAdjudicacionDetCompra ($criterio,$tipo);
		$this->salida = $dbAdjudicacion->salida;
		$this->query = $dbAdjudicacion->query;
		return $res;
	}
	...
	function InsertarPlanillaDet($id_planilla,$id_plan_pago,$tipo_plantilla,$fecha_pagado,$num_factura,$fecha_factura,$por_anticipo,$por_retgar,$multas,$obs_descuentos,$monto_no_pagado)
	{
		$this->salida = "";
		$dbPlanilla = new cls_DBPlanilla($this->decodificar);
		$res = $dbPlanilla ->InsertarPlanillaDet($id_planilla,$id_plan_pago,$tipo_plantilla,$fecha_pagado,$num_factura,$fecha_factura,$por_anticipo,$por_retgar,$multas,$obs_descuentos,$monto_no_pagado);
		$this->salida = $dbPlanilla ->salida;
		$this->query = $dbPlanilla ->query;
		return $res;
	}
