 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tad_tad_caracteristica
 * Autor:				(autogenerado)
...
class cls_DBCaracteristica
{
	 ...
	 * Propósito:				Desplegar los registros de tad_caracteristica
	 * Autor:				    (autogenerado)
...
//		exit();
	 ...
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tad_caracteristica
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-13 09:57:25
	 */
	 ...
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tad_caracteristica
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-13 09:57:25
	 */
	 ...
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tad_caracteristica
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-13 09:57:25
	 */
	 ...
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tad_caracteristica
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-13 09:57:25
	 */
	...
	/**
	 * Nombre de la función:	ListarCaracteristicaSeguimientoSolicitud
	 * Propósito:				Desplegar los registros de tad_caracteristica
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-16 11:58:34
	 */
	...
	/**
	 * Nombre de la función:	ContarCaracteristicaSeguimientoSolicitud
	 * Propósito:				Contar los registros de tad_caracteristica
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-16 11:58:34
	 */
	...
	/**
	 * Nombre de la función:	InsertarCaracteristicaSeguimientoSolicitud
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tad_caracteristica
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-16 11:58:34
	 */
	...
	/**
	 * Nombre de la función:	ModificarCaracteristicaSeguimientoSolicitud
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tad_caracteristica
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-16 11:58:34
	 */
	...
	/**
	 * Nombre de la función:	EliminarCaracteristicaSeguimientoSolicitud
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tad_caracteristica
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-16 11:58:34
	 */
	...
	/**
	 * Nombre de la función:	ValidarCaracteristicaSeguimientoSolicitud
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tad_caracteristica
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-16 11:58:34
	 */
