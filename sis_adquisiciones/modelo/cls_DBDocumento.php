 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tad_tad_documento
 * Autor:				(autogenerado)
 * Fecha creación:		2008-05-08 15:50:17
 */
...
class cls_DBDocumento
{
	 ...
	 * Propósito:				Desplegar los registros de tad_documento
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-08 15:50:17
	 */
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tad_documento_sel';
		$this->codigo_procedimiento = "'AD_DOCUME_SEL'";
	 ...
	 * Propósito:				Contar los registros de tad_documento
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-08 15:50:17
	 */
	function ContarDocumento($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tad_documento_sel';
		$this->codigo_procedimiento = "'AD_DOCUME_COUNT'";
	 ...
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tad_documento
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-08 15:50:17
	 */
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tad_documento_iud';
		$this->codigo_procedimiento = "'AD_DOCUME_INS'";
	 ...
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tad_documento
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-08 15:50:17
	 */
	function ModificarDocumento($id_documento,$codigo,$descripcion)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tad_documento_iud';
		$this->codigo_procedimiento = "'AD_DOCUME_UPD'";
	 ...
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tad_documento
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-08 15:50:17
	 */
	function EliminarDocumento($id_documento)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tad_documento_iud';
		$this->codigo_procedimiento = "'AD_DOCUME_DEL'";
	 ...
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tad_documento
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-05-08 15:50:17
	 */
