...
var elemento={idContenedor:idContenedor,pagina:new pag_cot_dir_det(idContenedor,direccion,paramConfig,idContenedorPadre)};
...
function pag_cot_dir_det(idContenedor,direccion,paramConfig,idContenedorPadre)
{
	...
	var ds = new Ext.data.Store({
		...
		,'id_item_aprobado','estado','id_proceso_compra','desc_moneda', 'precio_moneda_cotizada','descripcion_item','reg_cabecera','precio_cantidad','id_unidad_medida','abreviatura','especificaciones_tecnicas','reformular','id_proceso_compra_det'
