...
function pagina_plan_pago(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
		...
		this.reload=function(m){
			...
			ds.lastOptions={
				params:{
					...
					m_id_cotizacion:datos.m_id_cotizacion
				}
			};
...
*/
		...
		this.AdicionarBoton('../../../lib/imagenes/print.gif','Reporte de Comprobante',btn_reporte_comprobante_pago,true,'comprobante','Comprobante de Pago');
