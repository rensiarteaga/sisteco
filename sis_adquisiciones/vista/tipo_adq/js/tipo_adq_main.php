...
var elemento={pagina:new pagina_tipo_adq(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
function pagina_tipo_adq(idContenedor,direccion,paramConfig){
	...
	Atributos[1]={
		validacion:{
			...
			loadMask:true,
			triggerAction:'all',
			//store:new Ext.data.SimpleStore({fields:['ID', 'valor'],data:Ext.tipo_adq_combo.tipo_adq}),
