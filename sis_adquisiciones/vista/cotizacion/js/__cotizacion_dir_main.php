...
function pagina_cotizacion_dir(idContenedor,direccion,paramConfig,maestro,idContenedorPadre){
	...
	var ds = new Ext.data.Store({
		...
		'factura_total','num_autoriza_factura','cod_control_factura',{name: 'fecha_factura',type:'date',dateFormat:'Y-m-d'},'reg_cabecera','falta_adjudicar','justificacion_adjudicacion','total_cotizado'
...
//		 txt impuestos
	...
	Atributos[36]={
		...
		var layout_cot_dir = new DocsLayoutMaestroDeatalle(idContenedor,idContenedorPadre);
