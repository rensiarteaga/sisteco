...
function main(){
    ...
    $id_usuario_compro=$_SESSION['ss_id_usuario'];
    echo "var id_usuario_compro='$id_usuario_compro';";
	?>
var fa=false;
<?php if($_SESSION["ss_filtro_avanzado"]!=''){echo 'fa='.$_SESSION["ss_filtro_avanzado"].';';}?>
var paramConfig={TamanoPagina:_CP.getConfig().ss_tam_pag,TiempoEspera:_CP.getConfig().ss_tiempo_espera,CantFiltros:1,FiltroEstructura:false,FiltroAvanzado:fa};
var elemento={pagina:new pag_proc_bien_mul(idContenedor,direccion,paramConfig, id_usuario_compro),idContenedor:idContenedor};
...
*/
function pag_proc_bien_mul(idContenedor,direccion,paramConfig, id_usuario_compro){
