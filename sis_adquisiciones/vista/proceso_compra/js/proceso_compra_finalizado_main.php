<?php 
/**
 * Nombre:		  	    proceso_compra_finalizado_main.php
...
var elemento={pagina:new pagina_procesoCompraFinalizado(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
function pagina_procesoCompraFinalizado(idContenedor,direccion,paramConfig){
	...
	var ds = new Ext.data.Store({
		...
		'desc_tipo_adq',
		'tipo_adq',
		'id_tipo_adq','id_proceso_compra_ant','num_convocatoria','id_cotizacion','id_moneda_base','numeracion_periodo_proceso','num_sol_por_proc','es_item'
		]),remoteSort:true});
