<?php 
/**
 * Nombre:		  	    proceso_compra_fin_serv_main.php
...
var elemento={pagina:new pagina_proceso_compra_fin_serv(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
