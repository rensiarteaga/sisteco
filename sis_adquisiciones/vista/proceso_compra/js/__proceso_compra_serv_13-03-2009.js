...
function pagina_proceso_compra_serv(idContenedor,direccion,paramConfig){
	...
	var ds = new Ext.data.Store({
		...
		'desc_tipo_adq',
		'tipo_adq',
		'id_tipo_adq','id_proceso_compra_ant','num_convocatoria','id_cotizacion','id_moneda_base','numeracion_periodo_proceso','proceso_cotizado','ejecutado','proceso_adjudicado','observaciones_acta','numeracion_periodo_cotizacion'
		]),remoteSort:true});
