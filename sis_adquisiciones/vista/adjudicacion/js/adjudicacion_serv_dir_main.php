<?php
/**
 * Nombre:		  	    adjudicacion_serv_dir_main.php
...
var elemento={idContenedor:idContenedor,pagina:new pag_adj_serv_dir(idContenedor,direccion,paramConfig,idContenedorPadre)};
...
function pag_adj_serv_dir(idContenedor,direccion,paramConfig,idContenedorPadre)
{
	...
	var ds = new Ext.data.Store({
		...
		//jun2015
		,'codigo_item','nombre_item','id_item','num_sol'
		]),remoteSort:true});
...
// txt id_cotizacion
	...
	//----------- FUNCIONES RENDER
     ...
     function InitDetalleAdj(id_servicio,id_cotizacion,cantidad_cotizada,servicio_cotizado,adj, es_item){
			...
			function reloadDetalleGrupo(id_servicio,id_cotizacion,cantidad_cotizada,servicio_cotizado,adj, es_item){
						...
						if(SelectionsRecord.data.estado=='adjudicado'){
						   ...
						   //gDlg.buttons[0].disable();
							...
							// if(parseFloat(SelectionsRecord.data.id_servicio_cotizado)>0 ){//|| SelectionsRecord.data.monto_aprobado<SelectionsRecord.data.precio){
									var item_cotiz;
										 if(sw_grup){
											  if(parseFloat(SelectionsRecord.data.es_item)==0){
						 							if(SelectionsRecord.data.id_servicio_cotizado>0){
								     						item_cotiz=SelectionsRecord.data.id_servicio_cotizado;
													}else{
									 						item_cotiz=0;
