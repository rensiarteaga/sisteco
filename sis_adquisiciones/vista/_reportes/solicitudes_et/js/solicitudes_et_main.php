...
var elemento={pagina:new pagina_solicitudes_et(idContenedor,direccion,empleado,paramConfig,vista),idContenedor:idContenedor};
...
* Autor:				AVQ
* Fecha creación:		26/06/2009
*/
function pagina_solicitudes_et(idContenedor,direccion,empleado,paramConfig,vista)
{
	//alert (vista);
	...
	switch (vista)
		{
			case 'tiempos_estados_x_solicitud_detalle': 
				...
				var paramFunciones = {
					...
					height:'100%',
					url:direccion+'../../../../control/_reportes/solicitudes_et/ActionPDFRepSolicitudesTiemposEstados.php',
