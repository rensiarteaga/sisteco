...
var elemento={pagina:new pagina_prestacion_servicios(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
vectorAtributos[12]={
	...
	function iniciarEventosFormularios(){
		...
		combo_desc_tipo_adq=ClaseMadre_getComponente('desc_tipo_adq');
		...
		function funComboTipoAdq(combo,record,index){
			//alert ("entra aqui por fa");
			//componentes[10].setValue(index);
			combo_tipo_servicio.filterValues[0]=record.data.id_tipo_adq;
			combo_tipo_servicio.modificado = true;
			combo_desc_tipo_adq.setValue(record.data.descripcion);
