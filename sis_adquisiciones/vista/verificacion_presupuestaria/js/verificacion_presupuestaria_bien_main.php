...
function pagina_verificacion_presupuestaria_bien(idContenedor,direccion,paramConfig,tipo,id_empleado){
	...
	var ds = new Ext.data.Store({
		...
		'aprobador',
		'tiene_presupuesto',
		'permite_agrupar','tiene_suplente','suplente','id_presupuesto','desc_presupuesto','nro_solicitud_cadena','es_item'
		]),remoteSort:true});
...
//		};
		...
		{*/
			var config={titulo_maestro:'Aprobacion XXXX',grid_maestro:'grid-'+idContenedor,urlHijo:'../../../sis_adquisiciones/vista/detalle_solicitud_servicio/detalle_seguimiento_solicitud_det.php'};
		//}
