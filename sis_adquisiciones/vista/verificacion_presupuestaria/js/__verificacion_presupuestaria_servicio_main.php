...
var elemento={pagina:new pagina_verificacion_presupuestaria_servicio(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
	...
	function btn_anular(){
		...
		else
		{
			...
			function btn_suplente(){
				...
				var ParamVentana={Ventana:{width:450,height:150}};
