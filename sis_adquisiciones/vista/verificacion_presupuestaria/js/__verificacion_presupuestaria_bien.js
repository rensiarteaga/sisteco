function pagina_verificacion_presupuestaria_bien(idContenedor,direccion,paramConfig,tipo,id_empleado){
	...
	var ds = new Ext.data.Store({
		...
		'aprobador',
		'tiene_presupuesto',
		'permite_agrupar','tiene_suplente','suplente','id_presupuesto','desc_presupuesto','nro_solicitud_cadena'
		]),remoteSort:true});
...
//		
		...
		Atributos[10]={
			...
			filtro_0:true,
			filtro_1:true,
			filterColValue:'ppto.desc_presupuesto'
		};
		// txt localidad
		Atributos[11]={
			validacion:{
...
//		};
		...
		if(tipo=='bien'){
		     var config={titulo_maestro:'Verificacion Presupuestaria XXX',grid_maestro:'grid-'+idContenedor,urlHijo:'../../../sis_adquisiciones/vista/detalle_verificacion_solicitud_bien/detalle_verificacion_solicitud_det.php'};
		}
		else
		{
			var config={titulo_maestro:'Aprobacion XXXX',grid_maestro:'grid-'+idContenedor,urlHijo:'../../../sis_adquisiciones/vista/detalle_verificacion_solicitud_servicio/detalle_verificacion_solicitud_det.php'};
		}
	...
	function btn_cert_pres(){
		...
		else
		{
			...
			this.AdicionarBoton('../../../lib/imagenes/print.gif','Certificación Presupuestaria',btn_cert_pres,true,'ver_cert_pres','Certificación Presupuestaria');
