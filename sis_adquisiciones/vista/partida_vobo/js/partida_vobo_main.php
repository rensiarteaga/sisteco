...
var maestro={id_vobo_detalle:<?php echo $m_id_vobo_detalle;?>};

idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_partida_vobo(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
