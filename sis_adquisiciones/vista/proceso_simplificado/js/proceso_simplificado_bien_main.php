...
var elemento={pagina:new pag_proc_simplif_bien(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
					...
					var SelectionsRecord=sm.getSelected();
    					...
    					var ParamVentana={title:'Cotizaciones Recepcionadas',Ventana:{width:'85%',height:'85%'}}
    					 if(((SelectionsRecord.data.id_caja_regis>0|| SelectionsRecord.data.id_cuenta_doc>0) &&SelectionsRecord.data.tipo_recibo=='provisorio')||SelectionsRecord.data.tipo_recibo=='pago'){
                                lay_proc_simplif_factura.loadWindows(direccion+'../../../../sis_adquisiciones/vista/proceso_simplificado/proceso_simplificado_factura_serv.php?'+data,'Registro de Factura',ParamVentana);
