<?php 
/**
 * Nombre:		  	    proceso_fin_simplificado_main.php
...
var elemento={pagina:new pag_proc_fin_simplif_bien(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
/**
* Nombre:		  	    pagina_proc_fin_simplif_main.js
* Propósito: 			pagina objeto principal
* Autor:				Generado Automaticamente
* Fecha creación:		2008-05-13 18:03:05
*/
function pag_proc_fin_simplif_bien(idContenedor,direccion,paramConfig){
...
//	    
	 ...
	 Atributos[11]={
		...
		lay_proc_fin_simplif_factura=new DocsLayoutMaestro(idContenedor);
		lay_proc_fin_simplif_factura.init(config);
		...
		this.pagina(paramConfig,Atributos,ds,lay_proc_fin_simplif_factura,idContenedor);
		...
		var paramFunciones={
			...
			function btn_proceso_compra_det(){
				...
				if(NumSelect!=0){
					...
					lay_proc_fin_simplif_factura.loadWindows(direccion+url,'Procedimiento Detalle',ParamVentana);
					lay_proc_fin_simplif_factura.getVentana().on('resize',function(){
						lay_proc_fin_simplif_factura.getLayout().layout();
					})
				}
				else
				{
			...
			this.getLayout=function(){return lay_proc_fin_simplif_factura.getLayout()};
			...
			lay_proc_fin_simplif_factura.getLayout().addListener('layout',this.onResize);//aregla la forma en que se ve el grid dentro del layout
