 ...
 */
function pagina_preaprobacion_solicitud_servicio(idContenedor,direccion,paramConfig,id_empleado_s){
...
// txt id_fina_regi_prog_proy_acti
	...
	*/
	...
	function btn_suplente(){
		var data='id_empleado='+id_empleado_s+'&subsis=COMPRO&vista=pre';
		var ParamVentana={Ventana:{width:450,height:200}};
		layout_preaprobacion_solicitud_servicio.loadWindows(direccion+'../../../../sis_adquisiciones/vista/suplente/suplente.php?'+data,'Suplente',ParamVentana)
	}
