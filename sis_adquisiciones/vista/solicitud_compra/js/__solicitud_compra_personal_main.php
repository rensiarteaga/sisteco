...
var empleado={
	    	id_empleado:<?php echo $_SESSION['ss_id_empleado'];?>, nombre_empleado:'<?php echo $_SESSION['ss_nombre_empleado'];?>',paterno_empleado:'<?php echo $_SESSION["ss_paterno_empleado"];?>', materno_empleado:'<?php echo $_SESSION["ss_materno_empleado"];?>', id_empresa:<?php echo $_SESSION['ss_id_empresa'];?>,id_usuario:<?php echo $_SESSION['ss_id_usuario'];?>,nombre_usuario:_CP.getConfig().ss_nombre_usuario}
var elemento={pagina:new pagina_solicitud_compra_personal(idContenedor,direccion,empleado,paramConfig),idContenedor:idContenedor};
