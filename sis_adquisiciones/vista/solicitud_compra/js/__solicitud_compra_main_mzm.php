...
* Autor:				Generado Automaticamente
* Fecha creacion:		2008-05-09 09:11:12
*/

//modificar  el onSelect de solicitante para que cuando elija id_tipo_categoria filtre despues los RPAs en base a la categoria que eligio y seguir
...
function pagina_solicitud_compra(idContenedor,direccion,usuario,paramConfig){
	...
	var ds = new Ext.data.Store({
		...
		//,'tipo_presu'
,'id_correspondencia','id_presupuesto','desc_presupuesto','correspondencia_asociada','id_gestion','es_item'
		]),remoteSort:true});
...
*/
	...
	reader:new Ext.data.XmlReader({record:'ROWS',id:'id_presupuesto',totalRecords: 'TotalCount'},['id_presupuesto','tipo_pres','estado_pres','id_unidad_organizacional','nombre_unidad','id_fina_regi_prog_proy_acti',
																																								...
																																								'cp_cod_organismo_fin','cp_cod_fuente_financiamiento','codigo_sisin','obliga_ot'
...
*/
	...
	Atributos[39]={
		...
		var paramFunciones={
			...
			//funcion para terminar la orden de ingreso
