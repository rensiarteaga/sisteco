...
function pagina_seguimiento_solicitud_per_servicio(idContenedor,direccion,paramConfig){
	...
	var ds = new Ext.data.Store({
		...
		'aprobador',
		'monto_total'
		,'transcriptor','id_presupuesto','desc_presupuesto'
		]),remoteSort:true});
...
// txt id_fina_regi_prog_proy_acti
	...
	var config={titulo_maestro:'seguimiento_solicitud',grid_maestro:'grid-'+idContenedor,urlHijo:'../../../sis_adquisiciones/vista/detalle_seguimiento_solicitud_servicio/detalle_seguimiento_solicitud_det.php'};
