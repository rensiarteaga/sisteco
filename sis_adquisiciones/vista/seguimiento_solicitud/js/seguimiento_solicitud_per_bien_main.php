...
var elemento={pagina:new pagina_seguimiento_solicitud_per_bien(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
function pagina_seguimiento_solicitud_per_bien(idContenedor,direccion,paramConfig){
	...
	var ds = new Ext.data.Store({
		...
		'preaprobador',
		'aprobador',
		'monto_total','id_presupuesto','desc_presupuesto','es_item'
		]),remoteSort:true});
