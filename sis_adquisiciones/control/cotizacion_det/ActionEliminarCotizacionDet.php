...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCotizacionDet.php
Propósito:				Permite eliminar registros de la tabla tad_cotizacion_det
...
$nombre_archivo = "ActionEliminarCotizacionDet.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_cotizacion_det == "undefined" || $id_cotizacion_det == "")
		{
			$resp = new cls_manejo_mensajes(true, "406");
		...
		{	//Eliminación
			$res = $Custom-> EliminarCotizacionDet($id_cotizacion_det);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
