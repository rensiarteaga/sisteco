...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarDetalleSeguimientoSolicitud.php
Propósito:				Permite eliminar registros de la tabla tad_solicitud_compra_det
...
$nombre_archivo = "ActionEliminarDetalleSeguimientoSolicitud.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDetalleSeguimientoSolicitud($id_solicitud_compra_det);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	$res = $Custom->ContarDetalleSeguimientoSolicitud($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
