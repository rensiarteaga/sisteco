...
/**
**********************************************************
Nombre de archivo:	    ActionListarDetalleSeguimientoSolicitud.php
...
Fecha de Creación:		2008-05-16 15:31:58
Versión:				1.0.0
...
$nombre_archivo = 'ActionListarDetalleSeguimientoSolicitud .php';
...
//Parámetros del filtro
	...
	$cond->add_criterio_extra("SEGSOL.id_solicitud_compra",$m_id_solicitud_compra);
	...
	$res = $Custom -> ContarDetalleSeguimientoSolicitud($cant ,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);

	if($res) $total_registros= $Custom->salida;

	//Obtiene el conjunto de datos de la consulta
	$res = $Custom->ListarDetalleSeguimientoSolicitud($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
