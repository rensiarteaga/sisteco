...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			...
			//8ago11
			$doc_respaldo= $_GET["doc_respaldo_$j"];
		...
		else
		{
			...
			//8ago11
			$doc_respaldo= $_POST["doc_respaldo_$j"];
		...
		if ($id_categoria_adq == "undefined" || $id_categoria_adq == "")
		{
			...
			$res = $Custom -> InsertarCategoriaAdq($id_categoria_adq, $nombre, $observaciones, $descripcion, $fecha_reg, $precio_min, $precio_max, $id_moneda,$norma,$simplificada,$defecto,$doc_respaldo);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarCategoriaAdq($id_categoria_adq, $nombre, $observaciones, $descripcion, $fecha_reg, $precio_min, $precio_max, $id_moneda,$norma,$simplificada,$defecto,$doc_respaldo);
