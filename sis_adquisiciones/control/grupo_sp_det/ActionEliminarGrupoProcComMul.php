...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarGrupoProcComMul.php
Propósito:				Permite eliminar registros de la tabla tad_grupo_sp_det
...
$nombre_archivo = "ActionEliminarGrupoProcComMul.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarGrupoProcComMul($id_grupo_sp_det);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
