...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarProveedor.php
Propósito:				Permite eliminar registros de la tabla tad_proveedor
...
$nombre_archivo = "ActionEliminarProveedor.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarProveedor($hidden_id_proveedor);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
