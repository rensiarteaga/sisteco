...
//			$rubro2= $_GET["rubro2"];
			...
			//institucion
			$nombre_ins=$_GET["nombre_ins"];
			$direccion_ins=$_GET["direccion_ins"];
			$id_tipo_doc_institucion=$_GET["id_tipo_doc_institucion"];
			$doc_id=$_GET["doc_id"];
			$con_contacto=$_GET["con_contacto"];
			//datos contacto
			$telefono1=$_GET["telefono1"];
			$telefono2=$_GET["telefono2"];
			$celular1=$_GET["celular1"];
...
//			$rubro2= $_POST["rubro2"];
			...
			$id_tipo_doc_institucion=$_POST["id_tipo_doc_institucion"];
			$doc_id=$_POST["doc_id"];
			$con_contacto=$_POST["con_contacto"];
			//datos contacto
			$telefono1=$_POST["telefono1"];
			$telefono2=$_POST["telefono2"];
			$celular1=$_POST["celular1"];
...
//			}
			...
			$res=$Custom->InsertarNuevoProveedor($tipo_proveedor,$id_depto,	$id_rubro,$nombre_ins,$direccion_ins,$id_tipo_doc_institucion,
			$doc_id,$con_contacto,$telefono1,$telefono2,$celular1,$celular2,$fax,$email1,$email2,$pag_web,$rubro1,$rubro2,$tipo,$apellido_paterno,$apellido_materno,$nombre_p,$id_tipo_doc_identificacion,$doc_id_p,$direccion_p,$apellido_paterno_c,$apellido_materno_c,$nombre_c,$telefono1_c,$celular1_c,$email1_c,$tipo_contacto,$direccion_c
			,$nombre_pago,$codigo
			);
