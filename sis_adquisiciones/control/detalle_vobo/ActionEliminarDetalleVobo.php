...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarPartidaVobo.php
Propósito:				Permite eliminar registros de la tabla tad_partida_vobo
Tabla:					tad_partida_vobo

Valores de Retorno:    	Número de registros
Fecha de Creación:		2010-02-05
Versión:				1.0.0
...
$nombre_archivo = "ActionEliminarDetalleVobo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarDetalleVobo($id_vobo_detalle);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
