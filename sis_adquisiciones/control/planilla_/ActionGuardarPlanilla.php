...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_planilla == "undefined" || $id_planilla == "")
		{
				...
				$res = $Custom->InsertarPlanilla($id_planilla,$observaciones,$fecha_planilla,$id_gestion,$id_periodo,$id_depto_tesoro,$plantilla);
				  if(!$res)
					{
						//Se produjo un error
						$resp = new cls_manejo_mensajes(true, "406");
		...
		{	///////////////////////Modificación////////////////////
			...
			if($con_plantilla=='si'){
				...
				$res = $Custom->ModificarPlanilla($id_planilla,$observaciones,$fecha_planilla,$id_gestion,$id_periodo,$id_depto_tesoro,$plantilla);
				  if(!$res)
					{
						//Se produjo un error
						$resp = new cls_manejo_mensajes(true, "406");
