...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($id_proveedor_cuenta_auxiliar == "undefined" || $id_proveedor_cuenta_auxiliar == "")
		{
			...
			$res = $Custom -> InsertarProveedorCuentaDetalle($id_proveedor_cuenta_auxiliar, $id_proveedor,$id_cuenta,$id_auxiliar,$id_gestion,$tipo,$id_cuenta_anticipo,$id_cuenta_garantia,$id_cuenta_descuento);
		...
		{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarProveedorCuentaDetalle($id_proveedor_cuenta_auxiliar, $id_proveedor,$id_cuenta,$id_auxiliar,$id_gestion,$tipo,$id_cuenta_anticipo,$id_cuenta_garantia,$id_cuenta_descuento);
