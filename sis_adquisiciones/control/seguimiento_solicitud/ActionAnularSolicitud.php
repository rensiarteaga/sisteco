...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	
			$res = $Custom-> AnularSolicitud($hidden_id_solicitud_compra,$observaciones);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	$res = $Custom->ContarSeguimientoSolicitud($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,'');
