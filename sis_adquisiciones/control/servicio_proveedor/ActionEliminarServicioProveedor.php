...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarServicioProveedor.php
Propósito:				Permite eliminar registros de la tabla tad_servicio_proveedor
...
$nombre_archivo = "ActionEliminarServicioProveedor.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarServicioProveedor($hidden_id_servicio_proveedor);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
