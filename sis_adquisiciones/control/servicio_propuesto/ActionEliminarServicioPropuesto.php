...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarServicioPropuesto.php
Propósito:				Permite eliminar registros de la tabla tad_servicio_propuesto
Tabla:					tad_tad_servicio_propuesto
Parámetros:				$hidden_id_servicio_propuesto
...
$nombre_archivo = "ActionEliminarServicioPropuesto.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarServicioPropuesto($hidden_id_servicio_propuesto);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
