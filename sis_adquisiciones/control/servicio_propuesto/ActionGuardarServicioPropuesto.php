...
Propósito:				Permite insertar y modificar datos en la tabla tad_servicio_propuesto
...
exit;
	*/		//Validación de datos (del lado del servidor)
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tad_servicio_propuesto
