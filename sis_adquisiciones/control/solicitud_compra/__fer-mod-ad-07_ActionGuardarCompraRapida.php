...
Fecha de Creación:		2008-07-01 17:05:11
Versión:				1.0.0
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		else
		{
	       ...
	       if($simplificada=='NO'){
			$res = $Custom->ModificarCompraRapida($id_solicitud_compra,$codigo_proceso,$observaciones_proceso,$_SESSION['ss_id_empresa'],$pago_variable);
	       }
	       else{
	       	$res = $Custom->ModificarCompraRapidaSimplificada($id_solicitud_compra,$codigo_proceso,$observaciones_proceso,$_SESSION['ss_id_empresa'],$id_comprador,$tipo_recibo);
