...
//	exit;
	...
	$criterio_filtro= $criterio_filtro. " AND (SOLADQ.estado_vigente_solicitud in (''borrador'',''pre_aprobado'',''aprobado''))";
...
//exit;
	...
	if($res)
	{
		...
		foreach ($Custom->salida as $f)
		{
			...
			$f["id_correspondencia"]=str_replace("{","",$f["id_correspondencia"]);
			$f["id_correspondencia"]=str_replace("}","",$f["id_correspondencia"]);
