...
//Se obtiene el criterio del filtro con formato sql para mandar a la BD
	...
	/*echo "mmm no se que sera no entra a nada".$m_id_solicitud_compra.'----'.$criterio_filtro;
	exit;*/
	...
	$solicitud_det = array();
		...
		//$_SESSION['PDF_solicitud']=$Custom->salida;
			...
			{ 
				...
				$_SESSION['PDF_gestion']=$f["gestion"];
				 $_SESSION['PDF_nro_generacion_sc']=$f["nro_generacion_sc"];
				 $_SESSION['PDF_ot']=$f["ot"];
		...
		$_SESSION['PDF_nom_usuario']=$nom_usuario;
