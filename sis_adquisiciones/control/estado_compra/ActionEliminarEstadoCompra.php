...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarEstadoCompra.php
Propósito:				Permite eliminar registros de la tabla tad_estado_compra
...
$nombre_archivo = "ActionEliminarEstadoCompra.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarEstadoCompra($hidden_id_estado_compra);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
