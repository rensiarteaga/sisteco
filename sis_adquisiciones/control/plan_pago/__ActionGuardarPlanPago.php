...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
				   ...
				   if($terminado!=''){
						...
						//Validación de datos (del lado del servidor)
						  ...
						  if(!$res)
							...
							$res = $Custom -> InsertarPlanPago($id_plan_pago, $tipo_pago, $nro_cuota, $fecha_pago, $monto_original, $estado, $id_cotizacion,$id_gestion,$id_avance,$por_anticipo,$por_retgar);
		...
		$res = $Custom->ModificarPlanPago($id_plan_pago, $tipo_pago, $nro_cuota, $fecha_pago, $monto_original, $estado, $id_cotizacion,$fecha_pagado,$num_factura,$observaciones,$boleta_garantia,$num_autoriza_factura,$cod_control_factura,$fecha_factura,$multas,$tipo_plantilla,$id_gestion,$id_avance,$por_anticipo,$por_retgar);
				  if(!$res)
					{
						//Se produjo un error
						$resp = new cls_manejo_mensajes(true, "406");
