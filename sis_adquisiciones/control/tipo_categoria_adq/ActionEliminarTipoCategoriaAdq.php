...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarTipoCategoriaAdq.php
Propósito:				Permite eliminar registros de la tabla tad_tipo_categoria_adq
Tabla:					tad_tad_tipo_categoria_adq
Parámetros:				$id_tipo_categoria_adq
...
$nombre_archivo = "ActionEliminarTipoCategoriaAdq.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarTipoCategoriaAdq($id_tipo_categoria_adq);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
