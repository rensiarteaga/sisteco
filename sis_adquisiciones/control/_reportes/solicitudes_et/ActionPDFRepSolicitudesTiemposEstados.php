...
//Se obtiene el criterio del filtro con formato sql para mandar a la BD
    ...
    switch ($estados[$i]) {
    	...
    	break;
 		...
 		case 'Proceso':
 			if($i==0){
      	    	$estado_cons=$estado_cons." estado_solicitud like ''p_activo''";
    		  }else{
            	$estado_cons=$estado_cons." or estado_solicitud like ''p_activo''";
 		     }  
		break;
		case 'Cotizacion':
			if($i==0){
   ...
   $UOCabecera = array();
	...
	$SETDetalle = $Custom->ListarSolEstadosTiemposDetalle($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$id_fina_regi_prog_proy_acti,$id_unidad_organizacional,$txt_fecha_desde,$txt_fecha_hasta,$tipo_adq);
