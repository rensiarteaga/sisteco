...
Propósito:				Permite realizar el listado en tad_proceso_compra_det
...
Fecha de Creación:		2008-05-20 17:42:45
Versión:				1.0.0
...
$nombre_archivo = 'ActionListarProcesoCompraMulSerDet .php';
...
//Parámetros del filtro
	...
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,'ProcesoCompraMulSerDet');
	$sortcol = $crit_sort->get_criterio_sort();
	

	//Obtiene el total de los registros
	$res = $Custom -> ContarProcesoCompraMulSerDet($cant ,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);

	if($res) $total_registros= $Custom->salida;

	//Obtiene el conjunto de datos de la consulta
	$res = $Custom->ListarProcesoCompraMulSerDet($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
	...
	if($res)
	{
		...
		foreach ($Custom->salida as $f)
		{
        	...
        	$xml->add_nodo('nombre_tipo_servicio',$f['nombre_tipo_servicio']);
