...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		if ($get)
		{
			...
			//jun2015
			$tiene_anticipo=$_GET["tiene_anticipo_$j"];
			$ancitipo_con_ejecucion=$_GET["anticipo_con_ejecucion_$j"];
				
			//ago2015
			$con_contrato=$_GET["con_contrato_$j"];
			$id_cotizacion_ampliacion=$_GET["id_cotizacion_ampliacion_$j"];
		...
		else
		{
			...
			//jun2015
			$tiene_anticipo=$_POST["tiene_anticipo_$j"];
			$ancitipo_con_ejecucion=$_POST["anticipo_con_ejecucion_$j"];
				
			//ago2015
			$con_contrato=$_POST["con_contrato_$j"];
			$id_cotizacion_ampliacion=$_POST["id_cotizacion_ampliacion_$j"];
		...
		$id_empresa=$_SESSION["ss_id_empresa"];
			...
			if($bandera_fin>0){
				...
				if($estado_vigente=='formulacion_pp' || $estado_vigente=='en_pago'){
					...
					//ago2015:campo id_empresa albergará el valor de id_cotizacion_ampliacion
				    ...
				    $res = $Custom->ModificarCotizacionOrdenCompra($id_cotizacion, $lugar_entrega, $forma_pago, $fecha_entrega,
				     ...
				     $tipo_plantilla,$por_adelanto,$por_retgar,$nro_contrato,$monto_adelanto_moneda_cotizada,$fecha_ini_ctto,$fecha_fin_ctto,$tiene_anticipo,$ancitipo_con_ejecucion,$con_contrato,$id_cotizacion_ampliacion);
