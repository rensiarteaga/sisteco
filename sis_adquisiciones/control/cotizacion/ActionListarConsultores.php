...
//Parámetros del filtro
	...
	if($en_planilla=='no'){
		...
		if($en_planilla=='si'){
			...
			AND PLA.nro_cuota=(select min(nro_cuota) from compro.tad_plan_pago where id_cotizacion=c.id_cotizacion and estado=''pendiente'') and c.estado_vigente in (''en_pago'',''formulacion_pp'') ";
		}
	}
