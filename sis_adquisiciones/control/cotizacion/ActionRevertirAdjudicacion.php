...
/**
**********************************************************
Nombre de archivo:	    ActionRevertirAdjudicacion.php
Propósito:				Permite anular las adjudicaciones realizadas, revertir Ordenes de Compra, Ordenes de Ingreso a Almacenes(si el proceso es de bienes), siempre que no se hayan realizado pagos
...
$nombre_archivo = "ActionRevertirAdjudicacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	//Realiza el bucle por todos los ids mandados
		$res = $Custom->RevertirAdjudicacion($id_cotizacion,$id_proceso_compra);
 		    if(!$res)
			   {
					//Se produjo un error
					$resp = new cls_manejo_mensajes(true, "406");
