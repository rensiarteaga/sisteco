...
Propósito:				Permite insertar y modificar datos en la tabla tsg_metaproceso_envio_alerta
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_metaproceso_envio_alerta == "undefined" || $hidden_id_metaproceso_envio_alerta == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tsg_metaproceso_envio_alerta
