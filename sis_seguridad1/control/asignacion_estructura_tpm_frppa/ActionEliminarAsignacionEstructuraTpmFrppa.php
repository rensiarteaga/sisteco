...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarAsignacionEstructuraTpmFrppa.php
Propósito:				Permite eliminar registros de la tabla tsg_asignacion_estructura_tpm_frppa
...
$nombre_archivo = "ActionEliminarAsignacionEstructuraTpmFrppa.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarAsignacionEstructuraTpmFrppa($hidden_id_asignacion_estructura_frppa);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
