...
$nombre_archivo = 'ActionListarNivelSeguridad.php';
...
//Par�metros del filtro
	...
	if($_SESSION["ss_rol_adm"]==0){
		$criterio_filtro.=" and prioridad<=(select prioridad 
											from sss.tsg_usuario u 
											inner join tsg_nivel_seguridad ns 
											on(ns.id_nivel_seguridad=u.id_nivel_seguridad)
	...
	//$crit_sort = new cls_criterio_sort($sortcol,$sortdir,'id_nivel_seguridad');
	...
	$res = $Custom->ListarNivelSeguridad($cant,$puntero,$sortcol,$sortdir,$criterio_filtro);
		if($res)
	{
