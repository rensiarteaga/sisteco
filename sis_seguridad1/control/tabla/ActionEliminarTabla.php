...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarTabla.php
Propósito:				Permite eliminar registros de la tabla tsg_tabla
Tabla:					tsg_tsg_tabla
Parámetros:				$id_tabla
...
$nombre_archivo = "ActionEliminarTabla.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarTabla($id_tabla);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
