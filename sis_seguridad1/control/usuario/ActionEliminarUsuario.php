...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarUsuario.php
Propósito:				Permite eliminar registros de la tabla tsg_usuario
...
$nombre_archivo = "ActionEliminarUsuario.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarUsuario($hidden_id_usuario);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
