...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarCampo.php
Propósito:				Permite eliminar registros de la tabla tsg_campo
Tabla:					tsg_tsg_campo
Parámetros:				$id_campo
...
$nombre_archivo = "ActionEliminarCampo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarCampo($id_campo);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
