<?php
/**
 * Nombre del archivo:	ActionEliminarPersona.php
 * Propósito:			Permite eliminar registros de Persona
 * Tabla:				tsg_persona
 * Parámetros:			
 * Valores de Retorno:	
 * Autor:				
...
if($_SESSION['autentificado']=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_persona == "undefined" || $hidden_id_persona =="")
		{
			...
			$resp->mensaje_error = "MENSAJE ERROR = No existe la Persona especificada para eliminar.";
			$resp->origen = "ORIGEN = $nombre_archivo";
			$resp->proc = "PROC = $nombre_archivo";
			$resp->nivel = "NIVEL = 4";
			echo $resp->get_mensaje();
