...
Propósito:				Permite insertar y modificar datos en la tabla tsg_registro_evento
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_registro_eventos == "undefined" || $hidden_id_registro_eventos == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tsg_registro_evento
