...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarParametroGeneral.php
Propósito:				Permite eliminar registros de la tabla tsg_parametro_general
Tabla:					tsg_tsg_parametro_general
Parámetros:				$hidden_id_parametro_general
...
$nombre_archivo = "ActionEliminarParametroGeneral.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarParametroGeneral($hidden_id_parametro_general);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
