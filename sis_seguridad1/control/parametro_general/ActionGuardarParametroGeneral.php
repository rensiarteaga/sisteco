...
Propósito:				Permite insertar y modificar datos en la tabla tsg_parametro_general
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		if ($hidden_id_parametro_general == "undefined" || $hidden_id_parametro_general == "")
		{
			...
			//Validación satisfactoria, se ejecuta la inserción en la tabla tsg_parametro_general
