...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarAsignacionEstructura.php
Propósito:				Permite eliminar registros de la tabla tsg_asignacion_estructura
...
$nombre_archivo = "ActionEliminarAsignacionEstructura.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarAsignacionEstructura($hidden_id_asignacion_estructura);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
