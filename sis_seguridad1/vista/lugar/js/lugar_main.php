...
var elemento={pagina:new pagina_lugar(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
function pagina_lugar(idContenedor,direccion,paramConfig)
{
	...
	ds = new Ext.data.Store({
		...
		reader: new Ext.data.XmlReader({
			...
			'sw_municipio',
			'nombre_nivel',
			'sw_impuesto','prioridad_kard','sigla_sigma'
		]),remoteSort:true});
...
// txt observacion
	...
	vectorAtributos[13]= {
		...
		filtro_0:true,
		filtro_1:true,
		filterColValue:'LUGARR.prioridad_kard',
		save_as:'prioridad_kard',
		id_grupo:2
	};
