<?php 
/**
 * Nombre:		  	    asignacion_estructura_main.php
...
?>
//<script>
var pagina_asignacion_estructura;
...
var elemento={pagina:new pagina_asignacion_estructura(idContenedor,direccion,paramConfig),idContenedor:'<?php echo $idContenedor;?>'};
 ...
 * Autor:				Generado Automaticamente
 * Fecha creaciï¿½n:		2007-10-31 11:34:02
 */
...
// txt fecha_ultima_modificacion
	vectorAtributos[5]= {
		validacion:{
			...
			fieldLabel:'Fecha Ultima Modificaciï¿½n',
			allowBlank:true,
			format: 'd/m/Y', //formato para validacion
			minValue: '01/01/1900',
			disabledDaysText: 'Dia no valido',
