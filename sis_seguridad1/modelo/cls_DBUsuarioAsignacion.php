<?php
/**
 * Nombre de la clase:	cls_DBUsuarioAsignacion.php
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tsg_tsg_usuario_asignacion
 * Autor:				(autogenerado)
 * Fecha creación:		2007-10-26 17:45:05
 */

class cls_DBUsuarioAsignacion
{
	var $salida;
	var $query;
	var $var;
	 ...
	 * Propósito:				Desplegar los registros de tsg_usuario_asignacion
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-26 17:45:05
	 */
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tsg_usuario_asignacion_sel';
		$this->codigo_procedimiento = "'SG_USUASG_SEL'";
		...
		$this->var->add_def_cols('id_usuario_asignacion','int4');
	 ...
	 * Propósito:				Contar los registros de tsg_usuario_asignacion
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-26 17:45:05
	 */
	function ContarUsuarioAsignacion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tsg_usuario_asignacion_sel';
		$this->codigo_procedimiento = "'SG_USUASG_COUNT'";
	 ...
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tsg_usuario_asignacion
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-26 17:45:05
	 */
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tsg_usuario_asignacion_iud';
		$this->codigo_procedimiento = "'SG_USUASG_INS'";
	 ...
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tsg_usuario_asignacion
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-26 17:45:05
	 */
	function ModificarUsuarioAsignacion($id_usuario_asignacion,$id_asignacion_estructura,$id_usuario)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tsg_usuario_asignacion_iud';
		$this->codigo_procedimiento = "'SG_USUASG_UPD'";

		//Instancia la clase midlle para la ejecución de la función de la BD
		$this->var = new cls_middle($this->nombre_funcion,$this->codigo_procedimiento,$this->decodificar);
		$this->var->add_param($id_usuario_asignacion);
		$this->var->add_param($id_asignacion_estructura);
		$this->var->add_param($id_usuario);
	 ...
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tsg_usuario_asignacion
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-26 17:45:05
	 */
	function EliminarUsuarioAsignacion($id_usuario_asignacion)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tsg_usuario_asignacion_iud';
		$this->codigo_procedimiento = "'SG_USUASG_DEL'";
	 ...
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tsg_usuario_asignacion
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-26 17:45:05
	 */
	function ValidarUsuarioAsignacion($operacion_sql,$id_usuario_asignacion,$id_asignacion_estructura,$id_usuario)
	{
		...
		if($operacion_sql=='insert' || $operacion_sql=='update')
		{
			...
			{
				//Validar id_usuario_asignacion - tipo int4
				$tipo_dato->_reiniciar_valor();
				$tipo_dato->set_MaxLength(10);
				$tipo_dato->set_Columna("id_usuario_asignacion");

				if(!$valid->verifica_dato($tipo_dato->TipoDatoInteger(), "id_usuario_asignacion", $id_usuario_asignacion))
				{
