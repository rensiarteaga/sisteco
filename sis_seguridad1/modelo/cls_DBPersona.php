...
class cls_DBPersona
{
	...
	function ListarPersona($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
	 ...
	 //	$this->var->add_def_cols('foto_persona','bytea');
		...
		$this->var->add_def_cols('apellido_casada','varchar');  
		$this->var->add_def_cols('libreta_militar','varchar'); 
		$this->var->add_def_cols('num_complementario_doc_identif','varchar');
			...
			)
	{
		...
		$this->var->add_param("'$expedicion'");
		//24.04.2014
	
		$this->var->add_param("'$apellido_casada'");
		$this->var->add_param("'$libreta_militar'");
		$this->var->add_param("'$num_complementario_doc_identif'");
	...
	function InsertarPersonaFoto($id_persona, $apellido_paterno, $apellido_materno, $nombre, $fecha_nacimiento,
	                             ...
	                             $id_tipo_doc_identificacion,$expedicion)
	{
	...
	function SubirFoto($id_persona, $txt_foto_persona, $nombre_foto, $numero, $extension, $id_empleado, $vista_per)
	{
		...
		{
			//echo '1';
			$this->nombre_funcion = 'f_tsg_persona_foto_gral';
			$this->codigo_procedimiento = "'SG_FOTOG_UPD'";
		}
		else 
		{
			//echo '2';
			$this->nombre_funcion = 'f_tsg_persona_foto';
			$this->codigo_procedimiento = "'SG_FOTO_UPD'";
		}
		//exit;
		...
		$this->var = new cls_middle($this->nombre_funcion,$this->codigo_procedimiento,$this->decodificar);
		$this->var->add_param($id_persona);		
		$this->var->add_archivo($txt_foto_persona);		
		$this->var->add_param("'$nombre_foto'");
		$this->var->add_param($numero);		
		$this->var->add_param("'$extension'");
	...
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tsg_pers_foto_sel';
		$this->codigo_procedimiento = "'SG_PERS_FOTO_SEL'";
	...
	function SeleccionarIdsPersona($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_persona)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tsg_pers_foto_sel';
		$this->codigo_procedimiento = "'SG_IDPERS_SEL'";
...
//			}
	...
	function ModificarPersonaEmpleado($id_persona,$apellido_paterno,$apellido_materno,$nombre,$fecha_nacimiento,$foto_persona,$doc_id,$genero,$casilla,$telefono1,$telefono2,$celular1,$celular2,$pag_web,$email1,$email2,$email3,$fecha_registro,$hora_registro,$fecha_ultima_modificacion,$hora_ultima_modificacion,$observaciones,$id_tipo_doc_identificacion,$direccion,$nro_registro,$nombre_foto,$numero,$extension,$expedicion)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tsg_persona_iud';
		$this->codigo_procedimiento = "'SG_PEREMP_UPD'";
