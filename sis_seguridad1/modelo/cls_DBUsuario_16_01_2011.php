...
/*echo $this->query;
	 ...
	 * Fecha de creación:		2007-10-26 17:44:00
	 */
	function InsertarUsuario($id_usuario,$id_persona,$login,$contrasenia,$fecha_registro,$hora_registro,$fecha_ultima_modificacion,$hora_ultima_modificacion,$estado_usuario,$estilo_usuario,$filtro_avanzado,$fecha_expiracion)
	{
		$this->salida = "";
		...
		$this->var->add_param("'$contrasenia'");
	...
	function ModificarUsuarioPref($id_usuario,$contrasenia,$contrasenia_nueva,$contrasenia_nueva_rep,$estilo_usuario)
	{
		...
		$this->var->add_param("'$contrasenia_nueva'");//login
		...
		$this->var->add_param("'$contrasenia_nueva_rep'");//estado_usuario
