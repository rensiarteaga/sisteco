 ...
 * Prop�sito:			Permite ejecutar toda la funcionalidad de la tabla tsg_tsg_usuario
 * Autor:				(autogenerado)
 * Fecha creaci�n:		2007-10-26 17:44:00
 */
...
class cls_DBUsuario
{
	...
	*/
	/**
	 * Funcion que verifica el usuario y contrase�a (agregada de la anterior version por Enzo)
	 *
	...
	/**
	 * Nombre de la funci�n:	ListarUsuario
	 * Prop�sito:				Desplegar los registros de tsg_usuario
	 * Autor:				    (autogenerado)
...
/*echo $this->query;
	...
	/**
	 * Nombre de la funci�n:	ContarUsuario
	 * Prop�sito:				Contar los registros de tsg_usuario
	 * Autor:				    (autogenerado)
	 * Fecha de creaci�n:		2007-10-26 17:44:00
	 */
	...
	/**
	 * Nombre de la funci�n:	InsertarUsuario
	 * Prop�sito:				Permite ejecutar la funci�n de inserci�n de la tabla tsg_usuario
	 * Autor:				    (autogenerado)
	 * Fecha de creaci�n:		2007-10-26 17:44:00
	 */

	function InsertarUsuario($id_usuario,$id_persona,$login,$contrasenia,$fecha_registro,$hora_registro,$fecha_ultima_modificacion,$hora_ultima_modificacion,$estado_usuario,$estilo_usuario,$filtro_avanzado,$fecha_expiracion,$autentificacion)
	{
		$this->salida = "";
   ...
   function ModificarUsuario($id_usuario,$id_persona,$login,$contrasenia,$fecha_registro,$hora_registro,$fecha_ultima_modificacion,$hora_ultima_modificacion,$estado_usuario,$estilo_usuario,$filtro_avanzado,$fecha_expiracion,$autentificacion)
	{
	...
	/**
	 * Nombre de la funci�n:	EliminarUsuario
	 * Prop�sito:				Permite ejecutar la funci�n de eliminaci�n de la tabla tsg_usuario
	 * Autor:				    (autogenerado)
	 * Fecha de creaci�n:		2007-10-26 17:44:00
	 */
...
exit;
	...
	/**
	 * Nombre de la funci�n:	ListarUsuarioVista
	 * Prop�sito:				Desplegar los registros de tsg_usuario
	 * Autor:				    RCM
	 * Fecha de creaci�n:		22/04/2010
	 */
	...
	/**
	 * Nombre de la funci�n:	ValidarUsuario
	 * Prop�sito:				Permite ejecutar la validaci�n del lado del servidor de la tabla tsg_usuario
	 * Autor:				    (autogenerado)
	 * Fecha de creaci�n:		2007-10-26 17:44:00
	 */
	function ValidarUsuario($operacion_sql,$id_usuario,$id_persona,$login,$contrasenia,$fecha_registro,$hora_registro,$fecha_ultima_modificacion,$hora_ultima_modificacion,$estado_usuario,$estilo_usuario,$filtro_avanzado)
	{
		...
		if($operacion_sql=='insert' || $operacion_sql=='update')
		{
			...
			{
				$this->salida[0] = "f";
				$this->salida[1] = "Error de validacion en columna 'filtro_avanzado': El valor no esta dentro del dominio definido";
