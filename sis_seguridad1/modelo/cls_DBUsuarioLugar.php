 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla tsg_tsg_usuario_lugar
 * Autor:				(autogenerado)
 * Fecha creación:		2007-10-26 17:44:38
 */
...
class cls_DBUsuarioLugar
{
	...
	/**
	 * Nombre de la función:	ListarUsuarioLugar
	 * Propósito:				Desplegar los registros de tsg_usuario_lugar
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-26 17:44:38
	 */
	...
	/**
	 * Nombre de la función:	ContarUsuarioLugar
	 * Propósito:				Contar los registros de tsg_usuario_lugar
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-26 17:44:38
	 */
	...
	/**
	 * Nombre de la función:	InsertarUsuarioLugar
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tsg_usuario_lugar
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-26 17:44:38
	 */
	...
	/**
	 * Nombre de la función:	ModificarUsuarioLugar
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tsg_usuario_lugar
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-26 17:44:38
	 */
	...
	/**
	 * Nombre de la función:	EliminarUsuarioLugar
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tsg_usuario_lugar
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-26 17:44:38
	 */
	...
	/**
	 * Nombre de la función:	ValidarUsuarioLugar
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tsg_usuario_lugar
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-10-26 17:44:38
	 */
