 ...
 * Propósito:			Permite ejecutar toda la funcionalidad de la tabla presto.tpr_caif
 * Autor:				(autogenerado)
...
class cls_DBClasificadorCaifArb{
	...
	/**
	 * ***********************************************************
	 * Para el Manejo de Árboles
	 * 
	 * 
	 ************************************************************* 
	 */
	/**
	 * Nombre de la función:	ListarCaifRaiz
	 * Propósito:				Desplegar los registros de tpr_caif
	 * Autor:				    (autogenerado)
	...
	/**
	 * Nombre de la función:	ListarcaifIngresoRaiz
	 * Propósito:				Desplegar los registros de tpr_caif
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-07 15:46:18
	 */
	...
	/**
	 * Nombre de la función:	ListarcaifArb
	 * Propósito:				Desplegar los registros de tpr_caif
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-07 15:46:18
	 */
	...
	/**
	 * Nombre de la función:	ContarcaifArb
	 * Propósito:				Contar los registros de tpr_caif
	 * Autor:				    (autogenerado)
	...
	/**
	 * Nombre de la función:	InsertarcaifRaiz
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tpr_caif
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-07 15:46:18
	 */
	...
	/**
	 * Nombre de la función:	InsertarCaifArb
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tpr_caif
	 * Autor:				    (autogenerado)	
	 * Fecha de creación:		2007-11-07 15:46:18
	 */
	...
	/**
	 * Nombre de la función:	ModificarcaifArb
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tpr_caif
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-07 15:46:18
	 */
...
/*echo $this->query ;
	...
	/**
	 * Nombre de la función:	EliminarcaifArb
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tpr_caif
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-07 15:46:18
	 */
	...
	/**
	 * Nombre de la función:	EliminarcaifRaiz
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tpr_caif
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2007-11-07 15:46:18
	 */
