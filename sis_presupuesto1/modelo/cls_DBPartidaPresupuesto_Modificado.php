 ...
 * Autor:				(autogenerado)
 * Fecha creación:		2008-10-13 17:48:39
 */
...
class cls_DBPartidaPresupuesto
{
	...
	/**
	 * Nombre de la función:	ListarEjecucion
	 * Propósito:				Desplegar los registros de tpr_partida_presupuesto
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-10-13 17:48:39
	 */
	function ListarEjecucion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpr_partida_presupuesto_sel';
		$this->codigo_procedimiento = "'PR_EJEUNI_SEL'";
		...
		$this->var->add_def_cols('importe_com_eje','numeric');
	...
	/**
	 * Nombre de la función:	ContarEjecucion
	 * Propósito:				Contar los registros de tpr_partida_presupuesto
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-10-13 17:48:39
	 */
	function ContarEjecucion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpr_partida_presupuesto_sel';
		$this->codigo_procedimiento = "'PR_EJEUNI_COUNT'";
	...
	/**
	 * Nombre de la función:	InsertarEjecucion
	 * Propósito:				Permite ejecutar la función de inserción de la tabla tpr_partida_presupuesto
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-10-13 17:48:39
	 */
	function InsertarEjecucion($id_partida_presupuesto,$fecha_elaboracion,$id_partida,$id_presupuesto,$importe_com_eje,$id_partida_detalle,$mes_01,$mes_02,$mes_03,$mes_04,$mes_05,$mes_06,$mes_07,$mes_08,$mes_09,$mes_10,$mes_11,$mes_12,$total,$id_moneda)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpr_partida_presupuesto_iud';
		$this->codigo_procedimiento = "'PR_EJEUNI_INS'";
		...
		$this->var->add_param($importe_com_eje);
	...
	/**
	 * Nombre de la función:	ModificarEjecucion
	 * Propósito:				Permite ejecutar la función de modificación de la tabla tpr_partida_presupuesto
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-10-13 17:48:39
	 */
	function ModificarEjecucion($id_partida_presupuesto,$fecha_elaboracion,$id_partida,$id_presupuesto,$importe_com_eje,$id_partida_detalle,$mes_01,$mes_02,$mes_03,$mes_04,$mes_05,$mes_06,$mes_07,$mes_08,$mes_09,$mes_10,$mes_11,$mes_12,$total,$id_moneda)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpr_partida_presupuesto_iud';
		$this->codigo_procedimiento = "'PR_EJEUNI_UPD'";
	...
	/**
	 * Nombre de la función:	EliminarEjecucion
	 * Propósito:				Permite ejecutar la función de eliminación de la tabla tpr_partida_presupuesto
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-10-13 17:48:39
	 */
	function EliminarEjecucion($id_partida_presupuesto)
	{
		$this->salida = "";
		$this->nombre_funcion = 'f_tpr_partida_presupuesto_iud';
		$this->codigo_procedimiento = "'PR_EJEUNI_DEL'";
	...
	/**
	 * Nombre de la función:	ValidarEjecucion
	 * Propósito:				Permite ejecutar la validación del lado del servidor de la tabla tpr_partida_presupuesto
	 * Autor:				    (autogenerado)
	 * Fecha de creación:		2008-10-13 17:48:39
	 */
	function ValidarEjecucion($operacion_sql,$id_partida_presupuesto,$fecha_elaboracion,$id_partida,$id_presupuesto,$importe_com_eje,$id_partida_detalle,$mes_01,$mes_02,$mes_03,$mes_04,$mes_05,$mes_06,$mes_07,$mes_08,$mes_09,$mes_10,$mes_11,$mes_12,$total,$id_moneda)
	{
		$this->salida = "";
		...
		if($operacion_sql=='insert' || $operacion_sql=='update')
		{
			...
			//Validar fecha_elaboracion - tipo date
			$tipo_dato->_reiniciar_valor();
			$tipo_dato->set_Columna("fecha_elaboracion");
			$tipo_dato->set_MaxLength(10);
			$tipo_dato->set_AllowBlank(true);
			if(!$valid->verifica_dato($tipo_dato->TipoDatoDate(), "fecha_elaboracion", $fecha_elaboracion))
			{
				$this->salida = $valid->salida;
				return false;
			}
			...
			//Validar importe_com_eje - tipo numeric
			$tipo_dato->_reiniciar_valor();
			$tipo_dato->set_Columna("importe_com_eje");
			$tipo_dato->set_MaxLength(1179650);
			$tipo_dato->set_AllowBlank(true);
			if(!$valid->verifica_dato($tipo_dato->TipoDatoReal(), "importe_com_eje", $importe_com_eje))
			{
				$this->salida = $valid->salida;
				return false;
			}
