...
class cls_CustomDBPresupuesto{
	...
	function __construct(){
		...
		include_once("cls_DBCaiffAjusteCbte.php");
		include_once("cls_DBCaif.php");
...
/// --------------------- tpr_categoria_prog --------------------- ///
	...
	function InsertarSietCbte($id_siet_cbte,$id_siet_declara,$id_extracto_bancario,$sw_ingresa_declaracion,$sw_fa)
	{
		$this->salida = "";
		$dbSietCbte = new cls_DBSietCbte($this->decodificar);
		$res = $dbSietCbte ->InsertarSietCbte($id_siet_cbte,$id_siet_declara,$id_extracto_bancario,$sw_ingresa_declaracion,$sw_fa);
		$this->salida = $dbSietCbte ->salida;
		$this->query = $dbSietCbte ->query;
		return $res;
	}
	...
	function InsertarSietCbtePartidaExcel($id_siet_cbte,$importe,$codigo_partida,$codigo_oec)
	{
		$this->salida = "";
		$dbSietCbtePartida = new cls_DBSietCbtePartida($this->decodificar);
		$res = $dbSietCbtePartida ->InsertarSietCbtePartidaExcel($id_siet_cbte,$importe,$codigo_partida,$codigo_oec);
		$this->salida = $dbSietCbtePartida ->salida;
		$this->query = $dbSietCbtePartida ->query;
		return $res;
	}
	...
	function ModificarExtractoBancario($id_extracto_bancario,$sub_tipo_importe,$observaciones,$id_cbte)
	{
		$this->salida = "";
		$dbExtractoBancario = new cls_DBExtractoBancario($this->decodificar);
		$res = $dbExtractoBancario ->ModificarExtractoBancario($id_extracto_bancario,$sub_tipo_importe,$observaciones,$id_cbte);
		$this->salida = $dbExtractoBancario ->salida;
		$this->query = $dbExtractoBancario ->query;
		return $res;
	}
...
/*********************SIET TRASPASOS ************/
	...
	function ListarCaiffAjusteCbte($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad)
	
	{
		$this->salida = "";
		$dbCaiffAjusteCbte = new cls_DBCaiffAjusteCbte($this->decodificar);
		$res = $dbCaiffAjusteCbte ->ListarCaiffAjusteCbte($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
		$this->salida = $dbCaiffAjusteCbte->salida;
		$this->query = $dbCaiffAjusteCbte->query;
		return $res;
	}
    function ContarCaiffAjusteCbte($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad)
	
	{
		$this->salida = "";
		$dbCaiffAjusteCbte = new cls_DBCaiffAjusteCbte($this->decodificar);
		$res = $dbCaiffAjusteCbte ->ContarCaiffAjusteCbte($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
		$this->salida = $dbCaiffAjusteCbte->salida;
		$this->query = $dbCaiffAjusteCbte->query;
		return $res;
	}
	function ListarCaiffAjusteTra($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad)
	
	{
		$this->salida = "";
		$dbCaiffAjusteCbte = new cls_DBCaiffAjusteCbte($this->decodificar);
		$res = $dbCaiffAjusteCbte ->ListarCaiffAjusteTra($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
	    $this->salida = $dbCaiffAjusteCbte->salida;
		$this->query = $dbCaiffAjusteCbte->query;
		return $res;
	}
	function ContarCaiffAjusteTra($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad)
	
	{
		$this->salida = "";
		$dbCaiffAjusteCbte = new cls_DBCaiffAjusteCbte($this->decodificar);
		$res = $dbCaiffAjusteCbte ->ContarCaiffAjusteTra($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
		$this->salida = $dbCaiffAjusteCbte->salida;
		$this->query = $dbCaiffAjusteCbte->query;
		return $res;
	}
	...
	{
		$this->salida = "";
		$dbCaif = new cls_DBCaif($this->decodificar);
		$res = $dbCaif ->ListarCaifField($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbCaif->salida;
		$this->query = $dbCaif->query;
		return $res;
	}
	...
	
	{
		$this->salida = "";
		$dbCaif = new cls_DBCaif($this->decodificar);
		$res = $dbCaif ->ContarCaifField($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbCaif->salida;
		$this->query = $dbCaif->query;
		return $res;
	}
	...
	
	{
		$this->salida = "";
		$dbCaif = new cls_DBCaif($this->decodificar);
		$res = $dbCaif ->ContarCaifPartida($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbCaif->salida;
		$this->query = $dbCaif->query;
		return $res;
	}
	...
	
	{
		$this->salida = "";
		$dbCaif = new cls_DBCaif($this->decodificar);
		$res = $dbCaif ->ListarCaifPartida($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
		$this->salida = $dbCaif->salida;
		$this->query = $dbCaif->query;
		return $res;
	}
