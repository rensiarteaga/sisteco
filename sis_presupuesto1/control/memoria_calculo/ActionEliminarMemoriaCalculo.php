...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarMemoriaCalculo.php
Propósito:				Permite eliminar registros de la tabla tpr_memoria_calculo
...
$nombre_archivo = "ActionEliminarMemoriaCalculo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarMemoriaCalculo($id_memoria_calculo);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
