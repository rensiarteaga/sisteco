...
/**
**********************************************************
Nombre de archivo:	    ActionGenerarSietOECs.php
Propósito:				Permite insertar oecs a los comprobantes que ingresaran a la declaración
...
$nombre_archivo = "ActionGenerarSietPartidas.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		//Validación satisfactoria, se ejecuta la inserción en la tabla tpr_categoria<a
			...
			$res = $Custom ->GenerarSietOecs($id_siet_declara);
			if(!$res)
			{
				//Se produjo un error
				$resp = new cls_manejo_mensajes(true, "406");
