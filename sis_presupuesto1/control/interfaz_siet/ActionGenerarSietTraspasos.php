...
/**
**********************************************************
Nombre de archivo:	    ActionGenerarSietTraspasos.php
Propósito:				Permite insertar y modificar datos en la tabla tpr_siet_traspasos
Tabla:					tpr_siet_traspasos
Parámetros:				$id_siet_traspaso
...
$nombre_archivo = "ActionGenerarSietTraspasos.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		//Validación satisfactoria, se ejecuta la inserción en la tabla tpr_categoria<a
			...
			$res = $Custom ->GenerarSietTraspaso($id_siet_declara);
			if(!$res)
			{
				//Se produjo un error
				$resp = new cls_manejo_mensajes(true, "406");
