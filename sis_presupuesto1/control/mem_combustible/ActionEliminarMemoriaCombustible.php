...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarMemoriaCombustible.php
Propósito:				Permite eliminar registros de la tabla tpr_mem_combustible
...
$nombre_archivo = "ActionEliminarMemoriaCombustible.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarMemoriaCombustible($id_mem_combustible);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
