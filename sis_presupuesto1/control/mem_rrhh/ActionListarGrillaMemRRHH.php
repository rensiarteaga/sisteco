...
$nombre_archivo = 'ActionListarGrillaMemRRHH.php';
...
if($_SESSION['autentificado']=='SI')
{
	...
	$cond->add_criterio_extra("MEMCAL.id_memoria_calculo",$id_memoria_calculo);
	
	$criterio_filtro = $cond -> obtener_criterio_filtro();
	
	//Filtramos por el id moneda
	if($filtro==1){
		$criterio_filtro=$criterio_filtro." AND MEMRRH.id_moneda=".$id_moneda;
	}
