...
/**
**********************************************************
Nombre de archivo:	    ActionListarCaiff.php
...
$nombre_archivo = 'ActionListarCaiff .php';
...
//Par�metros del filtro
	...
	if($sort == '') $sortcol = 'id_caiff'; //nombre_unidad
	else $sortcol = $sort;
	...
	$crit_sort = new cls_criterio_sort($sortcol,$sortdir,'CAIF');
	...
	$res = $Custom->ListarCaiff($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$hidden_ep_id_financiador,$hidden_ep_id_regional,$hidden_ep_id_programa,$hidden_ep_id_proyecto,$hidden_ep_id_actividad);
	...
	if($res)
	{
		...
		{
			$xml->add_rama('ROWS');
			$xml->add_nodo('id_caiff',$f["id_caiff"]);
