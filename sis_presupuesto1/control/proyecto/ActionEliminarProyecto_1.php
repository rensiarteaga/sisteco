...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarProyecto.php
Propósito:				Permite eliminar registros de la tabla tpr_proyecto
Tabla:					tpr_tpr_proyecto
...
$nombre_archivo = "ActionEliminarProyecto.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarProyecto($id_proyecto);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
