...
if($_SESSION['autentificado']=="SI"){
	        ...
	        if($res){
	        	...
	        	if($tipo_reporte=="Periodo"){
	         		header("location:PDFMemoriaCalculoPasaje.php?id_partida_presupuesto=$id_partida_presupuesto&id_presupuesto=$id_presupuesto&tipo_memoria=$tipo_memoria&id_partida=$id_partida&id_moneda=$id_moneda");	        			        	              
	        	}
	        	else{
	        		header("location:PDFMemoriaCalculoPasajeGeneral.php?id_partida_presupuesto=$id_partida_presupuesto&id_presupuesto=$id_presupuesto&tipo_memoria=$tipo_memoria&id_partida=$id_partida&id_moneda=$id_moneda");	        			        	              
	        	}	         
	        }
			else{
