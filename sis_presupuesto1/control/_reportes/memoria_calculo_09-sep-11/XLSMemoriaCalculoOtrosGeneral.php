<?php
	...
	$nombre_archivo='MEMORIA_CALC_OTROS_GRAL.xls';
    ...
    $nuevahoja->write(18,2,'COSTO UNITARIO',$negritaCentrado);
    $nuevahoja->write(18,3,'COSTO TOTAL',$negritaCentrado);	
	...
	$res = $Custom->ListarRepGralMemoriaCalculoOtros($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
	...
	if($res)
	{
		...
		$res2 = $CustomS->SumaCostoMemoriaCalculoOtros(15,0,'','',$criterio_suma,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
