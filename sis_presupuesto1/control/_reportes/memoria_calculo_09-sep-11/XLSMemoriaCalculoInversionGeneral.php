<?php
	...
	$nombre_archivo='MEMORIA_CALC_INV_GRAL.xls';
	$docexcel = new Spreadsheet_Excel_Writer(); //creamos una instancia de excel
	$nuevahoja =& $docexcel->addWorksheet($_SESSION['rep_mem_cal_codigo_partida']); //colocamos nombre a la pestaña
	...
	$nuevahoja->write(4,2,'ANTEPROYECTO PRESUPUESTO GESTIÓN '.$_SESSION['rep_mem_cal_gestion_pres'],$titulo2);
	...
	$nuevahoja->write(14,4,'GESTIÓN:     '.$_SESSION['rep_mem_cal_gestion_pres'],$bordesSimplesNegrita);
    ...
    $nuevahoja->write(18,1,'DESCRIPCIÓN',$negritaCentrado);
    $nuevahoja->write(18,2,'CANTIDAD',$negritaCentrado);
    $nuevahoja->write(18,3,'COSTO UNITARIO',$negritaCentrado);
    $nuevahoja->write(18,4,'COSTO TOTAL',$negritaCentrado);	
	$nuevahoja->write(18,5,'JUSTIFICACIÓN',$negritaCentrado);	
	...
	$res = $Custom->ListarRepGralMemoriaInversion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
	...
	if($res)
	{
		...
		$res2 = $CustomS->SumaCostoMemoriaInversion(15,0,'','',$criterio_suma,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
		...
		$nuevahoja->write($fila,5,'',$bordesSimplesNegrita);
