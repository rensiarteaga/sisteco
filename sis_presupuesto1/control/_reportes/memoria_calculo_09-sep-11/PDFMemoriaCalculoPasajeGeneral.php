...
class PDF extends FPDF
{
	...
	function LoadData($id_partida_presupuesto,$id_presupuesto,$tipo_memoria,$id_partida,$id_moneda,$tipo_pres,$cod_prog,$cod_proy,$cod_act,$cod_fuente_fin,$cod_organismo){
		...
		$Custom->ListarRepGralMemoriaCalculoPasaje($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad,$cod_prog,$cod_proy,$cod_act,$cod_fuente_fin,$cod_organismo);		
	    $data=$Custom->salida;
	    return $data;
	}
