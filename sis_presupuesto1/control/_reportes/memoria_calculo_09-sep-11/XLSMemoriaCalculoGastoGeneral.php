<?php
	...
	$nombre_archivo='MEMORIA_CALC_GASTO_GRAL.xls';
	...
	$res = $Custom->ListarRepGralMemoriaGasto($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
	...
	if($res)
	{
		...
		$res2 = $CustomS->SumaCostoMemoriaGasto(15,0,'','',$criterio_suma,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
