...
class PDF extends FPDF
{
	...
	function LoadData($id_partida_presupuesto,$id_presupuesto,$tipo_memoria,$id_partida,$id_moneda,$tipo_pres){ 
		...
		$Custom->ListarRepMemoriaInversion($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
	...
	/*	$this->SetFillColor(255,255,255);
		...
		$CustomC->ContarRepMemoriaInversion(15,0,'','',$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
		...
		$w=array(10,50,20,15,19,17,40);
			...
			//Datos			    
				...
				$this->SetAligns(array('C','L','C','C','R','R','L','J'));
			    ...
			    $this->SetFormatNumber(array(0,0,0,0,1,1,0,0));				   	  
		       ...
		       /*foreach($data as $row){       
					...
					$this->MultiCell($w[6],4,$row[6],'R','L',0);
					//$this->Ln(4);
					$numero=$numero+1;
			    }*/
