...
class PDF extends FPDF
{
	...
	function LoadData($id_partida_presupuesto,$id_presupuesto,$tipo_memoria,$id_partida,$id_moneda,$tipo_pres){
		...
		$Custom->ListarRepGralMemoriaServicio($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
	...
	function FancyTable($data,$id_partida_presupuesto,$id_presupuesto,$tipo_memoria,$id_partida,$id_moneda,$tipo_pres){
		...
		$CustomC->ContarRepGralMemoriaServicio(15,0,'','',$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
		...
		$w=array(10,65,25);
			...
			//Datos			    
			   ...
			   $this->Cell(25,4,number_format($suma_total, 2, '.', ','),'LTRB',0,'R'); 	
			   $this->Cell(65,4,'',1,0,'L');					   
			   $this->Ln(4);
