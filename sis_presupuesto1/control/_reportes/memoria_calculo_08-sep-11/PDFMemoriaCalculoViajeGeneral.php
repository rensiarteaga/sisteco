...
class PDF extends FPDF
{
	...
	$this->Cell(75,4,'DESCRIPCIÓN','R',0,'C');
	$this->Cell(15,4,'Nro. DIAS','R',0,'C');
	$this->Cell(20,4,'COSTO VIATICOS','R',0,'C');
	$this->Cell(20,4,'COSTO ANUAL','R',0,'C');
	$this->Cell(50,4,'JUSTIFICACIÓN','R',0,'C');
	$this->Ln(4);
	$this->SetFont('Arial','B',4);
	$this->Cell(10,3,'','LBR',0,'C');
	$this->Cell(75,3,'','BR',0,'C');
	$this->Cell(15,3,'','BR',0,'C');
	$this->Cell(20,3,'('.$_SESSION['rep_mem_cal_simbolo'].')','BR',0,'C');
	$this->Cell(20,3,'('.$_SESSION['rep_mem_cal_simbolo'].')','BR',0,'C');
	$this->Cell(50,3,'','BR',0,'C');
	$this->Ln(3);
	$this->Cell(10,4,'','LR',0,'L');
	$this->Cell(75,4,'','R',0,'L');
	...
	function LoadData($id_partida_presupuesto,$id_presupuesto,$tipo_memoria,$id_partida,$id_moneda,$tipo_pres){
		...
		$Custom->ListarRepGralMemoriaCalculoViaje($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
	    $data=$Custom->salida;
	    return $data;
	}
	//Tabla coloreada
	function FancyTable($data,$id_partida_presupuesto,$id_presupuesto,$tipo_memoria,$id_partida,$id_moneda,$tipo_pres){
		...
		$CustomC->ContarRepGralMemoriaCalculoViaje(15,0,'','',$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
		...
		$w=array(10,75,15,20,20,50);			
			...
			//Datos					
				$numero=1;
				$this->SetWidths(array(10,75,15,20,20,50));
		       ...
		       /*foreach($data as $row){       
					...
					$this->MultiCell($w[5],4,$row[4],'RL','J',0);
					//$this->Ln(4);
					$numero=$numero+1;
			    }
