	        ...
	        if($res){
	    		...
	    		{	
		        	...
		        	if($tipo_reporte=="Periodo"){
		         		header("location:PDFMemoriaCalculoCombustible.php?id_partida_presupuesto=$id_partida_presupuesto&id_presupuesto=$id_presupuesto&tipo_memoria=$tipo_memoria&id_partida=$id_partida&id_moneda=$id_moneda&tipo_pres=$tipo_pres");	        			        	              
		        	}
		        	else{
		        		header("location:PDFMemoriaCalculoCombustibleGeneral.php?id_partida_presupuesto=$id_partida_presupuesto&id_presupuesto=$id_presupuesto&tipo_memoria=$tipo_memoria&id_partida=$id_partida&id_moneda=$id_moneda&tipo_pres=$tipo_pres");	        			        	              
		        	}
		        }   
	    		else 
	    		{
