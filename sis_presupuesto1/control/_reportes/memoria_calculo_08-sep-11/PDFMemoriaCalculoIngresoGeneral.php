...
class PDF extends FPDF
{
	...
	function LoadData($id_partida_presupuesto,$id_presupuesto,$tipo_memoria,$id_partida,$id_moneda,$tipo_pres){
		...
		$Custom->ListarRepMemoriaCalculoIngreso($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
	...
	function FancyTable($data,$id_partida_presupuesto,$id_presupuesto,$tipo_memoria,$id_partida,$id_moneda,$tipo_pres){
		...
		$CustomC->ContarRepMemoriaCalculoIngreso(15,0,'','',$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
	    $cantidad=sizeof($CustomC->salida);
	    $CustomS= new cls_CustomDBPresupuesto();
		$CustomS->SumaCostoMemoriaCalculoIngreso(15,0,'','',$criterio_suma,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);		
		...
		$w=array(10,65,29,29,57);			
			...
			//Datos					
			    ...
			    $this->SetFormatNumber(array(0,0,0,1,0));				   	  
		       ...
		       /*foreach($data as $row){       
					...
					//$this->MultiCell($w[4],4,$row[3],'R',0,'L');
					$this->MultiCell($w[4],4,$row[3],'R','J',0);
					//$this->Ln(4);
					$numero=$numero+1;
			    }
			   for($i=1;$i<=$restante;$i++){
					...
					//$this->MultiCell($w[4],4,'','R',0,'L');
					$this->MultiCell($w[4],4,'','R','J',0);
					//$this->Ln(4);
					$numero=$numero+1;
			   }*/
			   $this->SetFont('Arial','',7);
...
$pdf->AddPage();$pdf->FancyTable($data,$id_partida_presupuesto,$id_presupuesto,$tipo_memoria,$id_partida,$id_moneda,$tipo_pres);
$pdf->Output();
?>