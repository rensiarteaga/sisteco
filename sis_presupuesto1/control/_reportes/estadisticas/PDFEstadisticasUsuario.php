...
$pdf->Cell(0,4,'CANTIDAD DE TRANSACCIONES POR USUARIO',0,1,'C');

$pdf->SetFont('Arial','B',8);
$pdf->Ln();
$pdf->Cell(50,4,'Gestión: '.$_SESSION['PDF_gestion'],0,1,'L');
$pdf->Cell(50,4,'Subsistema: '.$_SESSION['PDF_subsistema'],0,1,'L');
$pdf->Ln();
$pdf->SetFont('Arial','B',6);

//$pdf->SetX(75);
$pdf->Cell(5,6,'Nº','LRTB',0,'C');
$pdf->Cell(55,6,'USUARIO','LRTB',0,'C');
...
$v_estadisticas_usuario=array();
$v_estadisticas_usuario=$_SESSION['PDF_estadisticas_usuario'];
...
for($i=0;$i<count($v_estadisticas_usuario);$i++)
{
	$pdf->SetFont('Arial','',6);
	$pdf->Cell(5,3,$i+1,1,0,'C');
	$pdf->MultiTabla($v_estadisticas_usuario[$i],0,3,3,6,1);
}
