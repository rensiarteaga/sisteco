...
$nombre_archivo='MemoriaCalculoOtros.php';
...
if($_SESSION['autentificado']=="SI"){
		    ...
		    {
		    	$criterio_filtro=$condicion." and VPRE.cod_prg = $cod_prog and vpre.cod_proy = $cod_proy and vpre.cod_act = $cod_act and vpre.cod_fin = $cod_fuente_fin and vpre.codigo_fuente = $cod_organismo and MEMCAL.tipo_detalle = $tipo_memoria AND MONEDA.id_moneda = $id_moneda";
		    }
	        $res=$Custom->ListarCabMemoriaCalculoCombustible($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad);
	        if($res){
	    		...
	    		{	
		        	...
		        	if($tipo_reporte=="Periodo"){
		         		header("location:PDFMemoriaCalculoCombustible.php?id_partida_presupuesto=$id_partida_presupuesto&id_presupuesto=$id_presupuesto&tipo_memoria=$tipo_memoria&id_partida=$id_partida&id_moneda=$id_moneda&tipo_pres=$tipo_pres&cod_prog=$cod_prog&cod_proy=$cod_proy&cod_act=$cod_act&cod_fuente_fin=$cod_fuente_fin&cod_organismo=$cod_organismo");	        			        	              
		        	}
		        	else{
		        		header("location:PDFMemoriaCalculoCombustibleGeneral.php?id_partida_presupuesto=$id_partida_presupuesto&id_presupuesto=$id_presupuesto&tipo_memoria=$tipo_memoria&id_partida=$id_partida&id_moneda=$id_moneda&tipo_pres=$tipo_pres&cod_prog=$cod_prog&cod_proy=$cod_proy&cod_act=$cod_act&cod_fuente_fin=$cod_fuente_fin&cod_organismo=$cod_organismo");	        			        	              
		        	}
		        }   
	    		else 
	    		{
