<?php
	...
	$nuevahoja =& $docexcel->addWorksheet($_SESSION['rep_mem_serv_codigo_partida']); //colocamos nombre a la pesta�a
	...
	$nuevahoja->write(4,2,'ANTEPROYECTO PRESUPUESTO GESTI�N '.$_SESSION['rep_mem_serv_gestion_pres'],$titulo2);
	...
	$nuevahoja->write(14,4,'GESTION:     '.$_SESSION['rep_mem_serv_gestion_pres'],$bordesSimplesNegrita);
    ...
    $nuevahoja->write(18,1,'DESCRIPCION DEL SERVICIO',$negritaCentrado);
