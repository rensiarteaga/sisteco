...
class PDF extends FPDF
{
	...
	$this->Cell(180,10,'INCREMENTO PRESUPUESTARIO',0,0,'C');
	$this->Ln(5);	
	...
	$this->Cell(180,10,'Fecha Incremento: '.$_SESSION['rep_fecha_conclusion'],0,0,'C');
	$this->Ln(10);
...
//Parte 2	
	/*$this->SetX(30);
	$this->Cell(200,10,'TRASPASO DE:',0,0,'L');
	$this->Ln(10);
	$this->SetX(30);
...
//Parte 3	
	$this->SetX(30);
	$this->Cell(200,10,'INCREMENTO A:',0,0,'L');
	$this->Ln(10);
	$this->SetX(30);
	$this->Cell(60,4,'UNIDAD ORGANIZACIONAL','LTRB',0,'L');	
...
//FIRMAS	
	...
	{*/
		...
		$this->Cell(75,4,$_SESSION['rep_desc_usuario_destino'],0,0,'C');
		
		$this->Ln(4);
		$this->SetX(30);
		$this->Cell(75,4,'RESPONSABLE REGISTRO',0,0,'C');
		$this->Cell(75,4,'RESPONSABLE APROBACIÓN',0,0,'C');
