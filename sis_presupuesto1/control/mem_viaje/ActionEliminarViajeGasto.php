...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarViajeGasto.php
Propósito:				Permite eliminar registros de la tabla tpr_mem_viaje
...
$nombre_archivo = "ActionEliminarViajeGasto.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarViajeGasto($id_mem_viaje);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
