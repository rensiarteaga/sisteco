...
function Header()
{
    ...
    $this->Cell(0,7,'CONSOLIDACIÓN PRESUPUESTARIA',0,0,'C'); //dibuja una celad con contenido y orientacion  x, y 
    ...
    $this->Ln(8);
     ...
     $epe=" ";   
      $bandera=false;
     if($_SESSION['regional']){$epe=$epe."REGIONAL: ".$_SESSION['regional'];$bandera=true;}
    	...
    	$this->SetFont('Arial','B',8);
   		$this->Cell(0,2,$_SESSION['desc_estado_gral'],0,0,'R');
