...
class PDF extends FPDF
{
	...
	function Header()
	{
	    ...
	    $this->Ln();
	    $this->Cell(0,4,'Del '.$_SESSION['fecha_ini'].' Al '.$_SESSION['fecha_fin']." ",0,0,'C'); //dibuja una celad con contenido y orientacion  x, y 
	    $this->Ln(3);
	    ...
	    $this->MultiCell(200,2,$_SESSION['Fuente_financiamiento']);
	...
	function maestro()
	{
		...
		for($i=0;$i<$_SESSION['CantFiltros'];$i++)
		{
		 ...
		 $fecha= substr( $_SESSION['fecha_fin'],3,2)."/".substr($_SESSION['fecha_fin'],0,2)."/".substr( $_SESSION['fecha_fin'],6,4);
		 $fecha_ini= substr( $_SESSION['fecha_ini'],3,2)."/".substr($_SESSION['fecha_ini'],0,2)."/".substr( $_SESSION['fecha_ini'],6,4);
		 
		 $res = $Custom->ListarEjecucionPartidaFech($_SESSION['limit'],$_SESSION['start'],'codigo_partida','asc',$criterio_filtro,$id_financiador,$id_regional,$id_programa,$id_proyecto,$id_actividad ,$_SESSION['tipo_pres'],$_SESSION['id_parametro'],$_SESSION['id_moneda'],$_SESSION['ids_u_o'],$_SESSION['ids_financiador'],$_SESSION['ids_regional'],$_SESSION['ids_programa'],$_SESSION['ids_proyecto'],$_SESSION['ids_actividad'],$_SESSION['sw_vista'],$fecha,$fecha_ini);
