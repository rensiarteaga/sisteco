...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarConceptoIngas.php
Propósito:				Permite eliminar registros de la tabla tpr_concepto_ingas
...
$nombre_archivo = "ActionEliminarConceptoCta.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarConceptoCta($id_concepto_cta);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
	...
	if($criterio_filtro == "") $criterio_filtro = "CONCTA.id_concepto_cta=''$id_concepto_cta''";
