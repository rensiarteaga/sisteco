 ...
 if ($reporte_excel=='si')
	{	$fecha= substr( $_GET['fecha_fin'],3,2)."/".substr( $_GET['fecha_fin'],0,2)."/".substr( $_GET['fecha_fin'],6,4);
       $fecha_ini= substr( $_GET['fecha_ini'],3,2)."/".substr( $_GET['fecha_ini'],0,2)."/".substr( $_GET['fecha_ini'],6,4);
		...
		$res = $Custom->ListarEjecucionPartida($cant,$puntero,$sortcol,$sortdir,$criterio_filtro,$_GET['id_financiador'],$_GET['id_regional'],$_GET['id_programa'],$_GET['id_proyecto'],$_GET['id_actividad'],$_GET['tipo_pres'],$_GET['id_parametro'],$_GET['id_moneda'],$_GET['ids_fuente_financiamiento'],$_GET['ids_u_o'],$_GET['ids_financiador'],$_GET['ids_regional'],$_GET['ids_programa'],$_GET['ids_proyecto'],$_GET['ids_actividad'],$_GET['sw_vista'],$_GET['ids_concepto_colectivo'],$fecha,$fecha_ini);
