...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarNivelPartida.php
Propósito:				Permite eliminar registros de la tabla tpr_nivel_partida
...
$nombre_archivo = "ActionEliminarNivelPartida.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarNivelPartida($id_nivel_partida);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
