...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarPartidaModificacion.php
Propósito:				Permite eliminar registros de la tabla tpr_partida_modificacion
...
$nombre_archivo = "ActionEliminarPartidaModificacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarPartidaModificacion($id_partida_modificacion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
