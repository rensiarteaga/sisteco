...
{   
	...
	function Header()
	{       
   		$this->Image('../../../lib/images/logo_reporte.jpg',240,2,45,20);
  		$this->Ln(7); 		 		  
	}
	    ...
	    {		    	
	    	...
	    	if($tipo=='Disminucion'){
	    		...
	    		if ($row[6]=='Disminucion')
	    		{
	        		...
	        		$suma_mes_01=$suma_mes_01+$row[20];
	        		$suma_mes_02=$suma_mes_02+$row[21];
	        		$suma_mes_03=$suma_mes_03+$row[22];
	        		$suma_mes_04=$suma_mes_04+$row[23];
	        		$suma_mes_05=$suma_mes_05+$row[24];
	        		$suma_mes_06=$suma_mes_06+$row[25];
	        		$suma_mes_07=$suma_mes_07+$row[26];
	        		$suma_mes_08=$suma_mes_08+$row[27];
	        		$suma_mes_09=$suma_mes_09+$row[28];
	        		$suma_mes_10=$suma_mes_10+$row[29];
	        		$suma_mes_11=$suma_mes_11+$row[30];
	        		$suma_mes_12=$suma_mes_12+$row[31];
