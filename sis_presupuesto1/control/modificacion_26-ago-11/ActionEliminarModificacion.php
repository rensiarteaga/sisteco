...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarModificacion.php
Propósito:				Permite eliminar registros de la tabla tpr_modificacion
...
$nombre_archivo = "ActionEliminarModificacion.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarModificacion($id_modificacion);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
