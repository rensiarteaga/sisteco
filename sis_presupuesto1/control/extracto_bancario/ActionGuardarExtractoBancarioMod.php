...
if (sizeof($_GET) > 0)
	...
	{  
		...
		if ($id_extracto_bancario == "undefined" || $id_extracto_bancario == "")
		{
			...
			$res = $Custom -> InsertarExtractoBancario($id_extracto_bancario,$id_cuenta_bancaria,$fecha_movimiento,$agencia,$descripcion,$nro_documento,$monto,$tipo_importe,$sub_tipo_importe,$id_cbte);
			if(!$res)
			{
				//Se produjo un error
				$resp = new cls_manejo_mensajes(true, "406");
	...
	{	///////////////////////Modificación////////////////////
			...
			$res = $Custom->ModificarExtractoBancario($id_extracto_bancario,$sub_tipo_importe,$observaciones,$id_cbte);
