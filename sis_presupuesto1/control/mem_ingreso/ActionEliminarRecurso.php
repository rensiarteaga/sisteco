...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarRecurso.php
Propósito:				Permite eliminar registros de la tabla tpr_mem_ingreso
Tabla:					tpr_tpr_mem_ingreso
Parámetros:				$id_mem_ingreso
...
$nombre_archivo = "ActionEliminarRecurso.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarRecurso($id_mem_ingreso);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
