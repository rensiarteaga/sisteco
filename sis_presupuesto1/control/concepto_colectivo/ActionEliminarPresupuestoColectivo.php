...
/**
**********************************************************
Nombre de archivo:	    ActionEliminarPresupuestoColectivo.php
Propósito:				Permite eliminar registros de la tabla tpr_concepto_colectivo
...
$nombre_archivo = "ActionEliminarPresupuestoColectivo.php";
...
if($_SESSION["autentificado"]=="SI")
{
	...
	for($j = 0;$j < $cont; $j++)
	{
		...
		{	//Eliminación
			$res = $Custom-> EliminarPresupuestoColectivo($id_concepto_colectivo);
			if(!$res)
			{
				$resp = new cls_manejo_mensajes(true, "406");
