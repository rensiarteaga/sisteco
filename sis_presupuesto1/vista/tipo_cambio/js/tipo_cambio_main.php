<?php
/**
 * Nombre:		  	    tipo_cambio_main.php
 * Propósito: 			pagina que arranca la configuracion de la vista del Hijo
 * Autor:				Generado Automaticamente
 * Fecha creación:		2008-08-18 16:49:31
 *
 */
session_start();
?>
...
var maestro={id_parametro:<?php echo $m_id_parametro;?>,gestion_pres:decodeURIComponent('<?php echo $m_gestion_pres;?>'),estado_gral:decodeURIComponent('<?php echo $m_estado_gral;?>')};
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_tipo_cambio(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
