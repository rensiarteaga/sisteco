...
var componentes=new Array();
	...
	['id_siet_cbte','id_comprobante','nro_cbte','concepto_cbte'
	...
	vectorAtributos[8]={
      ...
      vectorAtributos[9]= {
		...
		vectorAtributos[10]={
			...
			displayField: 'concepto_cbte',
			queryParam: 'filterValue_0',
			filterCol:'compro.id_comprobante#compro.nro_cbte#sc.importe',
            filterColValue:'compro.id_comprobante#compro.nro_cbte#sc.importe',
			typeAhead:false,
			tpl:tpl_id_comprobante,
			forceSelection:true,
			mode:'remote',
...
var SelectionsRecord=sm.getSelected();
		...
		/*ds_extracto_bancario.baseParams={
				  tipo_declara:tipo_declara,
                		  id_periodo_dec:id_periodo_dec,
		 		 m_vista:'siet_cbte'	
		}*/
	...
	this.AdicionarBoton('../../../lib/imagenes/detalle.png','Detalle de Solicitud',btn_solicitud_compra_det,true,'solicitud_compra_det','Partidas');
	this.AdicionarBoton('../../../lib/imagenes/print.gif','Imprime el relacionamiento de cbtes y partidas',btn_reporte,true,'imp_ejecucion','Detalle Partidas');
	
	this.AdicionarMenuBotonSimple({text:'Cbtes', 
           nombre:'Inf. Cbtes',
           icon:'../../../lib/imagenes/det.ico',
           cls: 'x-btn-text-icon bmenu', // icon and text class
           items:[{ text:'Asoc Cbtes y EB',
        	      ...
        	      // cls:'x-btn-text-icon'
        	       ...
        	       {   text:'Cbtes. No Ingresan',
            	    ...
            	    {   text:'Conciliación Comprobantes',
