...
function pagina_actividad(idContenedor,direccion,paramConfig){
	...
	var ds = new Ext.data.Store({
		...
		record: 'ROWS',id:'id_actividad',totalRecords:'TotalCount'
		},[		
				'id_actividad',
		'codigo',
		'descripcion',
...
// txt descripcion
	...
	var config={titulo_maestro:'Actividad',grid_maestro:'grid-'+idContenedor};
	var layout_actividad=new DocsLayoutMaestro(idContenedor);
	...
	this.pagina(paramConfig,Atributos,ds,layout_actividad,idContenedor);
	...
	var paramFunciones={
		...
		Formulario:{html_apply:'dlgInfo-'+idContenedor,height:400,width:480,minWidth:150,minHeight:200,	closable:true,titulo:'Actividad'}};
