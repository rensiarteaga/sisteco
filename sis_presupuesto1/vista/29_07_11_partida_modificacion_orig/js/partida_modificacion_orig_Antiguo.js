...
// txt fecha_reg
   ...
   var data='id_modificacion='+maestro.id_modificacion+'&id_moneda='+maestro.id_moneda+'&id_parametro='+maestro.id_parametro+'&tipo_presupuesto='+maestro.tipo_presupuesto;	
   var config={titulo_maestro:'Partida Modificación Origen',grid_maestro:'grid-'+idContenedor,urlHijo:'../../../sis_presupuesto/vista/partida_modificacion_dest/partida_modificacion_dest.php?'+data};
...
//alert ('llega a la vista4');
	...
	{			
		...
		//_CP.getPagina(layout_partida_modificacion_orig.getIdContentHijo()).pagina.limpiarStore();
		
		//_CP.getPagina(layout_partida_modificacion_orig.getIdContentHijo()).pagina.bloquearMenu();
		
		 var dt='id_modificacion='+maestro.id_modificacion+'&id_moneda='+maestro.id_moneda+'&id_parametro='+maestro.id_parametro+'&tipo_presupuesto='+maestro.tipo_presupuesto;	
	...
	{
			//combo partida
			componentes[6].store.baseParams={sw_traspaso:'si',m_id_presupuesto:record.data.id_presupuesto};
			componentes[6].modificado=true;		
			componentes[6].setValue('');
			componentes[6].setDisabled(false);	
			
			//combo responsable de persupuesto
			componentes[9].store.baseParams={sw_responsable:'si',id_unidad_organizacional:record.data.id_unidad_organizacional};
	...
	layout_partida_modificacion_orig.getLayout().addListener('layout',this.onResize);//aregla la forma en que se ve el grid dentro del layout
