...
// txt justificacion
	...
	function btn_aprobar_traspaso()
	{
		...
		{			
			...
			//{
				var sw=false;
				if(confirm('Esta seguro de APROBAR los registros seleccionados?'))
						{sw=true}
				if(sw)
				{
					...
					var SelectionsRecord=sm.getSelections(); 			
		 			...
		 			for(var i=0 ; i<NumSelect ; i++)
		 			{
						...
						method:'POST',
						params:{cantidad_ids:NumSelect, id_partida_traspaso:arr_id_partida_traspasos[i], accion:'aprobar_modificacion'},  //estado traspaso el estado esta en concluido		
				...
				if(sw)
				{
					...
					var SelectionsRecord=sm.getSelections(); 			
		 			...
		 			for(var i=0 ; i<NumSelect ; i++)
		 			{
						...
						url:direccion+"../../../control/partida_traspaso/ActionEstadoPartidaTraspaso.php",
						method:'POST',
						params:{cantidad_ids:NumSelect, id_partida_traspaso:arr_id_partida_traspasos[i], accion:'rechazar_modificacion'},  //estado traspaso el estado esta en concluido		
						success:modificacion_Success,						
						failure:ClaseMadre_conexionFailure,
						timeout:100000000
						});						    
