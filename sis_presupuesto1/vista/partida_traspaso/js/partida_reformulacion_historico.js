 ...
 */
function pagina_partida_reformulacion_historico(idContenedor,direccion,paramConfig){
	...
	var ds = new Ext.data.Store({
		...
		baseParams:{filtro_reformulacion_concluidos:'si'},   //mostramos solo las reformulaciones concluidas
		remoteSort:true});
...
// txt justificacion
	...
	var layout_partida_reformulacion_historico=new DocsLayoutMaestro(idContenedor);
	layout_partida_reformulacion_historico.init(config);
	...
	this.pagina(paramConfig,Atributos,ds,layout_partida_reformulacion_historico,idContenedor);
	...
	this.getLayout=function(){return layout_partida_reformulacion_historico.getLayout()};
	...
	layout_partida_reformulacion_historico.getLayout().addListener('layout',this.onResize);//aregla la forma en que se ve el grid dentro del layout
