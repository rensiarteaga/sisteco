...
var elemento={pagina:new pagina_disminuciones_2(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
 ...
 * Fecha creación:		2010-05-10 18:01:22
 */
function pagina_disminuciones_2(idContenedor,direccion,paramConfig)
{
	...
	var ds = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/modificacion/ActionListarModificacion.php?tipo_modificacion=4&reformulacion=si'}),
...
//	function render_id_tipo_pres_gestion(value,cell,record,row,colum,store){return String.format('{0}', record.data['desc_tipo_pres']);}
	...
	Atributos[2] = {
		validacion: {
			...
			loadMask: true,
			triggerAction: 'all',
			store: new Ext.data.SimpleStore({fields:['id','valor'],data:[['1', 'Traspaso'],['2', 'Reformulación'],['3', 'Incremento'],['4', 'Disminución']]}),
			valueField:'id',
			displayField:'valor',
...
// txt fecha_conclusion
	...
	function btnDetalleModificaciones()
	{
		...
		//	layout_modificacion_aprobar.loadWindows(direccion+'../../../../sis_presupuesto/vista/partida_modificacion_orig/partida_modificacion_orig.php?'+data,'Disminuciones',ParamVentana);
			...
			layout_incremento.loadWindows(direccion+'../../../../sis_presupuesto/vista/partida_modificacion_orig/partida_modificacion_orig.php?'+data,'Disminuciones',ParamVentana);
    ...
    this.AdicionarBoton('../../../lib/imagenes/detalle.png','Detalle de los presupuestos y partidas afectadas',btnDetalleModificaciones,true,'detalle','Detalle Disminuciones'); //tucrem
	...
	this.AdicionarBoton('../../../lib/imagenes/tucrem.png','Autorizar la Modificación',btn_autorizacion_modificacion,true,'autorizacion_traspaso','Enviar Para Autorización');
	...
	this.AdicionarBoton('../../../lib/imagenes/book_next.png','Concluir la Modificación',btn_concluir_modificacion,true,'concluir_traspaso','Concluir Disminución');
