...
// txt fecha_reg
	...
	function evento_presupuesto( combo, record, index )
	{
			if(maestro.tipo_presupuesto == 1 || maestro.tipo_presupuesto == 4)
			{
				componentes[7].store.baseParams={m_sw_partida_cuenta:'si',m_id_presupuesto:record.data.id_presupuesto};
				CM_mostrarComponente(componentes[7]);
				CM_ocultarComponente(componentes[6]);
			...
			{
				componentes[6].store.baseParams={m_sw_partida_cuenta:'si',m_id_presupuesto:record.data.id_presupuesto};
				CM_mostrarComponente(componentes[6]);
				CM_ocultarComponente(componentes[7]);					
  ...
  function total_reformulacion(e){
  	...
  	var rec = ds2.getAt(1);
    	...
    	//console.log(parseFloat(ds2.getAt(0).data['total'])+parseFloat(rec.data['total']))
    ...
    function total_restante(e){
    	...
    	//console.log('restante>>>>> ',e.field,parseFloat(rec1.data[e.field])+parseFloat(e.value))
