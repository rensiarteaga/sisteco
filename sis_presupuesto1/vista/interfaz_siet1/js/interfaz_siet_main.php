...
function main(){
	...
	var elemento={pagina:new pagina_interfaz_siet(idContenedor,direccion,paramConfig,sw_vista),idContenedor:idContenedor};
	ContenedorPrincipal.setPagina(elemento);
}
Ext.onReady(main,main);

function pagina_interfaz_siet(idContenedor, direccion, paramConfig, sw_vista) {
	...
	*/
	...
	layout_interfaz_siet = new DocsLayoutProceso(idContenedor);
	layout_interfaz_siet.init(config);
	...
	this.pagina(paramConfig, vectorAtributos, layout_interfaz_siet, idContenedor);
			...
			Formulario:{
				...
				submit:function (){	
					...
					if(mensaje==""){
						...
						layout_interfaz_siet.loadWindows(direccion+'../../../../sis_presupuesto/vista/interfaz_siet/interfaz_siet_detalle.php?'+data,'Detalle SIET',ParamVentana);
					}
					else{
						alert(mensaje);
					}
