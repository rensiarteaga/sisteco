...
var elemento ={pagina:new EjecucionInversionReporte(idContenedor,direccion,paramConfig,configConsolidacion),idContenedor:idContenedor};
...
function EjecucionInversionReporte(idContenedor,direccion,paramConfig,configConsolidacion)
{
...
vectorAtributos[2]={
	...
	vectorAtributos[4]={
		validacion:{
			...
			loadMask:true,
			triggerAction:'all',
			store:new Ext.data.SimpleStore({fields:['ID','valor'],data:[['0','Por Proyectos'],['1','Por Financiadores']]}),
	...
	var config=
	{
		titulo_maestro:"Ejecución Inversión"
	};
	...
	var paramFunciones = {
		...
		Formulario:{
			labelWidth: 75, //ancho del label
		 	url:direccion+'../../../../control/_reportes/ejecucion_inversion/ActionPDFEjecucionInversion.php',
			abrir_pestana:true, //abrir pestana
			titulo_pestana:'Ejecución Inversión',
			fileUpload:false,
			columnas:['40%','40%'],			
			grupos:[
			{
				tituloGrupo:'Asigne Datos Para Consultar la Ejecución - Inversión ',
				columna:0,
				id_grupo:0
			}
