...
var elemento ={pagina:new EstadisticasUsuario(idContenedor,direccion,paramConfig,configConsolidacion),idContenedor:idContenedor};

ContenedorPrincipal.setPagina(elemento);

}
Ext.onReady(main,main);
function EstadisticasUsuario(idContenedor,direccion,paramConfig,configConsolidacion)
{
	...
	var config=
	{
		titulo_maestro:"Estadisticas Usuario"
	};
	layout_estadisticas_usuario=new DocsLayoutProceso(idContenedor);
	layout_estadisticas_usuario.init(config);
	...
	this.pagina(paramConfig,vectorAtributos,layout_estadisticas_usuario,idContenedor);
	...
	var paramFunciones={
		Formulario:{labelWidth:75,
		            url:direccion+'../../../../../sis_presupuesto/control/_reportes/estadisticas/ActionListarEstadisticasUsuario.php',
		            abrir_pestana:true,
		            titulo_pestana:'Estadisticas de transacciones por usuario',
		            fileUpload:false,
		            columnas:[420,420],
			        grupos:[{tituloGrupo:'Datos para el reporte Estadisticas por Usuario',
			        		 columna:0,
			        		 id_grupo:0
			        		}],
			        parametros:''}
	...
	function iniciarEventosFormularios()
	{
		...
		componentes[1].on('select',evento_subsistema);		
	}
	
	function evento_subsistema( combo, record, index )
	{		
		componentes[3].setValue(record.data.nombre_largo);
	}
