<?php 
/**
 * Nombre:		  	    fuente_financiamiento_main.php
...
var elemento={pagina:new pagina_fuente_financiamiento(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
