...
var maestro={
			...
			nombre_partida:decodeURIComponent('<?php echo utf8_decode($m_nombre_partida);?>'),
			...
			tipo_memoria:'<?php echo utf8_decode($m_tipo_memoria);?>'};
			
idContenedorPadre='<?php echo $idContenedorPadre;?>';
var elemento={idContenedor:idContenedor,pagina:new pagina_concepto_ingas(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)};
