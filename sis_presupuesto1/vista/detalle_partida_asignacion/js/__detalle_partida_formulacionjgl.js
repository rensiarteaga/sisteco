...
function pagina_detalle_partida_formulacion(idContenedor,direccion,paramConfig,maestro,idContenedorPadre)
{
	...
	var gridMaestro=new Ext.grid.Grid(div_grid_detalle,{ds:new Ext.data.SimpleStore({fields:['atributo','valor'],data:[['Presupuesto',maestro.id_presupuesto],
																														['Nombre Financiador',maestro.nombre_financiador],
																														['Nombre Regional',maestro.nombre_regional],
																														['Nombre Programa',maestro.nombre_programa],
																														['Nombre Proyecto',maestro.nombre_proyecto],
																														['Nombre Actividad',maestro.nombre_actividad]
																														]}),cm:cmMaestro});
	gridMaestro.render();
...
// txt id_metaproceso
	...
	var config={
		...
		layout_detalle_partida_formulacion = new DocsLayoutArb(idContenedor);
	...
	this.pagina(paramConfig,vectorAtributos,layout_detalle_partida_formulacion,idContenedor,DatosNodo,DatosDefecto);
	...
	var paramFunciones = {
		...
		Listar:{
			url:direccion+'../../../../sis_presupuesto/control/partida/ActionListarPartidaArb.php',
	...
	this.reload=function(params){
		...
		gridMaestro.getDataSource().loadData([['Presupuesto',maestro.id_presupuesto],	['Nombre Financiador',maestro.nombre_financiador],
																														['Nombre Regional',maestro.nombre_regional],
																														['Nombre Programa',maestro.nombre_programa],
																														['Nombre Proyecto',maestro.nombre_proyecto],
																														['Nombre Actividad',maestro.nombre_actividad]]);
		...
		cmpId_metaproceso=getComponente("id_metaproceso");
				...
				getTreePanel().on('checkchange', function(e,r){
				  ...
				  if(r==true){
							...
							Ext.Ajax.request({
							url:direccion+'../../../../sis_presupuesto/control/partida/ActionEliminarPartida.php?id_rol='+maestro.id_rol,
				  ...
				  if(r==false){
					      ...
					      Ext.Ajax.request({
						     url:direccion+'../../../../sis_presupuesto/control/partida/ActionEliminarPartida.php',
						 	 params: postData,
							 method:'POST',
							 success: gSuccess,
							 failure:fallaDropItem,
