...
var elemento={pagina:new pagina_incrementos_2(idContenedor,direccion,paramConfig),idContenedor:idContenedor};
...
// txt fecha_conclusion
	...
	var paramFunciones={
		...
		Formulario:{html_apply:'dlgInfo-'+idContenedor,height:350,width:480,minWidth:150,minHeight:200,	closable:true,titulo:'Modificación'}};
	...
	this.AdicionarBoton('../../../lib/imagenes/book_next.png','Concluir la Modificación',btn_concluir_modificacion,true,'concluir_traspaso','Concluir Incremento');
