...
function pagina_modificacion(idContenedor,direccion,paramConfig){
	...
	var ds = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({url: direccion+'../../../control/modificacion/ActionListarModificacion.php'}),
		...
		{			
			...
			//{
				...
				if(sw)
				{
					...
					method:'POST',
					params:{cantidad_ids:'1',id_modificacion:SelectionsRecord.data.id_modificacion,accion:'enviar_autorizar'},
		...
		{			
			...
			//{
				...
				if(sw)
				{
					...
					url:direccion+"../../../control/modificacion/ActionEstadoModificacion.php",
					method:'POST',
					params:{cantidad_ids:'1',id_modificacion:SelectionsRecord.data.id_modificacion,accion:'aprobar_modificacion'},
					success:modificacion_Success,
					failure:ClaseMadre_conexionFailure,
					timeout:100000000
					});				
		...
		{			
			...
			//{
				...
				if(sw)
				{
					...
					url:direccion+"../../../control/modificacion/ActionEstadoModificacion.php",
					method:'POST',
					params:{cantidad_ids:'1',id_modificacion:SelectionsRecord.data.id_modificacion,accion:'rechazar_modificacion'},
					success:modificacion_Success,
					failure:ClaseMadre_conexionFailure,
					timeout:100000000
					});				
